...
@section('breadcrumbs')
    ...
    <a href="{{url('gimnasio_usuario/'.$usuariogim->id)}}" class="breadcrumb">Ver Usuario</a>
@endsection
                ...
                <div class="row">
                    <div class="col s12 m6 l4">
                        <div class="input-field">
                            ...
                            <input type="number" name="aluClave" id="aluClave" class="validate" value="{{$usuariogim->dimnasio_usuario_id}}" readonly>
                        </div>
                    </div>
                    <div class="col s12 m6 l4">
