...
@section('breadcrumbs')
  ...
  <a href="{{url('gimnasio_alumno/cambiar_matricula/' . $alumno->id)}}" class="breadcrumb">Cambiar matrícula alumno</a>
@endsection
...
@section('content')
  ...
  <div class="row">
    <div class="col s12 ">
      {!! Form::open(['url' => 'gimnasio_alumno/cambiar_matricula/edit', 'method' => 'POST']) !!}
