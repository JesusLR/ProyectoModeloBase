...
@section('content')
    <div id="table-datatables">
        ...
        <a href="{{ url('/gimnasio_alumno/create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
        ...
        <div class="row">
            <div class="col s12">
                <table id="tbl-gimnasio-alumno" class="responsive-table display" cellspacing="0" width="100%">
                    <thead>
                    <tr>
                        <th>Clave Alumno</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#tbl-gimnasio-alumno').dataTable({
                ...
                "ajax": {
                    "type" : "GET",
                    'url': base_url+"/api/gimnasio_alumno/list",
                    beforeSend: function () {
