...
@section('breadcrumbs')
    ...
    <a href="" class="breadcrumb">Copiar inscritos</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_copiar_inscritos.store', 'method' => 'POST']) !!}
        <div class="card ">
            <div class="card-content ">
                <span class="card-title">COPIAR INSCRITOS</span>
...
@include('bachiller.copiarIncritos.guardadoDeMigracion')
@include('bachiller.copiarIncritos.obtenerGrupoOrigen')
@include('bachiller.copiarIncritos.obtenerGrupoDestino')
@include('bachiller.copiarIncritos.obtenerAlumnosGrupo')
