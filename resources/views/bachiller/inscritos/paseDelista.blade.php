...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_grupo_uady')}}" class="breadcrumb">Lista de grupos</a>
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_inscritos.asistencia_alumnos', 'method' => 'POST']) !!}
        <div class="card ">
...
@include('bachiller.inscritos.jsPaseDelista')
