...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_cambiar_contrasenia')}}" class="breadcrumb">Lista de docentes</a>
    <a href="{{url('bachiller_cambiar_contrasenia/'.$docente->id)}}" class="breadcrumb">Ver Docente</a>
@endsection
