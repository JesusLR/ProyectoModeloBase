...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_cambiar_contrasenia')}}" class="breadcrumb">Lista Docentes</a>
    <a href="{{url('bachiller_cambiar_contrasenia/create')}}" class="breadcrumb">Crear Contraseña</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_cambiar_contrasenia.store', 'method' => 'POST']) !!}
        <div class="card ">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
      ...
      function obtenerCorreoEmpleado(empleado_id) {
          ...
          $.get(base_url+`/bachiller_cambiar_contrasenia/getEmpleadoCorreo/${empleado_id}`, function(res,sta) {
