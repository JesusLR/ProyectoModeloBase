...
<div id="table-datatables">
    <h4 class="header">HISTORIAL ACADÉMICO (REVALIDACIONES)</h4>
    <a href="{{ route('bachiller.bachiller_revalidaciones.create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#tbl-historial-academico').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/bachiller_revalidaciones/list",
                beforeSend: function () {
