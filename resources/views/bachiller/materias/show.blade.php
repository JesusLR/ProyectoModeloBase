        ...
        <div class="card ">
          <div class="card-content ">
            ...
            <div id="general">
                ...
                <div class="col s12 m6 l4">
                    <div class="input-field">
                        {!! Form::text('matVigentePlanPeriodoActual', $materia->matVigentePlanPeriodoActual, array('readonly' => 'true')) !!}
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l4">
                        <div class="input-field">
                            {!! Form::text('matClasificacion', clasificacion($materia->matClasificacion, $ubicacion_id), array('readonly' => 'true')) !!}
...
@php
    function clasificacion($valor, $ubicacion_id){
