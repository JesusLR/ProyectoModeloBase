...
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_materia.agregarPreRequisitos', 'method' => 'POST']) !!}
            <div class="card ">
...
@section('footer_scripts')
    @include('bachiller.materias.scripts-pre_requisitos')
@endsection