...
<div id="table-datatables">
    ...
    <a href="{{ route('bachiller.bachiller_materia.create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#tbl-materia-bachiller').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/bachiller_materia/list",
                beforeSend: function () {
            ...
            "columns":[
                ...
                {data: "matVigentePlanPeriodoActual",name: "bachiller_materias.matVigentePlanPeriodoActual"},
                {data: "action"}
            ],
            //Apply the search
