...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_cgt_materias')}}" class="breadcrumb">CGT Materia</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_cgt_materias.store', 'method' => 'POST']) !!}
        <div class="card ">
            <div class="card-content ">
                ...
                <div id="general">
                    ...
                    <div class="row">
                        ...
                        {{--  <div class="col s12 m6 l4">
                            {!! Form::label('semestreCgt', 'Grado/Semestre *', array('class' => '')); !!}
                            <select id="semestreCgt" data-semestreCgt-id="{{old('semestreCgt')}}" class="browser-default validate select2" required name="semestreCgt"
                                style="width: 100%;">
                            </select>
                        </div>  --}}
                    </div>
...
@include('bachiller.CGTMaterias.crearTablaJs')


@include('bachiller.CGTMaterias.guardarJS')
