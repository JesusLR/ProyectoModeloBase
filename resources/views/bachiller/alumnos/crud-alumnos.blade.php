<script>
    ...
    function addRow_tutor(tutNombre, tutTelefono, tutCalle, tutColonia, tutCodigoPostal, tutPoblacion, tutEstado, id, tutCorreo,tutorAlumno_id) {
        ...
        var tutor_row = `<tr><input type="hidden" name="tutores[]" value="${tutNombre}~${tutTelefono}~${tutCalle}~${tutColonia}~${tutCodigoPostal}~${tutPoblacion}~${tutEstado}~${id}~${tutCorreo}~${tutorAlumno_id}"/>` +
                            ...
                            `<td><a class="desvincular" onclick='obtenerId(${tutorAlumno_id})' style="cursor:pointer;" title="Desvincular">
            ...
            success: function (data) {
                if(data){
                    ...
                    $.each(data, function (key, value) {
                        console.log(value);
                        (!$.isEmptyObject(value)) && addRow_tutor(value.tutNombre, value.tutTelefono, value.tutCalle, value.tutColonia, value.tutCodigoPostal, value.tutPoblacion, value.tutEstado, value.id, value.tutCorreo, value.tutorAlumno_id);
                    });
                }
            },
