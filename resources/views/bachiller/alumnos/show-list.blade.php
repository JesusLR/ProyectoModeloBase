...
@section('content')
    <div id="table-datatables">
        ...
        <a href="{{ route('bachiller.bachiller_alumno.create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
        ...
        <div class="row">
            <div class="col s12">
                <table id="tbl-alumno-bachiller" class="responsive-table display" cellspacing="0" width="100%">
                    <thead>
                    <tr>
                        <th>Clave Alumno</th>
    ...
    <div id="modalEstatusAlumno-bachiller" class="modal">
        <div class="modal-content">
            ...
            <div class="row">
                <div class="col s12">
                    <button type="button" class="guardar-estatus-alumno-bachiller btn-large waves-effect  darken-3 btn-flat" style="color: #fff;">
                        <i class="material-icons left">add</i>
                        Guardar
                    </button>
                </div>
    ...
    {{-- MODAL EQUIVALENTES --}}
    <div id="modalHistorialPagosAluBachiller" class="modal">
        <div class="modal-content">
            <div class="row">
                <div class="col s12 m6 l6">
                    <h4>Historial de pagos</h4>
...
@section('footer_scripts')
    ...
    <script>
        $(document).on("click", ".btn-modal-estatus-alumno", function (e) {
            ...
            $("#modalEstatusAlumno-bachiller").find(".alumnoId").val(alumnoId)
        ...
        $(document).on("click", ".guardar-estatus-alumno-bachiller", function (e) {
            e.preventDefault()

            var aluEstado = $(".aluEstado").val()
            var alumnoId = $("#modalEstatusAlumno-bachiller").find(".alumnoId").val()
            var resFechaBaja = $('#resFechaBaja').val();
            var resObservaciones = $('#resObservaciones').val();
            var conceptosBaja = $('#conceptosBaja').val();
            ...
            if (aluEstado !== "") {
                $.ajax({
                    ...
                    type: "POST",
                    dataType: "JSON",
                    url: base_url + "/bachiller_alumno/cambiarEstatusAlumno",
                })
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $.get(base_url+`/bachiller_alumno/conceptosBaja`, function(data) {
            ...
            $.fn.dataTable.ext.errMode = 'throw';
            $('#tbl-alumno-bachiller').dataTable({
                ...
                "ajax": {
                    "type" : "GET",
                    'url': base_url+"/bachiller_alumno/list",
                    beforeSend: function () {
