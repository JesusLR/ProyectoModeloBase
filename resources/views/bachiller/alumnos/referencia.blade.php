...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_curso')}}" class="breadcrumb">Lista de preinscritos</a>
@endsection

@section('content')
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_curso.crearReferencia', 'method' => 'POST']) !!}
    <div class="card ">
