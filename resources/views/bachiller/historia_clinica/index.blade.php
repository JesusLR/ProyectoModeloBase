...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_historia_clinica')}}" class="breadcrumb">Lista expedientes</a>
@endsection
...
<div id="table-datatables">
    ...
    <a href="{{ route('bachiller.bachiller_historia_clinica.create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var tableCurso = $('#tbl-historia-clinica').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url +"/bachiller_historia_clinica/list",
                beforeSend: function () {
