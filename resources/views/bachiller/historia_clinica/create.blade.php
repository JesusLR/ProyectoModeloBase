...
<a href="{{url('bachiller_historia_clinica/create')}}" class="breadcrumb">Agregar expediente</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_historia_clinica.store', 'method' => 'POST']) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col s12 m6 l4">
                            ...
                            <div class="input-field col s12 m6 l6">
                                ...
                                <label for="aluNivelIngr"><strong style="color: #000; font-size: 16px;">Semestre Ingreso *</strong></label>
                            </div>
                        </div>
                        <div class="col s12 m6 l4">
                            {{-- COLUMNA --}}
    ...
    {{--  
                ...
                {{-- FAMILIARES BAR --}}
                @include('bachiller.historia_clinica.familiares-create')
                
                {{--  EMBARAZO Y NACIMIENTO   --}}
                @include('bachiller.historia_clinica.embarazo-create')

                {{--  HISTORIA MEDICA   --}}
                @include('bachiller.historia_clinica.medica-create')

                {{--  HÁBITOS E HIGIENE  --}}
                @include('bachiller.historia_clinica.habitos-create')

                {{--  HISTORIA DEL DESARROLLO  --}}
                @include('bachiller.historia_clinica.desarrollo-create')

                {{--  ANTECEDENTES HEREDO FAMILIARES  --}}
                @include('bachiller.historia_clinica.heredo-create')

                {{--  RELACIONES SOCIALES  --}}
                @include('bachiller.historia_clinica.sociales-create')

                {{-- CONDUCTA  --}}
                @include('bachiller.historia_clinica.conducta-create')

                {{-- ACTIVIDADES QUE REALIZA  --}}
                @include('bachiller.historia_clinica.actividades-create')
            ...
            <div class="card-action">
                {!! Form::button('<i class=" material-icons left validar-campos">save</i> Guardar', ['class' => 'btn-guardar-alumno-bachiller btn-large waves-effect  darken-3','id'=>'btn-guardar-alumno-bachiller']) !!}
