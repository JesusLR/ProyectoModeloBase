...
<a href="{{url('bachiller_historia_clinica/'.$historia->id)}}" class="breadcrumb">Ver expediente</a>
@endsection
...
<div class="row">
                ...
                <div id="general">
                    ...
                    <div class="row">
                        <div class="col s12 m6 l4">
                            ...
                            <select disabled id="paisSecundariaId" class="browser-default validate select2"  name="paisSecundariaId" style="width: 100%;">
                        ...
                        <div class="col s12 m6 l4">
                            ...
                            <select disabled id="estado_secundaria_id" data-estado-id="{{$secundaria_estado_id}}"
                        ...
                        <div class="col s12 m6 l4">
                            ...
                            <select disabled id="municipio_secundaria_id" data-municipio-id="{{$secundaria_municipio_id}}"
                                class="browser-default validate select2"
                    ...
                    <div class="row">
                        <div class="col s12 m6 l4">
                            ...
                            <select disabled id="secundaria_id" data-secundaria-id="{{$alumno->secundaria_id}}"
                        ...
                        <div class="col s12 m6 l4">
                            ...
                            <select disabled id="sec_tipo_escuela" class="browser-default validate select2" name="sec_tipo_escuela"
                                style="width: 100%;">
                                <option value="" selected disabled>SELECCIONE UNA OPCIÓN</option>
    ...
    {{--  
                    ...
                    <div class="row">
                        <div class="col s12 m6 l4">
                            <div class="input-field">
                                {!! Form::text('hisTutorOficial', $historia->hisTutorOficial, array('id' => 'hisTutorOficial', 'class' => 'validate','maxlength'=>'255', 'readonly')) !!}
                        ...
                        <div class="col s12 m6 l4">
                            <div class="input-field">
                                {!! Form::text('hisParentescoTutor', $historia->hisParentescoTutor, array('id' => 'hisParentescoTutor', 'class' => 'validate','maxlength'=>'255', 'readonly')) !!}
                                <label for="hisParentescoTutor"><strong style="color: #000; font-size: 16px;">Parentesco legal *</strong></label>
                            </div>
                        </div>
                        <div class="col s12 m6 l4">
                            <div class="input-field">
                            {!! Form::number('hisCelularTutor', $historia->hisCelularTutor, array('id' => 'hisCelularTutor', 'class' => 'validate','min'=>'0','max'=>'9999999999','onKeyPress="if(this.value.length==10) return false;"', 'readonly')) !!}
                    ...
                    <div class="row">
                        <div class="col s12 m6 l4">
                            ...
                            {!! Form::email('hisCorreoTutor', $historia->hisCorreoTutor, ['id' => 'hisCorreoTutor', 'class' => 'noUpperCase', 'maxlength' => '100', 'readonly']) !!}
                            </div>
                        </div>
                        <div class="col s12 m6 l4">
                            <div class="input-field">
                                {!! Form::text('hisCalleTutor', $historia->hisCalleTutor, array('id' => 'hisCalleTutor', 'class' => 'validate','maxlength'=>'25', 'readonly')) !!}
                                <label for="hisCalleTutor"><strong style="color: #000; font-size: 16px;">Calle</strong></label>
                            </div>
                        </div>
                        <div class="col s12 m6 l4">
                            <div class="input-field">
                                {!! Form::text('hisNumeroExtTutor', $historia->hisNumeroExtTutor, array('id' => 'hisNumeroExtTutor', 'class' => 'validate','maxlength'=>'6', 'readonly')) !!}
                    ...
                    <div class="row">                   
                        <div class="col s12 m6 l4">
                            <div class="input-field">
                            {!! Form::text('hisNumeroIntTutor', $historia->hisNumeroIntTutor, array('id' => 'hisNumeroIntTutor', 'class' => 'validate','maxlength'=>'6', 'readonly')) !!}
                        ...
                        <div class="col s12 m6 l4">
                            <div class="input-field">
                                {!! Form::text('hisColoniaTutor', $historia->hisColoniaTutor, array('id' => 'hisColoniaTutor', 'class' => 'validate','maxlength'=>'60', 'readonly')) !!}
                                <label for="hisColoniaTutor"><strong style="color: #000; font-size: 16px;">Colonia</strong></label>
                            </div>
                        </div>
                        <div class="col s12 m6 l4">
                            <div class="input-field">
                                {!! Form::number('hisCPTutor', $historia->hisCPTutor, array('id' => 'hisCPTutor', 'class' => 'validate','min'=>'0','max'=>'99999','onKeyPress="if(this.value.length==5) return false;"', 'readonly')) !!}
