...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_cgt')}}" class="breadcrumb">Lista de Cgt</a>
    <a href="{{url('bachiller_cgt/create')}}" class="breadcrumb">Agregar Cgt</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_cgt.store', 'method' => 'POST']) !!}
