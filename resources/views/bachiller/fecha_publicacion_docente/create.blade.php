...
@section('breadcrumbs')
    ...
    <a href="{{route('bachiller.bachiller_fecha_publicacion_calificacion_docente.index')}}" class="breadcrumb">Lista fechas de captura de calificaciones</a>
    <a href="{{route('bachiller.bachiller_fecha_publicacion_calificacion_docente.create')}}" class="breadcrumb">Agregar fechas de captura calificaciones</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_fecha_publicacion_calificacion_docente.store','method' => 'POST']) !!}
        <div class="card ">
                        ...
                        <div class="col s12 m6 l4">
                            ...
                            <select id="bachiller_mes_evaluaciones_id" data-plan-id="{{old('bachiller_mes_evaluaciones_id')}}" class="browser-default validate select2" required name="bachiller_mes_evaluaciones_id"
                                ...
                                {{--  @foreach ($bachiller_mes_evaluaciones as $mes_evaluacion)
                                    <option value="{{$mes_evaluacion->id}}" {{ old('bachiller_mes_evaluaciones_id') == $mes_evaluacion->id ? 'selected' : '' }}>{{$mes_evaluacion->mes}}</option>
                                @endforeach  --}}
                            </select>
                        </div>  
                    </div>
...
@include('bachiller.fecha_publicacion_docente.getMesEvidenciaJs')
