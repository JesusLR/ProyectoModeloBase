...
<div id="table-datatables">
    ...
    <a href="{{ route('bachiller.bachiller_recuperativos.fecha_general_index') }}"
        class="btn-large waves-effect  darken-3" type="button">Ficha general
        <i class="material-icons left">add</i>
    </a>

    @if (auth()->user()->empleado_id == 4818 || auth()->user()->empleado_id == 4684)
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.updateEstadoPago', 'method' =>
    'POST', 'style' => 'display: inline;']) !!}
    {!! Form::button('<i class="material-icons left">refresh</i> Actualizar estado de pago', ['class' => 'btn-large
    waves-effect darken-3','type' => 'submit']) !!}
    {!! Form::close() !!}
    @endif

    <a href="{{ route('bachiller_recuperativos.pago_recuperativo') }}" class="btn-large waves-effect  darken-3"
        type="button">Pago de recuperativos
        <i class="material-icons left">monetization_on
        </i>
    </a>
