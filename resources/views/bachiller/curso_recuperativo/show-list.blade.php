...
@section('breadcrumbs')
    ...
    <label class="breadcrumb">Lista de cursos recuperativos</label>
@endsection

@section('content')

<div id="table-datatables">
    <h4 class="header">CURSOS RECUPERATIVOS</h4>
    @php use App\Models\User; @endphp
    {{--  @if (User::permiso("extraordinario") != "D" && User::permiso("extraordinario") != "P")      --}}
    <a href="{{ url('bachiller_curso_recuperativo/create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
        <i class="material-icons left">add</i>
    </a>
    {{--  @endif  --}}
    {{--  <a href="{{ url('solicitudes/bachiller_curso_recuperativo') }}" class="btn-large waves-effect  darken-3" type="button">Solicitudes
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#tbl-extra-bachiller').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/api/bachiller_curso_recuperativo",
                beforeSend: function () {
...
<script type="text/javascript">
    function modalValidarAlumno(aluClave){
        ...
        $('#tbl-validar-alumno-bachiller').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/api/bachiller_curso_recuperativo/validarAlumno/"+aluClave,
                beforeSend: function () {
                    $('.preloader').fadeIn(200,function(){$(this).append('<div id="preloader"></div>');;});
                },
                complete: function () {
