...
@section('template_title')
    Bachiller Observaciones
@endsection

@section('breadcrumbs')
    <a href="{{url('bachiller_curso')}}" class="breadcrumb">Inicio</a>
    <a href="{{url('bachiller_curso')}}" class="breadcrumb">Lista de Preinscripción</a>
    <a href="{{url('bachiller_curso/observaciones/'.$curso->id)}}" class="breadcrumb">Observaciones</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_curso.storeObservacionesCurso', 'method' => 'POST','enctype' => 'multipart/form-data', "class" => "form-guardar-bachiller"]) !!}
                        ...
                        <div class="col s12 m6 l8">
                            <div class="file-field input-field">
                                <a {{!$cursoObservaciones ? "disabled": ""}}
                                   class="btn" href="{{url('bachiller_curso/curso_archivo_observaciones/'. $curso->id)}}" target="blank">
