...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_curso/grupos_alumno/'.$curso->id)}}" class="breadcrumb">Lista de grupos alumno</a>
@endsection
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#tbl-grupo-cali').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/bachiller_curso/listGruposAlumno/{{$curso->aluClave}}",
                beforeSend: function () {
