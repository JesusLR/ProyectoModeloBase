...
@section('template_title')
  Bachiller historial de calificaciones
@endsection
...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_curso/' . $curso->id . '/historial_calificaciones_alumno')}}" class="breadcrumb">Historial de calificaciones</a>
@endsection
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    var tableCurso = $('#tbl-calificaciones').dataTable({
      ...
      "ajax": {
        "type" : "GET",
        'url': base_url + '/bachiller_curso/api/curso/' + cursoId + '/listHistorialCalifAlumnos/',
        beforeSend: function () {
