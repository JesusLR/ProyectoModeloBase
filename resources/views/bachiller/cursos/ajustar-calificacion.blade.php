...
<a href="{{url('bachiller_curso/grupos_alumno/'.$curso_id)}}" class="breadcrumb">Lista de grupos alumno</a>
...
<div class="row">
    <div class="col s12 "></div>
        {{ Form::open(['enctype' => 'multipart/form-data', 'method'=>'PATCH','route' => ['bachiller.bachiller_curso.ajustar_calificacion_update', $calificaciones->id]]) }}
        <div class="card ">
                ...
                <div id="general">
                    ...
                    <div class="row">
                        ...
                        <div class="col s12 m6 l4">
                            ...
                            <select name="grupo_id2" id="grupo_id2"
                                ...
                                <option value="{{$calificaciones->grupo_id}}">
                                    #{{$calificaciones->grupo_id}}, Grado: {{$calificaciones->gpoGrado}},
                    ...
                    <div class="row">
                        <div class="col s12 m6 l4">
                            ...
                            !!}
                            <select id="bachiller_grupo_evidencia_id" class="browser-default validate select2" required
                                name="bachiller_grupo_evidencia_id" style="width: 100%;"
                                data-mes-idold="bachiller_grupo_evidencia_id">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function obtenerMesEvaluacion(mes_id) {
            ...
            $("#bachiller_grupo_evidencia_id").empty();



            $.get(base_url+`/bachiller_grupo/getMesEvidencias/${mes_id}`, function(res,sta) {

                //seleccionar el post preservado
                var numeroEvaSeleccionadoOld = $("#bachiller_grupo_evidencia_id").data("mes-idold")
                $("#bachiller_grupo_evidencia_id").empty()
                ...
                if(res != ""){
                    ...
                    res.forEach(element => {
                        ...
                        $("#bachiller_grupo_evidencia_id").append(`<option value=${element.id} ${selected}>${element.mes}</option>`);

                    });
                    $('#bachiller_grupo_evidencia_id').trigger('change'); // Notify only Select2 of changes
                }else{
                    $("#bachiller_grupo_evidencia_id").append(`<option value="" selected disabled>NO HAY MES EVIDICENCIA PARA ESTE GRUPO</option>`);
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function obtenerMeses(id_evidencia_grupo) {
            ...
            $.get(base_url+`/bachiller_calificacion/getMeses/${id_evidencia_grupo}`, function(res,sta) {
        ...
        obtenerMeses($("#bachiller_grupo_evidencia_id").val())
        $("#bachiller_grupo_evidencia_id").change( event => {
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        function obtenerNumEvaluacion(mes) {
            ...
            $.get(base_url+`/bachiller_calificacion/getNumeroEvaluacion/${mes}`, function(res,sta) {
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        function obtenerAlumnos(alumnoId, grupoId, aluClave) {
            $.get(base_url+`/bachiller_curso/getCalificacionUnicoAlumno/${alumnoId}/${grupoId}/${aluClave}`, function(res,sta) {
                    ...
                    const data = res;
                        ...
                        const tableData = data.map(function(element){
                            ...
                            function calcularPromedio(id){
                                var parciales = 0;
                                var promedio  = 0;
                                $('.evidencia_' + element.bachiller_inscrito_id).each(function(){
                                    if ($(this).val() != "") {
                                        parciales++;
                                ...
                                $('#promedioTotal' + element.bachiller_inscrito_id).val(promedio);
                            }
                            ...
                            return (
                                `<tr>
                                    ...
                                    <td><input name='bachiller_inscrito_id' type='hidden' value='${element.bachiller_inscrito_id}'></td>
                                    <td>${element.perApellido1} ${element.perApellido2} ${element.perNombre}</td>
                                    <td><input id='evidencia1' value='${element.calificacion_evidencia1}' name='evidencia1' step="0.0" type='number' min="5" max="100" class='calif evidencia_${element.bachiller_inscrito_id}' data-inscritoid='${element.bachiller_inscrito_id}'></td>
                                    <td><input id='evidencia2' value='${element.calificacion_evidencia2}' name='evidencia2' step="0.0" type='number' min="5" max="100" class='calif evidencia_${element.bachiller_inscrito_id}' data-inscritoid='${element.bachiller_inscrito_id}'></td>
                                    <td><input id='evidencia3' value='${element.calificacion_evidencia3}' name='evidencia3' step="0.0" type='number' min="5" max="100" class='calif evidencia_${element.bachiller_inscrito_id}' data-inscritoid='${element.bachiller_inscrito_id}'></td>
                                    <td><input id='evidencia4' value='${element.calificacion_evidencia4}' name='evidencia4' step="0.0" type='number' min="5" max="100" class='calif evidencia_${element.bachiller_inscrito_id}' data-inscritoid='${element.bachiller_inscrito_id}'></td>
                                    <td><input id='evidencia5' value='${element.calificacion_evidencia5}' name='evidencia5' step="0.0" type='number' min="5" max="100" class='calif evidencia_${element.bachiller_inscrito_id}' data-inscritoid='${element.bachiller_inscrito_id}'></td>
                                    <td><input id='evidencia6' value='${element.calificacion_evidencia6}' name='evidencia6' step="0.0" type='number' min="5" max="100" class='calif evidencia_${element.bachiller_inscrito_id}' data-inscritoid='${element.bachiller_inscrito_id}'></td>
                                    <td><input id='evidencia7' value='${element.calificacion_evidencia7}' name='evidencia7' step="0.0" type='number' min="5" max="100" class='calif evidencia_${element.bachiller_inscrito_id}' data-inscritoid='${element.bachiller_inscrito_id}'></td>
                                    <td><input id='evidencia8' value='${element.calificacion_evidencia8}' name='evidencia8' step="0.0" type='number' min="5" max="100" class='calif evidencia_${element.bachiller_inscrito_id}' data-inscritoid='${element.bachiller_inscrito_id}'></td>
                                    <td><input id='evidencia9' value='${element.calificacion_evidencia9}' name='evidencia9' step="0.0" type='number' min="5" max="100" class='calif evidencia_${element.bachiller_inscrito_id}' data-inscritoid='${element.bachiller_inscrito_id}'></td>
                                    <td><input id='evidencia10' value='${element.calificacion_evidencia10}' name='evidencia10' step="0.0" type='number' min="5" max="100" class='calif evidencia_${element.bachiller_inscrito_id}' data-inscritoid='${element.bachiller_inscrito_id}'></td>
                                    <td><input onmouseover="this.value = parseFloat(this.value).toFixed(1)" readonly='true' id='promedioTotal${element.bachiller_inscrito_id}' name='promedioTotal' step="0.0" type='number' min="5" max="100" value='${element.promedio_mes}'></td>
                                </tr>`
                            );
        ...
        obtenerAlumnos($("#bachiller_grupo_evidencia_id").val(), $("#grupo_id2").val(), $("#aluClave").val())
        $("#bachiller_grupo_evidencia_id").change( event => {
            obtenerAlumnos(event.target.value,$("#grupo_id2").val(),$("#aluClave").val())
