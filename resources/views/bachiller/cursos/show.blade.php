...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_curso/'.$curso->id)}}" class="breadcrumb">Ver curso</a>
@endsection
            ...
            <div id="general">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m4">
                        <a href="#modalAlumnoDetalle-bachiller" data-alumno-id="{{ $curso->alumno_id  }}" class="btn modal-trigger btn-modal-alumno-detalle-bachiller button button--icon js-button js-ripple-effect ">Ver alumno</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col s12 m6 l4">
                ...
                <div class="row">
                    <div class="col s12 m6 l4">
                        {!! Form::label('curBachillerFoto', 'Foto del Curso', ['class' => '']); !!}
                        
                        <div class="input-field">
                            @if ($curso->curBachillerFoto && !strpos($curso->curBachillerFoto, '.pdf'))
                            ...
                            @if($curso->curBachillerFoto && strpos($curso->curBachillerFoto, '.pdf'))
                                <label>Imagen</label>
                                <embed src="/bachiller_curso_images/{{$curso->curBachillerFoto}}/{{$periodo->perAnio.'-'.$periodo->perNumero}}/{{$nombreCarpeta}}"
