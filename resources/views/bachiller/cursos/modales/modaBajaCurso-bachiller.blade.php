{{-- MODAL BAJA CURSO --}}
<div id="modalBajaCursoBachiller" class="modal">
    <div class="modal-content">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_curso.bajaCurso', 'method' => 'POST', 'class' => 'form-baja-alumno']) !!}
