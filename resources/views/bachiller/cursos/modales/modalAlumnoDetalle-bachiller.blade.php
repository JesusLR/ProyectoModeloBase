{{-- MODAL EQUIVALENTES --}}
<div id="modalAlumnoDetalle-bachiller" class="modal">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on("click", ".btn-modal-alumno-detalle-bachiller", function (e) {
            e.preventDefault()
            var alumno_id = $(this).data("alumno-id");
  
            $.get(base_url+`/bachiller_alumno/alumnoById/${alumno_id}`, function(res,sta) {
                console.log("res", res)
                ...
                $("#modalAlumnoDetalle-bachiller label").addClass("active")
