...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_formatos')}}" class="breadcrumb">Formatos</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_formatos.reporte', 'method' => 'POST']) !!}
      <meta name="csrf-token" content="{{ csrf_token() }}">
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">GENERAR FORMATO</span>
            ...
            <div id="general">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l4">
                        ...
                        <select id="cgtGradoSemestre" class="browser-default validate select2" data-cgt-grado="{{old('cgtGradoSemestre')}}"  name="cgtGradoSemestre" style="width: 100%;">
          ...
          <div class="card-action">
            {!! Form::button('<i class="material-icons left">save</i> Generar', [ 'id'=>'btn-guardar','class' => 'btn-large waves-effect  darken-3','type' => 'submit']) !!}
          </div>
        </div>
      {!! Form::close() !!}
    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        plan.on('change', function() {
            this.value ? getSemestresTODOS(this.value) : resetSelectTODOS('cgtGradoSemestre');
        });
    ...
    function crear_cgt_bachiller() {
        ...
        $.ajax({
            type: 'POST',
            url: '{{route('bachiller.bachiller_cgt.store')}}',
            dataType: 'json',
            data: $('form').serialize(),
