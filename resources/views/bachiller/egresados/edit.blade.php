...
@section('breadcrumbs')
	...
	<a href="{{url('bachiller_egresados')}}" class="breadcrumb">Lista de Egresados</a>
	<label class="breadcrumb">Editar Egresado</label>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {{ Form::open(array('method'=>'PUT','route' => ['bachiller_egresados.update', $egresado->id])) }}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">EDITAR EGRESADO #{{$egresado->id}}</span>
          ...
          <div id="filtros">
            ...
            <div class="row">
              <div class="col s12 m6 l4">
                <div class="input-field col s12 m6 14">
                  {!! Form::text('perApellido1', NULL, array('id' => 'perApellido1', 'class' => 'validate','readonly'=>'true')) !!}
                  {!! Form::label('perApellido1', 'Apellido Paterno', array('class' => '')); !!}
                </div>
                <div class="input-field col s1 m6 14">
                  {!! Form::text('perApellido2', NULL, array('id' => 'perApellido2', 'class' => 'validate','readonly'=>'true')) !!}
                  {!! Form::label('perApellido2', 'Apellido Materno', array('class' => '')); !!}
                </div>
              </div>
              <div class="col s12 m6 l4">
                <div class="input-field col s12 m6 14">
                  {!! Form::text('perNombre', NULL, array('id' => 'perNombre', 'class' => 'validate','readonly'=>'true')) !!}
                  {!! Form::label('perNombre', 'Nombre', array('class' => '')); !!}
                </div>
                <div class="input-field col s12 m6 14">
                  {!! Form::text('perSexo', NULL, array('id' => 'perSexo', 'class' => 'validate','maxlength'=>'1','readonly'=>'true')) !!}
                  {!! Form::label('perSexo', 'Sexo (F, M)', array('class' => '')); !!}
                </div>
              </div>
              <div class="col s12 m6 l4">
                <div class="input-field col s12 m6 14">
                  {!! Form::text('progClave', NULL, array('id' => 'progClave', 'class' => 'validate','min'=>'0','required','readonly'=>'true')) !!}
                  {!! Form::label('progClave', 'Clave de programa', array('class' => '')); !!}
                </div>
                <div class="input-field col s12 m6 14">
                   {!! Form::text('planClave', NULL, array('id' => 'planClave', 'class' => 'validate','min'=>'0','required','readonly'=>'true')) !!}
            ...
            <div class="row">
              <div class="col s12 m6 l4">
                <div class="input-field col s12 m6 14">
                  ...
                  {!! Form::number('totalCreditosPlan', NULL, array('id' => 'totalCreditosPlan', 'class' => 'validate','min'=>'1','step'=>'1','readonly'=>'true')) !!}
                </div>
                <div class="input-field col s12 m6 14">
            ...
            <div class="row">
              ...
              <div class="col s12 m6 l4">
                ...
                <div class="input-field col s12 m6 14">
                  {!! Form::number('cgtGradoSemestre', NULL, array('id' => 'cgtGradoSemestre', 'class' => 'validate','min'=>'0','max'=>'12','readonly'=>'true')) !!}
                  {!! Form::label('cgtGradoSemestre', 'Grado', array('class' => '')); !!}
                </div> 
                <div class="input-field col s12 m6 14">
                  {!! Form::text('cgtGrupo', NULL, array('id' => 'cgtGrupo', 'class' => 'validate','min'=>'0','readonly'=>'true')) !!}
              ...
              <div class="col s12 m6 l4">
                <br>
                <div class="input-field col s12 m6 14">
                  {!! Form::text('progClaveUltCurso', NULL, array('id' => 'progClaveUltCurso', 'class' => 'validate','maxlength'=>'3','readonly'=>'true')) !!}
                  {!! Form::label('progClaveUltCurso', 'Clave de programa', array('class' => '')); !!}
                </div>
                <div class="input-field col s12 m6 14">
                   {!! Form::text('curEstadoUltCurso', NULL, array('id' => 'curEstadoUltCurso', 'class' => 'validate','maxlength'=>'1','readonly'=>'true')) !!}
            ...
            <div class="row">
              ...
              <div class="col s12 m4 14">
                <div class="input-field col s12 m6 14">
                  ...
                  {!! Form::date('fechaExamenProf', NULL, array('id' => 'fechaExamenProf', 'class' => 'validate')) !!}
                </div>
                <div class="input-field col s12 m6 14">
                  <p style="text-align:center;">Fecha expedición de título</p>
                  {!! Form::date('fechaExpedicionTitulo', NULL, array('id' => 'fechaExpedicionTitulo', 'class' => 'validate')) !!}
                </div>
              </div>
              <div class="col s12 m4 14">
                <div class="input-field">
            ...
            <div class="row">
              <div class="col s12 m6 l4">
                <div class="input-field col s12 m6 14">
                  {!! Form::number('aluMatricula', NULL, array('id' => 'aluMatricula', 'class' => 'validate','min'=>'0','readonly'=>'true')) !!}
                  {!! Form::label('aluMatricula', 'Clave Sep (Mat)', array('class' => '')); !!}
                </div>
                <div class="input-field col s12 m6 14">
                  {!! Form::text('claveSegey', NULL, array('id' => 'claveSegey', 'class' => 'validate','readonly'=>'true')) !!}
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    var fillableForm = {
        ...
        // perIngreso: datos.resumen.resPeriodoIngreso,
        // perEgreso: datos.resumen.resPeriodoUltimo,
    ...
    buscarPeriodos(ubiClave, 'T', selectItems, periodosSelects);
    fillFormElements(fillableForm);
    disableElements(noEditable);
...
@include('bachiller.scripts.egresados')
</script>
@endsection