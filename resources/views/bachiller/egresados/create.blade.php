...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'bachiller_egresados.store', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
    ...
    $('#buscarAlumno').on('click',function(){
      ...
      if(aluClave && progClave && planClave && ubiClave && depClave){
        $.ajax({
          processing : 'true',
          serverSide : 'true',
          url : base_url+'/bachiller_egresados/buscar_alumno/' + aluClave,
          method : 'POST',
          data : {
            aluClave : aluClave,
            progClave : progClave,
