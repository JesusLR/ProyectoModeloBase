...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_empleado')}}" class="breadcrumb">Lista de empleados</a>
@endsection
...
<div id="table-datatables">
    ...
    <a href="{{ route('bachiller.bachiller_empleado.create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
        <i class="material-icons left">add</i>
    </a>
    <a href="{{ route('bachiller_empleado.cambio-estado') }}" class="btn-large waves-effect  darken-3" type="button">Cambio de estado
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#table-empleados-bachiller').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/bachiller_empleado/list",
                beforeSend: function () {
