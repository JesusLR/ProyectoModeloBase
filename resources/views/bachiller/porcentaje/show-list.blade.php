...
<div id="table-datatables">
    ...
    <a href="{{ route('bachiller.bachiller_porcentaje.create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
    ...
    <div class="row">
        <div class="col s12">
            <table id="tbl-porcentaje-bachiller" class="responsive-table display" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th>Ubicación</th>
                    <th>Año</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#tbl-porcentaje-bachiller').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/bachiller_porcentaje/list",
                beforeSend: function () {
