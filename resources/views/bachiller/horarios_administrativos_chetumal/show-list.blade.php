...
@section('template_title')
    Bachiller horarios administrativos
@endsection
...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_horarios_administrativos_seq')}}" class="breadcrumb">Horarios administrativos</a>
@endsection
        ...
        <div class="col s12">
            ...
            <div class="card ">
                ...
                <div class="card-action">
                    <a href="{{ url('/bachiller_horarios_administrativos_seq/calendario/create') }}" class="btn-agregar-horario btn-large waves-effect  darken-3" type="button">Agregar
...
<script type="text/javascript">
    ...
    $("#periodoId").on("change", function (e) {
        ...
        if ($("#empleadoId").val() !== "" && $("#periodoId").val() !== "") {
            $(".btn-agregar-horario").attr("href", base_url + "/bachiller_horarios_administrativos_seq/" + $("#empleadoId").val() + "/" + $("#periodoId").val() + "/calendario")
    ...
    $(document).ready(function() {
        ...
        function obtenerPeriodos(departamentoId) {
            ...
            $.get(base_url+`/bachiller_periodo/api/periodoByDepartamento/${departamentoId}`, function(res,sta) {
                $("#periodoId").append(`<option selected value="">SELECCIONAR</option>`);
                //seleccionar el post preservado
                $("#periodoId").empty()
                res.forEach(element => {
    ...
    $(document).ready(function() {
        $('#table-empleados').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url + "/api/bachiller_horarios_administrativos_seq",
                beforeSend: function () {
