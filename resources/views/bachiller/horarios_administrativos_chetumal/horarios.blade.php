...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'bachiller_horarios_administrativos_seq/agregarHorarios', 'method' => 'POST']) !!}
        <div class="card ">
          <div class="card-content ">
            ...
            <div id="general">
                ...
                <div class="row">
                    <div class="col s12">
                        <span>Docente: <b>{{$maestro->empNombre}} {{$maestro->empApellido1}} {{$maestro->empApellido2}}</b></span>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        ...
        if (claveMaestro !== "" && claveMaestro !== null && periodoId !== "" && periodoId !== null) {
            $('#tbl-horario').dataTable({
                ...
                "ajax": {
                    "type" : "GET",
                    'url': base_url + "/api/bachiller_horarios_administrativos_seq/horario/" + claveMaestro + "/" + periodoId,
                    beforeSend: function () {
        ...
        $('#tbl-horario-gpo').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url + "/api/bachiller_horarios_administrativos_seq/horario_gpo/" + claveMaestro + "/" + periodoId,
                beforeSend: function () {
                    $('.preloader').fadeIn(200, function() {
                        $(this).append('<div id="preloader"></div>');
                    });
