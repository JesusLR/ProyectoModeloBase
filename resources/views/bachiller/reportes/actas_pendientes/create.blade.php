...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_actas_pendientes.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
          ...
          <div id="filtros">
            ...
            <div class="row">
              <div class="col s12 m6 l4">
                ...
                <select name="tipoActa" id="tipoActa" class="browser-default validate select2" style="width: 100%;">
                  ...
                  <option value="EXTRAORDINARIO">Recuperativos</option>
                </select>
              </div>
              ...
              <div id="select-extras" class="col s12 m6 l4">
                ...
                <select name="actasPendientesExtras" id="actasPendientesExtras" class="browser-default validate select2" style="width: 100%;">
                  ...
                  <option value="pendientesPorCalificarNombre">Pendientes por calificar (nombre alumno)</option>
                </select>
              </div>
            ...
            <div class="row">
              ...
              <div class="col s12 m6 l4">
                ...
                {!! Form::date('extFecha', NULL, array('id' => 'extFecha', 'class' => 'validate','min'=>'0')) !!}                  
              </div>
            </div>
...
@include('bachiller.scripts.planes-espesificos')
  ...
  @include('bachiller.scripts.actas-pendientes')
