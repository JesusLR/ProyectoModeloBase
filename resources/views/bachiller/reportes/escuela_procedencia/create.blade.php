...
@section('breadcrumbs')
    ...
    <a href="" class="breadcrumb">Escuela de procedencia</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_escuela_procedencia.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">ESCUELA DE PROCEDENCIA</span>
