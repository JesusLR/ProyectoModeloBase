...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'route' => 'bachiller.bachiller_historial_alumno.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#buscarProgramas').click(function(){
      ...
      if(aluClave) {
        buscar_programas(`/bachiller_historial_alumno/obtenerProgramasClave/${aluClave}`);
      }else if(aluMatricula) {
        buscar_programas(`/bachiller_historial_alumno/obtenerProgramasMatricula/${aluMatricula}`);
      }else {
        resetSelect('plan_id');
        $('#botonSubmit').prop('disabled', true);
        swal({
