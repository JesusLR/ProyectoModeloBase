...
@section('content')
  <div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_relacion_bajas_periodo.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
        <div class="card ">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#departamento_id').on('change', function() {
      ...
      if(departamento_id) {
        getPeriodosTodos(departamento_id, 'periodo_id');
