...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_grupo_materia.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
        <div class="card ">
          <div class="card-content ">
            ...
            <div id="filtros">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l4">
                      <label for="empleado_id">Docente</label>
                      <select class="browser-default validate select2" data-plan-id="{{old('empleado_id')}}" name="empleado_id" id="empleado_id" style="width:100%;">
                        <option value="">SELECCIONE UNA OPCIÓN</option>
...
@include('bachiller.reportes.grupo_materia.obtenerGruposMateria')
