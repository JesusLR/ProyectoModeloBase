...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'route' => 'bachiller_reporte.boleta_calificaciones.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
...
@include('bachiller.reportes.calificaciones_por_grupo.ComboBoxJs')
