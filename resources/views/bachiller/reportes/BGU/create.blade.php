...
@section('breadcrumbs')
    ...
    <label class="breadcrumb">BGU Resultados</label>
@endsection
...
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_BGU_Resultados.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">BGU Resultados</span>
                ...
                {{--  <div class="row">
                    <div class="col s12 m6 l12">
                        <div class="input-field">
                            {!! Form::textarea('matriculas', NULL, array('id' => 'matriculas', 'class' => 'validate','min'=>'0')) !!}
                            {!! Form::label('matriculas', 'Matriculas', array('class' => '')); !!}
                        </div>
                    </div>
                </div>
                  --}}
