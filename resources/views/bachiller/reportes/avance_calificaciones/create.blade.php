...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Avance de calificaciones</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'route' => 'bachiller.bachiller_avance_calificaciones.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">REPORTE AVANCE DE CALIFICACIONES</span>
          {{-- NAVIGATION BAR--}}
