...
@section('breadcrumbs')
    ...
    <label class="breadcrumb">SOCA (Optativas)</label>
@endsection
...
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_SOCA.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">SOCA (Optativas)</span>
