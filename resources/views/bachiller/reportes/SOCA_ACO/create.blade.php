...
@section('breadcrumbs')
    ...
    <label class="breadcrumb">SOCA (Acompañamientos)</label>
@endsection
...
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_SOCA_ACO.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">SOCA (Acompañamientos)</span>
            ...
            <div id="general">
                ...
                <div class="row">
                    ...
                    {{--  <div class="col s12 m6 l4">
                        {!! Form::label('tipo_recupetivo', 'Tipo recuperativo *', array('class' => '')); !!}
                        <select id="tipo_recupetivo"
                            data-plan-id="{{old('tipo_recupetivo')}}"
                            class="browser-default validate select2" required name="tipo_recupetivo" style="width: 100%;">
