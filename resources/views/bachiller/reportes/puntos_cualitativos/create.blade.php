...
@section('breadcrumbs')
    ...
    <a href="" class="breadcrumb">Reporte de puntos cualitativos final</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_puntos_cualitativos.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">REPORTE DE PUNTOS CUALITATIVOS</span>
