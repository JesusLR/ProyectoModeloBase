...
<div id="table-datatables">
    <br>
    <a id="listaAsistencia" class="btn-large waves-effect darken-3" target="_blank"  href="{{url('bachiller_inscritos_seq/lista_de_asistencia/grupo/'.$grupo->id)}}">Lista asistencia
        <i class="material-icons left">picture_as_pdf</i>
    </a>
    <a href="{{route('bachiller.bachiller_asignar_grupo_seq.create')}}" class="btn-large waves-effect darken-3" type="button">Inscribir
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#tbl-grupo-bachiller').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/bachiller_inscritos_seq/list/" + {!! json_encode($grupo->id)!!},
                beforeSend: function () {
            ...
            "columns":[
                ...
                {data: "gpoGrado",name:"bachiller_cch_grupos.gpoGrado"},
                {data: "gpoClave",name:"bachiller_cch_grupos.gpoClave"},
                {data: "action"}
            ],
            //Apply the search
...
<script type="text/javascript">
$(document).ready(function() {
    var json =  base_url+"/bachiller_inscritos_seq/list/" + {!! json_encode($grupo->id)!!}
        $.ajax({
            type: "GET",
            url: json,
