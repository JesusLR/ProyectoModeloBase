...
@section('breadcrumbs')
    ...
    <a href="{{route('bachiller.bachiller_fecha_publicacion_calificacion_alumno.create')}}" class="breadcrumb">Agregar fechas de captura calificaciones</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_fecha_publicacion_calificacion_alumno.store','method' => 'POST']) !!}
        <div class="card ">
