                ...
                <div id="general">
                    ...
                    <div class="row">
                        <div class="col s12 m6 l4">
                            ...
                            <input type="text" name="" id="" value="{{$bachiller_evidencias->perNumero.'-'.$bachiller_evidencias->perAnio}}" readonly>
                        </div>
                        <div class="col s12 m6 l4">
                    ...
                    <div class="row">
                        <div class="col s12 m6 l4">
                            {!! Form::label('materia_acd_id', 'Grado', array('class' => '')); !!}
                            <input type="text" name="" id="" value="{{$bachiller_evidencias->matSemestre}}" readonly>
                        </div>
                        <div class="col s12 m6 l4">
                        ...
                        <div class="col s12 m6 l4">
                            {!! Form::label('materia_acd_id', 'Materia ACD', array('class' => '')); !!}
                            <input type="text" name="" id="" value="{{$bachiller_evidencias->gpoMatComplementaria}}" readonly>
                        </div>
                    </div>
