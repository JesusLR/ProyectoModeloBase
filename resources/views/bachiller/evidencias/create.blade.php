...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_evidencias.store', 'method' => 'POST']) !!}
        <div class="card ">
            ...
            <div id="general">
                ...
                <div class="row">                  
                    ...
                    <div class="col s12 m6 l4">
                        ...
                        <select id="materia_acd_id" disabled data-plan-id="{{old('materia_acd_id')}}"
                ...
                <div class="row">
                    <div class="col s12 m6 l4">
                        <div class="input-field">
                            {!! Form::number('eviNumero', NULL, array('id' => 'eviNumero', 'class' => '','maxlength'=>'15')) !!}
                    ...
                    <div class="col s12 m6 l4">
                        <div class="input-field">
                            {!! Form::text('eviDescripcion', NULL, array('id' => 'eviDescripcion', 'class' => '','maxlength'=>'255')) !!}
                    ...
                    <div class="col s12 m6 l4">
                        ...
                        {!! Form::date('eviFechaEntrega', NULL, array('id' => 'eviFechaEntrega', 'class' => '','maxlength'=>'15')) !!}
                    </div>  
                </div>
                ...
                <div class="row">
                    <div class="col s12 m6 l4">
                        <div class="input-field">
                            {!! Form::number('eviPuntos', NULL, array('id' => 'eviPuntos', 'class' => '','maxlength'=>'15')) !!}
                    ...
                    <div class="col s12 m6 l4">
                        ...
                        <select id="eviTipo"
                            data-eviTipo-id="{{old('eviTipo')}}"
                            class="browser-default validate select2" name="eviTipo" style="width: 100%;">
                            {{--  <option value="" selected disabled>SELECCIONE UNA OPCIÓN</option>  --}}
                            <option select value="A">A - DE PROCESO</option>
                ...
                <div class="row">
                    <div class="input-field col s6 m6 l3">
                        <a name="agregarMateriaEvidencias" id="agregarMateriaEvidencias" class="waves-effect btn-large tooltipped #2e7d32 green darken-3" 
                            data-position="right" data-tooltip="Agregar evidencia">
                ...
                <div class="row">
                    <div class="col s12 m6 l3">
                        ...
                        <b><input style="color: red" type="text" name="" id="contador" name="contador" value="0" readonly></b>
                    </div>
                    <div class="col s12 m6 l3">
                        <label for="contadorRestantes"><b style="color: #000">Puntos restantes</b></label>
                        <b><input style="color: red" type="text" name="" id="contadorRestantes" name="contadorRestantes" value="100" readonly></b>
                    </div>

                    <div class="col s12 m6 l3">
                        <label for="puntosProceso"><b style="color: #000">Puntos proceso</b></label>
                        <b><input style="color: red" type="text" name="" id="puntosProceso" name="puntosProceso" value="0" readonly></b>
                    </div>
                    <div class="col s12 m6 l3">
                        <label for="puntosProducto"><b style="color: #000">Puntos producto</b></label>
                        <b><input style="color: red" type="text" name="" id="puntosProducto" name="puntosProducto" value="0" readonly></b>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col s12">
                        <table id="tbl_materias_bachiller" class="responsive-table display" cellspacing="0" width="100%">
                            <thead>
                            <tr>
                                <th>Período-Año</th>
                                <th>Clave-Nombre</th>
...
@include('bachiller.evidencias.getMateriasACD')
    ...
    $('#agregarMateriaEvidencias').on('click',function(e){
        ...
        if(parseInt(eviPuntos) <= parseInt(contadorRestantes2)){
            ...
            if(materia_id && eviNumero && eviDescripcion && eviFechaEntrega && eviPuntos && eviTipo && eviFaltas){             
                ...
                $("#MateriaSemestre").prop('disabled',true);
    ...
    $('#tbl_materias_bachiller').on('click','.quitar', function (event) {
       ...
       $("#contadorRestantes").val(parseInt($(this).parents('tbody tr').find('td:eq(6)').text()) + parseInt(contadorRestantes2));
        ...
        if($('#tbl_materias_bachiller tbody tr').length == 0){
            ...
            $("#MateriaSemestre").prop('disabled',false);
            $('.submit-button').prop('disabled',true);
