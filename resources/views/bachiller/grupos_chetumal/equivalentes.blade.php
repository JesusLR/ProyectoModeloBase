{{-- MODAL EQUIVALENTES --}}
<div id="modalEquivalenteChetumal" class="modal">
    <div class="modal-content">
        ...
        <table id="tbl-grupo-equivalente-chetumal" class="responsive-table display" cellspacing="0" width="100%">
            <thead>
            <tr>
                <th>Plan</th>
                <th>Programa</th>
...
function seleccionarGrupo(grupo_id){
    $.get(base_url+`/bachiller_grupo_seq/getGrupo/${grupo_id}`,function(res,sta) {
