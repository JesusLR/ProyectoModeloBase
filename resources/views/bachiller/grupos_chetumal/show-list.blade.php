...
<div id="table-datatables">
    ...
    <div class="row">
        <div class="col s12">
            <a href="{{ route('bachiller.bachiller_grupo_seq.create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
                <i class="material-icons left">add</i>
            </a>
             {{--  <a href="{{ route('bachiller.bachiller_calificacion_chetumal.create') }}" class="btn-large waves-effect  darken-3" type="button">Calificaciones
                <i class="material-icons left">add</i>
            </a>   --}}
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#tbl-grupo-bachiller').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/bachiller_grupo_seq/list",
                beforeSend: function () {
            ...
            "columns":[
                ...
                {data: "periodo_numero", name: "periodo_numero"},
                ...
                {data: "recuperacion", name: "gpoTurno"},  
                {data: "recuperacion"},              
                {data: "action"}
            ],
            //Apply the search
