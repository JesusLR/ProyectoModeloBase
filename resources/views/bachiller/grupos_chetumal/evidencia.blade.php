...
@section('breadcrumbs')
    ...
    <a href="{{ url('bachiller_grupo_seq/'.$grupo->id.'/evidencia') }}" class="breadcrumb">Agregar evidencia</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_grupo_seq.guardar_actualizar_evidencia', 'method' => 'POST']) !!}
        <div class="card ">
          <div class="card-content ">
            ...
            {{-- GENERAL BAR--}}
            <div id="general">
                {{-- <input type="hidden" name="bachiller_grupo_seq_id" value="{{$grupo->id}}"> --}}
...
@include('bachiller.grupos_chetumal.funcionesJS')
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function obtenerDatos(grupo_id,mes_id) {
            ...
            $.get(base_url+`/bachiller_calificacion_seq/api/getEvidencias/${grupo_id}/${mes_id}`, function(res,sta) {
        ...
        obtenerDatos($("#bachiller_grupo_id").val(),$("#bachiller_mes_evaluacion_id").val())
        $("#bachiller_mes_evaluacion_id").change( event => {
            obtenerDatos($("#bachiller_grupo_id").val(),event.target.value)
        });
     });
  </script>
