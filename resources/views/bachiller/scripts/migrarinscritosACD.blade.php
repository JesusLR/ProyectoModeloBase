<script type="text/javascript">
    $(document).ready(function() {
        ...
        function obtenerDepartamentos(ubicacionId) {
            ...
            $.get(base_url+`/bachiller_migrar_inscritos_acd/api/getDepartamentosPorUbiClave/${ubicacionId}`, function(res,sta) {
...
<script type="text/javascript">
    $(document).ready(function() {
        function obtenerEscuelas (departamentoId) {
            ...
            $.get(base_url+`/bachiller_api/escuelas/${departamentoId}`,function(res,sta){
