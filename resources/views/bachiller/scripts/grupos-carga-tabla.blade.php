        ...
        if (periodo_id != "" && cgt_id != "") {
            ...
            $.get(base_url + `/bachiller_paquete/todos/getCgtsGruposTodos/${event.target.value}/${periodo_id}/${cgt_id}`, function(todos, sta) {
                todos.forEach(elementTodos => {
                    if(elementTodos.gpoMatComplementaria != null){
                        $("#grupo_id").append(`<option value=${elementTodos.id}><b>Materia:</b> ${elementTodos.bachiller_materia.matClave}-${elementTodos.bachiller_materia.matNombre} <b>Materia complementaria:</b> ${elementTodos.gpoMatComplementaria} <b>Maestro:</b> ${elementTodos.bachiller_empleado.id}-${elementTodos.bachiller_empleado.empNombre} ${elementTodos.bachiller_empleado.empApellido1} ${elementTodos.bachiller_empleado.empApellido2} <b>CGT:</b> ${elementTodos.gpoGrado}-${elementTodos.gpoClave}-${elementTodos.gpoTurno} </option>`);  
