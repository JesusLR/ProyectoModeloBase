...
function resetSelectTODOS(selectId) {
    $('#' + selectId).empty().append(new Option('TODOS', ''));
    $('#' + selectId).trigger('change');
}
...
function getDepartamentos(ubicacion_id, targetSelect = 'departamento_id', val = null, dataName = null) {
    ...
    $.ajax({
        type: 'GET',
        url: base_url + '/bachiller_api/departamentos/' + ubicacion_id,
        dataType: 'json',
...
function getDepartamentosListaCompleta(ubicacion_id, targetSelect = 'departamento_id', val = null, dataName = null) {
    ...
    $.ajax({
        type: 'GET',
        url: base_url + '/bachiller_api/get_departamentos_lista_completa/' + ubicacion_id,
        dataType: 'json',
        data: { ubicacion_id: ubicacion_id },
        success: function(departamentos) {
            if (departamentos) {
...
function getPeriodos(departamento_id, targetSelect = 'periodo_id', val = null, dataName = null) {
    ...
    $.ajax({
        type: 'GET',
        url: base_url + '/bachiller_periodo/api/periodos/' + departamento_id,
        dataType: 'json',
...
function getPeriodosTodos(departamento_id, targetSelect = 'periodo_id', val = null, dataName = null) {
    var select = $('#' + targetSelect);
    var current_data = dataName || 'periodo-id';
    var current_value = val || select.data(current_data);
    select.empty().append(new Option('SELECCIONE UNA OPCIÓN', ''));
    $.ajax({
        type: 'GET',
        url: base_url + '/bachiller_periodo/todos/periodos/' + departamento_id,
        dataType: 'json',
        data: { departamento_id: departamento_id },
        success: function(periodos) {
            if (periodos) {
...
function getPeriodosCurso(departamento_id, targetSelect = 'periodo_id', val = null, dataName = null) {
    var select = $('#' + targetSelect);
    var current_data = dataName || 'periodo-id';
    var current_value = val || select.data(current_data);
    select.empty().append(new Option('SELECCIONE UNA OPCIÓN', ''));
    $.ajax({
        type: 'GET',
        url: base_url + '/bachiller_periodo/curso/periodos/' + departamento_id,
        dataType: 'json',
        data: { departamento_id: departamento_id },
        success: function(periodos) {
            if (periodos) {
...
/*                                  No borrar                                 */
/* -------------------------------------------------------------------------- */
{{-- envia los datos del periodo por el campo perAnioPago, esto se usa en la mayoria de los reportes  --}}
...
function getPeriodos2Todos(departamento_id, targetSelect = 'periodo_id', val = null, dataName = null) {
    var select = $('#' + targetSelect);
    var current_data = dataName || 'periodo-id';
    var current_value = val || select.data(current_data);
    select.empty().append(new Option('SELECCIONE UNA OPCIÓN', ''));
...
function getPeriodos_fieldTodos(departamento_id, targetSelect, val = null, dataName = null, field = 'perNumero') {
    var select = $('#' + targetSelect);
    var current_data = dataName || 'periodo-field-value';
    var current_value = val || select.data(current_data);
    select.empty().append(new Option('SELECCIONE UNA OPCIÓN', ''));
...
function getPeriodos_afterDate(departamento_id, targetSelect, val = null, dataName = null, fecha = null) {
    ...
    $.ajax({
        type: 'GET',
        url: base_url + '/bachiller_periodo/api/periodo/' + departamento_id + '/posteriores',
        dataType: 'json',
...
function getEscuelas(departamento_id, targetSelect = 'escuela_id', val = null, dataName = null) {
    ...
    $.ajax({
        type: 'GET',
        url: base_url + '/bachiller_api/escuelas/' + departamento_id,
        dataType: 'json',
        data: { departamento_id: departamento_id },
...
function getEscuelasListaCompleta(departamento_id, targetSelect = 'escuela_id', val = null, dataName = null) {
    ...
    $.ajax({
        type: 'GET',
        url: base_url + '/bachiller_api/get_escuelas_lista_completa/' + departamento_id,
        dataType: 'json',
        data: { departamento_id: departamento_id },
        success: function(escuelas) {
            if (escuelas) {
...
function getProgramas(escuela_id, targetSelect = 'programa_id', val = null, dataName = null) {
    ...
    $.ajax({
        type: 'GET',
        url: base_url + '/bachiller_programa/api/programas/' + escuela_id,
        dataType: 'json',
        data: { escuela_id: escuela_id },
        success: function(programas) {
            if (programas) {
                $.each(programas, function(key, value) {
                    //select.empty().append(new Option(value.progClave + '-' + value.progNombre, value.id));
...
function getPlanes(programa_id, targetSelect = 'plan_id', val = null, dataName = null) {
    ...
    $.ajax({
        type: 'GET',
        url: base_url + '/bachiller_api/api/planes/' + programa_id,
        dataType: 'json',
...
function getPlanesTodos(programa_id, targetSelect = 'plan_id', val = null, dataName = null) {
    var select = $('#' + targetSelect);
    var current_data = dataName || 'plan-id';
    var current_value = val || select.data(current_data);
    select.empty().append(new Option('SELECCIONE UNA OPCIÓN', ''));
    $.ajax({
        type: 'GET',
        url: base_url + '/bachiller_api/api/planesTodos/' + programa_id,
        dataType: 'json',
        data: { programa_id: programa_id },
        success: function(planes) {
            if (planes) {
...
function getSemestres(plan_id, targetSelect = 'cgtGradoSemestre', val = null, dataName = null) {
    ...
    $.ajax({
        type: 'GET',
        url: base_url + '/bachiller_plan/plan/semestre/' + plan_id,
        dataType: 'json',
        data: { plan_id: plan_id },
        success: function(plan) {
            if (plan) {
                //PARA SECUNDARIA SON 3 GRADOS
...
function getSemestresTODOS(plan_id, targetSelect = 'cgtGradoSemestre', val = null, dataName = null) {
    var select = $('#' + targetSelect);
    var current_data = dataName || 'cgt-grado';
    var current_value = val || select.data(current_data);
    ...
    $.ajax({
        type: 'GET',
        url: base_url + '/api/plan/semestre/' + plan_id,
        dataType: 'json',
        data: { plan_id: plan_id },
        success: function(plan) {
            if (plan) {
...
function getMaterias(plan_id, targetSelect = 'materia_id', val = null, dataName = null) {
    ...
    $.ajax({
        type: 'GET',
        url: base_url + '/bachiller_materia/getMateriasByPlan/' + plan_id,
        dataType: 'json',
        data: { plan_id: plan_id },
...
function getCgts_plan_periodo(plan_id, periodo_id, targetSelect = 'cgt_id', val = null, dataName = null) {
    var select = $('#' + targetSelect);
    ...
    $.ajax({
        type: 'GET',
        url: base_url + '/bachiller_cgt/api/cgts/' + plan_id + '/' + periodo_id,
        dataType: 'json',
...
function getEstadosMadre(paisMadre_Id, targetSelect = 'estadoMadre_id', val = null, dataName = null) {
    ...
    $.ajax({
        type: 'GET',
        url: base_url + '/bachiller_historia_clinica/api/estados/' + paisMadre_Id,
        dataType: 'json',
...
function getMunicipiosMadre(estadoMadre_id, targetSelect = 'municipioMadre_id', val = null, dataName = null) {
    ...
    $.ajax({
        type: 'GET',
        url: base_url + '/bachiller_historia_clinica/api/municipios/' + estadoMadre_id,
        dataType: 'json',
...
function getPreparatorias(municipio_id, targetSelect, val = null, dataName = null) {
    ...
    $.ajax({
        type: 'GET',
        url: base_url + '/bachiller_alumno/preparatoriaProcedencia/' + municipio_id,
        dataType: 'json',
...
function getSecundaria(municipio_id, targetSelect, val = null, dataName = null) {
    var select = $('#' + targetSelect);
    var current_data = dataName || 'secundaria-id';
    var current_value = val || select.data(current_data);
    select.empty().append(new Option('SELECCIONE UNA OPCIÓN', ''));
    $.ajax({
        type: 'GET',
        url: base_url + '/bachiller_alumno/api/secundariaProcedencia/' + municipio_id,
        dataType: 'json',
        data: { municipio_id: municipio_id },
        success: function(secundarias) {
            if (secundarias) {
                $.each(secundarias, function(key, value) {
                    select.append(new Option(value.secNombre, value.id));
                    (value.id == current_value) && select.val(value.id);
                });
                select.trigger('change');
                select.trigger('click');
...
function periodo_fechasInicioFin(periodo_id, selectInicial = null, selectFinal = null) {
    ...
    $.ajax({
        type: 'GET',
        url: base_url + '/bachiller_periodo/api/periodo/' + periodo_id,
        dataType: 'json',
