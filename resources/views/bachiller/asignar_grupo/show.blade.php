...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_asignar_grupo')}}" class="breadcrumb">Lista de Inscritos Materia</a>
    <a href="{{url('bachiller_asignar_grupo/'.$inscrito->id)}}" class="breadcrumb">Ver inscrito materia</a>
@endsection
          ...
          <div class="card-content ">
            ...
            <div id="general">
                ...
                <div class="row">
                    <div class="col s12 ">
                        <div class="input-field">
                            {!! Form::text('grupo_id', $inscrito->bachiller_grupo->gpoGrado.'-'.$inscrito->bachiller_grupo->gpoClave.'-'.$inscrito->bachiller_grupo->gpoTurno.' '.$inscrito->bachiller_grupo->gpoMatComplementaria.', '.$inscrito->bachiller_grupo->bachiller_materia->matNombre, array('readonly' => 'true')) !!}
