        ...
        $("#tablePrint").html("");
        $.get(base_url+`/bachiller_asignar_grupo/obtener_grupos_materias/${cgt_actual}`, function(res, sta) {
        ...
        $("#tablePrintAcd").html("");
        $.get(base_url+`/bachiller_asignar_grupo/obtener_grupos_materias_acd_ingles/${cgt_actual}`, function(res, sta) {
        ...
        $.get(base_url+`/bachiller_asignar_grupo/obtener_grupos_materias_optativas/${cgt_actual}`, function(res, sta) {
        ...
        $.get(base_url+`/bachiller_asignar_grupo/obtener_grupos_materias_ocupacionales/${cgt_actual}`, function(res, sta) {
        ...
        $.get(base_url+`/bachiller_asignar_grupo/obtener_grupos_materias_complementaria/${cgt_actual}`, function(res, sta) {
        ...
        $.get(base_url+`/bachiller_asignar_grupo/obtener_grupos_materias_extra/${cgt_actual}`, function(res, sta) {
