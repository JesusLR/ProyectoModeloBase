...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_asignar_grupo/'.$inscrito->id.'/edit')}}" class="breadcrumb">Editar inscrito materia</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
        {{ Form::open(array('method'=>'PUT','route' => ['bachiller.bachiller_asignar_grupo.update', $inscrito->id])) }}
        <div class="card ">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#curso_id").change( event => {
            ...
            $.get(base_url+`/bachiller_asignar_grupo/grupos/${event.target.value}`, function(res, sta) {
