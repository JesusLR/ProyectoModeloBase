<script type="text/javascript">
    $(document).ready(function() {
        ...
        function obserBoleta(plan_id, periodo_id,cgt_id, mes) {
            $.get(base_url+`/bachiller_obs_boleta/obtenerObsBoleta/${plan_id}/${periodo_id}/${cgt_id}/${mes}`, function(res,sta) {
                ...
                if(res.length > 0){
                    ...
                    let myTable= "<table><tr><td style='color: #000; display:none;'></td>";
                        ...
                        for (let i = 0; i < res.length; i++) {
                            ...
                            myTable+="<tr><td style='display:none;'><input name='id' type='hidden' value='"+res[i].id+"'></td>";        
