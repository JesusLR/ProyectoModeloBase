        ...
        $("#bachiller_evidencia_id").change(event => {
            ...
            $.get(base_url + `/bachiller_evidencias_inscritos/capturas_realizadas/${bachiller_grupo_id}/${event.target.value}`, function(res, sta) {
                ...
                if (bachiller_evidencias.length > 0) {
                    ...
                    $("#puntosMaximos").text(bachiller_evidencias[0].eviPuntos);
                    ...
                    bachiller_evidencias.forEach(function(element, i) {
                        ...
                        if(estado_act == "C"){
                            myTable += `<td><input type='number' readonly onkeyup="if(this.value > ${element.eviPuntos}){this.value='';}else if(this.value < 0){this.value='';}" id='ievPuntos' class='noUpperCase' name='ievPuntos[]' value='${element.ievPuntos}' step='0.1'></td>`;
                        ...
                        if(ubicacion == "CME"){
                            if(se_registra_faltas == "S"){
                                ...
                                myTable += `<td><select style='margin-top:-15px;' id='ievClaveCualitativa1_${element.bachiller_inscrito_id}' class='browser-default validate select2' name='ievClaveCualitativa1[]'>`;
