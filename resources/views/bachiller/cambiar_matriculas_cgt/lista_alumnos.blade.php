...
<script type="text/javascript">
    ...
    function buscarCurso(cgt_id, alumno_id) {
      $.ajax({
        type: 'GET',
        url: `${base_url}/bachiller_cambiar_matriculas_cgt/${cgt_id}/buscar_alumno/${alumno_id}`,
        dataType: 'json',
    ...
    function cambiarMatricula(cgt_id, alumno_id, nueva_matricula) {
      $.ajax({
        type: 'POST', 
        url: `${base_url}/bachiller_cambiar_matriculas_cgt/${cgt_id}/actualizar/${alumno_id}`,
        dataType: 'json',
    ...
    function cambiarMultiplesMatriculas(cgt_id, listado) {
      $.ajax({
        type: 'POST',
        url: `${base_url}/bachiller_cambiar_matriculas_cgt/${cgt_id}/actualizar_lista`,
        dataType: 'json',
