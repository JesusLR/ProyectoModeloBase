...
<div id="table-datatables">
    @php
        $user = auth()->user()->campus_cch;
    @endphp
    <h4 class="header">INSCRITOS MATERIA</h4>
    {{-- @php use App\Models\User; @endphp
        @if (User::permiso("inscrito") != "D" && User::permiso("inscrito") != "P") --}}
        <a href="{{ route('bachiller.bachiller_asignar_grupo_seq.create') }}" class="btn-large waves-effect darken-3" type="button">Por materias
            <i class="material-icons left">add</i>
        </a>

        <a href="{{ route('bachiller.bachiller_asignar_grupo_seq.create_inscrito_recuperacion') }}" class="btn-large waves-effect darken-3" type="button">Para recuperación
            <i class="material-icons left">add</i>
        </a>

        @if ($user == 1)
        <a href="{{ route('bachiller.bachiller_asignar_grupo_seq.create_por_grupo') }}" class="btn-large waves-effect darken-3" type="button">Por grupos
            <i class="material-icons left">add</i>
        </a>
        @endif
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#tbl-inscrito-bachiller').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/bachiller_asignar_grupo_seq/list",
                beforeSend: function () {
            ...
            "columns":[
                ...
                {data: "semestre"},
                {data: "claveGrupo"},
                {data: "gpoMatComplementaria",name:"bachiller_grupos.gpoMatComplementaria"},
