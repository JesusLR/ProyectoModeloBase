        ...
        $("#tablePrint").html("");
        $.get(base_url+`/bachiller_asignar_grupo_seq/obtener_grupos_materias/${cgt_actual}`, function(res, sta) {
        ...
        $.get(base_url+`/bachiller_asignar_grupo_seq/obtener_grupos_materias_extra/${cgt_actual}`, function(res, sta) {
        ...
        $.get(base_url+`/bachiller_asignar_grupo_seq/obtener_grupos_materias_competencias/${cgt_actual}`, function(res, sta) {
        ...
        $.get(base_url+`/bachiller_asignar_grupo_seq/obtener_grupos_materias_especialidad/${cgt_actual}`, function(res, sta) {
