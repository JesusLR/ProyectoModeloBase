...
<a href="{{route('bachiller.bachiller_asignar_grupo_seq.index')}}" class="breadcrumb">Lista de Inscritos</a>
<a href="{{route('bachiller.bachiller_asignar_grupo_seq.create')}}" class="breadcrumb">Agregar Inscrito</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
        ...
        'bachiller.bachiller_asignar_grupo_seq.store_por_grupo', 'method' => 'POST']) !!}
        <div class="card ">
            <div class="card-content ">
                ...
                <div id="general">
                    ...
                    <div class="row" id="Tabla">                        
                        <div class="col s12">
                            <h5 style="color: red; display: none;" id="paraescolar">MATERIAS PARA ESCOLAR</h5
                            <div class="responsive-table display" cellspacing="0" width="100%" id="tablePrintParaEscolar">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" id="Tabla">
                        <div class="col s12">
                            <h5 style="color: red; display: none;" id="extras">MATERIAS EXTRACURRICULARES</h5>
                    ...
                    <div class="row" id="Tabla">
                        <div class="col s12">
                            <h5 style="color: red; display: none;" id="competencias">MATERIAS COMPETENCIAS</h5>
                            <div class="responsive-table display" cellspacing="0" width="100%" id="tablePrintCompetencias">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" id="Tabla">
                        <div class="col s12">
                            <h5 style="color: red; display: none;" id="especialidad">MATERIA ESPECIALIDAD</h5>
                            <div class="responsive-table display" cellspacing="0" width="100%" id="tablePrintEscialidad">
                            </div>
                        </div>
                    </div>
                </div>
...
@include('bachiller.asignar_grupo_chetumal.cursos')
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#curso_id").change(event => {  
            ...
            $.get(base_url + `/bachiller_asignar_grupo_seq/cgt_actual/${event.target.value}`, function(res, sta) {
                ...
                @include('bachiller.asignar_grupo_chetumal.pintaTabla2')
...
@include('bachiller.asignar_grupo_chetumal.pintarTablas')

@include('bachiller.asignar_grupo_chetumal.guardarJs')
@endsection