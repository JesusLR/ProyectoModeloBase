...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_asignar_grupo_seq.store', 'method' => 'POST']) !!}
        <div class="card ">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#curso_id").change( event => {
            ...
            $.get(base_url+`/bachiller_asignar_grupo_seq/obtener_grupos_recuperacion/${event.target.value}`, function(res, sta) {
                ...
                res.forEach(element => {
                    ...
                    if (!element.optNombre) {
                        $("#grupo_id").append(`<option value=${element.id}>
                            Grupo: ${element.gpoGrado}-${element.gpoClave}-${element.gpoTurno} ${acd},
