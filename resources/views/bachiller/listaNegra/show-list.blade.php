...
Bachiller Alumnos Restringidos
@endsection
...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_alumnos_restringidos')}}" class="breadcrumb">Lista de alumnos restringidos</a>
@endsection

@section('content')

<div id="table-datatables">
    <h4 class="header">ALUMNOS RESTRINGIDOS</h4>
    <a href="{{ route('bachiller.bachiller_alumnos_restringidos.create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
        <i class="material-icons left">add</i>
    </a>
    
    <div class="row">
        <div class="col s12">
            <table id="table-empleados-bachiller" class="responsive-table display" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th>Clave Alumno</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#table-empleados-bachiller').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/bachiller_alumnos_restringidos/list",
                beforeSend: function () {
        ...
        $('#table-empleados-bachiller').on('click', '.btn-darBaja', function () {

            var empleado_id = $(this).data('id');
            darBaja(empleado_id);
        });

        $('#table-empleados-bachiller').on('click', '.btn-borrar', function () {
            var empleado_id = $(this).data('id');
    ...
    function darBaja(empleado_id) {
        ...
        swal({
            ...
            function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: base_url + '/bachiller_empleado/darBaja/' + empleado_id,
                    dataType: 'json',
    ...
    function borrar_empleado(empleado_id) {
        $.ajax({
            type: 'GET',
            url: base_url + '/bachiller_empleado/verificar_delete/'+empleado_id,
            dataType: 'json',
