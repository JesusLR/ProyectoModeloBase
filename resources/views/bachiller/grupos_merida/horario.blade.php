...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_grupo_uady')}}" class="breadcrumb">Lista de Grupo</a>
    <a href="{{url('bachiller_grupo_uady/horario')}}" class="breadcrumb">Horario</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['class' => 'formAgregarHorario', 'onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller_grupo_uady.agregarHorario', 'method' => 'POST']) !!}
            <div class="card ">
                <div class="card-content ">
                    ...
                    <div id="general">
                        ...
                        <div class="row">
                            <div class="col s12">
                                <span>Materia ACD: <b>{{$bachiller_grupo->gpoMatComplementaria}}</b></span>
                            </div>
                        </div>
                        @endif
                        <div class="row">
                            <div class="col s12">
                                <span>Curso-Grado-Turno: <b>{{$bachiller_grupo->gpoGrado}}-{{$bachiller_grupo->gpoClave}}-{{$bachiller_grupo->gpoTurno}}</b></span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col s12">
                        ...
                        <div class="row">
                            <div class="col l6 m12 s12">
                                ...
                                <table id="tbl-horario-bachiller_merida" class="responsive-table display" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>Día</th>
                                            <th>Aula</th>
                            ...
                            <div class="col l6 m12 s12">
                                ...
                                <table id="tbl-horario-bachiller_merida-admivo" class="responsive-table display" cellspacing="0" width="100%">
                                    <thead>
                                    <tr>
                                        <th>Día</th>
                                        <th>Hora Inicio</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        if (grupo_id != "" && grupo_id != null) {
            $('#tbl-horario-bachiller_merida').dataTable({
            ...
            // "pageLength": 5,
                ...
                "ajax": {
                    "type" : "GET",
                    'url': base_url+"/api/bachiller_grupo_uady/horario/"+grupo_id,
                    beforeSend: function () {
        ...
        $('.btnAgregarHorario').on("click", function (e) {
            ...
            $.ajax({
                ...
                type: "POST",
                dataType: "JSON",
                url: base_url + "/bachiller_grupo_uady/verificarHorasRepetidas",
            })
        ...
        if (claveMaestro !== "" && claveMaestro !== null && periodoId !== "" && periodoId !== null) {
            $('#tbl-horario-bachiller_merida-admivo').dataTable({
                "language": {"url": base_url + "/api/lang/javascript/datatables"},
                "serverSide": true,
                "dom": '"top"i',
                "bPaginate": false,
                "ajax": {
                    "type" : "GET",
                    'url': base_url + "/api/bachiller_grupo_uady/horario_admin/" + claveMaestro + "/" + periodoId,
                    beforeSend: function () {
