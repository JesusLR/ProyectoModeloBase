...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_grupo_uady/'.$grupo->id.'/edit')}}" class="breadcrumb">Editar grupo</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
        {{ Form::open(array('method'=>'PUT','route' => ['bachiller.bachiller_grupo_uady.update', $grupo->id])) }}
        <div class="card ">
            ...
            <div id="general">
                    ...
                    <div class="col s12 m6 l3" style="margin-top:30px;">
                        <div style="position:relative;">
                            {{-- @if ($grupo->gpoMatComplementaria != "")
                                <input type="checkbox" checked {{ (! empty(old('gpoACD')) ? 'checked' : '') }} name="gpoACD" id="gpoACD" value="">
                            ...
                            <input type="checkbox" {{ ($grupo->gpoMatComplementaria != "" ? 'checked' : '') }} name="gpoACD" id="gpoACD" value="">
                                <label for="gpoACD"> ¿Es un grupo ACD?</label>
                ...
                <div class="row">
                    <div class="col s12 m6 l4">        
                        ...
                        {!! Form::date('gpoFechaExamenOrdinario', $grupo->gpoFechaExamenOrdinario, array('id' => 'gpoFechaExamenOrdinario', 'class' => 'validate','maxlength'=>'6')) !!}
                       
                    </div>

                    <div class="col s12 m6 l4">        
                        {!! Form::label('gpoHoraExamenOrdinario', 'Hora examen ordinario', array('class' => '')); !!}                
                        {!! Form::time('gpoHoraExamenOrdinario', $grupo->gpoHoraExamenOrdinario, array('id' => 'gpoHoraExamenOrdinario', 'class' => 'validate','maxlength'=>'6')) !!}
    ...
    @include('bachiller.grupos_merida.equivalentes')
            ...
            $("input[name=gpoACD]").change(function(){
                if ($(this).is(':checked') ) {
                    ...
                    var plan_id = $("#plan_id").val();
                        ...
                        $("#materia_acd_id").empty();
                        $("#materia_acd_id").append(`<option value="" selected disabled>SELECCIONE UNA OPCIÓN</option>`);
                        $.get(base_url+`/bachiller_grupo_uady/materiaComplementaria/${materia_id}/${plan_id}/${periodo_id}/${gpoSemestre}`,function(resACD,sta){
