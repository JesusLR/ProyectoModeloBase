...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_grupo_uady/'.$bachiller_grupo->id)}}" class="breadcrumb">Ver grupo</a>
@endsection
            ...
            <div id="general">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l3" style="margin-top:30px;">
                        <div style="position:relative;">
                            <input type="checkbox" @if ($bachiller_grupo->gpoACD == 1) checked @endif name="gpoACD" id="gpoACD" value="">
                ...
                <div class="row">
                    <div class="col s12 m6 l4">        
                        ...
                        {!! Form::date('gpoFechaExamenOrdinario', $bachiller_grupo->gpoFechaExamenOrdinario, array('readonly' => 'true')) !!}
                       
                    </div>

                    <div class="col s12 m6 l4">        
                        {!! Form::label('gpoHoraExamenOrdinario', 'Hora examen ordinario', array('class' => '')); !!}                
                        {!! Form::time('gpoHoraExamenOrdinario', $bachiller_grupo->gpoHoraExamenOrdinario, array('readonly' => 'true')) !!}
