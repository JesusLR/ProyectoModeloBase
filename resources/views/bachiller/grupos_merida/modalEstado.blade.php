...
<div id="modalGrupoEstado" class="modal">
    <div class="modal-content">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.estadoGrupo', 'method' => 'POST', 'class' => 'form-grupo-estado']) !!}
        <input type="hidden" value="" class="modalGrupoId" name="grupo_id">
        <div class="row">
          <div class="col s12 m12 l12">
            <h4>Cambiar estado del grupo</h4>
            <p style="font-weight: 700; margin-bottom: 0px;">(<span class="modalMateriaClave"></span>) <span class="modalMateriaNombre"></span> <span class="modalGpoMatComple"></span></p>
