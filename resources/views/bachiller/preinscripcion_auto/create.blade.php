...
@section('breadcrumbs')
	...
	<a href="" class="breadcrumb">Bachiller Preinscripción Automática</a>
@endsection
...
@section('content')
 ...
 <div class="row">
 	<div class="col s12">
 		{!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'bachiller_preinscripcion_auto/preinscribir', 'method' => 'POST', 'target' => '_blank']) !!}

      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Bachiller Preinscripción Automática</span>
          {{-- NAVIGATION BAR--}}
          ...
          <div id="filtros">
            ...
            <div class="row">
              ...
              <div class="col s12 m6 l4">
                  <label for="periodo_id">Periodo (último periodo cursado)*</label>
