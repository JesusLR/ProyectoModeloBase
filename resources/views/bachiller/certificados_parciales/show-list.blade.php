...
<div id="table-datatables">
    ...
    <div class="row">
        <div class="col s12">
            <table id="tbl-certificados-parciales" class="responsive-table display" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th>Folio</th>
                    <th>Ubic.</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#tbl-certificados-parciales').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/api/bachiller_certificados_parciales",
                beforeSend: function () {
