...
@section('breadcrumbs')
    ...
    <label class="breadcrumb">Certificados parciales</label>
@endsection
    ...
    <div class="col s12 ">
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">CERTIFICADOS PARCIALES</span>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#tbl-materias').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/api/bachiller_certificados_parciales/" + resumen_id + "/materias_faltantes",
                beforeSend: function () {
