...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_certificados_parciales')}}" class="breadcrumb">Lista de alumnos</a>
    <label class="breadcrumb">Agregar certificado parcial</label>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller_certificados_parciales.store', 'method' => 'POST']) !!}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">AGREGAR CERTIFICADO PARCIAL</span>
