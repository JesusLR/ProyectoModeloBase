<script type="text/javascript">
    $(document).ready(function() {
        ...
        function obtenerAlumnos(periodo_id, programa_id,plan_id, cgt_id) {
            ...
            $.get(base_url+`/bachiller_asignar_cgt/obtenerListaAlumnosCurso/${periodo_id}/${programa_id}/${plan_id}/${cgt_id}`, function(res,sta) {


                $.get(base_url+`/bachiller_asignar_cgt/getGradoGrupo/${periodo_id}/${programa_id}/${plan_id}/${cgt_id}`, function(grupos,sta) {
                    $.get(base_url+`/bachiller_asignar_cgt/getBachillerInscritoCursos/${periodo_id}/${programa_id}/${plan_id}/${cgt_id}`, function(cursos,sta) {
