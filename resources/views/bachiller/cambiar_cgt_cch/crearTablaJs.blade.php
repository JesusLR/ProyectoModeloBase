<script type="text/javascript">
    $(document).ready(function() {
        ...
        function obtenerAlumnos(periodo_id, programa_id,plan_id, cgt_id) {
            $.get(base_url+`/bachiller_cambiar_cgt_cch/getAlumnosGrado/${periodo_id}/${programa_id}/${plan_id}/${cgt_id}`, function(res,sta) {
                $.get(base_url+`/bachiller_cambiar_cgt_cch/getGradoGrupo/${periodo_id}/${programa_id}/${plan_id}/${cgt_id}`, function(grupos,sta) {
                    ...
                    if(res.length > 0){
                        ...
                        swal("Upsss...", "No hay alumnos registrados al CGT seleccionado", 'info');
