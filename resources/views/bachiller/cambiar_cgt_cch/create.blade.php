...
@section('breadcrumbs')
    ...
    <a href="{{route('bachiller.bachiller_cambiar_cgt_cch.edit')}}" class="breadcrumb">Cambiar CGT</a>
    <a href="{{route('bachiller.bachiller_cambiar_cgt_cch.edit')}}" class="breadcrumb">Cambiar CGT - Grupo </a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'bachiller.bachiller_cambiar_cgt_cch.update', 'method' => 'POST']) !!}
        <div class="card ">
...
@include('bachiller.cambiar_cgt_cch.crearTablaJs')
