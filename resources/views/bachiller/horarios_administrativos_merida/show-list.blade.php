...
@section('breadcrumbs')
    ...
    <a href="{{url('bachiller_horarios_administrativos')}}" class="breadcrumb">Horarios administrativos</a>
@endsection
        ...
        <div class="col s12">
            ...
            <div class="card ">
                ...
                <div class="card-action">
                    <a href="{{ url('/bachiller_horarios_administrativos/calendario/create') }}" class="btn-agregar-horario btn-large waves-effect  darken-3" type="button">Agregar
...
<script type="text/javascript">
    ...
    $("#periodoId").on("change", function (e) {
        ...
        if ($("#empleadoId").val() !== "" && $("#periodoId").val() !== "") {
            $(".btn-agregar-horario").attr("href", base_url + "/bachiller_horarios_administrativos/" + $("#empleadoId").val() + "/" + $("#periodoId").val() + "/calendario")
    ...
    $(document).ready(function() {
        $('#table-empleados').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url + "/api/bachiller_horarios_administrativos",
                beforeSend: function () {
