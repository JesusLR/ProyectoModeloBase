...
@section('breadcrumbs')
    ...
    <label class="breadcrumb">Lista de optativas</label>
@endsection

@section('content')

<div id="table-datatables">
    <h4 class="header">OPTATIVAS</h4>
    @php use App\Models\User; @endphp
    @if (User::permiso("optativa") != "D" && User::permiso("optativa") != "P")
    <a href="{{ url('/optativa/create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
