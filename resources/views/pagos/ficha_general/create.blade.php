...
@section('breadcrumbs')
    ...
    <a href="{{url('pagos/ficha_general')}}" class="breadcrumb">Referencia de pago</a>
@endsection
...
@section('content')
    ...
    <div class="card ">
        ...
        {!! Form::button('<i class="material-icons left">save</i> Generar', ['id' => 'btnGenerar', 'class' => 'btn-large waves-effect  darken-3','type' => 'submit']) !!}
        </div>
    </div>
    {!! Form::close() !!}
@endsection
...
<script type="text/javascript">
    ...
    $(document).on('click', '#btnGenerar', function (e) {
        ...
        var cuoAnio = $('#cuoAnio').val();
            $.get(base_url+`/pagos/ficha_general/check/${aluClave}/${cuoConcepto}/${cuoAnio}`, function(res,sta) {
                if(res.warning){
                    swal({
                        title: "Ups...",
                        text: "El alumno no tiene el estado de Egresado. ¿Desea imprimir su ficha?",
                        type: "warning",
