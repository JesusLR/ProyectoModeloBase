...
@section('breadcrumbs')
    ...
    <a href="{{url('api/pagos/listadopagos')}}" class="breadcrumb">Lista de pagos</a>
@endsection
...
<div id="table-datatables">
    ...
    <a href="{{ url('/pagos/aplicar_pagos/create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#tbl-aplicar-pagos').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url + "/api/pagos/listadopagos",
                beforeSend: function () {
