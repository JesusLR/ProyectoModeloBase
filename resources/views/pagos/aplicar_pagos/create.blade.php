...
@section('breadcrumbs')
    ...
    <a href="{{url('pagos/aplicar_pagos')}}" class="breadcrumb">Lista de pagos</a>
    <a href="{{url('pagos/aplicar_pagos/create')}}" class="breadcrumb">Agregar pagos</a>
@endsection
...
<div class="row">
  ...
  <div class="col s12 ">
    {!! Form::open(['class' => 'formAplicarPago', 'onKeypress' => 'return disableEnterKey(event)','route' => 'aplicarPagos.store', 'method' => 'POST']) !!}
      <div class="card ">
        <div class="card-content ">
          ...
          <div id="general">
            <div class="row">
              ...
              {{-- <div id="campo_opcional_periodo" class="col s12 m6 l4">
                {!! Form::label('perNumero', 'Número del periodo *', ['class' => '']); !!}
                <select id="perNumero" name="perNumero" data-per-numero="{{old('perNumero')}}" class="browser-default validate select2" style="width: 100%;">
            ...
            <div class="row">
              <div class="col s12 m6 l4">
                <div class="input-field">
                  {!! Form::number('pagImpPago', 0, array('id' => 'pagImpPago', 'class' => 'validate','required', 'min' => 0, 'max'=>99999999)) !!}
                  {!! Form::label('pagImpPago', 'Importe *', ['class' => '']); !!}
                </div>
              </div>
              <div class="col s12 m6 l4">
                <div class="input-field">
                  {!! Form::text('pagRefPago', NULL, array('id' => 'pagRefPago', 'class' => 'validate', 'maxlength' => '5')) !!}
            ...
            <div class="row">
              <div class="col s12 m6 l4">
                <div class="input-field">
                  {!! Form::text('pagComentario', NULL, array('id' => 'pagComentario', 'class' => 'validate', 'maxlength'=>'78')) !!}
...
@section('footer_scripts')
  ...
  <script type="text/javascript">
    ...
    function buscar_inscripciones_educacion_continua(selectObject, pagClaveAlu) {
      ...
      $.ajax({
        type: 'GET',
        url: `${base_url}/api/aplicar_pagos/buscar_inscripciones_educacion_continua/${pagClaveAlu}`,
        dataType: 'json',
    ...
    $('.btnVerificarPago').on("click", function (e) {
      ...
      $('#tbl-verificar-pagos').dataTable({
        ...
        "ajax": {
          ...
          'url': base_url + "/api/pagos/verificarExistePago",
          beforeSend: function () {
  ...
  <script type="text/javascript">
    $('.btnAplicarPago').on("click", function (e) {
      ...
      $.ajax({
          ...
          type: "POST",
          dataType: "JSON",
          url: base_url + "/pagos/aplicar_pagos/existeAlumnoByClavePago",
      })
