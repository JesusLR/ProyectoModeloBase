...
@section('breadcrumbs')
    ...
    <a href="{{url('plan')}}" class="breadcrumb">Lista de planes</a>
...
<div class="row">
    <div class="col s12 ">
        {{ Form::open(array('method'=>'PUT','route' => ['plan.update', $plan->id])) }}
        <div class="card ">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l4">
                        ...
                        <select id="tipo_registro" class="browser-default validate select2" required name="tipo_registro" style="width: 100%;">
                            <option value="E" @if($plan->planRegistro == 'E') selected @endif>ESTATAL</option>
                            <option value="F"  @if($plan->planRegistro == 'F') selected @endif>FEDERAL</option>
                        </select>
                    </div>
                </div>
