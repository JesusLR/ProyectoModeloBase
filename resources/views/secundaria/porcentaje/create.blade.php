...
@section('breadcrumbs')
    ...
    <a href="{{route('secundaria.secundaria_porcentaje.index')}}" class="breadcrumb">Lista de porcentajes</a>
    <a href="{{route('secundaria.secundaria_porcentaje.create')}}" class="breadcrumb">Agregar porcentaje</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_porcentaje.store', 'method' => 'POST']) !!}
        <div class="card ">
