...
@section('breadcrumbs')
    ...
    <a href="{{url('secundaria_porcentaje/'.$porcentajes->id.'/edit')}}" class="breadcrumb">Editar porcentaje</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {{ Form::open(array('method'=>'PUT','route' => ['secundaria.secundaria_porcentaje.update', $porcentajes->id])) }}
