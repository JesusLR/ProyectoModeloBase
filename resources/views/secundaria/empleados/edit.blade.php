...
@section('breadcrumbs')
    ...
    <a href="{{url('secundaria_empleado/'.$empleado->id.'/edit')}}" class="breadcrumb">Editar empleado</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {{ Form::open(array('method'=>'PUT','route' => ['secundaria.secundaria_empleado.update', $empleado->id])) }}
      <div class="card ">
        <div class="card-content ">
          ...
          <div id="personal">
              ...
              <div class="row">
                  <div class="col s12 m6 l4">
                      <div class="input-field">
                      {!! Form::text('empDireccionCalle', $empleado->empDireccionCalle, array('id' => 'empDireccionCalle', 'class' => 'validate','required','maxlength'=>'25')) !!}
                      {!! Form::label('empDireccionCalle', 'Calle *', array('class' => '')); !!}
                      </div>
                  </div>
                  <div class="col s12 m6 l4">
                        <div class="input-field">
                        {!! Form::text('empDireccionNumero', $empleado->empDireccionNumero, array('id' => 'empDireccionNumero', 'class' => 'validate','required','maxlength'=>'6')) !!}
              ...
              <div class="row">
                  <div class="col s12 m6 l4">
                      <div class="input-field">
                      {!! Form::text('empDireccionColonia', $empleado->empDireccionColonia, array('id' => 'empDireccionColonia', 'class' => 'validate','required','maxlength'=>'60')) !!}
                      {!! Form::label('empDireccionColonia', 'Colonia *', array('class' => '')); !!}
                      </div>
                  </div>
                  <div class="col s12 m6 l4">
                      <div class="input-field">
                      {!! Form::number('empDireccionCP', $empleado->empDireccionCP, array('id' => 'empDireccionCP', 'class' => 'validate','required', 'pattern' => '[A-Z,a-z,0-9]*','min'=>'0','max'=>'99999','onKeyPress="if(this.value.length==5) return false;"')) !!}
              ...
              <div class="row">
                  <div class="col s12 m6 l4">
                      <div class="input-field">
                      {!! Form::number('empTelefono', $empleado->empTelefono, array('id' => 'empTelefono', 'class' => 'validate','min'=>'0','max'=>'9999999999','onKeyPress="if(this.value.length==10) return false;"')) !!}
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            function obtenerEscuelas (departamentoId) {
                ...
                //OBTENER PERIODOS
                $.get(base_url+`/secundaria_periodo/api/periodos/${departamentoId}`,function(res2,sta){
                    var perSeleccionado;
