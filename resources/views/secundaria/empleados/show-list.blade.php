...
<div id="table-datatables">
    ...
    <a href="{{ route('secundaria.secundaria_empleado.create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
        <i class="material-icons left">add</i>
    </a>
    <a href="{{ route('secundaria_empleado.cambio-estado') }}" class="btn-large waves-effect  darken-3" type="button">Cambio de estado
    ...
    <div class="row">
        <div class="col s12">
            <table id="table-empleados-secundaria" class="responsive-table display" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th>Ubicacion</th>
                    <th>Clave Docente</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#table-empleados-secundaria').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/secundaria_empleado/list",
                beforeSend: function () {
        ...
        $('#table-empleados-secundaria').on('click', '.btn-darBaja', function () {

            var empleado_id = $(this).data('id');
            darBaja(empleado_id);
        });

        $('#table-empleados-secundaria').on('click', '.btn-borrar', function () {
            var empleado_id = $(this).data('id');
    ...
    function darBaja(empleado_id) {
        ...
        swal({
            ...
            function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: base_url + '/secundaria_empleado/darBaja/' + empleado_id,
                    dataType: 'json',
    ...
    function borrar_empleado(empleado_id) {
        $.ajax({
            type: 'GET',
            url: base_url + '/secundaria_empleado/verificar_delete/'+empleado_id,
            dataType: 'json',
