...
@section('breadcrumbs')
    ...
    <a href="{{url('secundaria/pagos/aplicar_pagos')}}" class="breadcrumb">Lista de pagos</a>
    <a href="{{url('secundaria/pagos/aplicar_pagos/create')}}" class="breadcrumb">Agregar pagos</a>
@endsection
...
<div class="row">
  ...
  <div class="col s12 ">
    {!! Form::open(['class' => 'formAplicarPago', 'onKeypress' => 'return disableEnterKey(event)','route' => 'secundariaAplicarPagos.store', 'method' => 'POST']) !!}
      <div class="card ">
 ...
 @include('secundaria.scripts.funcionesAuxiliares')
  ...
  <script type="text/javascript">
    ...
    function buscar_inscripciones_educacion_continua(selectObject, pagClaveAlu) {
      ...
      $.ajax({
        type: 'GET',
        url: `${base_url}/secundaria/api/aplicar_pagos/buscar_inscripciones_educacion_continua/${pagClaveAlu}`,
        dataType: 'json',
    ...
    $('.btnVerificarPago').on("click", function (e) {
      ...
      $('#tbl-verificar-pagos').dataTable({
        ...
        "ajax": {
          ...
          'url': base_url + "/secundaria/api/pagos/verificarExistePago",
          beforeSend: function () {
  ...
  <script type="text/javascript">
    $('.btnAplicarPago').on("click", function (e) {
      ...
      $.ajax({
          ...
          type: "POST",
          dataType: "JSON",
          url: base_url + "/secundaria/pagos/aplicar_pagos/existeAlumnoByClavePago",
      })
