...
@section('breadcrumbs')
    ...
    <a href="{{url('secundaria_plan')}}" class="breadcrumb">Lista de planes</a>
...
<div class="row">
    <div class="col s12 ">
        {{ Form::open(array('method'=>'PUT','route' => ['secundaria.secundaria_plan.update', $plan->id])) }}
        <div class="card ">
          <div class="card-content ">
            ...
            <div id="general">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l4">
                        {!! Form::label('planRegistro', 'Plan registro *', array('class' => '')); !!}
                        <select id="planRegistro" class="browser-default validate select2" required name="planRegistro" style="width: 100%;">
                            <option value="E" {{ $plan->planRegistro == 'E' ? 'selected' : '' }}>E</option>
                            <option value="F" {{ $plan->planRegistro == 'F' ? 'selected' : '' }}>F</option>
                        </select>
                    </div>
                </div>
