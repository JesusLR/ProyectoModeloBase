...
@section('breadcrumbs')
    ...
    <a href="{{url('secundaria_cambiar_contrasenia/'.$docente->id.'/edit')}}" class="breadcrumb">Editar Contraseña</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
        {{ Form::open(array('method'=>'PUT','route' => ['secundaria.secundaria_cambiar_contrasenia.update', $docente->id])) }}
        <div class="card ">
          <div class="card-content ">
            ...
            <div id="general">
              ...
              <input type="hidden" name="empleado_id" id="" value="{{$empleado->id}}">
                <div class="row">
