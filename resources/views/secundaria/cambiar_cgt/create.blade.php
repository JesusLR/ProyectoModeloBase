...
@section('breadcrumbs')
    ...
    {{--  <a href="{{route('secundaria_asignar_grupo.index')}}" class="breadcrumb">Lista de Inscritos</a>  --}}
    {{--  <a href="{{route('secundaria.secundaria_cambiar_cgt.edit')}}" class="breadcrumb">Cambiar CGT</a>  --}}
    <a href="{{route('secundaria.secundaria_cambiar_cgt.edit')}}" class="breadcrumb">Cambiar CGT - Grupo </a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_cambiar_cgt.update', 'method' => 'POST']) !!}
        <div class="card ">
            <div class="card-content ">
                <span class="card-title">CAMBIAR CGT - GRUPO</span>
...
<style>
    ...
    .checkbox-warning-filled [type="radio"][class*='filled-in']:checked+label:after {
        border-color: #01579B;
...
@include('secundaria.scripts.cgts_sin_grupo_N')
@include('secundaria.scripts.cursos')
@include('secundaria.cambiar_cgt.crearTablaJs')
