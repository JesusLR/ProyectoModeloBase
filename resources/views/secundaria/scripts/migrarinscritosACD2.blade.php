<script type="text/javascript">
    $(document).ready(function() {
        ...
        function obtenerDepartamentos(ubicacionId) {
            ...
            $.get(base_url+`/secundaria_migrar_inscritos_acd/api/getDepartamentosPorUbiClave/${ubicacionId}`, function(res,sta) {

                //seleccionar el post preservado
                var departamentoSeleccionadoOld = $("#departamento_id").data("departamento-id")
                $("#departamento_id").empty()
                res.forEach(element => {
                    var selected = "";
