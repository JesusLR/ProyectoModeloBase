...
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_materia.agregarPreRequisitos', 'method' => 'POST']) !!}
            <div class="card ">
...
@section('footer_scripts')
    @include('secundaria.materias.scripts-pre_requisitos')
@endsection