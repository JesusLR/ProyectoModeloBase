...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_materia.store', 'method' => 'POST']) !!}
        <div class="card ">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l2">
                        <div class="input-field col s6 m6 l3">
                            <a name="agregarMateriaSecundaria" id="agregarMateriaSecundaria" class="waves-effect btn-large tooltipped #2e7d32 green darken-3" 
...
$(document).ready(function(){
    ...
    var table_row = `<tr><input type="hidden" name="materias[]" 
        value="${planId}~${datos[0]}~${datos[1]}~${datos[2]}~${datos[3]}~${datos[4]}~${datos[5]}~${datos[6]}~${datos[7]}~${datos[8]}~${datos[9]}~${datos[10]}~${datos[11]}~${datos[12]}~${datos[13]}"/>`+
        '<td>'+datos[0]+'</td>'+
        '<td>'+datos[1]+'</td>'+
        '<td>'+datos[2]+'</td>'+
        '<td>'+datos[3]+'</td>'+
    ...
    $('#agregarMateriaSecundaria').on('click',function(e){
        e.preventDefault();
