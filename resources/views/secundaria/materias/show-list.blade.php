...
<div id="table-datatables">
    ...
    <a href="{{ route('secundaria.secundaria_materia.create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
    ...
    <div class="row">
        <div class="col s12">
            <table id="tbl-materia-secundaria" class="responsive-table display" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th>Ubicacion</th>
                    <th>Departamento</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#tbl-materia-secundaria').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/secundaria_materia/list",
                beforeSend: function () {
            ...
            "columns":[
                ...
                {data: "matSemestre",name: "secundaria_materias.matSemestre"},
                {data: "matClave",name: "secundaria_materias.matClave"},
                {data: "matNombre",name: "secundaria_materias.matNombre"},
                {data: "matVigentePlanPeriodoActual",name: "secundaria_materias.matVigentePlanPeriodoActual"},
                {data: "action"}
            ],
            //Apply the search
