...
@section('breadcrumbs')
    ...
    <a href="{{route('secundaria.secundaria_generar_promedios.index')}}" class="breadcrumb">Generar promedio</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_generar_promedios.generarPromedio', 'method' => 'POST']) !!}
        <div class="card ">
