...
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_cambio_programa.store',
        'method' => 'POST']) !!}
        <div class="card ">
...
@include('secundaria.cambio_de_programa.crearTablaJS')
...
@include('secundaria.cambio_de_programa.cargarCombos')
@include('secundaria.cambio_de_programa.guardar-js')
