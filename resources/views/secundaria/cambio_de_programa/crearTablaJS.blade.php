<script type="text/javascript">
    $(document).ready(function() {
        ...
        function obtenerAlumnoPrograma(periodo_id, programa_id, plan_id, cgt_id, aluClave) {
            $.get(base_url+`/secundaria_cambio_programa/getAlumnoPrograma/api/${periodo_id}/${programa_id}/${plan_id}/${cgt_id}/${aluClave}`, function(res,sta) {
     ...
     function obtenerNombrePrograma(programa_id2) {
        $.get(base_url+`/secundaria_cambio_programa/getANombrePrograma/api/${programa_id2}`, function(res,sta) {
