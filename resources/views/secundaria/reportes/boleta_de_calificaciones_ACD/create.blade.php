...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'route' => 'secundaria.secundaria_boleta_de_calificaciones_acd.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
          ...
          <div id="filtros">
            ...
            <div class="row">
              <div class="col s12 m6 l4">
                ...
                <div class="input-field col s12 m6 l6">                
                  <label for="gpoClave">Grupo(opcional)</label>
