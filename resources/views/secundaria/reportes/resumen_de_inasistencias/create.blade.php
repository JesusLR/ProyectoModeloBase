...
@section('template_title')
    Reporte resumen de inasistencia
@endsection

@section('breadcrumbs')
  <a href="{{url('secundaria_curso')}}" class="breadcrumb">Inicio</a>
  <a href="" class="breadcrumb">Resumen de Inasistencia</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'route' => 'secundaria.secundaria_resumen_inasistencias.reporteResumenInasistencias', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">RESUMEN DE INASISTENCIA</span>
          {{-- NAVIGATION BAR--}}
            ...
            <div class="row">
              <div id="vistaPorMes" class="col s12 m6 l4" style="display: none;">
                ...
                <select required name="mesEvaluar" id="mesEvaluar" data-mesEvaluar-id="{{old('mesEvaluar')}}" class="browser-default validate select2" style="width:100%;">
                    ...
                    {{-- <option value="Diciembre" {{ old('mesEvaluar') == 'porTrimestre' ? 'selected' : '' }}>DICIEMBRE</option> --}}
