...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'route' => 'secundaria.secundaria_historial_alumno.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">HISTORISL ACADÉMICO DE ALUMNOS</span>
          {{-- NAVIGATION BAR--}}
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#buscarProgramas').click(function(){
      ...
      if(aluClave) {
        buscar_programas(`/secundaria_historial_alumno/obtenerProgramasClave/${aluClave}`);
      }else if(aluMatricula) {
        buscar_programas(`/secundaria_historial_alumno/obtenerProgramasMatricula/${aluMatricula}`);
      }else {
        resetSelect('plan_id');
        $('#botonSubmit').prop('disabled', true);
        swal({
