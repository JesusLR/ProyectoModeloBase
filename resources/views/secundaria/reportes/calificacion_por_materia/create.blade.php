...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'route' => 'secundaria_reporte.calificacion_por_materia.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">RESEUMEN DE CALIFICACIONES POR MATERIA</span>
          {{-- NAVIGATION BAR--}}
          ...
          <div id="filtros">
            ...
            <div class="row">
                <div class="col s12 m6 l4">
                    ...
                    <select name="grupo_id" id="grupo_id" data-grupo-id="{{old('grupo_id')}}" class="browser-default validate select2" style="width:100%;">
                        <option value="">SELECCIONE UNA OPCIÓN</option>
                    </select>
                </div>
              <div class="col s12 m6 l4">
