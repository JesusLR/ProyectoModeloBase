...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Constancia buena conducta</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'route' => 'secundaria.secundaria_constancia_buena_conducta.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">CONTANCIA BUENA CONDUCTA</span>
          {{-- NAVIGATION BAR--}}
