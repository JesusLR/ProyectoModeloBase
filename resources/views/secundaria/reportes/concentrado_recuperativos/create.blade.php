...
@section('template_title')
    Reporte recuperativos
@endsection

@section('breadcrumbs')
  <a href="{{url('secundaria_curso')}}" class="breadcrumb">Inicio</a>
  <a href="" class="breadcrumb">Resumen de recuperativos</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'route' => 'secundaria.secundaria_recuperativos.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">RESUMEN DE RECUPERATIVOS</span>
          {{-- NAVIGATION BAR--}}
          ...
          <div id="filtros">
            ...
            <div class="row">
              <div class="col s12 m6 l4">
                <label for="tipoImpresion">Tipo *</label>
                <select name="tipoImpresion" id="tipoImpresion" data-tipoImpresion-id="{{old('tipoImpresion')}}" class="browser-default validate select2" style="width:100%;" required>
            ...
            <div class="row">
              <div class="col s12 m6 l4">
                <label for="trimestre">Trimeste a consultar</label>
                <select name="trimestre" id="trimestre" data-trimestre-id="{{old('trimestre')}}" class="browser-default validate select2" style="width:100%;" required>
                  <option value="" selected disabled>SELECCIONE UNA OPCIÓN</option>
              ...
              <div class="col s12 m6 l4">
                <div class="input-field col s12 m6 l6">
                  {!! Form::number('gpoGrado', old('gpoGrado'), array('id' => 'gpoGrado', 'class' => 'validate','min'=>'0')) !!}
