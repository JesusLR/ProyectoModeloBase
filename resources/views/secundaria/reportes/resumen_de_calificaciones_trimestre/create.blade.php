...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'route' => 'secundaria.secundaria_resumen_de_calificaciones_trim.reporteResumenCalificacion', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">RESUMEN DE CALIFICACIONES POR TRIMESTRE</span>
          {{-- NAVIGATION BAR--}}
          ...
          <div id="filtros">
            ...
            <div class="row">
              ...
              <div class="col s12 m6 l4">
                <label for="tipoReporte">Trimestre a promediar *</label>
                <select required name="tipoReporte" id="tipoReporte" data-tipoReporte-id="{{old('tipoReporte')}}" class="browser-default validate select2" style="width:100%;">
                    <option value="">SELECCIONE UNA OPCIÓN</option>
                    <option value="1-2" {{ old('tipoReporte') == '1-2' ? 'selected' : '' }}>TRIMESTRE 1 Y 2</option>
                    <option value="1-2-3" {{ old('tipoReporte') == '1-2-3' ? 'selected' : '' }}>TRIMESTRE 1, 2 Y 3</option>
                </select>
              </div>
