...
@section('breadcrumbs')
    ...
    <a href="" class="breadcrumb">Reporte alumnos no inscritos a ACD</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_acd_faltantes.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">REPORTE ALUMNOS NO INSCRITOS A ACD</span>
