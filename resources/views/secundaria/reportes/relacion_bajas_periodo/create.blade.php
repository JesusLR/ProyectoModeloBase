...
@section('content')
  <div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_relacion_bajas_periodo.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
        <div class="card ">
