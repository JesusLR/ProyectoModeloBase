...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_grupo_materia.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
        <div class="card ">
                    ...
                    <div class="col s12 m6 l4">
                        ...
                        <div class="col s12 m6 l6">
                            ...
                            <select class="browser-default validate select2" name="empleado_id" id="empleado_id">
                              ...
                              @foreach ($secundaria_empleados as $item)
