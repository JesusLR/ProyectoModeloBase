...
@section('breadcrumbs')
    ...
    <a href="{{route('secundaria.secundaria_asignar_cgt.edit')}}" class="breadcrumb">Asignar docente</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_asignar_docente.store',
        'method' => 'POST']) !!}
        <div class="card ">
                ...
                <div id="general">
                    ...
                    <div class="row">
                        ...
                        {{-- <div class="col s12 m6 l4">
                            ...
                            <select id="grupo_id" class="browser-default validate select2" required name="grupo_id"
                                style="width: 100%;">
                            </select>
                        </div> --}}
                    </div>
...
@include('secundaria.asignarDocenteCGT.crearTablaGruposJS')
@include('secundaria.asignarDocenteCGT.guardarJs')
