...
@section('breadcrumbs')
    ...
    <a href="{{url('secundaria_asignar_grupo')}}" class="breadcrumb">Lista de Inscritos Materia</a>
    <a href="{{url('secundaria_asignar_grupo/'.$inscrito->id)}}" class="breadcrumb">Ver inscrito materia</a>
@endsection
          ...
          <div class="card-content ">
            ...
            <div id="general">
                ...
                <div class="row">
                    <div class="col s12 ">
                        <div class="input-field">
                            {!! Form::text('grupo_id', $inscrito->secundaria_grupo->gpoGrado.'-'.$inscrito->secundaria_grupo->gpoClave.'-'.$inscrito->secundaria_grupo->gpoTurno.' '.$inscrito->secundaria_grupo->gpoMatComplementaria.', '.$inscrito->secundaria_grupo->secundaria_materia->matNombre, array('readonly' => 'true')) !!}
