...
@section('breadcrumbs')
    ...
    <a href="{{route('secundaria.secundaria_asignar_grupo.index')}}" class="breadcrumb">Lista de Inscritos</a>
    <a href="{{route('secundaria.secundaria_asignar_grupo.create')}}" class="breadcrumb">Agregar Inscrito</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_asignar_grupo.store', 'method' => 'POST']) !!}
        <div class="card ">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#curso_id").change( event => {
            ...
            $.get(base_url+`/secundaria_asignar_grupo/obtener_grupos/${event.target.value}`, function(res, sta) {
