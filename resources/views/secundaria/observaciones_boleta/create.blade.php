...
@section('breadcrumbs')
    ...
    <a href="{{route('secundaria.secundaria_asignar_cgt.edit')}}" class="breadcrumb">Agregar observación</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_obs_boleta.guardar',
        'method' => 'POST']) !!}
        <div class="card ">
...
@include('secundaria.observaciones_boleta.crearTablaJs')
