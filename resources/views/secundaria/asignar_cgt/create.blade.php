...
@section('breadcrumbs')
    ...
    <a href="{{route('secundaria.secundaria_asignar_cgt.edit')}}" class="breadcrumb">Asignar CGT</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_asignar_cgt.update', 'method' => 'POST']) !!}
        <div class="card ">
...
@include('secundaria.asignar_cgt.crearTablaJs')
