...
@section('breadcrumbs')
    ...
    <a href="{{route('secundaria.secundaria_grupo.index')}}" class="breadcrumb">Lista de grupos</a>
...
<div id="table-datatables">
    <br>
    <a id="listaAsistencia" class="btn-large waves-effect darken-3" target="_blank"  href="{{url('secundaria_inscritos/lista_de_asistencia/grupo/'.$grupo->id)}}">Lista asistencia
        <i class="material-icons left">picture_as_pdf</i>
    </a>
    <a href="{{route('secundaria.secundaria_asignar_grupo.create')}}" class="btn-large waves-effect darken-3" type="button">Inscribir
    ...
    <div class="row">
        <div class="col s12">
            <table id="tbl-grupo-secundaria-inscritos" class="responsive-table display" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th>Clave Alumno</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#tbl-grupo-secundaria-inscritos').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/secundaria_inscritos/list/" + {!! json_encode($grupo->id)!!},
                beforeSend: function () {
...
<script type="text/javascript">
$(document).ready(function() {
    var json =  base_url+"/secundaria_inscritos/list/" + {!! json_encode($grupo->id)!!}
        $.ajax({
            type: "GET",
            url: json,
