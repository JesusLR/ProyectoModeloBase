...
<div class="row">
    <div class="col s12 ">
        {{ Form::open(['enctype' => 'multipart/form-data', 'method'=>'PUT','route' => ['secundaria.secundaria_calificacion.calificaciones.update_calificacion', $calificaciones[0]->id]]) }}
        <div class="card ">
                        ...
                        <div class="col s12 m6 l4">
                            ...
                            <select name="materia_id2" id="materia_id2" class="browser-default validate select2"
                                ...
                                @if ($calificaciones[0]->gpoMatComplementaria != "")
                                    <option value="{{$calificaciones[0]->id_materia}}">{{$calificaciones[0]->matNombre}} - {{$calificaciones[0]->gpoMatComplementaria}}</option>
                                @else
                                    <option value="{{$calificaciones[0]->id_materia}}">{{$calificaciones[0]->matNombre}}</option>
                                @endif                                
                        ...
                        <table class="responsive-table display" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th id="claveGrupo" scope="col">CLAVE <p>GRUPO</p></th>
                                        ...
                                        <th id="classtotalFaltasSep" class="classtotalFaltasSep"><p id=""> FALTAS EN  </p> <p> <label style="color:#fff" id="totalFaltasSep1"></label><label style="color:#fff">SEPTIEMBRE</label></p></th>
                                        ...
                                        <th class="classtotalFaltasEne"><p id=""> FALTAS EN  </p> <p> <label style="color:#fff" id=""></label><label style="color:#fff">ENERO</label></p></th>
                                        <th class="classtotalFaltasFeb"><p id=""> FALTAS EN  </p> <p> <label style="color:#fff" id=""></label><label style="color:#fff">FEBRERO</label></p></th>
                                        ...
                                        <th class="classConductaEne"><p id=""> CONDUCTA EN  </p> <p> <label style="color:#fff" id=""></label><label style="color:#fff">ENERO</label></p></th>
                                        <th class="classConductaFeb"><p id=""> CONDUCTA EN  </p> <p> <label style="color:#fff" id=""></label><label style="color:#fff">FEBRERO</label></p></th>
