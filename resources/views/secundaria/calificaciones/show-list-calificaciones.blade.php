...
@section('breadcrumbs')
    ...
    <a href="{{url('secundaria_inscritos/'.$grupo_id)}}" class="breadcrumb">Alumnos</a>
            ...
            {!! Form::open(['route' => 'preescolarcalificaciones.store', 'method' => 'POST', 'id' => 'form-guardar']) !!}
                ...
                <div class="card ">
                    ...
                    <div class="card-content ">
                        <span class="card-title">CALIFICACIONES DEL ALUMNO - CLAVE {{$curso->alumno->aluClave}}</span>
                            ...
                            <div id="primertrimestre">
                                <div class="row">
                                    <div class="col s12">
                                        <table id="" class="responsive-table display tbl-calificaciones-secundaria" cellspacing="0" width="100%">
                                            <thead>
                                            <tr>
                                                <th>Categoría</th>
                                                <th>Aprendizaje</th>
                    ...
                    <div class="card-action">
                        ...
                        @endif
                            <a href="{{ url('secundaria_inscritos/'.$grupo->id) }}" class="btn-guardar btn-large">Regresar al listado de alumnos</a>
                    </div>
...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('.tbl-calificaciones-secundaria').dataTable({
                "bPaginate": false,
