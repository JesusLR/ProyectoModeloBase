                                ...
                                <table class="responsive-table display" cellspacing="0" width="100%">
                                    ...
                                    <tbody id="tableBody">
                                        ...
                                        <tr>
                                            ...
                                            <td  @if ($inscrito->inscTrimestre1 < 6) title="El alumno(a) SI debe el trimestre" @else title="El alumno(a) NO debe el trimestre" @endif align="center"><div class='form-check checkbox-warning-filled'>
                                            ...
                                            {{--  Trimestre 2   --}}
                                            <td @if ($inscrito->inscTrimestre2 < 6) title="El alumno(a) SI debe el trimestre" @else title="El alumno(a) NO debe el trimestre" @endif  align="center"><div class='form-check checkbox-warning-filled'>
                                            ...
                                            {{--  Trimestre 3   --}}
                                            <td @if ($inscrito->inscTrimestre3 < 6) title="El alumno(a) SI debe el trimestre" @else title="El alumno(a) NO debe el trimestre" @endif align="center"><div class='form-check checkbox-warning-filled'>
