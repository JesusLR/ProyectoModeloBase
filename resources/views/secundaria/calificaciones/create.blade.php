...
<a href="{{route('secundaria.secundaria_calificacion.create')}}" class="breadcrumb">Agregar calificaciones</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['enctype' => 'multipart/form-data', 'onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_calificacion.guardarCalificacion', 'method' => 'POST']) !!}
        <div class="card ">
                ...
                <div id="general">
                    ...
                    <div class="row">
                        <div class="col s12 m6 l4">
                            ...
                            <select id="secundaria_grupo_evidencia_id" class="browser-default validate select2" required name="secundaria_grupo_evidencia_id" style="width: 100%;" data-mes-idold="secundaria_grupo_evidencia_id">
                                <option value="" selected disabled>SELECCIONE UNA OPCIÓN</option>
                            </select>
                        </div>
...
@include('secundaria.calificaciones.funcionesJsParaCrear')
