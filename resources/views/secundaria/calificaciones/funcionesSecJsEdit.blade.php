    ...
    $(document).ready(function() {
        ...
        function obtenerMesEvaluacion(mes_id) {
            ...
            $.get(base_url+`/secundaria_grupo/getMesEvidencias/${mes_id}`, function(res,sta) {
                ...
                $("#secundaria_grupo_evidencia_id").empty()
                //$("#secundaria_grupo_evidencia_id").append(`<option value='' selected disabled}>SELECCIONE UNA OPCION</option>`);
                ...
                if(res.mesEvidencia != ""){
                    ...
                    res.mesEvidencia.forEach(element => {
                        ...
                        if(element.mes == "ENERO"){
                            $("#secundaria_grupo_evidencia_id").append(`<option value=${element.id} ${selected}>DICIEMBRE-ENERO</option>`);
...
<script type="text/javascript">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        obtenerNumEvaluacion($("#secundaria_grupo_evidencia_id").val())
        $("#secundaria_grupo_evidencia_id").change( event => {
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function obtenerAlumnos(alumnoId, grupoId) {
            ...
            $.get(base_url+`/secundaria_calificacion/getCalificacionesAlumnos/${alumnoId}/${grupoId}`, function(res,sta) {
                $("#tableBody").html("");

                if(res.length > 0){

                    var es_grupo_acd = res[0].gpoACD;
                    ...
                    function calcularPromedio(id){
                        ...
                        var promedio  = 0;
                        $('.evidencia_' + element.secundaria_inscrito_id).each(function(){
                            if ($(this).val() != "") {
                                evidencia++;
                        ...
                        $('#promedioTotal' + element.secundaria_inscrito_id).val(promedio);
                    }
                    ...
                    variableDeID.push(element.secundaria_inscrito_id)
                    ...
                    $tr.appendChild($id); //1
                    // El td de precio
                    let $secundaria_inscrito_id = document.createElement("td");
                    $secundaria_inscrito_id.innerHTML =`<input style='display:none;' name='secundaria_inscrito_id[]' type='hidden' value='${element.secundaria_inscrito_id}'>`; 
                    $tr.appendChild($secundaria_inscrito_id);//2
                    // El td del código

                    let $numerolista = document.createElement("td");
                    $numerolista.textContent = `${index+1}`; 
                    $tr.appendChild($numerolista);//3

                    let $clavePago = document.createElement("td");
                    $clavePago.textContent = `${element.aluClave}`; 
                    $tr.appendChild($clavePago);//4
                    ...
                    $tr.appendChild($nombreAlumno);//5

                    let $claveGrupo  = document.createElement("td");
                    $claveGrupo .textContent = `${element.cgtGrupo}`; 
                    $tr.appendChild($claveGrupo );//6

                    let $evidencia1 = document.createElement("td");
                    if(element.calificacion_evidencia1 != null){
                        $evidencia1.innerHTML = `<input tabindex="1" id='evidencia1_${element.secundaria_inscrito_id}' onKeyUp="if(this.value>10){this.value='0';}else if(this.value<0){this.value='0';}" value='${element.calificacion_evidencia1}' lang="en" name='evidencia1[]' step="0.1" type='number' min="0" max="10" class='calif evidencia_${element.secundaria_inscrito_id} noUpperCase' data-inscritoid='${element.secundaria_inscrito_id}'>`; 

                    }else{
                        $evidencia1.innerHTML = `<input tabindex="1" id='evidencia1_${element.secundaria_inscrito_id}' onKeyUp="if(this.value>10){this.value='0';}else if(this.value<0){this.value='0';}" value='' lang="en" name='evidencia1[]' step="0.1" type='number' min="0" max="10" class='calif evidencia_${element.secundaria_inscrito_id} noUpperCase' data-inscritoid='${element.secundaria_inscrito_id}'>`; 

                    }
                    $tr.appendChild($evidencia1);//7

                    let $evidencia2 = document.createElement("td");
                    if(element.calificacion_evidencia2 != null){
                        $evidencia2.innerHTML = `<input id='evidencia2_${element.secundaria_inscrito_id}' onKeyUp="if(this.value>10){this.value='0';}else if(this.value<0){this.value='0';}" value='${element.calificacion_evidencia2}' lang="en" name='evidencia2[]' step="0.1" type='number' min="0" max="10" class='calif evidencia_${element.secundaria_inscrito_id} noUpperCase' data-inscritoid='${element.secundaria_inscrito_id}'>`; 

                    }else{
                        $evidencia2.innerHTML = `<input id='evidencia2_${element.secundaria_inscrito_id}' onKeyUp="if(this.value>10){this.value='0';}else if(this.value<0){this.value='0';}" value='' lang="en" name='evidencia2[]' step="0.1" type='number' min="0" max="10" class='calif evidencia_${element.secundaria_inscrito_id} noUpperCase' data-inscritoid='${element.secundaria_inscrito_id}'>`;

                    }
                    $tr.appendChild($evidencia2);//8

                    let $evidencia3 = document.createElement("td");
                    if(element.calificacion_evidencia3 != null){
                        $evidencia3.innerHTML = `<input id='evidencia3_${element.secundaria_inscrito_id}' onKeyUp="if(this.value>10){this.value='0';}else if(this.value<0){this.value='0';}" value='${element.calificacion_evidencia3}' lang="en" name='evidencia3[]' step="0.1" type='number' min="0" max="10" class='calif evidencia_${element.secundaria_inscrito_id} noUpperCase' data-inscritoid='${element.secundaria_inscrito_id}'>`; 

                    }else{
                        $evidencia3.innerHTML = `<input id='evidencia3_${element.secundaria_inscrito_id}' onKeyUp="if(this.value>10){this.value='0';}else if(this.value<0){this.value='0';}" value='' lang="en" name='evidencia3[]' step="0.1" type='number' min="0" max="10" class='calif evidencia_${element.secundaria_inscrito_id} noUpperCase' data-inscritoid='${element.secundaria_inscrito_id}'>`; 

                    }
                    $tr.appendChild($evidencia3);//9

                    let $evidencia4 = document.createElement("td");
                    if(element.calificacion_evidencia4 != null){
                        $evidencia4.innerHTML = `<input id='evidencia4_${element.secundaria_inscrito_id}' onKeyUp="if(this.value>10){this.value='0';}else if(this.value<0){this.value='0';}" value='${element.calificacion_evidencia4}' lang="en" name='evidencia4[]' step="0.1" type='number' min="0" max="10" class='calif evidencia_${element.secundaria_inscrito_id} noUpperCase' data-inscritoid='${element.secundaria_inscrito_id}'>`; 

                    }else{
                        $evidencia4.innerHTML = `<input id='evidencia4_${element.secundaria_inscrito_id}' onKeyUp="if(this.value>10){this.value='0';}else if(this.value<0){this.value='0';}" value='' lang="en" name='evidencia4[]' step="0.1" type='number' min="0" max="10" class='calif evidencia_${element.secundaria_inscrito_id} noUpperCase' data-inscritoid='${element.secundaria_inscrito_id}'>`; 

                    }
                    $tr.appendChild($evidencia4);//10

                    let $evidencia5 = document.createElement("td");
                    if(element.calificacion_evidencia5 != null){
                        $evidencia5.innerHTML = `<input id='evidencia5_${element.secundaria_inscrito_id}' onKeyUp="if(this.value>10){this.value='0';}else if(this.value<0){this.value='0';}" value='${element.calificacion_evidencia5}' lang="en" name='evidencia5[]' step="0.1" type='number' min="0" max="10" class='calif evidencia_${element.secundaria_inscrito_id} noUpperCase' data-inscritoid='${element.secundaria_inscrito_id}'>`; 

                    }else{
                        $evidencia5.innerHTML = `<input id='evidencia5_${element.secundaria_inscrito_id}' onKeyUp="if(this.value>10){this.value='0';}else if(this.value<0){this.value='0';}" value='' lang="en" name='evidencia5[]' step="0.1" type='number' min="0" max="10" class='calif evidencia_${element.secundaria_inscrito_id} noUpperCase' data-inscritoid='${element.secundaria_inscrito_id}'>`; 

                    }
                    $tr.appendChild($evidencia5);//11

                    let $evidencia6 = document.createElement("td");
                    if(element.calificacion_evidencia6 != null){
                        $evidencia6.innerHTML = `<input id='evidencia6_${element.secundaria_inscrito_id}' onKeyUp="if(this.value>10){this.value='0';}else if(this.value<0){this.value='0';}" value='${element.calificacion_evidencia6}' lang="en" name='evidencia6[]' step="0.1" type='number' min="0" max="10" class='calif evidencia_${element.secundaria_inscrito_id} noUpperCase' data-inscritoid='${element.secundaria_inscrito_id}'>`; 

                    }else{
                        $evidencia6.innerHTML = `<input id='evidencia6_${element.secundaria_inscrito_id}' onKeyUp="if(this.value>10){this.value='0';}else if(this.value<0){this.value='0';}" value='' lang="en" name='evidencia6[]' step="0.1" type='number' min="0" max="10" class='calif evidencia_${element.secundaria_inscrito_id} noUpperCase' data-inscritoid='${element.secundaria_inscrito_id}'>`; 

                    }
                    $tr.appendChild($evidencia6);//12

                    let $evidencia7 = document.createElement("td");
                    if(element.calificacion_evidencia7 != null){
                        $evidencia7.innerHTML = `<input id='evidencia7_${element.secundaria_inscrito_id}' onKeyUp="if(this.value>10){this.value='0';}else if(this.value<0){this.value='0';}" value='${element.calificacion_evidencia7}' lang="en" name='evidencia7[]' step="0.1" type='number' min="0" max="10" class='calif evidencia_${element.secundaria_inscrito_id} noUpperCase' data-inscritoid='${element.secundaria_inscrito_id}'>`; 

                    }else{
                        $evidencia7.innerHTML = `<input id='evidencia7_${element.secundaria_inscrito_id}' onKeyUp="if(this.value>10){this.value='0';}else if(this.value<0){this.value='0';}" value='' lang="en" name='evidencia7[]' step="0.1" type='number' min="0" max="10" class='calif evidencia_${element.secundaria_inscrito_id} noUpperCase' data-inscritoid='${element.secundaria_inscrito_id}'>`; 

                    }
                    $tr.appendChild($evidencia7);//13

                    let $evidencia8 = document.createElement("td");
                    if(element.calificacion_evidencia8 != null){
                        $evidencia8.innerHTML = `<input id='evidencia8_${element.secundaria_inscrito_id}' onKeyUp="if(this.value>10){this.value='0';}else if(this.value<0){this.value='0';}" value='${element.calificacion_evidencia8}' lang="en" name='evidencia8[]' step="0.1" type='number' min="0" max="10" class='calif evidencia_${element.secundaria_inscrito_id} noUpperCase' data-inscritoid='${element.secundaria_inscrito_id}'>`; 

                    }else{
                        $evidencia8.innerHTML = `<input id='evidencia8_${element.secundaria_inscrito_id}' onKeyUp="if(this.value>10){this.value='0';}else if(this.value<0){this.value='0';}" value='' lang="en" name='evidencia8[]' step="0.1" type='number' min="0" max="10" class='calif evidencia_${element.secundaria_inscrito_id} noUpperCase' data-inscritoid='${element.secundaria_inscrito_id}'>`; 

                    }
                    $tr.appendChild($evidencia8);//14

                    let $evidencia9 = document.createElement("td");
                    if(element.calificacion_evidencia9 != null){
                        $evidencia9.innerHTML = `<input id='evidencia9_${element.secundaria_inscrito_id}' onKeyUp="if(this.value>10){this.value='0';}else if(this.value<0){this.value='0';}" value='${element.calificacion_evidencia9}' lang="en" name='evidencia9[]' step="0.1" type='number' min="0" max="10" class='calif evidencia_${element.secundaria_inscrito_id} noUpperCase' data-inscritoid='${element.secundaria_inscrito_id}'>`; 

                    }else{
                        $evidencia9.innerHTML = `<input id='evidencia9_${element.secundaria_inscrito_id}' onKeyUp="if(this.value>10){this.value='0';}else if(this.value<0){this.value='0';}" value='' lang="en" name='evidencia9[]' step="0.1" type='number' min="0" max="10" class='calif evidencia_${element.secundaria_inscrito_id} noUpperCase' data-inscritoid='${element.secundaria_inscrito_id}'>`; 

                    }
                    $tr.appendChild($evidencia9);//15

                    let $evidencia10 = document.createElement("td");
                    if(element.calificacion_evidencia10 != null){
                        $evidencia10.innerHTML = `<input id='evidencia10_${element.secundaria_inscrito_id}' onKeyUp="if(this.value>10){this.value='0';}else if(this.value<0){this.value='0';}" value='${element.calificacion_evidencia10}' lang="en" name='evidencia10[]' step="0.1" type='number' min="0" max="10" class='calif evidencia_${element.secundaria_inscrito_id} noUpperCase' data-inscritoid='${element.secundaria_inscrito_id}'>`; 

                    }else{
                        $evidencia10.innerHTML = `<input id='evidencia10_${element.secundaria_inscrito_id}' onKeyUp="if(this.value>10){this.value='0';}else if(this.value<0){this.value='0';}" value='' lang="en" name='evidencia10[]' step="0.1" type='number' min="0" max="10" class='calif evidencia_${element.secundaria_inscrito_id} noUpperCase' data-inscritoid='${element.secundaria_inscrito_id}'>`; 

                    }
                    $tr.appendChild($evidencia10);//16

                    let $faltasSep = document.createElement("td");
                    if(element.inscFaltasInjSep != null){
                        $faltasSep.innerHTML = `<input tabindex="2" id='faltaSep' value='${element.inscFaltasInjSep}' name='faltaSep[]' type='number' step='any' min='0' max="20">`; 

                    }else{
                        $faltasSep.innerHTML = `<input tabindex="2" id='faltaSep' value='' name='faltaSep[]' type='number' step='any' min='0' max="20">`; 

                    }
                    $tr.appendChild($faltasSep);//17

                    let $faltasOct = document.createElement("td");
                    if(element.inscFaltasInjOct != null){
                        $faltasOct.innerHTML = `<input tabindex="3" id='faltaOct' value='${element.inscFaltasInjOct}' name='faltaOct[]' type='number' step='any' min='0' max="20">`; 

                    }else{
                        $faltasOct.innerHTML = `<input tabindex="3" id='faltaOct' value='' name='faltaOct[]' type='number' step='any' min='0' max="20">`; 

                    }
                    $tr.appendChild($faltasOct);//18

                    let $faltasNov = document.createElement("td");
                    if(element.inscFaltasInjNov != null){
                        $faltasNov.innerHTML = `<input tabindex="4" id='faltaNov' value='${element.inscFaltasInjNov}' name='faltaNov[]' type='number' step='any' min='0' max="20">`; 

                    }else{
                        $faltasNov.innerHTML = `<input tabindex="4" id='faltaNov' value='' name='faltaNov[]' type='number' step='any' min='0' max="20">`; 

                    }
                    $tr.appendChild($faltasNov);//19

                    let $faltasDic = document.createElement("td");
                    if(element.inscFaltasInjDic != null){
                        $faltasDic.innerHTML = `<input tabindex="5" id='faltaDic' value='${element.inscFaltasInjDic}' name='faltaDic[]' type='number' step='any' min='0' max="20">`; 

                    }else{
                        $faltasDic.innerHTML = `<input tabindex="5" id='faltaDic' value='' name='faltaDic[]' type='number' step='any' min='0' max="20">`; 

                    }
                    $tr.appendChild($faltasDic);//20

                    let $faltasEne = document.createElement("td");
                    if(element.inscFaltasInjEne != null){
                        $faltasEne.innerHTML = `<input tabindex="6" id='faltaEne' value='${element.inscFaltasInjEne}' name='faltaEne[]' type='number' step='any' min='0' max="20">`; 

                    }else{
                        $faltasEne.innerHTML = `<input tabindex="6" id='faltaEne' value='${element.inscFaltasInjEne}' name='faltaEne[]' type='number' step='any' min='0' max="20">`; 

                    }
                    $tr.appendChild($faltasEne);//21

                    let $faltasFeb = document.createElement("td");
                    if(element.inscFaltasInjFeb != null){
                        $faltasFeb.innerHTML = `<input tabindex="7" id='faltaFeb' value='${element.inscFaltasInjFeb}' name='faltaFeb[]' type='number' step='any' min='0' max="20">`; 

                    }else{
                        $faltasFeb.innerHTML = `<input tabindex="7" id='faltaFeb' value='' name='faltaFeb[]' type='number' step='any' min='0' max="20">`; 

                    }
                    $tr.appendChild($faltasFeb);//22

                    let $faltasMar = document.createElement("td");
                    if(element.inscFaltasInjMar != null){
                        $faltasMar.innerHTML = `<input tabindex="8" id='faltaMar' value='${element.inscFaltasInjMar}' name='faltaMar[]' type='number' step='any' min='0' max="20">`; 

                    }else{
                        $faltasMar.innerHTML = `<input tabindex="8" id='faltaMar' value='' name='faltaMar[]' type='number' step='any' min='0' max="20">`; 

                    }
                    $tr.appendChild($faltasMar);//23

                    let $faltasAbr = document.createElement("td");
                    if(element.inscFaltasInjAbr != null){
                        $faltasAbr.innerHTML = `<input tabindex="9" id='faltaAbr' value='${element.inscFaltasInjAbr}' name='faltaAbr[]' type='number' step='any' min='0' max="20">`; 

                    }else{
                        $faltasAbr.innerHTML = `<input tabindex="9" id='faltaAbr' value='' name='faltaAbr[]' type='number' step='any' min='0' max="20">`; 

                    }
                    $tr.appendChild($faltasAbr);//24

                    let $faltasMay = document.createElement("td");
                    if(element.inscFaltasInjMay != null){
                        $faltasMay.innerHTML = `<input tabindex="10" id='faltaMay' value='${element.inscFaltasInjMay}' name='faltaMay[]' type='number' step='any' min='0' max="20">`; 

                    }else{
                        $faltasMay.innerHTML = `<input tabindex="10" id='faltaMay' value='' name='faltaMay[]' type='number' step='any' min='0' max="20">`; 

                    }
                    $tr.appendChild($faltasMay);//25

                    let $faltasJun = document.createElement("td");
                    if(element.inscFaltasInjJun != null){
                        $faltasJun.innerHTML = `<input tabindex="11" id='faltaJun' value='${element.inscFaltasInjJun}' name='faltaJun[]' type='number' step='any' min='0' max="20">`; 

                    }else{
                        $faltasJun.innerHTML = `<input tabindex="11" id='faltaJun' value='' name='faltaJun[]' type='number' step='any' min='0' max="20">`; 

                    }
                    $tr.appendChild($faltasJun);//26
                    
                    let $conductaSep = document.createElement("td");
                    $conductaSep.innerHTML = `<select style='margin-top: -18px;' id="conductaSep_${element.secundaria_inscrito_id}" class="browser-default validate select2" name="conductaSep[]" style="width: 100%;">
                        <option value="B">BUENA</option>
                        <option value="M">MALA</option>
                        <option value="R">REGULAR</option>
                    </select>`; 
                    $tr.appendChild($conductaSep);//27


                    let $conductaOct = document.createElement("td");
                    $conductaOct.innerHTML = `<select style='margin-top: -18px;' id="conductaOct_${element.secundaria_inscrito_id}" class="browser-default validate select2" name="conductaOct[]" style="width: 100%;">
                        <option value="B">BUENA</option>
                        <option value="M">MALA</option>
                        <option value="R">REGULAR</option>
                    </select>`; 
                    $tr.appendChild($conductaOct);//28

                    let $conductaNov = document.createElement("td");
                    $conductaNov.innerHTML = `<select style='margin-top: -18px;' id="conductaNov_${element.secundaria_inscrito_id}" class="browser-default validate select2" name="conductaNov[]" style="width: 100%;">
                        <option value="B">BUENA</option>
                        <option value="M">MALA</option>
                        <option value="R">REGULAR</option>
                    </select>`; 
                    $tr.appendChild($conductaNov);//29

                    let $conductaDic = document.createElement("td");
                    $conductaDic.innerHTML = `<select style='margin-top: -18px;' id="conductaDic_${element.secundaria_inscrito_id}" class="browser-default validate select2" name="conductaDic[]" style="width: 100%;">
                        <option value="B">BUENA</option>
                        <option value="M">MALA</option>
                        <option value="R">REGULAR</option>
                    </select>`; 
                    $tr.appendChild($conductaDic);//30

                    let $conductaEne = document.createElement("td");
                    $conductaEne.innerHTML = `<select style='margin-top: -18px;' id="conductaEne_${element.secundaria_inscrito_id}" class="browser-default validate select2" name="conductaEne[]" style="width: 100%;">
                        <option value="B">BUENA</option>
                        <option value="M">MALA</option>
                        <option value="R">REGULAR</option>
                    </select>`; 
                    $tr.appendChild($conductaEne);//31


                    let $conductaFeb = document.createElement("td");
                    $conductaFeb.innerHTML = `<select style='margin-top: -18px;' id="conductaFeb_${element.secundaria_inscrito_id}" class="browser-default validate select2" name="conductaFeb[]" style="width: 100%;">
                        <option value="B">BUENA</option>
                        <option value="M">MALA</option>
                        <option value="R">REGULAR</option>
                    </select>`; 
                    $tr.appendChild($conductaFeb);//32


                    let $conductaMar = document.createElement("td");
                    $conductaMar.innerHTML = `<select style='margin-top: -18px;' id="conductaMar_${element.secundaria_inscrito_id}" class="browser-default validate select2" name="conductaMar[]" style="width: 100%;">
                        <option value="B">BUENA</option>
                        <option value="M">MALA</option>
                        <option value="R">REGULAR</option>
                    </select>`; 
                    $tr.appendChild($conductaMar);//33


                    let $conductaAbr = document.createElement("td");
                    $conductaAbr.innerHTML = `<select style='margin-top: -18px;' id="conductaAbr_${element.secundaria_inscrito_id}" class="browser-default validate select2" name="conductaAbr[]" style="width: 100%;">
                        <option value="B">BUENA</option>
                        <option value="M">MALA</option>
                        <option value="R">REGULAR</option>
                    </select>`; 
                    $tr.appendChild($conductaAbr);//34

                    let $conductaMay = document.createElement("td");
                    $conductaMay.innerHTML = `<select style='margin-top: -18px;' id="conductaMay_${element.secundaria_inscrito_id}" class="browser-default validate select2" name="conductaMay[]" style="width: 100%;">
                        <option value="B">BUENA</option>
                        <option value="M">MALA</option>
                        <option value="R">REGULAR</option>
                    </select>`; 
                    $tr.appendChild($conductaMay);//35

                    let $conductaJun = document.createElement("td");
                    $conductaJun.innerHTML = `<select style='margin-top: -18px;' id="conductaJun_${element.secundaria_inscrito_id}" class="browser-default validate select2" name="conductaJun[]" style="width: 100%;">
                        <option value="B">BUENA</option>
                        <option value="M">MALA</option>
                        <option value="R">REGULAR</option>
                    </select>`; 
                    $tr.appendChild($conductaJun);//36

                    let $promediomes = document.createElement("td");
                    if(element.promedio_mes != null){
                        $promediomes.innerHTML = `<td><input onmouseover="this.value = parseFloat(this.value).toFixed(1)" value='${element.promedio_mes}' readonly='true' id='promedioTotal${element.secundaria_inscrito_id}' name='promedioTotal[]' step="0.0" type='number' min="5" max="10"></td>`; 

                    }else{
                        $promediomes.innerHTML = `<input onmouseover="this.value = parseFloat(this.value).toFixed(1)" readonly='true' id='promedioTotal${element.secundaria_inscrito_id}' name='promedioTotal[]' step="0.0" type='number' min="5" max="10">`; 

                    }
                    $tr.appendChild($promediomes);//37
                    ...
                    //creamos la tabla
                        ...
                        for(var i=0; i < variableDeJun.length; i++){
                            for(var x=0; x < variableDeID.length; x++){
                                if(variableDeJun[i] == "null" || variableDeJun[i] == null){
                        ...
                        $('td:nth-child(2)').hide();
                        $('td:nth-child(1)').hide();
                        $('td:nth-child(37)').hide();


                        //validamos si es grupo ACD para mostrar la columna de cgtGrupo

                        if("{{$validar_si_esta_activo_cme}}" == "1"){
                            if(es_grupo_acd == 0){
                                $('td:nth-child(6)').hide();
                                $("#claveGrupo").hide();
                            }else{
                        ...
                        if(numero_evidencias == 1){
                            ...
                            //ocultamos las evidencias que no se va a usar
                            for(ocultarEvidencias=8; ocultarEvidencias < 17; ocultarEvidencias++){
                                $('td:nth-child('+ocultarEvidencias+')').hide();    
                            }

                            //ocultamos evidencias del 2 al 10 
                            for(let numEv=2; numEv < 11; numEv++){
                                $(".classEvi"+numEv).hide();
                            }
                        ...
                        if(mes == "SEPTIEMBRE"){
                            ...
                            $('td:nth-child(33)').hide();
                            $('td:nth-child(34)').hide();
                            $('td:nth-child(35)').hide();
                            $('td:nth-child(36)').hide();
        ...
        obtenerAlumnos($("#secundaria_grupo_evidencia_id").val(), $("#grupo_id2").val())
        $("#secundaria_grupo_evidencia_id").change( event => {
