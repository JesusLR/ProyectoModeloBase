...
@section('breadcrumbs')
    ...
    <a href="{{url('secundaria_cgt')}}" class="breadcrumb">Lista de Cgt</a>
    <a href="{{url('secundaria_cgt/'.$cgt->id.'/edit')}}" class="breadcrumb">Editar cgt</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
        {{ Form::open(array('method'=>'PUT','route' => ['secundaria.secundaria_cgt.update', $cgt->id])) }}
        <div class="card ">
...
@include('secundaria.scripts.semestres')
