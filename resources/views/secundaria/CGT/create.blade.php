...
@section('breadcrumbs')
    ...
    <a href="{{url('secundaria_cgt/create')}}" class="breadcrumb">Agregar Cgt</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_cgt.store', 'method' => 'POST']) !!}
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#btn-guardar').on('click', function() {
            crear_cgt_secundaria();
        });


    });

    function crear_cgt_secundaria() {
        ...
        $.ajax({
            type: 'POST',
            url: '{{route('secundaria.secundaria_cgt.store')}}',
            dataType: 'json',
            data: $('form').serialize(),
