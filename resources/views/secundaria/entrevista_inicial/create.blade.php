...
@section('breadcrumbs')
    ...
    <a href="{{url('secundaria_entrevista_inicial')}}" class="breadcrumb">Agregar entrevista</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria_entrevista_inicial.store', 'method' => 'POST']) !!}
        <div class="card ">
            ...
            <nav class="nav-extended">
              <div class="nav-content">
                <ul class="tabs tabs-transparent">
                  <li class="tab"><a class="active" href="#general">Datos básicos para la entrevista inicial - Ingreso a Secundaria de la Escuela Modelo</a></li>
                </ul>
              </div>
            </nav>
