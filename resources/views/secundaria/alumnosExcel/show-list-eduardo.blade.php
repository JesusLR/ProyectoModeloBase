...
@section('breadcrumbs')
    ...
    <a href="{{route('secundaria.secundaria_datos_completos_alumno.reporteAlumnos')}}" class="breadcrumb">Alumnos Excel</a>
...
<div id="table-datatables">
    ...
    <div class="row">
        <div class="col s12">
            <table  id="tbl-cursos-alumnos-secundaria" class="responsive-table display nowrap" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th>Período</th>
                    <th>Ubicación</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#tbl-cursos-alumnos-secundaria').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/reporte/secundaria_datos_completos_alumno/getAlumnosCursosEduardo/secundaria",
    ...
    if( periodo_id != '')
    {
    $('#tbl-cursos-alumnos-secundaria').DataTable().destroy();
