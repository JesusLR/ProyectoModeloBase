...
<div id="table-datatables">
    ...
    <a href="{{ route('secundaria.secundaria_fecha_publicacion_calificacion_docente.create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#tbl-fecha-publicacion-calif').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/secundaria_fecha_publicacion_calificacion_docente/list",
                beforeSend: function () {
