...
@section('breadcrumbs')
    ...
    <a href="{{route('secundaria.secundaria_fecha_publicacion_calificacion_docente.index')}}" class="breadcrumb">Lista fechas de captura de calificaciones</a>
    <a href="{{route('secundaria.secundaria_fecha_publicacion_calificacion_docente.create')}}" class="breadcrumb">Agregar fechas de captura calificaciones</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_fecha_publicacion_calificacion_docente.store','method' => 'POST']) !!}
        <div class="card ">
            <div class="card-content ">
                <span class="card-title">AGREGAR FECHAS DE CAPTURA DE CALIFICACIONES</span>
                ...
                <div id="general">
                    ...
                    <div class="row">
                        ...
                        <div class="col s12 m6 l4">
                            ...
                            <select id="secundaria_mes_evaluaciones_id" data-evaluacion-id="{{old('secundaria_mes_evaluaciones_id')}}" class="browser-default validate select2" required name="secundaria_mes_evaluaciones_id"
                                style="width: 100%;">
                                <option value="" selected disabled>SELECCIONE UNA OPCIÓN</option>
                    ...
                    <div class="row">
                        <div class="col s12 m6 l3">
                            ...
                            {!! Form::date('calInicioCaptura', old('calInicioCaptura'), array('id' => 'calInicioCaptura', 'class' => 'validate')) !!}
                        </div>

                        <div class="col s12 m6 l3">
                            {!! Form::label('calFinCaptura', 'Fecha final de captura *', ['class' => '']); !!}
                            {!! Form::date('calFinCaptura', old('calFinCaptura'), array('id' => 'calFinCaptura', 'class' => 'validate')) !!}
                        </div>

                        <div class="col s12 m6 l3">
                            {!! Form::label('calInicioRevision', 'Fecha inicio de revisión *', ['class' => '']); !!}
                            {!! Form::date('calInicioRevision', old('calInicioRevision'), array('id' => 'calInicioRevision', 'class' => 'validate')) !!}
                        </div>

                        <div class="col s12 m6 l3">
                            {!! Form::label('calFinRevision', 'Fecha fin de revisión *', ['class' => '']); !!}
                            {!! Form::date('calFinRevision', old('calFinRevision'), array('id' => 'calFinRevision', 'class' => 'validate')) !!}
                        </div>
                    </div>
