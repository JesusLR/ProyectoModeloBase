...
@section('breadcrumbs')
    ...
    <a href="{{route('secundaria.secundaria_materias_inscrito.index')}}" class="breadcrumb">Cargar materias a alumno</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['enctype' => 'multipart/form-data', 'onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_materias_inscrito.store', 'method' => 'POST']) !!}
        <div class="card ">
...
<script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#alumno_id').on('change', function() {
        ...
        $.ajax({
            type: 'GET',
            url: base_url+'/secundaria_materias_inscrito/ultimo_curso/'+alumno_id,
            dataType: 'json',
    ...
    function buscarAlumno()
      {
        ...
        $.ajax({
            type: "POST",
            url: base_url + `/secundaria_materias_inscrito/api/getMultipleAlumnosByFilter`,
            data: {
                aluClave: aluClave,
  ...
  @include('secundaria.cargarMateriasInscrito.ajaxCargarMaterias')
