...
@section('breadcrumbs')
    ...
    <a href="{{route('secundaria.secundaria_alumnos_restringidos.index')}}" class="breadcrumb">Lista de alumnos restringidos</a>
    <a href="{{route('secundaria.secundaria_alumnos_restringidos.create')}}" class="breadcrumb">Agregar alumno restringido</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['enctype' => 'multipart/form-data', 'onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_alumnos_restringidos.store', 'method' => 'POST']) !!}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">ALUMNOS RESTRINGIDOS</span>
            ...
            <div class="row">
                    ...
                    <div style="position:relative">
                        <select id="lnNivel" class="browser-default validate select2" required name="lnNivel" style="width: 100%;">
                           ...
                           @forelse ($NivelListaNegra as $lista)
                            <option value="{{$lista->id}}" {{ old('lnNivel') == $lista->id ? 'selected' : '' }}>{{$lista->nlnClave}} - {{$lista->nlnDescripcion}}</option>                               
                           @empty
                ...
                <div class="col s12 m4">
                    ...
                    <input type="date" value="{{old('lnFecha', $fechaActual)}}" max="{{$fechaActual}}" id="lnFecha" name="lnFecha" required>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col s12 m4 l12">
                    ...
                    <input type="text" name="lnRazon" id="lnRazon" value="{{old('lnRazon')}}" required maxlength="255">
                </div>
            </div>
