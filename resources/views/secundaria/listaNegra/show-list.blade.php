...
<div id="table-datatables">
    ...
    <a href="{{ route('secundaria.secundaria_alumnos_restringidos.create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#table-empleados-secundaria').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/secundaria_alumnos_restringidos/list",
                beforeSend: function () {
