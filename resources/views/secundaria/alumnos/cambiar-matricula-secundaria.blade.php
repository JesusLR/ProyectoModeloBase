...
@section('breadcrumbs')
  ...
  <a href="{{url('secundaria_alumno/cambiar_matricula/' . $alumno->id)}}" class="breadcrumb">Cambiar matrícula alumno</a>
@endsection
...
@section('content')
  ...
  <div class="row">
    <div class="col s12 ">
      {!! Form::open(['route' => 'secundaria.secundaria_alumno.cambiarMatricula', 'method' => 'POST']) !!}
