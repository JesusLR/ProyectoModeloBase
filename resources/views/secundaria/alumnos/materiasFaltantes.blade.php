...
@section('breadcrumbs')
    ...
    <a href="{{url('secundaria_curso/' . $curso->id . '/materias_faltantes')}}" class="breadcrumb">Materias Faltantes</a>
@endsection
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    var tableCurso = $('#tbl-materias').dataTable({
      ...
      "ajax": {
        "type" : "GET",
        'url': base_url + '/secundaria_curso/listMateriasFaltantes/' + cursoId+'/',
        beforeSend: function () {
