...
@section('breadcrumbs')
    ...
    <a href="{{url('secundaria_curso')}}" class="breadcrumb">Lista de preinscritos</a>
@endsection

@section('content')
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_curso.crearReferencia', 'method' => 'POST']) !!}
    <div class="card ">
