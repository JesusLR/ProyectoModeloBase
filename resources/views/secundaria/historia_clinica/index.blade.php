...
@section('breadcrumbs')
    ...
    <a href="{{url('secundaria_historia_clinica')}}" class="breadcrumb">Lista expedientes</a>
@endsection
...
<div id="table-datatables">
    <h4 class="header">EXPEDIENTES DE ALUMNOS</h4>
    <a href="{{ route('secundaria.secundaria_historia_clinica.create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var tableCurso = $('#tbl-historia-clinica').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url +"/secundaria_historia_clinica/list",
                beforeSend: function () {
