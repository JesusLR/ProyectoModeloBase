{{-- MODAL BAJA CURSO --}}
<div id="modalBajaCursoSecundaria" class="modal">
    <div class="modal-content">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_curso.bajaCurso', 'method' => 'POST', 'class' => 'form-baja-alumno']) !!}
        ...
        <div class="row">
          ...
          <div class="col s6 m6 l6">
            ...
            <select id="conceptosBaja" class="browser-default validate " required name="conceptosBaja" style="width: 100%;">
