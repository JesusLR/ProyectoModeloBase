{{-- MODAL EQUIVALENTES --}}
<div id="modalAlumnoDetalle-secundaria" class="modal">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on("click", ".btn-modal-alumno-detalle-secundaria", function (e) {
            e.preventDefault()
            var alumno_id = $(this).data("alumno-id");
  
            $.get(base_url+`/secundaria_alumno/alumnoById/${alumno_id}`, function(res,sta) {
                console.log("res", res)
                ...
                $("#modalAlumnoDetalle-secundaria label").addClass("active")
