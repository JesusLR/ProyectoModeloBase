    ...
    <div class="modal-content">
        ...
        <div class="row">
            ...
            <div id="tab1" class="col s12">
                <table id="tbl-historial-pagos-secundaria" class="responsive-table display" cellspacing="0" width="100%">
                    <thead>
                        <tr>
            ...
            <div id="tab2" class="col s12">
                ...
                <table id="tbl-historial-pagos-alu-secundaria" class="responsive-table display" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th>Concepto de pago</th>
                            <th>Importe</th>
