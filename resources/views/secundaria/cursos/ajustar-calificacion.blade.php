...
<a href="{{url('secundaria_curso/grupos_alumno/'.$curso_id)}}" class="breadcrumb">Lista de grupos alumno</a>
...
<div class="row">
    <div class="col s12 "></div>
        {{ Form::open(['enctype' => 'multipart/form-data', 'method'=>'PATCH','route' => ['secundaria.secundaria_curso.ajustar_calificacion_update', $calificaciones->id]]) }}
        <div class="card ">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        function obtenerAlumnos(alumnoId, grupoId, aluClave) {
            $.get(base_url+`/secundaria_curso/getCalificacionUnicoAlumno/${alumnoId}/${grupoId}/${aluClave}`, function(res,sta) {
                        ...
                        const tableData = data.map(function(element){
                            ...
                            return (
                                `<tr>
                                    ...
                                    <td><input name='secundaria_inscrito_id' type='hidden' value='${element.secundaria_inscrito_id}'></td>
                                    <td>${element.perApellido1} ${element.perApellido2} ${element.perNombre}</td>
                                    <td><input id='evidencia1' value='${element.calificacion_evidencia1}' name='evidencia1' step="0.0" type='number' min="5" max="100" class='calif evidencia_${element.secundaria_inscrito_id}' data-inscritoid='${element.secundaria_inscrito_id}'></td>
                                    <td><input id='evidencia2' value='${element.calificacion_evidencia2}' name='evidencia2' step="0.0" type='number' min="5" max="100" class='calif evidencia_${element.secundaria_inscrito_id}' data-inscritoid='${element.secundaria_inscrito_id}'></td>
                                    <td><input id='evidencia3' value='${element.calificacion_evidencia3}' name='evidencia3' step="0.0" type='number' min="5" max="100" class='calif evidencia_${element.secundaria_inscrito_id}' data-inscritoid='${element.secundaria_inscrito_id}'></td>
                                    <td><input id='evidencia4' value='${element.calificacion_evidencia4}' name='evidencia4' step="0.0" type='number' min="5" max="100" class='calif evidencia_${element.secundaria_inscrito_id}' data-inscritoid='${element.secundaria_inscrito_id}'></td>
                                    <td><input id='evidencia5' value='${element.calificacion_evidencia5}' name='evidencia5' step="0.0" type='number' min="5" max="100" class='calif evidencia_${element.secundaria_inscrito_id}' data-inscritoid='${element.secundaria_inscrito_id}'></td>
                                    <td><input id='evidencia6' value='${element.calificacion_evidencia6}' name='evidencia6' step="0.0" type='number' min="5" max="100" class='calif evidencia_${element.secundaria_inscrito_id}' data-inscritoid='${element.secundaria_inscrito_id}'></td>
                                    <td><input id='evidencia7' value='${element.calificacion_evidencia7}' name='evidencia7' step="0.0" type='number' min="5" max="100" class='calif evidencia_${element.secundaria_inscrito_id}' data-inscritoid='${element.secundaria_inscrito_id}'></td>
                                    <td><input id='evidencia8' value='${element.calificacion_evidencia8}' name='evidencia8' step="0.0" type='number' min="5" max="100" class='calif evidencia_${element.secundaria_inscrito_id}' data-inscritoid='${element.secundaria_inscrito_id}'></td>
                                    <td><input id='evidencia9' value='${element.calificacion_evidencia9}' name='evidencia9' step="0.0" type='number' min="5" max="100" class='calif evidencia_${element.secundaria_inscrito_id}' data-inscritoid='${element.secundaria_inscrito_id}'></td>
                                    <td><input id='evidencia10' value='${element.calificacion_evidencia10}' name='evidencia10' step="0.0" type='number' min="5" max="100" class='calif evidencia_${element.secundaria_inscrito_id}' data-inscritoid='${element.secundaria_inscrito_id}'></td>
                                    <td><input onmouseover="this.value = parseFloat(this.value).toFixed(1)" readonly='true' id='promedioTotal${element.secundaria_inscrito_id}' name='promedioTotal' step="0.0" type='number' min="5" max="100" value='${element.promedio_mes}'></td>
                                </tr>`
                            );
        ...
        obtenerAlumnos($("#secundaria_grupo_evidencia_id").val(), $("#grupo_id2").val(), $("#aluClave").val())
        $("#secundaria_grupo_evidencia_id").change( event => {
