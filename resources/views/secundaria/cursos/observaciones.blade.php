...
@section('breadcrumbs')
    ...
    <a href="{{url('secundaria_curso/observaciones/'.$curso->id)}}" class="breadcrumb">Observaciones</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_curso.storeObservacionesCurso', 'method' => 'POST','enctype' => 'multipart/form-data', "class" => "form-guardar-secundaria"]) !!}
                        ...
                        <div class="col s12 m6 l8">
                            <div class="file-field input-field">
                                <a {{!$cursoObservaciones ? "disabled": ""}}
                                   class="btn" href="{{url('secundaria_curso/curso_archivo_observaciones/'. $curso->id)}}" target="blank">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        e.preventDefault()
			...
			function(isConfirm) {
				if (isConfirm) {
                    $(".form-guardar-secundaria").submit()
                } else {
                    swal.close()
				}
			});
