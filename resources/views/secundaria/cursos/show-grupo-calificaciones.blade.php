...
@section('template_title')
    Secundaria curso grupos alumno
@endsection
...
@section('breadcrumbs')
    ...
    <a href="{{url('secundaria_curso/grupos_alumno/'.$curso->id)}}" class="breadcrumb">Lista de grupos alumno</a>
@endsection
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#tbl-grupo-cali').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/secundaria_curso/listGruposAlumno/{{$curso->aluClave}}",
                beforeSend: function () {
