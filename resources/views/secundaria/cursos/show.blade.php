...
@section('breadcrumbs')
    ...
    <a href="{{url('secundaria_curso/'.$curso->id)}}" class="breadcrumb">Ver curso</a>
@endsection
            ...
            <div id="general">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m4">
                        <a href="#modalAlumnoDetalle-secundaria" data-alumno-id="{{ $curso->alumno_id  }}" class="btn modal-trigger btn-modal-alumno-detalle-secundaria button button--icon js-button js-ripple-effect ">Ver alumno</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col s12 m6 l4">
                ...
                <div class="row">
                    <div class="col s12 m6 l4">
                        ...
                        <div class="input-field">
                            @if ($curso->curSecundariaFoto && !strpos($curso->curSecundariaFoto, '.pdf'))
                                <img style="width:200px;" src="{{url('/secundaria_curso_images/' . $curso->curSecundariaFoto . '/' . $periodo->perAnioPago.'/'.$campus) }}" alt="">
                            @endif

                            @if($curso->curPrimariaFoto && strpos($curso->curPrimariaFoto, '.pdf'))
                                <label>Imagen</label>
                                <embed src="/secundaria_curso_images/{{$curso->curPrimariaFoto}}/{{$periodo->perAnioPago}}/{{$campus}}"
