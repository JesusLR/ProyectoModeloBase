...
@section('breadcrumbs')
    ...
    <a href="{{route('secundaria.secundaria_curso.create')}}" class="breadcrumb">Agregar preinscripción</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['enctype' => 'multipart/form-data', 'onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_curso.store', 'method' => 'POST']) !!}
        <div class="card ">
                    ...
                    <div class="col s12 m6 l8">
                        ...
                        @if (isset($candidato))
                            ...
                            @if ($candidato->perFoto)
                                    ...
                                    @if ($candidato->perFoto && !strpos($candidato->perFoto, '.pdf'))
                                        <img height="200px" src="{{url('/secundaria_curso_images/' . $candidato->perFoto) }}" alt="">
                                    @endif
                                    @if($candidato->perFoto && strpos($candidato->perFoto, '.pdf'))
                                        <label>Imagen</label>
                                        <embed src="/secundaria_curso_images/{{$candidato->perFoto}}"
...
<script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#alumno_id').on('change', function() {
        ...
        $.ajax({
            type: 'GET',
            url: base_url+'/secundaria_alumno/ultimo_curso/'+alumno_id,
            dataType: 'json',
