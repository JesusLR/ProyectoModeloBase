...
<a href="{{ url('secundaria_grupo/calificaciones/'.$calificaciones[0]->grupo_id.'/edit') }}"
                        ...
                        const tableData = data.map(function(element){
                            ...
                            return (
                                `<tr>
                                    ...
                                    <td><input id='evidencia1' value='${element.calificacion_evidencia1}' name='evidencia1[]' step="0.0" type='number' min="0" max="100" class='calif evidencia_${element.secundaria_inscrito_id}' data-inscritoid='${element.secundaria_inscrito_id}'></td>
                                    <td><input id='evidencia2' value='${element.calificacion_evidencia2}' name='evidencia2[]' step="0.0" type='number' min="0" max="100" class='calif evidencia_${element.secundaria_inscrito_id}' data-inscritoid='${element.secundaria_inscrito_id}'></td>
                                    <td><input id='evidencia3' value='${element.calificacion_evidencia3}' name='evidencia3[]' step="0.0" type='number' min="0" max="100" class='calif evidencia_${element.secundaria_inscrito_id}' data-inscritoid='${element.secundaria_inscrito_id}'></td>
                                    <td><input id='evidencia4' value='${element.calificacion_evidencia4}' name='evidencia4[]' step="0.0" type='number' min="0" max="100" class='calif evidencia_${element.secundaria_inscrito_id}' data-inscritoid='${element.secundaria_inscrito_id}'></td>
                                    <td><input id='evidencia5' value='${element.calificacion_evidencia5}' name='evidencia5[]' step="0.0" type='number' min="0" max="100" class='calif evidencia_${element.secundaria_inscrito_id}' data-inscritoid='${element.secundaria_inscrito_id}'></td>
                                    <td><input id='evidencia6' value='${element.calificacion_evidencia6}' name='evidencia6[]' step="0.0" type='number' min="0" max="100" class='calif evidencia_${element.secundaria_inscrito_id}' data-inscritoid='${element.secundaria_inscrito_id}'></td>
                                    <td><input id='evidencia7' value='${element.calificacion_evidencia7}' name='evidencia7[]' step="0.0" type='number' min="0" max="100" class='calif evidencia_${element.secundaria_inscrito_id}' data-inscritoid='${element.secundaria_inscrito_id}'></td>
                                    <td><input id='evidencia8' value='${element.calificacion_evidencia8}' name='evidencia8[]' step="0.0" type='number' min="0" max="100" class='calif evidencia_${element.secundaria_inscrito_id}' data-inscritoid='${element.secundaria_inscrito_id}'></td>
                                    <td><input id='evidencia9' value='${element.calificacion_evidencia9}' name='evidencia9[]' step="0.0" type='number' min="0" max="100" class='calif evidencia_${element.secundaria_inscrito_id}' data-inscritoid='${element.secundaria_inscrito_id}'></td>
                                    <td><input id='evidencia10' value='${element.calificacion_evidencia10}' name='evidencia10[]' step="0.0" type='number' min="0" max="100" class='calif evidencia_${element.secundaria_inscrito_id}' data-inscritoid='${element.secundaria_inscrito_id}'></td>
                                    <td><input onmouseover="this.value = parseFloat(this.value).toFixed(1)" readonly='true' id='promedioTotal${element.secundaria_inscrito_id}' name='promedioTotal[]' step="0.0" type='number' min="0" max="100" value='${element.promedio_mes}'></td>
                                </tr>`
                            );
