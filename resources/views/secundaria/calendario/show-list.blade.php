...
<a href="{{ route('secundaria.secundaria_calendario.index') }}" class="breadcrumb">Calendario</a>
@endsection
...
<script>
 document.addEventListener('DOMContentLoaded', function() {
    var calendarEl = document.getElementById('secundaria_calendar');
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: "{{ url('/secundaria_calendario/show') }}",
    ...
    function recolectarDatosGUI(method) {
        ...
        nuevoEvento = {
            ...
            color: '{{$secundaria_agenda_colores->preesColor}}',
            textColor: '#fff',
    ...
    function enviarInformacion(accion, objEvento) {
        $.ajax({
            type: "POST",
            url: "{{url('/secundaria_calendario')}}" + accion,
            data: objEvento,
...
<div class="row">
    ...
    <div class="col s9">
        <div id='secundaria_calendar'></div>
    </div>
    <div class="col s1"></div>
</div>

{{-- se incluye la vista del modal  --}}
@include('secundaria.calendario.modaEvento')
