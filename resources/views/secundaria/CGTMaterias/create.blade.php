...
@section('breadcrumbs')
    ...
    <a href="{{url('secundaria_cgt_materias')}}" class="breadcrumb">CGT Materia</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'secundaria.secundaria_cgt_materias.store', 'method' => 'POST']) !!}
        <div class="card ">
...
@include('secundaria.CGTMaterias.crearTablaJs')
...
@include('secundaria.CGTMaterias.guardarJS')
