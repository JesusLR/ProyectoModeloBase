<script>
    $(document).ready(function() {
        ...
        $(document).on("click", ".btn-guardar-grupo-cgt", function(e) {
            ...
            //var secundaria_materia =  $("input[name='secundaria_materia[]']").map(function(){return $(this).val();}).get();
            ...
            var secundaria_materia =  $("input[name='secundaria_materia[]']:checked").map(function () {
                return this.value;
               }).get();
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        url: "{{route('secundaria.secundaria_cgt_materias.store')}}",
                        method: "POST",
                        dataType: "json",
                        data: {
