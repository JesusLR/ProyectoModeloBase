<script type="text/javascript">
    $(document).ready(function() {
        ...
        function obtenerMaterias(periodo_id, programa_id,plan_id, cgt_id) {
            $.get(base_url+`/secundaria_cgt_materias/obtenerMaterias/${periodo_id}/${programa_id}/${plan_id}/${cgt_id}`, function(res,sta) {
                        ...
                        if(res.length > 0){
                            ...
                            let myTable= "<table><tr><th style='display:none'></th>";
                                ...
                                for (let i = 0; i < res.length; i++) {
                                    ...
                                    myTable+="<td><div  class='form-check checkbox-warning-filled'><input class='micheckbox filled-in' type='checkbox' checked name='secundaria_materia[]' value='"+res[i].id+"' id='"+res[i].id+"'><label for='"+res[i].id+"'></label></div></td>";
