...
@section('breadcrumbs')
    ...
    <a href="{{url('portal-configuracion')}}" class="breadcrumb">Lista de configuraciones</a>
@endsection
...
<div id="table-datatables">
    ...
    <div class="row">
        <div class="col s12">
            <table id="table-portal-configuracion" class="responsive-table display" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th>Clave</th>
                    <th>Portal</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#table-portal-configuracion').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/api/portal-configuracion",
                beforeSend: function () {
