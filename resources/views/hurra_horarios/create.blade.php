...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Hurra horarios</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'hurra_horarios/generar', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Hurra Horarios</span>
          {{-- NAVIGATION BAR--}}
