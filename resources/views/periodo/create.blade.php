...
@section('breadcrumbs')
    ...
    <a href="{{url('periodo')}}" class="breadcrumb">Lista de periodos</a>
...
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'periodo.store', 'method' => 'POST']) !!}
            <div class="card ">
...
@include('scripts.departamentosListaCompleta')
