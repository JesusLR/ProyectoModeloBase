...
@section('breadcrumbs')
    ...
    <a href="{{url('recibo_pago/create')}}" class="breadcrumb">Recibo de pago</a>
@endsection

@section('content')
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'recibo_pago.store', 'method' => 'POST',  "target" => "_blank"]) !!}
    <div class="card ">
        <div class="card-content ">
        <span class="card-title">GENERAR RECIBO DE PAGO</span>
        ...
        {!! Form::button('<i class="material-icons left">save</i> Generar recibo de pago', ['class' => 'btn-large waves-effect  darken-3','type' => 'submit']) !!}
        </div>
    </div>
    {!! Form::close() !!}
@endsection
