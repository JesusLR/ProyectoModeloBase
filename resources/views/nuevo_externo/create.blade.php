...
@section('breadcrumbs')
    ...
    <a href="{{url('alumno/create')}}" class="breadcrumb">Agregar alumno</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'universidad.universidad_nuevo_externo.store', 'method' => 'POST']) !!}
        ...
        <div class="card ">
          <div class="card-content ">
            ...
            <div id="general">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l4">
                                    ...
                                    <select id="aluNivelIngr" class="browser-default validate select2" required name="aluNivelIngr" style="width: 100%;" {{isset($candidato) ? "readonly": ""}}>
                                        ...
                                        @foreach($departamentos as $departamento)
                                            <option value="{{$departamento->depNivel}}"
                                                ...
                                                @if ($departamento->depClave == "AEX") ACTIVIDADES EXTRAESCOLARES @endif
                        ...
                        <div class="col s12 m6 l6">
                            ...
                            <select class="browser-default validate select2" data-grado-ingreso="{{old('aluGradoIngr') ?: 1}}" id="aluGradoIngr" name="aluGradoIngr" style="width:100%;">
                                @for($i = 1; $i < 10; $i++)
                ...
                <div class="row">
                    <div class="col s12 m6 l4">
                        @php
                            $candidato_municipio = isset($candidato) ? $municipio : null;
                            $estado = isset($candidato) ? $candidato_municipio->estado : null;
                            $candidato_pais = $estado ? $estado->pais : null;
                        @endphp
                        {!! Form::label('paisId', 'País *', array('class' => '')); !!}
                        <div style="position:relative">
                            <select id="paisId"
                                data-pais-id="{{old('paisId') ?: (isset($candidato) ? $candidato_pais->id : null)}}"
                                class="browser-default validate select2" required name="paisId" style="width: 100%;" {{ isset($candidato) ? "readonly": ""}}>
                                <option value="_">SELECCIONE UNA OPCIÓN</option>
                    ...
                    <div class="col s12 m6 l4">
                            ...
                            <div style="position:relative">
                                <select id="estado_id"
                                    ...
                                    data-estado-id="{{old('estado_id') ?: optional($estado)->id}}"
                    ...
                    <div class="col s12 m6 l4">
                        ...
                        <div style="position:relative">
                            <select id="municipio_id"
                                {{isset($candidato) ? "readonly": ""}}
                                data-municipio-id="{{old('municipio_id') ?: optional($candidato_municipio)->id}}"
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l4">
                        ...
                        {!! Form::email('perCorreo1', isset($candidato) ? $candidato->perCorreo1 : null,
                            ['id' => 'perCorreo1', isset($candidato) ? "readonly": "", 'class' => 'validate', 'maxlength' => '60', 'required']) !!}
                        </div>
                    </div>
                </div>
          ...
          <div class="card-action">
            {!! Form::button('<i class=" material-icons left validar-campos">save</i> Guardar y continuar preinscripción', ['class' => 'btn-guardar btn-large waves-effect  darken-3','id'=>'btn-guardar']) !!}
          </div>
        </div>
      {!! Form::close() !!}
    </div>
    ...
    <script type="text/javascript">
        ...
        */
        ...
        function verificarPersona() {
            ...
            $.ajax({
                type:'GET',
                url: base_url + '/api/alumno/verificar_persona',
                data: $('form').serialize(),
                dataType: 'json',
                success: function(data) {
