...
<div id="table-datatables">
    ...
    <div class="row">
        <div class="col s12">
            <a href="{{ route('universidad.universidad_actividades_inscritos.create') }}" class="btn-large waves-effect  darken-3" type="button"> Inscribir en Actividad (Grupo)
                <i class="material-icons left">add</i>
            </a>
            {{--  <a href="{{ route('universidad.universidad_calificacion.create') }}" class="btn-large waves-effect  darken-3" type="button">Calificaciones
                <i class="material-icons left">add</i>
            </a>  --}}

            <table id="tbl-actividades-inscritos-universidad" class="responsive-table display" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>Año Escolar</th>
                        <th>Período</th>
...
@include('actividades_inscritos.modaHistorialPagos-universidad')
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#tbl-actividades-inscritos-universidad').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/actividades_inscritos/list",
                beforeSend: function () {
...
<script>
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", ".btn-modal-historial-pagos-universidad", function (e) {
            e.preventDefault()
