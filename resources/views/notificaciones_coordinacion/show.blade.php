...
@section('breadcrumbs')
    ...
    <a href="{{url('notificaciones_coordinacion/'.$empleadoSeguimiento->id)}}" class="breadcrumb">Mostrar Notificaciones Coordinación</a>
@endsection
    ...
    <div class="col s12 ">
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">MOSTRAR NOTIFICACIONES COORDINACIÓN</span>
            ...
            <div class="row">
                ...
                <div class="input-field col s4">
                    {!! Form::text('empCorreo1', $empleadoSeguimiento->empCorreo1 ,array('readonly' => 'true')) !!}
