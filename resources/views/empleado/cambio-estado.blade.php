...
@section('breadcrumbs')
    ...
    <a href="{{url('empleados/cambio-estado')}}" class="breadcrumb">Cambio estado de empleados</a>
@endsection
...
<div id="table-datatables">
    ...
    <div class="row">
        <div class="col s12">
            <table id="table-empleados-cambio-estado" class="responsive-table display" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th>ID</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        escuela.on('change', function() {
            if (this.value) {
                ...
                $('#table-empleados-cambio-estado').dataTable({
                    ...
                    "ajax": {
                        "type" : "GET",
                        'url': base_url+"/api/empleados/"+this.value,
                        beforeSend: function () {
        ...
        $('#table-empleados-cambio-estado').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/api/empleados"+escuela_id,
                beforeSend: function () {
                    $('.preloader').fadeIn(200,function(){$(this).append('<div id="preloader"></div>');;});
    ...
    function cambiarMultiplesStatusEmpleados(listado) {
        $.ajax({
            type: 'POST',
            url: `${base_url}/cambiar_status_empleado/actualizar_lista`,
            dataType: 'json',
