...
@section('breadcrumbs')
    ...
    <a href="{{url('extracurricular/'.$inscrito->id)}}" class="breadcrumb">Ver inscrito extracurricular</a>
@endsection
    ...
    <div class="col s12 ">
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">INSCRITO EXTRACURRICULAR #{{$inscrito->id}}</span>
            ...
            <div id="general">
                ...
                <div class="row">
                    <div class="col s12 ">
                        <div class="input-field">
                            {!! Form::text('grupo_id', $inscrito->grupo->gpoSemestre.'-'.$inscrito->grupo->gpoClave.'-'.$inscrito->grupo->gpoTurno.' '.$inscrito->grupo->materia->matNombre, array('readonly' => 'true')) !!}
