...
<div id="table-datatables">
    <h4 class="header">EXTRACURRICULAR INSCRITO</h4>
    @php use App\Models\User; @endphp
        @if (User::permiso("inscrito") != "D" && User::permiso("inscrito") != "P")
        <a href="{{ url('extracurricular/create') }}" class="btn-large waves-effect darken-3" type="button">Por materias
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#tbl-inscrito').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/api/extracurinscrito",
                beforeSend: function () {
