...
@section('breadcrumbs')
    ...
    <a href="{{url('extracurricular')}}" class="breadcrumb">Lista de Inscritos extracurricular</a>
    <a href="{{url('extracurricular/'.$inscrito->id.'/edit')}}" class="breadcrumb">Editar inscrito extracurricular</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
        {{ Form::open(array('method'=>'PUT','route' => ['extracurricular.update', $inscrito->id])) }}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">EDITAR INSCRITO EXTRACURRICULAR #{{$inscrito->id}}</span>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
      ...
      $("#curso_id").change( event => {
          ...
          $.get(base_url+`/api/gruposextracur/${event.target.value}`, function(res, sta) {
