...
@section('breadcrumbs')
    ...
    <a href="{{url('extracurricular/create')}}" class="breadcrumb">Agregar Inscrito extracurricular</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'extracurricular.store', 'method' => 'POST']) !!}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">INSCRIBIR POR MATERIA EXTRACURRICULAR</span>
