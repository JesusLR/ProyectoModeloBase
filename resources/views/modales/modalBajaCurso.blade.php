{{-- MODAL BAJA CURSO --}}
<div id="modalBajaCurso" class="modal">
    <div class="modal-content">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'curso/bajaCurso', 'method' => 'POST', 'class' => 'form-baja-alumno']) !!}
        ...
        <div class="row">
          ...
          <div class="col s6 m6 l6">
            ...
            <select id="conceptosBaja" class="browser-default validate" name="conceptosBaja" style="width: 100%;" required>
