...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $.get(base_url+`/api/departamentos/${ubicacion_id}`,function(res,sta){
            ...
            $.get(base_url+`/api/periodos/${departamento_id}`,function(res2,sta){
                var perSeleccionado;
            ...
            $.get(base_url+`/api/escuelas/${departamento_id}`,function(res,sta){
                ...
                $.get(base_url+`/api/programas/${escuela_id}`,function(res,sta){
                    res.forEach(element => {
                    ...
                    if(programa_id != "" && programa_id != null){
                        ...
                        $.get(base_url+`/api/planes/${programa_id}`,function(res2,sta){
                            res2.forEach(element => {
                                ...
                                if(periodo_id != "" && periodo_id != null){
                                    ...
                                    $.get(base_url+`/api/cgts/${plan_id}/${periodo_id}`,function(res3,sta){
                            ...
                            if(plan_id != "" && plan_id != null){
                                ...
                                $.get(base_url+`/api/plan/semestre/${plan_id}`,function(res,sta){
