...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'storeGrupo', 'method' => 'POST']) !!}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">INSCRIBIR POR GRUPO</span>
            ...
            <div id="general">
                ...
                <div class="row">
                    <div class="col s6">
                        {!! Form::label('claveGrupo', 'Clave del grupo *', array('class' => '')); !!}
                        <input type="text" class="form-control" value=""name="claveGrupo" required />
                    </div>
                </div>
            </div>
          </div>
