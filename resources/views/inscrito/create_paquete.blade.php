...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'storePaquete', 'method' => 'POST']) !!}
        <div class="card ">
          <div class="card-content">
            <span class="card-title">INSCRIBIR POR PAQUETE</span>
            ...
            <div id="general">
                ...
                <div class="row">
                    <div class="col s12 ">
                        {!! Form::label('paquete_id', 'Paquete *', array('class' => '')); !!}
                        <select id="paquete_id" class="browser-default validate select2" required name="paquete_id" style="width: 100%;">
                            <option value="" selected disabled>SELECCIONE UNA OPCIÓN</option>
                        </select>
                    </div>
                </div>
