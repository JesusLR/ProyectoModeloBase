...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Acta de examen extraordinario federal</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte-federal/acta_extraordinario/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Acta de examen extraordinario federal</span>
          {{-- NAVIGATION BAR--}}
