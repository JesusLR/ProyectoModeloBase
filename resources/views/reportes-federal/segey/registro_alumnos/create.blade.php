...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">SEGEY Federal - Registros de Alumnos</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte-federal/segey/registro_alumnos/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        programa.on('change', function() {
            this.value ? getPlanesFederales(this.value) : resetSelect('plan_id');
        });
