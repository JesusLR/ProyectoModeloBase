...
@section('breadcrumbs')
    ...
    <a href="" class="breadcrumb">Actas de Examen Ordinario Federales</a>
@endsection

@section('content')
  <div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte-federal/acta_examen_ordinario_federales/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">ACTAS DE EXAMEN ORDINARIO FEDRALES</span>
