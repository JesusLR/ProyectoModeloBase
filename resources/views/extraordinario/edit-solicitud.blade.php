          ...
          <div class="card-content ">
            ...
            <div id="general">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l4">
                        {!! Form::label('iexEstado', 'Estado pago', array('class' => '')); !!}
                    ...
                    <div class="col s12 m6 l4">
                        ...
                        <select name="iexModoRegistro" id="iexModoRegistro" class="browser-default validate select2" style="width: 100%;">
                            <option value="" selected disabled>SELECCIONE UNA OPCIÓN</option>
                            @foreach($iexModoRegistro as $key => $value)
                                <option value="{{$key}}" @if($solicitud->iexModoRegistro == $key) {{ 'selected' }} @endif>{{$value}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
