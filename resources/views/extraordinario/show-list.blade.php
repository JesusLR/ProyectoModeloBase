...
<div id="table-datatables">
    ...
    <a href="{{ url('extraordinario/create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
        <i class="material-icons left">add</i>
    </a>
    @endif
    <a href="{{ url('solicitudes/extraordinario') }}" class="btn-large waves-effect  darken-3" type="button">Solicitudes
