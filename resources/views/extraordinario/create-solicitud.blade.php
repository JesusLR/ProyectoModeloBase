...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'store.solicitud','target'=>"_blank", 'method' => 'POST', 'id' => 'form_solicitud']) !!}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">AGREGAR SOLICITUD EXTRAORDINARIO</span>
            ...
            <div id="general">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l4">
                        {!! Form::label('iexModoRegistro', 'Tipo de pago *', ['class' => '']); !!}
                        <select name="iexModoRegistro" id="iexModoRegistro" class="browser-default validate select2" style="width: 100%;">
            ...
            <hr>
            <h5>Detalles del extraordinario</h5>
            <div class="row">
...
<script type="text/javascript">
    $(document).on('click', '#btnValidarAlumno', function (e) {
        ...
        $.get(base_url + `/api/extraordinario/validarAlumnoPresentaExtra/` + extraordinario_id + "/" + alumno_id, function(res,sta) {
