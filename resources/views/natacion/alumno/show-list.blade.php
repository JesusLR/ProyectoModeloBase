...
@section('content')
    <div id="table-datatables">
        ...
        <a href="{{ url('/natacion_alumno/create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
        ...
        <div class="row">
            <div class="col s12">
                <table id="tbl-natacion-alumno" class="responsive-table display" cellspacing="0" width="100%">
                    <thead>
                    <tr>
                        <th>Clave Alumno</th>
    ...
    <script type="text/javascript">
        function modalHistorialPagos(aluClave) {
            ...
            $('#tbl-historial-pagos').dataTable({
                ...
                "ajax": {
                    "type" : "GET",
                    'url': base_url + "/api/natacion_alumno/listHistorialPagosAluclave/" + aluClave,
                    beforeSend: function () {
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#tbl-natacion-alumno').dataTable({
                ...
                "ajax": {
                    "type" : "GET",
                    'url': base_url+"/api/natacion_alumno/list",
                    beforeSend: function () {
