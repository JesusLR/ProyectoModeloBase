...
@section('breadcrumbs')
    ...
    <a href="{{url('natacion_alumno/create')}}" class="breadcrumb">Agregar alumno</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'natacion_alumno.store', 'method' => 'POST']) !!}
    ...
    <script type="text/javascript">
        ...
        */
        ...
        function verificarPersona() {
            ...
            $.ajax({
                type:'GET',
                url: base_url + '/api/natacion_alumno/verificar_persona',
                data: $('form').serialize(),
                dataType: 'json',
                success: function(data) {
                    if(data.alumno){
