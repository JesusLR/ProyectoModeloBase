...
@section('breadcrumbs')
  ...
  <a href="{{url('natacion_alumno/cambiar_matricula/' . $alumno->id)}}" class="breadcrumb">Cambiar matrícula alumno</a>
@endsection
...
@section('content')
  ...
  <div class="row">
    <div class="col s12 ">
      {!! Form::open(['url' => 'natacion_alumno/cambiar_matricula/edit', 'method' => 'POST']) !!}
