...
@section('breadcrumbs')
    ...
    <a href="" class="breadcrumb">Relación de pagos</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/rel_pagos_educontinua/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">RELACIÓN DE PAGOS</span>
            ...
            <div id="filtros">
              <div class="row">
                <div class="col s12 m6 l4">
                  <div class="input-field">
                    {!! Form::number('perNumero', NULL, array('id' => 'perNumero', 'class' => 'validate')) !!}
              ...
              <div class="row">
                <div class="col s12 m6 l4">
                  <div class="input-field">
                    {!! Form::text('educacioncontinua_id', NULL, array('id' => 'educacioncontinua_id', 'class' => 'validate','min'=>'0')) !!}
                    {!! Form::label('educacioncontinua_id', 'Num. id prog', array('class' => '')); !!}
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col s12 m6 l4">
                  <div class="input-field">
                    {!! Form::text('nombreCompleto', NULL, array('id' => 'nombreCompleto', 'class' => 'validate','min'=>'0')) !!}
                    {!! Form::label('nombreCompleto', 'Nombre alumno', array('class' => '')); !!}
                  </div>
                </div>
              </div>
