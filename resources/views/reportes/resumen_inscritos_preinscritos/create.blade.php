...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Resumen de inscritos y preinscritos</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/resumen_inscritos_preinscritos/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Resumen de inscritos y preinscritos</span>
          {{-- NAVIGATION BAR--}}
