...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">CIBIES Administrativos</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/cibies_administrativos/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">CIBIES Administrativos</span>
          {{-- NAVIGATION BAR--}}
