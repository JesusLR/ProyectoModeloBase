...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Carga de alumnos por aula</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/carga_alumnos_aula/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Carga de alumnos por aula</span>
          {{-- NAVIGATION BAR--}}
              ...
              <div class="row">
                ...
                <div class="col s12 m6 l4">
                  <div class="input-field col s12 m6 l6">
                    <input type="text" name="aulaClave" id="aulaClave" value="{{old('aulaClave')}}">
                    <label for="aulaClave">Clave de aula</label>
                  </div>
                </div>
              </div>
