...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Lista de servicio social</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/lista_servicio_social/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Lista de servicio social</span>
          {{-- NAVIGATION BAR--}}
