...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Relación de inscritos a primero</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/relacion_inscritos_primero/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Relación de inscritos a primero</span>
          {{-- NAVIGATION BAR--}}
