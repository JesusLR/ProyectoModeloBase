...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Alumnos de último grado</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/alumnos_ultimo_grado/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Alumnos de último grado</span>
          {{-- NAVIGATION BAR--}}
