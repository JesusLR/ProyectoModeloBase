...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Relación de alumnos sin renovación de beca</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/alumnos_sin_renovacion_beca/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Relación de alumnos sin renovación de beca</span>
          {{-- NAVIGATION BAR--}}
          ...
          <div id="filtros">
              ...
              <div class="row">
                ...
                <div class="col s12 m6 l4">
                  <div class="input-field col s12 m6 l6">
                    <input type="number" name="semestre" id="semestre" class="validate">
                    <label for="semestre">Clave de pago</label>
                  </div>
                  <div class="input-field col s12 m6 l6">
                    <input type="number" name="aluClave" id="aluClave" class="validate">
              ...
              <div class="row">
                <div class="col s12 m6 l4">
                  <label for="curTipoBeca">Tipo de beca</label>
                  <select class="browser-default validate select2" data-tipo-beca="{{old('curTipoBeca')}}" name="curTipoBeca" id="curTipoBeca" style="width:100%;">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    apply_data_to_select('curTipoBeca', 'tipo-beca');
