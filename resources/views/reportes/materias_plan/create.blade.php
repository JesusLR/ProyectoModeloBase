...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Materias por plan</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'url' => 'reporte/materias_plan/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Materias por plan</span>
          {{-- NAVIGATION BAR--}}
