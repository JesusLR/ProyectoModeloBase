...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Relación de optativas del periodo</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/optativas_periodo/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Relación de optativas del periodo</span>
          {{-- NAVIGATION BAR--}}
