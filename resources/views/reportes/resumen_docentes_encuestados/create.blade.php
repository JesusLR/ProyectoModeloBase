...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Resumen Docentes Encuestados</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/resumen_docentes_encuestados/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Resumen Docentes Encuestados</span>
          {{-- NAVIGATION BAR--}}
