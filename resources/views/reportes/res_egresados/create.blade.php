...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    departamento.on('change', function() {
      (this.value && tipoReporte.value != 'C') ? getPeriodos(this.value) : resetSelect('periodo_id');
    ...
    $('#tipoReporte').on('change', function() {
      if(this.value == 'C') {
        ...
        periodo.prop('required', false).prop('disabled', true);
        // programa.prop('required', true);
      } else {
        periodo.removeAttr('disabled').prop('required', true);
        // programa.prop('required', false);
        departamento.val() ? getPeriodos(departamento.val()) : resetSelect('periodo_id');
      }
    });
