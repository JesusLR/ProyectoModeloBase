...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Kardex Académico</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'url' => 'reporte/kardex_academico/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Kardex Académico</span>
          {{-- NAVIGATION BAR--}}
          ...
          <div id="filtros">
            <div class="row">
              <div class="col s12 m4 l4">
                ...
                <select name="ubicacion_id" id="ubicacion_id" class="browser-default validate select2" data-ubicacion-id="{{old('ubicacion_id') ?: $ubicacion_id}}" style="width: 100%;" required>
              ...
              <div class="col s12 m4 l4">
                <label for="formato_reporte">Formato reporte</label>
                <select class="browser-default validate select2" data-formato-reporte="{{old('formato_reporte')}}" name="formato_reporte" id="formato_reporte" style="width:100%;" required>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#ubicacion_id').val() && obtenerFirmantes($('#ubicacion_id').val());
    ...
    $('#buscarProgramas').click(function(){
      ...
      if(aluClave) {
        buscar_programas(`/historial_alumno/obtenerProgramasClave/${aluClave}`);
      }else if(aluMatricula) {
        buscar_programas(`/historial_alumno/obtenerProgramasMatricula/${aluMatricula}`);
      }else {
        resetSelect('plan_id');
        $('#botonSubmit').prop('disabled', true);
        swal({
