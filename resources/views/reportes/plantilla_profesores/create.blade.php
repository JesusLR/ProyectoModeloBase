...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Plantilla de profesores</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/plantilla_profesores/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Plantilla de profesores</span>
          {{-- NAVIGATION BAR--}}
