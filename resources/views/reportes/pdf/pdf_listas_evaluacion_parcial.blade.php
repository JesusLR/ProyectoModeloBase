        ...
        <div class="columns medium-12">
          <p>
            @if ($grupo)
              ...
              ({{$grupo["periodo"]["perNumero"]."/".$grupo["periodo"]["perAnio"]}})
            @endif
          </p>
        </div>
      </div>
          ...
          <table class="table">
            <thead>
              <tr style="margin-top: 10px;">
                ...
                @if($TERCER_PARCIAL)
                <th align="center" style="font-weight: 400; width: 30px;">1er Parcial<br> Calif</th>
            ...
            <tbody>
              @foreach ($grupo->inscritos as $inscrito)
                <tr>
                  ...
                  <td style="font-size: 10px;">{{$inscrito->aluClave ?$inscrito->aluClave: "" }}</td>
                  <td style="">{{$inscrito["perApellido1"]}} {{$inscrito["perApellido2"]}} {{$inscrito["perNombre"]}}</td>
