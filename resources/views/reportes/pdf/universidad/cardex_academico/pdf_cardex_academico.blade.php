  ...
  <body>
    ...
    <header>
      ...
      <div class="row">
        <div class="columns medium-12">
          <table class="table">
            <tr>
              <td style="border-top: 1px solid; border-bottom: 1px solid; border-left: 1px solid; border-right: 1px solid; width: 60px;">Escuela:</td>
              <td style="border-top: 1px solid; border-bottom: 1px solid; border-left: 1px solid; border-right: 1px solid;">UNIVERSIDAD MODELO</td>
              <td style="border-top: 1px solid; border-bottom: 1px solid; border-left: 1px solid; border-right: 1px solid;">CCT:{{ $centroTrabajo }}</td>
              <td style="border-top: 1px solid; border-bottom: 1px solid; border-left: 1px solid; border-right: 1px solid; width: 130px;">Créditos Aprobados: {{$creditosAprob}}</td>
            </tr>

            <tr>
              <td style="border-top: 1px solid; border-bottom: 1px solid; border-left: 1px solid; border-right: 1px solid;">Programa:</td>
              <td style="border-top: 1px solid; border-bottom: 1px solid; border-left: 1px solid; border-right: 1px solid;">{{$progNombre}}</td>
              <td style="border-top: 1px solid; border-bottom: 1px solid; border-left: 1px solid; border-right: 1px solid;">Plan(es): {{$planClave}}</td>
              <td style="border-top: 1px solid; border-bottom: 1px solid; border-left: 1px solid; border-right: 1px solid;">Curso: {{ $ultimoCurso }}</td>
            </tr>
            ...
            <tr>
              ...
              <td style="border-top: 1px solid; border-bottom: 1px solid; border-left: 1px solid; border-right: 1px solid;">Prom: {{ number_format((float)$resPromedioAcumulado, 2, '.', '') }} </td>
            </tr>
      ...
      <div class="row">
        <div class="" style="border: 1px solid #000000; height: 60px;">
          ...
          <div class="columns medium-2">
            <div>
              <label style="position: fixed; top: -71px; left: 50px;">Grupo: {{ $grupo }}</label>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row"
      <div class="columns medium-12">
        <table class="table">
          <thead>
            <tr style="background-color: #ECE9E8">
              <th style="border-top: 1px solid; border-bottom: 1px solid; border-left: 1px solid; border-right: 1px solid; width: auto;">Curso</th>
              <th align="center" style="border-top: 1px solid; border-bottom: 1px solid; border-left: 1px solid; border-right: 1px solid; width: auto;">Clave</th>
              <th style="border-top: 1px solid; border-bottom: 1px solid; border-left: 1px solid; border-right: 1px solid; width: auto;">ORD</th>
              <th style="border-top: 1px solid; border-bottom: 1px solid; border-left: 1px solid; border-right: 1px solid; width: auto;">REG 1</th>
              <th style="border-top: 1px solid; border-bottom: 1px solid; border-left: 1px solid; border-right: 1px solid; width: auto;">REG 2</th>
              <th style="border-top: 1px solid; border-bottom: 1px solid; border-left: 1px solid; border-right: 1px solid; width: auto;">REG 3</th>
              <th style="border-top: 1px solid; border-bottom: 1px solid; border-left: 1px solid; border-right: 1px solid; width: auto;">ESP</th>
              <th align="right" style="border-top: 1px solid; border-bottom: 1px solid; border-left: 1px solid; border-right: 1px solid; width: auto;">EQ</th>
          </tr>
          </thead>

          <tbody>
            @foreach ($datos as $semestre => $datos_alumno)

              {{--  @if ($semestre == 1)  --}}
              <tr style="background-color: #ECE9E8">
                <td style="border-top: 1px solid; border-bottom: 1px solid; border-left: 1px solid; border-right: 1px solid;">Curso {{ $semestre }} @if($datos_alumno[0]->anioInicial != "") {{ $datos_alumno[0]->anioInicial }}-{{ $datos_alumno[0]->anioInicial+1 }} @else @endif</td>
