...
<header>
  <div class="row" style="margin-top: 0px;">
    <div class="rectangulo">
      ...
      <p style="text-align: center; font-size: 13px;">Ubicación: {{$ubicacion}}</p>
      <p style="text-align: center; font-size: 13px;">Nivel: {{$nivel}}</p>
      <p style="text-align: center; font-size: 13px;">Periodo: {{$peridoescolar}}</p>
  ...
  <div class="right">
    <img class="img-header" style="margin-top: -114px;" src="{{base_path('resources/assets/img/logo.jpg')}}" alt="">
  </div>
</header>

<body>

@foreach ($aluClavePago as $clavePago => $item)
  @php
      $vuelta = 1;
  @endphp
  ...
  @foreach ($ahorro_alumnos as $ahorro_alumno)
    ...
    <br>
          <div class="row">
            ...
            @endphp
            <p><strong>Clave pago: </strong>{{$ahorro_alumno->clave_pago}} - <strong>Alumno: </strong>{{$ahorro_alumno->apellido_paterno.' '.$ahorro_alumno->apellido_materno.' '.$ahorro_alumno->nombres}}</p>
              ...
              <table class="table table-bordered">
                  <thead>
                      <tr>
                          ...
                          <th align="center" style="width: 80px; border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;">MOVIMIENTO</th>
                          <th align="center" style="width: 75px; border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;">IMPORTE</th>
