    ...
    <header>
      <div class="row">
        <div class="columns medium-6">
          <h5 style="margin-top:0px; margin-bottom: 10px;">ESCUELA PRIM. PART. INC. MODELO</h5>
                ...
                @foreach ($calificacionesInscritos as $key => $inscrito)
                  ...
                  <tr>
                          ...
                          @if ($mesEvaluar == "Septiembre")
                            @if ($itemmatNombreColumna == $item->matClave && $item->clave_pago == $inscrito->aluClave)
                              <td align="center">
                                ...
                                @php
                                    $promedioGeneral = $promedioGeneral + $item->inscCalificacionSep;
                                @endphp
                                @else
                                __
                                @endif
                          ...
                          @if ($mesEvaluar == "Octubre")
                            @if ($itemmatNombreColumna == $item->matClave && $item->clave_pago == $inscrito->aluClave)
                              <td align="center">
                                ...
                                @php
                                    $promedioGeneral = $promedioGeneral + $item->inscCalificacionOct;
                                @endphp
                                @else
                                __
                                @endif
                          ...
                          @if ($mesEvaluar == "Noviembre")
                            @if ($itemmatNombreColumna == $item->matClave && $item->clave_pago == $inscrito->aluClave)
                              <td align="center">
                                ...
                                @php
                                    $promedioGeneral = $promedioGeneral + $item->inscCalificacionNov;
                                @endphp
                                @else
                                __
                                @endif
                          ...
                          @if ($mesEvaluar == "Diciembre")
                            @if ($itemmatNombreColumna == $item->matClave && $item->clave_pago == $inscrito->aluClave)
                              <td align="center">
                                ...
                                @php
                                    $promedioGeneral = $promedioGeneral + $item->inscCalificacionDic;
                                @endphp
                                @else
                                __
                                @endif
                          ...
                          @if ($mesEvaluar == "Enero")
                            @if ($itemmatNombreColumna == $item->matClave && $item->clave_pago == $inscrito->aluClave)
                              <td align="center">
                                ...
                                @php
                                    $promedioGeneral = $promedioGeneral + $item->inscCalificacionEne;
                                @endphp
                                @else
                                __
                                @endif
                          ...
                          @if ($mesEvaluar == "Febrero")
                            @if ($itemmatNombreColumna == $item->matClave && $item->clave_pago == $inscrito->aluClave)
                              <td align="center">
                                ...
                                @php
                                    $promedioGeneral = $promedioGeneral + $item->inscCalificacionFeb;
                                @endphp
                                @else
                                __
                                @endif
                          ...
                          @if ($mesEvaluar == "Marzo")
                            @if ($itemmatNombreColumna == $item->matClave && $item->clave_pago == $inscrito->aluClave)
                              <td align="center">
                                ...
                                @php
                                    $promedioGeneral = $promedioGeneral + $item->inscCalificacionMar;
                                @endphp
                                @else
                                __
                                @endif
                          ...
                          @if ($mesEvaluar == "Abril")
                            @if ($itemmatNombreColumna == $item->matClave && $item->clave_pago == $inscrito->aluClave)
                              <td align="center">
                                ...
                                @php
                                    $promedioGeneral = $promedioGeneral + $item->inscCalificacionAbr;
                                @endphp
                                @else
                                __
                                @endif
                          ...
                          @if ($mesEvaluar == "Mayo")
                            @if ($itemmatNombreColumna == $item->matClave && $item->clave_pago == $inscrito->aluClave)
                              <td align="center">
                                ...
                                @php
                                    $promedioGeneral = $promedioGeneral + $item->inscCalificacionMay;
                                @endphp
                                @else
                                __
                                @endif
                          ...
                          @if ($mesEvaluar == "Junio")
                            @if ($itemmatNombreColumna == $item->matClave && $item->clave_pago == $inscrito->aluClave)
                              <td align="center">
                                ...
                                @php
                                    $promedioGeneral = $promedioGeneral + $item->inscCalificacionJun;
                                @endphp
                                @else
                                __
                                @endif
                    ...
                    @php
                        ...
                        $resultadoFaltas = collect($faltas);
                    @endphp

                    {{-- Realizamos la operacion para sacar el promedio  --}}
                    @php
                        $promedioGeneralResultado = $promedioGeneral/$vuelta;
                    @endphp
                    ...
                    @if ($tipoReporte == "porMes")
                      @if ($mesEvaluar == "Septiembre")
                        @foreach ($resultadoFaltas as $falta)
                          <td align="center">{{$falta->falTotalSep}}</td>
                        @endforeach
                      @endif

                      @if ($mesEvaluar == "Octubre")
                        @foreach ($resultadoFaltas as $falta)
                          <td align="center">{{$falta->falTotalOct}}</td>
                        @endforeach
                      @endif

                      @if ($mesEvaluar == "Noviembre")
                        @foreach ($resultadoFaltas as $falta)
                          <td align="center">{{$falta->falTotalNov}}</td>
                        @endforeach
                      @endif

                      @if ($mesEvaluar == "Diciembre")
                        @foreach ($resultadoFaltas as $falta)
                          <td align="center">{{$falta->falTotalDic}}</td>
                        @endforeach
                      @endif

                      @if ($mesEvaluar == "Enero")
                        @foreach ($resultadoFaltas as $falta)
                          <td align="center">{{$falta->falTotalEne}}</td>
                        @endforeach
                      @endif

                      @if ($mesEvaluar == "Febrero")
                        @foreach ($resultadoFaltas as $falta)
                          <td align="center">{{$falta->falTotalFeb}}</td>
                        @endforeach
                      @endif

                      @if ($mesEvaluar == "Marzo")
                        @foreach ($resultadoFaltas as $falta)
                          <td align="center">{{$falta->falTotalMar}}</td>
                        @endforeach
                      @endif

                      @if ($mesEvaluar == "Abril")
                        @foreach ($resultadoFaltas as $falta)
                          <td align="center">{{$falta->falTotalAbr}}</td>
                        @endforeach
                      @endif

                      @if ($mesEvaluar == "Mayo")
                        @foreach ($resultadoFaltas as $falta)
                          <td align="center">{{$falta->falTotalMay}}</td>
                        @endforeach
                      @endif

                      @if ($mesEvaluar == "Junio")
                        @foreach ($resultadoFaltas as $falta)
                          <td align="center">{{$falta->falTotalJun}}</td>
                        @endforeach
                      @endif
                    @endif
                    ...
                    @if ($tipoReporte == "porBimestre")
                          ...
                          @if ($bimestreEvaluar == "BIMESTRE1")
                            @foreach ($resultadoFaltas as $falta)
                              <td align="center">{{$falta->faltasBimestre1}}</td>
                            @endforeach
                          @endif
                          ...
                          @if ($bimestreEvaluar == "BIMESTRE2")
                            @foreach ($resultadoFaltas as $falta)
                              <td align="center">{{$falta->faltasBimestre2}}</td>
                            @endforeach
                          @endif
                          ...
                          @if ($bimestreEvaluar == "BIMESTRE3")
                            @foreach ($resultadoFaltas as $falta)
                              <td align="center">{{$falta->faltasBimestre3}}</td>
                            @endforeach
                          @endif
                          ...
                          @if ($bimestreEvaluar == "BIMESTRE4")
                            @foreach ($resultadoFaltas as $falta)
                              <td align="center">{{$falta->faltasBimestre4}}</td>
                            @endforeach
                          @endif
                          ...
                          @if ($bimestreEvaluar == "BIMESTRE5")
                            @foreach ($resultadoFaltas as $falta)
                              <td align="center">{{$falta->faltasBimestre5}}</td>
                            @endforeach
                          @endif
                    @endif
                    ...
                    @if ($tipoReporte == "porTrimestre")
                      ...
                      @if ($trimestreEvaluar == "TRIMESTRE1")
                        @foreach ($resultadoFaltas as $falta)
                          <td align="center">{{$falta->faltasTimestre1}}</td>
                        @endforeach
                      @endif

                      @if ($trimestreEvaluar == "TRIMESTRE2")
                        @foreach ($resultadoFaltas as $falta)
                          <td align="center">{{$falta->faltasTimestre2}}</td>
                        @endforeach
                      @endif

                      @if ($trimestreEvaluar == "TRIMESTRE3")
                        @foreach ($resultadoFaltas as $falta)
                          <td align="center">{{$falta->faltasTimestre3}}</td>
                        @endforeach
                      @endif
                    @endif
