  ...
  <body>
    ...
    <div class="row">
      <div class="columns medium-12">
        ...
        <p style="text-indent: 3em; font-size: 15px; text-align: justify;">
          A pedimento de la parte interesada y para los fines que se requiera, se expide la presente constancia el día de hoy en la ciudad de @if ($parametro_ubicacion == "CME") Mérida, @else Valladolid, @endif Yucatán, México.
        </p>
      </div>
    </div>
