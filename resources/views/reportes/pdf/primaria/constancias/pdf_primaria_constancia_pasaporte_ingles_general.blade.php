...
<head>
  <title>Constancia pasaporte ingles</title>
  ...
  <body>
    ...
    <div class="row">
      <div class="columns medium-12">
        ...
        <p style="text-indent: 3em; font-size: 15px; text-align: justify;">
          ...
          @endif
          director of the “Modelo” Incorporated Elementary School with work code {{ $item->depClaveOficial }}, established in this city STATES:
        </p>
        <br>
        <br>
        <br>
        ...
        <p style="text-indent: 3em; font-size: 15px; text-align: justify;">
          And at the request of the interested party and for the purposes that are required, this certificate is issued today, in the city of @if ($parametro_ubicacion == "CME") Mérida, @else Valladolid, @endif Yucatán, México.
        </p>
      </div>
    </div>
    ...
    <div class="row">
      <div class="columns medium-12">
        ...
        <p class="tcenter"><b>SINCERELY</b></p>
        <br><br><br><br>
        @if ($parametro_ubicacion == "CME")
