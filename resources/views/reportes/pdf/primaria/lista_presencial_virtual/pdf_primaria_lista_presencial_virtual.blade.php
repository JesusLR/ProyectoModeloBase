    ...
    <header>
        <div class="row">
            <div class="columns medium-12">
                ...
                <p style="margin-top:0px; font-size:14px;"><b>ESCUELA PRIM. PART. INC. MODELO</b></p>
                ...
                @if ($modalidad == "")
                    ...
                    <p style="margin-top:0px; font-size:11px;">{{$gpoGrado}}° BILINGÜE</p>
                    @endif
                @endif
                ...
                @if ($modalidad == "P")
                    ...
                    @if ($prametro_progClave == "PRB")
                    <p style="margin-top:0px; font-size:11px;">{{$gpoGrado}}° BILINGÜE PRESENCIAL</p>
                    @endif
                @endif
          ...
          <table class="table">
            <thead>
              <tr>
                ...
                <th  style="font-weight: 400; padding-top: 7px; width: 25px;">Grupo Origen</th>
                @for ($i = 0; $i < 25; $i++)
            ...
            <tbody>
                @foreach ($alumnos as $alumnoClave => $values)
                    @foreach ($values as $item)
                        @if ($alumnoClave == $item->aluClave && $vuelta++ == 1)
                            <tr>
                                <td style="height: 18px;">{{$total++}}</td>
                                <td>{{$item->aluClave}}</td>
                                <td>{{$item->perApellido1.' '.$item->perApellido2.' '.$item->perNombre}}</td>
                                <td>{{$item->gpoGrado}}°{{$item->gpoClave}}</td>
                                @for ($i = 0; $i < 25; $i++)
                                <td>
