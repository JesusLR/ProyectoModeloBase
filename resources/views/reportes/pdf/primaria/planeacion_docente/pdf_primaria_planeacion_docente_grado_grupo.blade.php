...
<head>
    <title>Planeación docente </title>
...
<body>
  ...
  @foreach ($agruacion_de_id as $id => $key)
    @foreach ($planeaciones as $key => $planeacion)
      ...
      <table class="table table-bordered">
        ...
        <thead>
            <tr>
               <td align="center" style="width: 50px; height:170px; border-top: 1px solid; border-right: 1px; border-bottom: 1px; border-left: 1px solid;" rowspan="3" scope="rowgroup">
                ...
                <td align="center" colspan="2" style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px; border-left: 1px solid;">
                  <p>Programa: {{$planeacion->progNombre}}</p>
                  <p>{{$bimestre}}</p>
                  <p>{{$trimestre}}</p>
                </td>
            </tr>
              <tr>
                <td colspan="5" style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px; border-left: 1px solid;">
                  ...
                  @else
                    Maestro:  {{$planeacion->empNombre.' '.$planeacion->empApellido1.' '.$planeacion->empApellido2}}
                  @endif
                </td>
            </tr>
            <tr>
              ...
              <td colspan="2" style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px; border-left: 1px solid;">
                Grado: {{$planeacion->grado}}°   Grupo: {{$planeacion->grupo}}
              </td>
            </tr>
            <tr>
              ...
              <td colspan="5" style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px; border-left: 1px solid;">
                Frase del mes: “{{$planeacion->frase_mes}}”
                <br>
            ...
            <tr>
              <td colspan="6" style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px; border-left: 1px solid;"><b>Objetivo general:</b>
                {{$planeacion->objetivo_general}}
              </td>
            </tr>
            <tr>
        ...
        <tbody>
          @foreach ($planeaciones as $key => $planeaciones_temas)
            @if ($id == $planeaciones_temas->id)
            <tr>
              <td align="center" style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;">
