...
<body>
  ...
  <table class="table table-bordered">
        ...
        <tr>
           <td align="center" style="width: 50px; height:170px; border-top: 1px solid; border-right: 1px; border-bottom: 1px; border-left: 1px solid;" rowspan="3" scope="rowgroup">
            ...
            <td align="center" colspan="2" style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px; border-left: 1px solid;">
              <p>Programa: {{$primaria_grupos_planeaciones->progNombre}}</p>
              <p>{{$primaria_grupos_planeaciones->bimestre}}</p>
    ...
    <tbody>
      @foreach ($primaria_grupos_planeaciones_temas as $planeaciones_temas)
      <tr>
        <td align="center" style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;">
