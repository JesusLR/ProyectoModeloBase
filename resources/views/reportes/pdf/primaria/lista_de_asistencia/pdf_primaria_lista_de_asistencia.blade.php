    ...
    <header>
        <div class="row">
          <div class="columns medium-12">
              ...
              <p style="margin-top:0px; margin-bottom: 10px;">LISTA DE ASISTENCIA POR GRUPO-MATERIA</p>
              ...
              @if ($inscritos[0]->matClaveAsignatura != "")
              <p>Materia: {{$inscritos[0]->matClave}} {{$inscritos[0]->matNombre}} &nbsp;&nbsp; Asignatura: {{$inscritos[0]->matClaveAsignatura}} {{$inscritos[0]->matNombreAsignatura}}  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Grado : {{$inscritos[0]->gpoGrado}}° Grupo: {{$inscritos[0]->gpoClave}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Fecha: __________________________</p>
              @endif

              <p>
                  @if ($inscritos[0]->empSexo == "F")
                      Maestra: {{$inscritos[0]->empNombre}} {{$inscritos[0]->empApellido1}} {{$inscritos[0]->empApellido2}} ({{$inscritos[0]->empleados_id}})
                  @endif

                  @if ($inscritos[0]->empSexo == "M")
                      Maestro: {{$inscritos[0]->empNombre}} {{$inscritos[0]->empApellido1}} {{$inscritos[0]->empApellido2}} ({{$inscritos[0]->empleados_id}})
                  @endif

                  @if ($inscritos[0]->empSexo == "")
                  Maestro(a): {{$inscritos[0]->empNombre}} {{$inscritos[0]->empApellido1}} {{$inscritos[0]->empApellido2}} ({{$inscritos[0]->empleados_id}})
                  @endif
              </p>
          ...
          <table class="table">
            <thead>
              <tr>
                ...
                <th style="font-weight: 400;width: 20px; padding-top: 7px;">Modalidad</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td align="center" style="padding-top: 5px;">{{$itemInscritos->inscTipoAsistencia}}</td>
                @for ($i = 0; $i < 25; $i++)
