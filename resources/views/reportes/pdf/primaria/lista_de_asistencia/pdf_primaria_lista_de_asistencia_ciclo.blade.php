    ...
    <header>
        <div class="row">
            <div class="columns medium-12">
                ...
                @if ($modalidad == "P")
                <label style="margin-top:0px; margin-bottom: 10px;">LISTA DE ASISTENCIA POR GRUPO-MATERIA MODALIDAD PRESENCIAL</label>
                @endif

                @if ($modalidad == "V")
                <label style="margin-top:0px; margin-bottom: 10px;">LISTA DE ASISTENCIA POR GRUPO-MATERIA MODALIDAD VIRTUAL</label>
                @endif
    ...
    @foreach ($agrupados as $datosCabecera)
        ...
        <div class="row">
            <div class="columns medium-12">
                ...
                @if ($datosCabecera->matClaveAsignatura == "")
                ...
                @if ($datosCabecera->matClaveAsignatura != "")
                <p>Materia: {{$datosCabecera->matClave}} {{$datosCabecera->matNombre}} Asinatura: {{$datosCabecera->matClaveAsignatura.'-'.$datosCabecera->matNombreAsignatura}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Grado
                    : {{$datosCabecera->gpoGrado}}° Grupo: {{$datosCabecera->gpoClave}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </p>
                @endif
              ...
              <table class="table">
                ...
                <tbody>
                    @foreach ($inscritos as $key => $itemInscritos)
                        @if ($itemInscritos->matNombre == $datosCabecera->matNombre && $datosCabecera->matClaveAsignatura == "")
                        <tr>
