...
<body>
        <div class="row">
            <div class="columns medium-12" style="margin-top: -110px;">
                ...
                <p style="text-align: center; margin-top:0px; font-size: 13px;"><b>Programa: </b>{{$programa->progClave}}-{{$programa->progNombre}}</p>
                <p style="text-align: center; margin-top:0px; font-size: 13px;"><b>Ciclo escolar: </b>{{$periodo->perAnioPago}}-{{$periodo->perAnioPago+1}}</p>

                <p style="text-align: center; margin-top:0px; font-size: 13px;"><b>Clave: </b>________________ <b>Curp: </b>_______________________</p>
                <p style="text-align: center; margin-top:0px; font-size: 13px;"><b>Alumno: </b>_____________________________________</p>
                <p style="text-align: center; margin-top:0px; font-size: 13px;"><b>Grupo: </b>________</p>

                <img class="img-header" style="margin-top: -45px;" src="{{base_path('resources/assets/img/logo.jpg')}}" alt="">
                <p style="text-align: right; margin-top: -45px;">Fecha: __________________________</p>
            </div>
        </div>
    ...
    <div class="row">
        <div class="columns medium-12">
            ...
            <br>
            <label>________________________________________________________________________</label>
        </div>
    </div>
    ...
    <div class="row">
        <div class="columns medium-12">
            ...
            <br><br>
            <label>___________________________________________________________________________________________________________________________________________________</label>
        </div>
    </div>
...
{{--
    ...
    <div class="row">
        ...
        <div class="columns medium-4">
            <label><b>a) Hemofilia
                <br>
             </b>___________________________________</label>
        </div>
        <div class="columns medium-8">
            <label><b>Observación
                <br>
             </b>_________________________________________________________________________________________________</label>
        </div>
    </div>
    ...
    <div class="row">
        <div class="columns medium-4">
            ...
            <br>
            <label>_________________________________________________________________________________________________</label>
        </div>
    </div>
