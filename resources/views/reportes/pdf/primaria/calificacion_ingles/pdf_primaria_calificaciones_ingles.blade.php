                        ...
                        @if ($mesEvaluar == "Septiembre")
                          ...
                          @endphp
                            <td align="center">
                              ...
                              @php
                                $sumaCalificaciones = $sumaCalificaciones + $item->inscCalificacionSep;
                              @endphp
                              @else
                              __
                              @endif
                        ...
                        @if ($mesEvaluar == "Octubre")
                          ...
                          @endphp
                            <td align="center">
                              ...
                              @php
                                $sumaCalificaciones = $sumaCalificaciones + $item->inscCalificacionOct;
                              @endphp
                              @else
                              __
                              @endif
                        ...
                        @if ($mesEvaluar == "Noviembre")
                          ...
                          @endphp
                            <td align="center">
                              ...
                              @php
                                $sumaCalificaciones = $sumaCalificaciones + $item->inscCalificacionNov;
                              @endphp
                              @else
                              __
                              @endif
                        ...
                        @if ($mesEvaluar == "Diciembre")
                          ...
                          @endphp
                            <td align="center">
                              ...
                              @php
                                $sumaCalificaciones = $sumaCalificaciones + $item->inscCalificacionDic;
                              @endphp
                              @else
                              __
                              @endif
                        ...
                        @if ($mesEvaluar == "Enero")
                          ...
                          @endphp
                            <td align="center">
                              ...
                              @php
                                $sumaCalificaciones = $sumaCalificaciones + $item->inscCalificacionEne;
                              @endphp
                              @else
                              __
                              @endif
                        ...
                        @if ($mesEvaluar == "Febrero")
                          ...
                          @endphp
                            <td align="center">
                              ...
                              @php
                                $sumaCalificaciones = $sumaCalificaciones + $item->inscCalificacionFeb;
                              @endphp
                              @else
                              __
                              @endif
                        ...
                        @if ($mesEvaluar == "Marzo")
                          ...
                          @endphp
                            <td align="center">
                              ...
                              @php
                                $sumaCalificaciones = $sumaCalificaciones + $item->inscCalificacionMar;
                              @endphp
                              @else
                              __
                              @endif
                        ...
                        @if ($mesEvaluar == "Abril")
                          ...
                          @endphp
                            <td align="center">
                              ...
                              @php
                                $sumaCalificaciones = $sumaCalificaciones + $item->inscCalificacionAbr;
                              @endphp
                              @else
                              __
                              @endif
                        ...
                        @if ($mesEvaluar == "Mayo")
                          ...
                          @endphp
                            <td align="center">
                              ...
                              @php
                                $sumaCalificaciones = $sumaCalificaciones + $item->inscCalificacionMay;
                              @endphp
                              @else
                              __
                              @endif
                        ...
                        @if ($mesEvaluar == "Junio")
                          ...
                          @endphp
                            <td align="center">
                              ...
                              @php
                                $sumaCalificaciones = $sumaCalificaciones + $item->inscCalificacionJun;
                              @endphp
                              @else
                              __
                              @endif
