      ...
      <div class="columns medium-4">
        ...
        <p>
          @if ($primaria_expediente_seguimiento_escolar->empSexo == "F")
            <b>Maestra:</b> {{$primaria_expediente_seguimiento_escolar->empNombre}} {{$primaria_expediente_seguimiento_escolar->empApellido1}} {{$primaria_expediente_seguimiento_escolar->empApellido2}}</p>

          @else
            <b>Maestro:</b> {{$primaria_expediente_seguimiento_escolar->empNombre}} {{$primaria_expediente_seguimiento_escolar->empApellido1}} {{$primaria_expediente_seguimiento_escolar->empApellido2}}</p>
