...
<header>
  <div class="row" style="margin-top: 0px;">
    <div class="rectangulo">
      ...
      <br>
      <p style="text-align: center; font-size: 13px; text-decoration: underline;"><strong>AUTORIZACIÓN DE SALIDA</strong></p>
      <br>
    </div>
  </div>
  <div class="right">
    <img class="img-header" style="margin-top: -85px;" src="{{base_path('resources/assets/img/logo.jpg')}}" alt="">
  </div>
</header>
...
<body>
  ...
  <div class="row">
    <div class="columns medium-12">
      <p style="text-align: right;">Fecha: _______________________________</p>
    </div>
  </div>
  ...
  <div class="row">
    <div class="columns medium-12">
      <p style="text-align: center;">NOMBRE Y FIRMA DEL PADRE O TUTOR RESPONSABLE</p>
    </div>
  </div>
