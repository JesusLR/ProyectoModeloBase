    ...
    <div class="row">
        <div class="columns medium-12">
            <table class="table table-bordered">
                <thead>
                    <tr>
                      <th style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;">ÁMBITOS DEL PERFIL</th>
                      <th colspan="3" align="center" style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;">INDICADORES OBSERVABLES</th>
                    ...
                    <tr>
                        ...
                        <th style="width: 10px; border-top: 1px solid; border-right: 1px; border-bottom: 1px; border-left: 1px solid; background-color: #CDC0DA;">CALIFICACIÓN</th>
                        <th style="width: 180px; border-top: 1px solid; border-right: 1px solid; border-bottom: 1px; border-left: 1px solid; background-color: #CDC0DA;">OBSERVACIÓN(S) PARTICULAR</th>
                        <th style="width: 5px; border-top: 0px solid; border-right: 0px solid; border-bottom: 1px; border-left: 1px solid;"></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        {{--  <td></td>  --}}
                        <td style="width: 170px; border-top: 0px solid; border-right: 1px; border-bottom: 1px; border-left: 1px solid;">
                            <b>Competencias curriculares de Español</b>
                            <br>
                            <label style="text-decoration: underline">NIVEL INTERMEDIO DE COMPRENSIÓN LECTORA</label>
                            <br>
                    ...
                    {{--  <tr>
                        <td colspan="8" style="width: 250px;border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;">
