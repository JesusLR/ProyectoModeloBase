...
{{--
  ...
  <img class="img-header" style="margin-top:-100px;" src="{{base_path('storage/app/public/primaria/cursos/fotos/' . $perAnioPago . '/' . $foto) }}" alt="">

  <div class="right">
   <img class="img-header-logo" style="margin-top: -100px;" src="{{base_path('resources/assets/img/logo.jpg')}}" alt="">
  </div>
</header>
<body>
