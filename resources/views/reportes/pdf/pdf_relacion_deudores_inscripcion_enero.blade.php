      ...
      <header>
          <div class="row">
              <div class="columns medium-6">
                  <p class="letraencabezado10">ESCUELA MODELO S.C.P.</p>
                  <p class="letraencabezado10bold">{{$elTitulo}}</p>
                  <p class="letraencabezado10">{{$elMes}}</p>
                  <p class="letraencabezado10">{{$elPeriodo}}</p>
              </div>
              <div class="columns medium-6">
                  <div style="text-align: right;">
                      ...
                      <p>{{$nombreArchivo}}</p>
                      <br>
                      <p class="letraencabezado10">{{$laUbicacion}}</p>
                ...
                <table class="table">
                      ...
                      <thead>
                          <tr>
                             ...
                             <th style="width:20px;">Cve Pago</th>
                             ...
                             <th style="width:30px;">Enero<br>Cve 05</th>
                             <th style="width:30px;">Insc<br>Cve 00</th>
                             <th style="width:10px;">Edo<br>Alumno</th>
                          </tr>
                      </thead>
                                  ...
                                  @foreach($pagos as $item)
                                            ...
                                            @endphp
                                             ...
                                             <tr>
                                                 ...
                                                 <td style="width:30px;">{{ empty($item->cve05_xcobrar) ? ' ' :number_format((float)$item->cve05_xcobrar, 2, '.', ',')}}</td>
                                                 <td style="width:30px;">{{ empty($item->cve00_xcobrar) ? ' ' :number_format((float)$item->cve00_xcobrar, 2, '.', ',')}}</td>
                                                <td style="width:10px;">{{$item->alu_estado}}</td>
                                             </tr>
                                  @endforeach
                                  <!-- FIN foreach -->
                      </tbody>
