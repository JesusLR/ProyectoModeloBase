...
<html>
  ...
  <body>
    @foreach($datos as $key => $ubicacion)
      @php
        $dato1 = $ubicacion->first()->first();
        $ubiClave = $dato1['ubiClave'];
        $ubiNombre = $dato1['ubiNombre'];
        $total = 0;
      @endphp
      <div class="row">
        <div class="columns medium-6">
      ...
      <div class="row">
        <div class="columns medium-12">
         <table class="table">
            <tr>
              @if($tipoReporte == 'P')
                <th align="center" style="width:15px;" class="boldFont">Período</th>
                <th align="center" style="width:60px;" class="boldFont">Año</th>
              @endif
              <th align="center" style="width:60px;" class="boldFont">Clave Carr</th>
              <th align="center" style="width:200px;" class="boldFont">Nombre de la Carrera</th>
            ...
            <tr>
              @if($tipoReporte == 'P')
              <td colspan="4" class="boldFont">Total de Egresados</td>
              @else
      ...
      @endif
    @endforeach <!-- FIN foreach ubicacion -->
  </body>
  <footer>
    <div>
