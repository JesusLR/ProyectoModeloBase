    ...
    <header>
      ...
      <div class="row" style="margin-bottom: 2px;">
        <div class="columns medium-12">
          @if (isset($escuelaNombre))
          <p>Escuela: {{$escuelaNombre->escClave}}  {{$escuelaNombre->escNombre}}</p>
          @endif
        </div>
      </div>
      <div class="row" style="margin-bottom: 2px;">
        ...
        <div class="columns medium-12">
          <table class="table">
            <tr>
              ...
              <th align="center" style="width: 30px;">Descripción del aula</th>
              <th align="center" style="width: 30px;">Ubicación del aula</th>
              <th align="center" style="width: 30px;">Carr Usa</th>
              <th align="center" style="width: 30px;">Esc Usa</th>
            </tr>
