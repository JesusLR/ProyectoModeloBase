...
<html>
  ...
  <body>
    ...
    @endphp
      ...
      @foreach ($materia_alumos as $keyMat => $matName)
      ...
      <div class="row">
            ...
            <tr>
              ...
              @foreach ($calificaciones as $key => $inscrito)
                ...
                @if ($matName->matNombre == $inscrito->matNombre)
                  ...
                  @if ($inscrito->gpoMatComplementaria == "")
                    <tr>
                      ...
                      @if ($tipoReporte == "porTrimestre")
                        @if ($trimestreEvaluar == "TRIMESTRE1")
                          <td align="center">{{$inscrito->inscTrimestre1}}</td>
                          <td align="center">{{$inscrito->faltasInjustificadasTrimestre1}}</td>
                          <td align="center">{{$inscrito->faltasJustificadasTrimestre1}}</td>
                        @endif


                        @if ($trimestreEvaluar == "TRIMESTRE2")
                          <td align="center">{{$inscrito->inscTrimestre2}}</td>
                          <td align="center">{{$inscrito->faltasInjustificadasTrimestre2}}</td>
                          <td align="center">{{$inscrito->faltasJustificadasTrimestre2}}</td>
                        @endif

                        @if ($trimestreEvaluar == "TRIMESTRE3")
                          <td align="center">{{$inscrito->inscTrimestre3}}</td>
                          <td align="center">{{$inscrito->faltasInjustificadasTrimestre3}}</td>
                  ...
                  @else
                    @if ($matName->gpoMatComplementaria == $inscrito->gpoMatComplementaria)
                    <tr>
                      <td align="center" style="width: 40px;">{{$pocision++}}</td>
                      <td align="center" style="width: 40px;">{{$inscrito->clave_pago}}</td>
                      <td style="width: 300px;">
       ...
       @if ($loop->first)
        <footer id="footer">
          <div class="row">
            {{--  @foreach ($datos_cabecera as $item2)
              @if ($item2->matNombre == $matName->matNombre)
                @if ($pocision3++ == 1)  --}}
                  <p>_____________________________________</p>
                  {{--  <p>{{$item2->empNombre}} {{$item2->empApellido1}} {{$item2->empApellido2}} ({{$item2->secundaria_empleado_id}})</p>  --}}
                  <p>Firma del Docente Titular</p>
                {{--  @endif
              @endif
            @endforeach              --}}
          </div>
