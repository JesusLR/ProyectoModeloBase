    ...
    <header>
        <div class="row">
            <div class="columns medium-12">
                ...
                <h3 style="margin-top:0px; margin-bottom: 10px;">LISTA DE ALUMNOS SIN ACD</h3>
                @endif

                @if ($tipoVistaReporte == "2")
                <h3 style="margin-top:0px; margin-bottom: 10px;">LISTA DE ALUMNOS SIN MATERIA DEL PLAN DE ESTUDIOS</h3>
                @endif
                ...
                <p>Ubicac. : {{$alumnos[0]->ubicacion}}-{{$alumnos[0]->ubiNombre}}</p>
                <p>Materia ACD: {{$materia->matNombre}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Grado
                    : {{$materia->matSemestre}}° &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </p>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    @php                       
                        ...
                        WHERE aluClave=$clavePago")
                    @endphp

                    @foreach ($alumno as $item)
                    <td style="padding-top: 5px;">{{$item->perApellido1}} {{$item->perApellido2}} {{$item->perNombre}}</td>
