...
<html>
	<head>
		<title>Resumen de calificaciones por materia</title>
        ...
        <table class="table">
          <thead>
            <tr>
              ...
              <th  style="font-weight: 400;">Clave pago</th>
              <th align="center" style="font-weight: 400;width: 350px;">Nombre del Alumno</th>
              @if ($parametroACD == 1)
              <th style="font-weight: 400;width: 20px;">Grupo</th>
              @endif
              <th align="center"  style="font-weight: 400;">Calif</th>
              <th  style="font-weight: 400;">Observaciones</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td align="center" >{{$itemInscritos->cgtGrupo}}</td>
              <td align="center">
                @if ($tipoReporte == "porMes")
                  @if ($mesEvaluar == "Septiembre")
