      ...
      <table class="table">
        <thead>
          ...
          <tr>
            ...
            @foreach ($matAgrupado as $matClave1 => $matValores1)
              @foreach ($matValores1 as $key => $materia)
                @if ($matClave1 == $materia->matClave && $cont++ == 1)
          ...
          <tr>
            ...
            @foreach ($matAgrupado as $matClave1 => $matValores1)
              @foreach ($matValores1 as $key => $materia)
                @if ($matClave1 == $materia->matClave && $cont2++ == 1)
                            ...
                            @isset($value[$calificacion])
                              @php
                                ...
                                if($value[$calificacionRecu] != "" && $value[$calificacionRecu] != -1 || $value[$calificacionRecu] != -2){
                                  $calculoMat1 = $calculoMat1 + $value[$calificacionRecu];
                                }else{
      ...
      <table class="table">
        <thead>
          ...
          <tr>
            ...
            @foreach ($matAgrupado as $matClave1 => $matValores1)
              @foreach ($matValores1 as $key => $materia)
                @if ($matClave1 == $materia->matClave && $cont3++ == 1)
          ...
          <tr>
            ...
            @foreach ($matAgrupado as $matClave1 => $matValores1)
              @foreach ($matValores1 as $key => $materia)
                @if ($matClave1 == $materia->matClave && $cont4++ == 1)
        ...
        @foreach ($alumnoGrupado as $aluClave => $valorsAlumno)
          @foreach ($valorsAlumno as $itemAlumno)
            @if ($itemAlumno->clave_pago == $aluClave && $contador3++ == 1)
      ...
      <table class="table">
        <thead>
          ...
          <tr>
            ...
            @foreach ($matAgrupado as $matClave1 => $matValores1)
              @foreach ($matValores1 as $key => $materia)
                @if ($matClave1 == $materia->matClave && $cont5++ == 1)
          ...
          <tr>
            ...
            @foreach ($matAgrupado as $matClave1 => $matValores1)
              @foreach ($matValores1 as $key => $materia)
                @if ($matClave1 == $materia->matClave && $cont6++ == 1)
        ...
        @foreach ($alumnoGrupado as $aluClave => $valorsAlumno)
          @foreach ($valorsAlumno as $itemAlumno)
            @if ($itemAlumno->clave_pago == $aluClave && $contador5++ == 1)
