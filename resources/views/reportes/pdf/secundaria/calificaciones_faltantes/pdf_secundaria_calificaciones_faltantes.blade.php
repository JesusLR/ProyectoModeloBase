    ...
    <header>
      <div class="row">
        <div class="columns medium-6">
          ...
          <p>Ubicación: CME MERIDA</p>
          <p>Ciclo escolar: {{$cicloescolar}}-{{$cicloescolar+1}}</p>
          <p>Mes: {{$mesEvaluar}}</p>
      ...
      <div class="row">
        <div class="columns medium-12">
          <table class="table">
            ...
            <tr>
              <td align="center" style="height: 30px;">{{$key+1}}</td>
              <td align="center" style="height: 30px;">{{$alumno->aluClave}}</td>
              <td style="height: 30px;">{{$alumno->alumno}}</td>
              <td align="center" style="height: 30px;">{{$alumno->grado}}</td>
              <td align="center" style="height: 30px;">{{$alumno->grupo}}</td>
