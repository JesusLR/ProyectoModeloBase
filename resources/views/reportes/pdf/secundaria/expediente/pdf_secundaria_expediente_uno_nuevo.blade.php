...
{{-- 
    ...
    <div class="row">
        ...
        <div class="columns medium-4">
            ...
            <label style="margin-top:0px; margin-bottom: 10px;"><strong>Alumno: </strong>{{$alumno[0]->ape_paterno}}
                {{$alumno[0]->ape_materno}} {{$alumno[0]->nombres}}</label>
           <br>
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="row">
        ...
        <table class="table">
            ...
            <tr>            
                ...
                <td><label>{{$historiaAlumno[0]->edadAlumno}}</label></td>

                <td><label>{{$historiaAlumno[0]->gradoInscrito}}°</label></td>
            </tr>
        </table>
        </div>
    </div>
    ...
    <div class="row">
        <div class="columns medium-12">
            ...
            <br>
            <label>{{$historiaAlumno[0]->tiempoResidencia}}</label>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <table class="table">
            ...
            <tr>            
                ...
                <td><label>{{$historiaAlumno[0]->edadPadre}}</label></td>

                <td><label>{{$historiaAlumno[0]->ocupacioPadre}}</label></td>
            </tr>
        </table>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <table class="table">
            ...
            <tr>            
                ...
                <td><label>{{$historiaAlumno[0]->edadMadre}}</label></td>

                <td><label>{{$historiaAlumno[0]->ocupacionMadre}}</label></td>
            </tr>
        </table>
        </div>
    </div>
    ...
    <div class="row">
        <div class="columns medium-4">
            ...
            <br>
            <label>{{$historiaAlumno[0]->estadoCilvilPadres}}</label>
        </div>

        <div class="columns medium-4">
            <label><b>Observaciones: </b></label>
            <br>
            <label>{{$historiaAlumno[0]->observacionePadres}}</label>
        </div>

        <div class="columns medium-4">
            <label><b>Religión: </b></label>
            <br>
            <label>{{$historiaAlumno[0]->religion}}</label>
        </div>
    </div>
    ...
    <div class="row" >
        <div class="columns medium-3">
            ...
            <br>
            <label>{{$historiaAlumno[0]->integrante1}}</label>
        </div>

        <div class="columns medium-3">
            <label><b>Relación integrante 1: </b></label>
            <br>
            <label>{{$historiaAlumno[0]->relacionIntegrante1}}</label>
        </div>
        <div class="columns medium-3">
            <label><b>Edad integrante 1: </b></label>
            <br>
            <label>{{$historiaAlumno[0]->edadIntegrante1}}</label>
        </div>
        <div class="columns medium-3">
            <label><b>Ocupación integrante 1: </b></label>
            <br>
            <label>{{$historiaAlumno[0]->ocupacionIntegrante1}}</label>
        </div>
    </div>
    <br>
    {{-- integrante 2 --}}
    <div class="row">
        <div class="columns medium-3">
            ...
            <br>
            <label>{{$historiaAlumno[0]->integrante2}}</label>
        </div>

        <div class="columns medium-3">
            <label><b>Relación integrante 2: </b></label>
            <br>
            <label>{{$historiaAlumno[0]->relacionIntegrante2}}</label>
        </div>
        <div class="columns medium-3">
            <label><b>Edad integrante 2: </b></label>
            <br>
            <label>{{$historiaAlumno[0]->edadIntegrante2}}</label>
        </div>
        <div class="columns medium-3">
            <label><b>Ocupación integrante 2: </b></label>
            <br>
            <label>{{$historiaAlumno[0]->ocupacionIntegrante2}}</label>
        </div>
    </div>
    ...
    <div class="row">
        <div class="columns medium-3">
            ...
            <br>
            <label>{{$historiaAlumno[0]->integrante3}}</label>
        </div>

        <div class="columns medium-3">
            <label><b>Relación integrante 3: </b></label>
            <br>
            <label>{{$historiaAlumno[0]->relacionIntegrante3}}</label>
        </div>
        <div class="columns medium-3">
            <label><b>Edad integrante 3: </b></label>
            <br>
            <label>{{$historiaAlumno[0]->edadIntegrante3}}</label>
        </div>
        <div class="columns medium-3">
            <label><b>Ocupación integrante 3: </b></label>
            <br>
            <label>{{$historiaAlumno[0]->ocupacionIntegrante3}}</label>
        </div>
    </div>
    ...
    <div class="row" >
        <div class="columns medium-3">
            ...
            <br>
            <label>{{$historiaAlumno[0]->integrante4}}</label>
        </div>

        <div class="columns medium-3">
            <label><b>Relación integrante 4: </b></label>
            <br>
            <label>{{$historiaAlumno[0]->relacionIntegrante4}}</label>
        </div>
        <div class="columns medium-3">
            <label><b>Edad integrante 4: </b></label>
            <br>
            <label>{{$historiaAlumno[0]->edadIntegrante4}}</label>
        </div>
        <div class="columns medium-3">
            <label><b>Ocupación integrante 4: </b></label>
            <br>
            <label>{{$historiaAlumno[0]->ocupacionIntegrante4}}</label>
        </div>
    </div>
    ...
    <div class="row">
        <div class="columns medium-6">
            ...
            @endif
            <br>
            <label>{{$historiaAlumno[0]->apoyoTareas}}</label>
        </div>
        <div class="row">
            <div class="columns medium-6">
                <label><b>Deporte(s) o actividad cultural que practica:</b></label>
                <br>
                <label>{{$historiaAlumno[0]->deporteActividad}}</label>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="columns medium-4">
            ...
            <br>
            <label>{{$historiaAlumno[0]->escuelaProcedencia}}</label>
        </div>
        <div class="columns medium-4">
            <label><b>Años estudiados en la escuela anterior:</b></label>
            <br>
            <label>{{$historiaAlumno[0]->aniosEstudios}}</label>
        </div>
        <div class="columns medium-4">
            <label><b>Motivos del cambio de escuela:</b></label>
            <br>
            <label>{{$historiaAlumno[0]->motivosCambio}}</label>
        </div>
    </div>
    ...
    <div class="row">
        <div class="columns medium-4">
            ...
            <br>
            <label style="text-align: center">{{$historiaAlumno[0]->kinder}}</label>
        </div>
        <div class="columns medium-8">
            <label><b>Observaciones:</b></label>
            <br>
            <label style="text-align: center">{{$historiaAlumno[0]->observacionesEscolar}}</label>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <table class="table">
            ...
            <tr>            
                ...
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>{{$historiaAlumno[0]->promedioGrado5}}</label></td>

                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>{{$historiaAlumno[0]->promedioGrado6}}</label></td>
            </tr>
        </table>
        </div>
    </div>
        ...
        <table class="table">
            ...
            <tr>            
                ...
                <td>
                    <label><b>______________________</b></label>
                    <br>
                    <label>{{$alumno[0]->ape_materno}}</label>
                </td>

                <td>
                    <label><b>______________________</b></label>
                    <br>
                    <label>{{ \Carbon\Carbon::parse($historiaAlumno[0]->perFechaNac)->format('d/m/Y')}}</label>
                </td>

                <td>
                    <label><b>______________________</b></label>
                    <br>
                    <label>{{$historiaAlumno[0]->edadAlumno}}</label>
                </td>

                <td>
                    <label><b>______________________</b></label>
                    <br>
                    <label>{{$historiaAlumno[0]->gradoInscrito}}°</label>
                </td>
            </tr>
        </table>
        </div>
        ...
        <table class="table">
            ...
            <tr>            
                ...
                <td>
                    <label><b>______________________</b></label>
                        <br>
                    <label>{{$historiaAlumno[0]->apellido2Padre}}</label>
                </td>

                <td>
                    <label><b>______________________</b></label>
                        <br>
                    <label>{{$historiaAlumno[0]->celularPadre}}</label>
                </td>

                <td>
                    <label><b>______________________</b></label>
                        <br>
                    <label>{{$historiaAlumno[0]->edadPadre}}</label>
                </td>

                <td>
                    <label><b>______________________</b></label>
                        <br>
                    <label>{{$historiaAlumno[0]->ocupacioPadre}}</label>
                </td>
            </tr>
        </table>
        </div>
        ...
        <table class="table">
            ...
            <tr>            
                ...
                <td>
                    <label><b>______________________</b></label>
                        <br>
                    <label>{{$historiaAlumno[0]->apellido2Madre}}</label>
                </td>

                <td>
                    <label><b>______________________</b></label>
                        <br>
                    <label>{{$historiaAlumno[0]->celularMadre}}</label>
                </td>

                <td>
                    <label><b>______________________</b></label>
                        <br>
                    <label>{{$historiaAlumno[0]->edadMadre}}</label>
                </td>

                <td>
                    <label><b>______________________</b></label>
                        <br>
                    <label>{{$historiaAlumno[0]->ocupacionMadre}}</label>
                </td>
            </tr>
        </table>
        </div>
        ...
        <table class="table">
            ...
            <tr>            
                ...
                <td>
                    ...
                    <b>________________</b></label>
                        <br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>{{$historiaAlumno[0]->promedioGrado3}}</label></td>

                <td>
                    <label>
                    <b>________________</b></label>
                        <br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>{{$historiaAlumno[0]->promedioGrado4}}</label></td>

                <td>
                    <label>
                    <b>________________</b></label>
                        <br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>{{$historiaAlumno[0]->promedioGrado5}}</label></td>

                <td>
                    <label>
                    <b>________________</b></label>
                        <br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>{{$historiaAlumno[0]->promedioGrado6}}</label></td>
            </tr>
        </table>
        </div>
    </div>
