            ...
            <table class="table" style="font-size: 16px;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;" align="center">
                          @if ($itemInscrito->inscCalificacionFinalModelo == "10.0")
                            {{number_format((float)$itemInscrito->inscCalificacionFinalModelo, 0, '.', '')}}
                          @else
                            {{$itemInscrito->inscCalificacionFinalModelo}}
                          @endif
                        </td>
                    </tr>
                    @php
                    ...
                    <tr>
                     ...
                     <td align="center"><b></b></td>
                     <td align="center"><b>
                        <b>{{number_format((float)$sumaDePromedios/$vuelta, 1, '.', '')}}</b>
                      </td>
