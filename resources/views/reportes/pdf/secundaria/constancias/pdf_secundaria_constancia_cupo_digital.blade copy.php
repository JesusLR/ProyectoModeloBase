...
<body>
    ...
    <div class="row" style="margin-top:-110px">
        <div class="columns medium-12">
            ...
            <br>
            <p style="font-size: 16px;" class="tright"><b>CONSTANCIA DE CUPO</b></p>
            <br>
            <br>
            ...
            <p style="font-size: 16px; text-align: justify;">
              ...
              Escuela Secundaria Modelo, clave C.T. 31PES0012T de esta ciudad hace
              constar {{$genero}}:
            </p>
            @endif
            ...
            @if ($parametro_ubicacion == "CVA")
                <p style="font-size: 16px; text-align: justify;">
                  ...
                  Secundaria “Modelo Valladolid”, clave C.T 31PES0143L, de esta ciudad, hace
    ...
    <div class="row">
        <div class="columns medium-12">
            <table class="table" style="font-size: 16px;">
                <thead>
                    <tr>
                        <th align="center" style="width: 240px; font-weight: 400; border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;"><b>Materias</b></th>
                        <th align="center" style="font-weight: 400; width: 90px; border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;"><b>1er período</b></th>
                        <th align="center" style="font-weight: 400; width: 90px; border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;"><b>2do período</b></th>
                        <th align="center" style="font-weight: 400; width: 90px; border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;"><b>3er período</b></th>
                        <th align="center" style="font-weight: 400; border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;"><b>Promedio</b></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;" align="center">
                          @if ($itemInscrito->trimestre1Sep == "10.0")
                        ...
                        <td style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;" align="center">
                          @if ($itemInscrito->trimestre2Sep == "10.0")
                            {{number_format((float)$itemInscrito->trimestre2Sep, 0, '.', '')}}
                          @else
                            {{$itemInscrito->trimestre2Sep}}
                          @endif
                        </td>
                        <td style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;" align="center">
                          @if ($itemInscrito->trimestre3Sep == "10.0")
                            {{number_format((float)$itemInscrito->trimestre3Sep, 0, '.', '')}}
                          @else
                            {{$itemInscrito->trimestre3Sep}}
                          @endif
                        </td>
                        <td style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;" align="center">
                          @if ($itemInscrito->inscCalificacionFinalSEP == "10.0")
                            {{number_format((float)$itemInscrito->inscCalificacionFinalSEP, 0, '.', '')}}
                          @else
                            {{$itemInscrito->inscCalificacionFinalSEP}}
                          @endif
                        </td>
                    </tr>
                    @php
                    ...
                    @foreach ($inscrito2 as $item)
                        <tr>
                          <td style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;">{{$item->matNombre}}</td>

                          <td style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;" align="center">

                            @if ($parametro_ubicacion == "CME")
                              @if (number_format((float)($promedioMatPer1 + $promedioVesPer1)/2, 0, '.', '') != 10)
                              {{number_format((float)($promedioMatPer1 + $promedioVesPer1)/2, 0, '.', '')}}
                              @else
                              {{number_format((float)($promedioMatPer1 + $promedioVesPer1)/2, 0, '.', '')}}
                            ...
                            {{--  Valladolid   --}}
                            @if ($parametro_ubicacion == "CVA")
                              @if (number_format((float)$promedioMatPer1, 0, '.', '') != 10)
                              {{number_format((float)$promedioMatPer1, 0, '.', '')}}
                              @else
                              {{number_format((float)$promedioMatPer1, 0, '.', '')}}
                          ...
                          <td style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;" align="center">
                            ...
                            @if ($parametro_ubicacion == "CME")
                              @if (number_format((float)($promedioMatPer2 + $promedioVesPer2)/2, 0, '.', '') != 10)
                            ...
                            @if ($parametro_ubicacion == "CVA")
                              @if (number_format((float)$promedioMatPer2, 0, '.', '') != 10)
                          ...
                          <td style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;" align="center">
                            @if ($parametro_ubicacion == "CME")
                              @if (number_format((float)($promedioMatPer3 + $promedioVesPer3)/2, 0, '.', '') != 10)
                              {{number_format((float)($promedioMatPer3 + $promedioVesPer3)/2, 0, '.', '')}}
                              @else
                              {{number_format((float)($promedioMatPer3 + $promedioVesPer3)/2, 0, '.', '')}}
                            ...
                            @if ($parametro_ubicacion == "CVA")
                              @if (number_format((float)$promedioMatPer3, 0, '.', '') != 10)
                              {{number_format((float)$promedioMatPer3, 0, '.', '')}}
                              @else
                              {{number_format((float)$promedioMatPer3, 0, '.', '')}}
                    ...
                    <tr>
                     ...
                     <td align="center"><b></b></td>
                     <td align="center"><b>
                        <b>{{number_format((float)$promedioGeneral, 1, '.', '')}}</b>
                      </td>
    ...
    <div class="row">
        ...
        <div class="columns medium-4">
            ...
            <div style="text-align: center">
              <img class="img-header"  src="{{base_path('resources/assets/img/firmas_logos_secundaria/secundaria_cme_firma_silvia.png')}}" alt="">
            </div>
        ...
        <div class="columns medium-4">
          <div style="text-align: right">
            ...
            @if ($parametro_ubicacion == "CME")
            <img style="margin-top: -25px; height: 170px;" src="{{base_path('resources/assets/img/firmas_logos_secundaria/secundaria_cme_sello.jpg')}}" alt="">
            @endif
          </div>
        </div>
    </div>
    <footer id="footer">
      <label style="color: #09315b; font-family: Arial, Helvetica, sans-serif; font-size: 16px;">www.modelo.edu.mx</label>
    </footer>
</body>
