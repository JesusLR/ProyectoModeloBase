...
<html>
	<head>
		<title>Constancia artes y talleres</title>
...
<body>
    ...
    <div class="row" style="margin-top:0px">
        <div class="columns medium-12">
            ...
            <br>
            <p style="font-size: 16px;" class="tright"><b>ASUNTO: CONSTANCIA</b></p>
            <br>
            <br>

            {{--  <img class="img-header-logo" style="margin-top: -40px;" src="{{base_path('resources/assets/img/logo.jpg')}}" alt="">  --}}

            <p style="font-size: 16px;"><b>A QUIEN CORRESPONDA:</b></p>
            <br>
            ...
            @if ($parametro_ubicacion == "CVA")
                <p style="font-size: 16px; text-align: justify;">
                  La que suscribe, Mtra. Lol –Há Canché Gómez, Directora de la Escuela Secundaria Particular Incorporada Modelo,
    ...
    <div class="row">
        ...
        <div class="columns medium-4">
          <div style="text-align: right">
            {{--  @if ($parametro_ubicacion == "CVA")
            <img style="margin-top: -25px; height: 180px;" src="{{base_path('resources/assets/img/firmas_logos_secundaria/secundaria_cva_sello.jpg')}}" alt="">
            @endif  --}}

            {{--  @if ($parametro_ubicacion == "CME")
            <img style="margin-top: -25px; height: 180px;" src="{{base_path('resources/assets/img/firmas_logos_secundaria/secundaria_cme_sello.jpg')}}" alt="">
            @endif  --}}
          </div>
        </div>
    </div>
