          ...
          <div class="columns medium-12">
            ...
            @if ($fotoAlumno == "SI")     
              ...
              @if ($curso->curSecundariaFoto != "")
                ...
                <img style="width:65px; float: left;  margin-left: -14px;" src="{{base_path('storage/app/public/secundaria/cursos/fotos/' . $curso->perAnioPago . '/' . $campus. '/' . $curso->curSecundariaFoto) }}">
                <br>
                <br>
                <br>
                <br>
