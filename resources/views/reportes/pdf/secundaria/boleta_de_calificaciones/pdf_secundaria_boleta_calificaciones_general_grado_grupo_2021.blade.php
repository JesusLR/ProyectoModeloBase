...
@foreach ($alumnoAgrupado as $clave_pago => $valores)
    @foreach ($calificaciones as $inscrito)
        ...
        @endphp
            ...
            <img class="img-foto" src="{{base_path('storage/app/public/secundaria/cursos/fotos/' . $inscrito->perAnioPago . '/' . $campus .'/'. $inscrito->cursecundariaFoto) }}" alt="">
        ...
        <div class="row">
          <div class="columns medium-12">
                ...
                <tbody>
                  @foreach($calificaciones as $key => $item)
                    @if ($item->clave_pago == $clave_pago)
                     ...
                     @endphp
                      <tr>
                        <td style="width: 227px; border-top: 0px solid; border-right: 0px solid; border-bottom: 1px solid; border-left: 1px solid;"><b>PROM. FORMACIÓN ACADÉMICA</b></td>


                        <td align="center" style="width: 37.7px; border-top: 0px solid; border-right: 0px solid; border-bottom: 1px solid; border-left: 1px solid;">
                        ...
                        <td align="center" style="width: 37.7px; border-top: 0px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;">
                          <b>{{number_format((float)$PromForAcademiPeriodo1, 0, '.', '')}}</b>
                        </td>
                        @else
                        <td align="center" style="width: 37.7px; border-top: 0px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;"><label style="opacity: .01;">0</label></td>
                        @endif

                        {{--  columna recuperativo1  --}}
                        <td align="center" style="width: 38.8px; border-top: 0px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;"><label style="opacity: .01;">0</label></td>



                        <td align="center" style="width: 37.1px; border-top: 0px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;">
                        ...
                        <td align="center" style="width: 37px; border-top: 0px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;">
                        ...
                        <td align="center" style="width: 37.8px; border-top: 0px solid; border-right: 0px solid; border-bottom: 1px solid; border-left: 1px solid;">
                        ...
                        @else
                        <td align="center" style="width: 38.2px; border-top: 0px solid; border-right: 0px solid; border-bottom: 1px solid; border-left: 1px solid;"><label style="opacity: .01;">0</label></td>
                        @endif
                        ...
                        <td align="center" style="width: 37.6px; border-top: 0px solid; border-right: 0px solid; border-bottom: 1px solid; border-left: 1px solid;">
                        ...
                        <td align="center" style="width: 42.4px; border-top: 0px solid; border-right: 0px solid; border-bottom: 1px solid; border-left: 1px solid;">
                        ...
                        <td align="center" style="width: 57px; border-top: 0px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;">
                          {{--  <label style="opacity: .01;">0</label>  --}}
                  ...
                  @foreach($calificaciones as $key => $item)
                    ...
                    @if ($posicion2++ == 1)
                      ...
                      <tr>
                        ...
                        {{--  promedio trimestree 1  --}}
                        @if ($item->inscTrimestre1SEP != "")
                        <td align="center" style="width: 37.4px; border-top: 1px solid; border-right: 0px solid; border-bottom: 1px solid; border-left: 1px solid;">
                          <b>{{$item->inscTrimestre1SEP}}</b>
                        </td>
                        @else
                        <td align="center" style="width: 37.4px; border-top: 1px solid; border-right: 0px solid; border-bottom: 1px solid; border-left: 1px solid;"><label style="opacity: .01;">0</label></td>
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    <td style="width: 227px;"><b>INASISTENCIAS INJUSTIFICADAS</b></td>
