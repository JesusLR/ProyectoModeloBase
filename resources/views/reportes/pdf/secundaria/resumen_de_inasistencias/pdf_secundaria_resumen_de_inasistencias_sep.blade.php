...
<html>
	<head>
		<title>Resumen de inasistencias SEP</title>
              ...
              @endphp
                @foreach ($calificacionesInscritos as $key => $inscrito)
                  ...
                  <tr>
                    ...
                    <td  style="border-top: 1px solid; border-right: 1px; border-bottom: 0px; border-left: 1px solid;"></td>
                    <td  style="border-top: 1px solid; border-right: 1px; border-bottom: 0px; border-left: 1px solid;"><p style="text-align: right">TOTALES: </p></td>
                    @foreach ($matClave as $KmatClave => $key)
                        ...
                        <td align="center"
                          ...
                          @endphp
                    @endforeach
                    <td align="center" style="border-top: 1px solid; border-right: 1px; border-bottom: 0px; border-left: 1px solid;">{{$inasistenciaTotal}}</td>
                    <td  style="border-top: 0px solid; border-right: 1px; border-bottom: 0px; border-left: 1px solid;"></td>
                  </tr>
                  <tr>
                      <td  style="border-top: 1px solid; border-right: 0px; border-bottom: 0px; border-left: 0px solid;"></td>
                      <td  style="border-top: 1px solid; border-right: 0px; border-bottom: 0px; border-left: 0px solid;"></td>
                      <td  style="border-top: 1px solid; border-right: 0px; border-bottom: 0px; border-left: 0px solid;"></td>
                      @for ($i = 0; $i < count($matNombreColumna); $i++)
                          <td align="center" style="border-top: 1px solid; border-right: 0px; border-bottom: 0px; border-left: 0px solid;"></td>
                      @endfor
                      <td  style="border-top: 1px solid; border-right: 0px; border-bottom: 0px; border-left: 0px solid;"></td>
