    ...
    <header>
        <div class="row">
          <div class="columns medium-6">
            ...
            <h5 style="margin-top:0px; margin-bottom: 10px;">LISTA DE ALUMNOS INSCRITOS A MATERIA</h5>
          </div>
          <div class="columns medium-6">
                ...
                <table class="table">
                  ...
                  @foreach ($grupo as $alumno)
                    ...
                    <tr>
                      ...
                      {{--  primeros   --}}
                      @if ($grado == 1)
                        @foreach ($grupos_activos as $item4)
                          @if ($item4->gpoGrado == 1)
                              <td align="center">
                                ...
                                @php
                                  ...
                                  $secundaria_inscrito = Secundaria_inscritos::select(
                                    'secundaria_inscritos.id',
                                    'cursos.id as curso_id',
                                    'secundaria_grupos.gpoClave'
                                  )
                                  ->join('secundaria_grupos', 'secundaria_grupos.id', '=', 'secundaria_inscritos.grupo_id')
                                  ->join('cursos', 'cursos.id', "=", 'secundaria_inscritos.curso_id')
                      ...
                      {{--  segundos   --}}
                      @if ($grado == 2)
                        @foreach ($grupos_activos as $item5)
                          @if ($item5->gpoGrado == 2)
                              <td align="center">
                      ...
                      {{--  terceros   --}}
                      @if ($grado == 3)
                        @foreach ($grupos_activos as $item6)
                          @if ($item6->gpoGrado == 3)
                             <td align="center">
