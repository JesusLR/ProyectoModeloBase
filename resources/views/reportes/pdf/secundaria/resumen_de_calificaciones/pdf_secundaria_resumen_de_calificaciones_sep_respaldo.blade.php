          ...
          <div class="columns medium-12">
            <table class="table">
              <tr>
                ...
                <th align="center" style="font-weight: 400; border-top: 1px solid; border-right: 1px; border-bottom: 0px; border-left: 1px solid;">Prome Edu. Fis.</th>
                @endif
              ...
              <tr>
                ...
                {{-- agregamos columna de promedio EDU FIS si es de merida  --}}
                @if ($parametro_ubicacion_clave === "CME")
                <th align="center" style="font-weight: 400; border-top: 0px solid; border-right: 1px; border-bottom: 0px; border-left: 1px solid;">Prome Edu. Fis.</th>
                @endif
              ...
              @endphp
                ...
                @foreach ($calificacionesInscritos as $key => $inscrito)                 
                  ...
                  <tr>                   
                    ...
                    @if ($parametro_ubicacion_clave === "CME")                     
                    <td align="center" style="border-top: 1px solid; border-right: 1px; border-bottom: 1px; border-left: 1px solid;">{{number_format((float)$promedioEducacionFis/$vueltaFis, 1, '.', '')}}</td>
                    @endif
