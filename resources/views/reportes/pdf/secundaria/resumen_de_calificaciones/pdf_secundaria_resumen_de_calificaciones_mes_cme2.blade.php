      ...
      <table class="table">
        <thead>
          <tr>
            ...
            @endphp
            @for ($i = 0; $i < count($matAgrupado); $i++) <th align="center"
        ...
        <tbody>
          @foreach ($alumnoGrupado as $aluClave => $valorsAlumno)
            @foreach ($valorsAlumno as $itemAlumno)
              @if ($itemAlumno->clave_pago == $aluClave && $contador1++ == 1)
                  <tr>
                    ...
                    @if ($modoCalificacion == "BASEDIEZ")
                      ...
                      <td align="center" style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;">
                        {{number_format((float)$promedioTotalAlumno/count($matAgrupado), 1, '.', '')}}

                        @php
                          $sumaPromedioDeAlumnos = $sumaPromedioDeAlumnos + ($promedioTotalAlumno/count($matAgrupado));
                        @endphp
                      ...
                      {{--  porcentaje reprobado vertical   --}}
                      <td align="center" style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;">
                        <b>{{number_format((float)($numerosDeReprobadosVertical * 100)/count($matAgrupado), 1, '.', '')}}</b>
                      </td>

                      {{--  porcentaje aprobado vertical   --}}
                      <td align="center" style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;">
                        <b>{{number_format((float)($numerosDeAprobadosVertical * 100)/count($matAgrupado), 1, '.', '')}}</b>
                      </td>
                      ...
                      @if ($valsosowswww->matClave == $matCa)
                        ...
                        @if ($modoCalificacion == "BASEDIEZ")
                          ...
                          @if ($tipoReporte == "porBimestre")
                            ...
                            @if ($bimestreEvaluar == "BIMESTRE1")
                              @if ($valsosowswww->inscPromedioBimestre1 < 6)
                                @php
                                  $reprobadosVertical++;
                                @endphp
                              @endif
                            ...
                            @if ($bimestreEvaluar == "BIMESTRE2")
                              @if ($valsosowswww->inscPromedioBimestre2 < 6)
                                @php
                                  $reprobadosVertical++;
                                @endphp
                              @endif
                            ...
                            @if ($bimestreEvaluar == "BIMESTRE3")
                              @if ($valsosowswww->inscPromedioBimestre3 < 6)
                                @php
                                  $reprobadosVertical++;
                                @endphp
                              @endif
                            ...
                            @if ($bimestreEvaluar == "BIMESTRE4")
                              @if ($valsosowswww->inscPromedioBimestre4 < 6)
                                @php
                                  $reprobadosVertical++;
                                @endphp
                              @endif
                            ...
                            @if ($bimestreEvaluar == "BIMESTRE5")
                              @if ($valsosowswww->inscPromedioBimestre5 < 6)
                                @php
                                  $reprobadosVertical++;
                                @endphp
                              @endif
                  ...
                  @foreach ($matAgrupado as $matCa => $valsoso)
                    ...
                    <td align="center"
                      ...
                      @if (number_format((float)($aprobadosVertical * 100)/$totalDeAlumnosNuevo3, 1, '.', '') == "100")
                        <b>{{number_format((float)($aprobadosVertical * 100)/$totalDeAlumnosNuevo3, 0, '.', '')}}</b>
                      @else
                        <b>{{number_format((float)($aprobadosVertical * 100)/$totalDeAlumnosNuevo3, 1, '.', '')}}</b>
                      @endif
                      </td>
                      @php
                      $aprobadosVertical = 0;
