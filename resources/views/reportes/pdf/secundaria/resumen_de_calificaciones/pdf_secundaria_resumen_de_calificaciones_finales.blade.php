                    ...
                    <tr>
                      ...
                      @for ($i = 0; $i < count($materia_alumos); $i++)
                          ...
                          @if ($tipoReporte == "porBimestre")
                            @if ($bimestreEvaluar == "BIMESTRE1")
                              @if ($matAlumnos->matClave == $item->matClave)
                                @php
                                  $sumaDePromedios = $sumaDePromedios +  $calificaciones[$x]->inscCalificacionSep + $calificaciones[$x]->inscCalificacionOct;
                                @endphp
                              @endif
                            @endif
                            ...
                            @if ($bimestreEvaluar == "BIMESTRE2")
                              @if ($matAlumnos->matClave == $item->matClave)
                                @php
                                  $sumaDePromedios = $sumaDePromedios +  $calificaciones[$x]->inscCalificacionNov + $calificaciones[$x]->inscCalificacionDic;
                                @endphp
                              @endif
                            @endif
                            ...
                            @if ($bimestreEvaluar == "BIMESTRE3")
                              @if ($matAlumnos->matClave == $item->matClave)
                                @php
                                  $sumaDePromedios = $sumaDePromedios +  $calificaciones[$x]->inscCalificacionEne + $calificaciones[$x]->inscCalificacionFeb;
                                @endphp
                              @endif
                            @endif
                            ...
                            @if ($bimestreEvaluar == "BIMESTRE2")
                              @if ($matAlumnos->matClave == $item->matClave)
                                @php
                                  $sumaDePromedios = $sumaDePromedios +  $calificaciones[$x]->inscCalificacionMar + $calificaciones[$x]->inscCalificacionAbr;
                                @endphp
                              @endif
                            @endif
                            ...
                            @if ($bimestreEvaluar == "BIMESTRE2")
                              @if ($matAlumnos->matClave == $item->matClave)
                                @php
                                  $sumaDePromedios = $sumaDePromedios +  $calificaciones[$x]->inscCalificacionMay + $calificaciones[$x]->inscCalificacionJun;
                                @endphp
                              @endif
                            @endif
                          @endif
                        ...
                        <td align="center"
                          ...
                          {{number_format((float)$sumaDePromedios/$totalDeAlumnos, 1, '.', '')}}
                          </td>
                          @php
                          $sumaDePromedios = 0;
                          @endphp
                      ...
                      @for ($i = 0; $i < count($materia_alumos); $i++)
                          @for ($x = 0; $x < count($calificaciones); $x++)
                            ...
                            @if ($tipoReporte == "porBimestre")
                              @if ($bimestreEvaluar == "BIMESTRE1")
                                @if ($matAlumnos->matClave == $item->matClave)
                                  @if (($calificaciones[$x]->inscCalificacionSep + $calificaciones[$x]->inscCalificacionOct) < 6)
                                    @php
                                      $reprobados++;
                                    @endphp
                                  @endif
                              ...
                              @if ($bimestreEvaluar == "BIMESTRE2")
                                @if ($matAlumnos->matClave == $item->matClave)
                                  @if (($calificaciones[$x]->inscCalificacionNov + $calificaciones[$x]->inscCalificacionDic) < 6)
                                    @php
                                      $reprobados++;
                                    @endphp
                                  @endif
                              ...
                              @if ($bimestreEvaluar == "BIMESTRE3")
                                @if ($matAlumnos->matClave == $item->matClave)
                                  @if (($calificaciones[$x]->inscCalificacionEne + $calificaciones[$x]->inscCalificacionFeb) < 6)
                                    @php
                                      $reprobados++;
                                    @endphp
                                  @endif
                              ...
                              @if ($bimestreEvaluar == "BIMESTRE4")
                                @if ($matAlumnos->matClave == $item->matClave)
                                  @if (($calificaciones[$x]->inscCalificacionMar + $calificaciones[$x]->inscCalificacionAbr) < 6)
                                    @php
                                      $reprobados++;
                                    @endphp
                                  @endif
                              ...
                              @if ($bimestreEvaluar == "BIMESTRE5")
                                @if ($matAlumnos->matClave == $item->matClave)
                                  @if (($calificaciones[$x]->inscCalificacionMay + $calificaciones[$x]->inscCalificacionJun) < 6)
                                    @php
                                      $reprobados++;
                                    @endphp
                                  @endif
                            ...
                            @if ($tipoReporte == "porTrimestre")
                              ...
                              @if ($trimestreEvaluar == "TRIMESTRE1")
                                @if ($materia_alumos[$i]->matClave == $calificaciones[$x]->matClave)
                                  @if (($calificaciones[$x]->inscCalificacionSep + $calificaciones[$x]->inscCalificacionOct + $calificaciones[$x]->inscCalificacionNov) < 6)
                                    @php
                                      $reprobados++;
                                    @endphp
                                  @endif
                              ...
                              @if ($trimestreEvaluar == "TRIMESTRE2")
                                @if ($materia_alumos[$i]->matClave == $calificaciones[$x]->matClave)
                                  @if (($calificaciones[$x]->inscCalificacionDic + $calificaciones[$x]->inscCalificacionEne + $calificaciones[$x]->inscCalificacionFeb + $calificaciones[$x]->inscCalificacionMar) < 6)
                                    @php
                                      $reprobados++;
                                    @endphp
                                  @endif
                              ...
                              @if ($trimestreEvaluar == "TRIMESTRE3")
                                @if ($materia_alumos[$i]->matClave == $calificaciones[$x]->matClave)
                                  @if (($calificaciones[$x]->inscCalificacionAbr + $calificaciones[$x]->inscCalificacionMay + $calificaciones[$x]->inscCalificacionJun) < 6)
                                    @php
                                      $reprobados++;
                                    @endphp
                                  @endif
