                        ...
                        @if ($parametro_ubicacion_clave === "CME")
                          ...
                          @if($tipoReporte == "califRecuperativos")
                            @php
                              ...
                              $totalMateriasHorizontal++;
                            @endphp
                            @if (number_format((float)($promedioEducacionFis/2), 1, '.', '') < 6)
                              <td align="center" style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid; background-color:#F3F648">
                  ...
                  @if($loop->last)
                    @if ($modoCalificacion == "BASEDIEZ")
                      <tr>
                                ...
                                @if ($parametro_ubicacion_clave === "CME")
                                  @if ($trimestreEvaluar == "TRIMESTRE1")
                                    ...
                                    @if ($KmatClave == $item->matClave && $item->clave_pago == $aluClave && $item->matNombreColumna != "EF.VESP" && $item->matNombreColumna != "EDU.FIS" && $item->matNombreColumna != "ARTES")
                                      ...
                                      @php
                                        $promedioGeneralHorizontal = $promedioGeneralHorizontal + number_format((float)$promedioMateriaVertical/$totalDeAlumnos, 0, '.', '');
                                        $promedioMateriaVertical = 0.0;
                                      @endphp
                                    @endif
                                  @endif
                                ...
                                @if ($parametro_ubicacion_clave === "CME")
                                  @if ($tipoRecuperativo == "recuperativosTrimestre2")
                                    ...
                                    @if ($KmatClave == $item->matClave && $item->clave_pago == $aluClave && $item->matNombreColumna != "EF.VESP" && $item->matNombreColumna != "EDU.FIS" && $item->matNombreColumna != "ARTES")
                                      ...
                                      @php
                                        $promedioGeneralHorizontal = $promedioGeneralHorizontal + number_format((float)$promedioMateriaVertical/$totalDeAlumnos, 1, '.', '');
                                        $promedioMateriaVertical = 0.0;
                                      @endphp
                                    @endif
                                  @endif
                        ...
                        @if ($parametro_ubicacion_clave === "CME")
                          @if ($tipoReporte == "porTrimestre")
                            ...
                            @if (number_format((float)$promedioMateriaVerticalEduFisica/$totalDeAlumnos, 0, '.', '') < 6)
                              $porgentajeReprobadosGeneralHorizontal++;
                            @endif
                          ...
                          @if($tipoReporte == "califRecuperativos")
                            <td align="center" style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;">
                              {{number_format((float)$promedioMateriaVerticalEduFisica/$totalDeAlumnos, 1, '.', '')}}
                            </td>

                            @if (number_format((float)$promedioMateriaVerticalEduFisica/$totalDeAlumnos, 1, '.', '') < 6)
                              $porgentajeReprobadosGeneralHorizontal++;
                            @endif
                                ...
                                @if ($parametro_ubicacion_clave === "CME")
                                  @if ($trimestreEvaluar == "TRIMESTRE1")
                                    ...
                                    @if ($KmatClave == $item->matClave && $item->clave_pago == $valor->clave_pago && $item->matNombreColumna == "ARTES")
                                      ...
                                      @if (number_format((float)$sumaDePromedioVerticalPorMateriaArtes/$totalDeAlumnos, 0, '.', '') < 6)
                                        $porgentajeReprobadosGeneralHorizontal++;
                                      @endif
                                ...
                                @if ($parametro_ubicacion_clave === "CME")
                                  @if ($tipoRecuperativo == "recuperativosTrimestre1")
                                    ...
                                    @if ($KmatClave == $item->matClave && $item->clave_pago == $valor->clave_pago && $item->matNombreColumna == "ARTES")
                                      ...
                                      @if (number_format((float)$sumaDePromedioVerticalPorMateriaArtes/$totalDeAlumnos, 1, '.', '') < 6)
                                        $porgentajeReprobadosGeneralHorizontal++;
                                      @endif
                        ...
                        @if ($tipoReporte == "porTrimestre")
                          ...
                          <td align="center" style="border-top: 1px solid; border-right: 1px; border-bottom: 1px solid; border-left: 0px solid;">
                            {{number_format((float)$promedioGeneralHorizontal/$totalMateriasGeneralHorizontal, 0, '.', '')}}
                          </td>

                          {{--  porcentaje reprobado general horizontal   --}}
                          <td align="center" style="border-top: 1px solid; border-right: 1px; border-bottom: 1px solid; border-left: 1px solid;">
                            <b>{{number_format((float)($porgentajeReprobadosGeneralHorizontal*100)/$totalMateriasGeneralHorizontal, 1, '.', '')}}</b>
                          </td>
                        ...
                        @if($tipoReporte == "califRecuperativos")
                            {{--  promedio general horizontal   --}}
                          <td align="center" style="border-top: 1px solid; border-right: 1px; border-bottom: 1px solid; border-left: 0px solid;">
                            {{number_format((float)$promedioGeneralHorizontal/$totalMateriasGeneralHorizontal, 1, '.', '')}}
                          </td>
                      ...
                      <tr>
                        ...
                        @foreach ($matClave as $KmatClave => $key)
                          @foreach ($calificaciones as $item)
                            ...
                            @if ($modoCalificacion == "BASEDIEZ")
                              ...
                              {{-- mostrar por trimestre recuperatvo--}}
                              @if ($tipoReporte == "califRecuperativos")
                        ...
                        <td align="center" style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;">
                          <b>{{number_format((float)($porgentajeReprobadosGeneralVertical * 100)/$totalDeAlumnos, 1, '.', '')}}</b>
                        </td>
                      ...
                      <tr>
                        ...
                        {{--  porcentaje general vertical   --}}
                        <td align="center" style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;">
                          <b>{{number_format((float)($porgentajeAprobadosGeneralVertical * 100)/$totalDeAlumnos, 1, '.', '')}}</b>
                        </td>
