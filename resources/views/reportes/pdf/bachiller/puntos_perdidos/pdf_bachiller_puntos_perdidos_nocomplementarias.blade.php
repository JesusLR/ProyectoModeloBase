      ...
      <div class="columns medium-12">
        <table class="table table-bordered">
          <thead>
            <tr>
              ...
              @foreach($clave_de_las_materias as $matClave => $valores)
                @foreach($valores as $item)
                  @if ($matClave == $item->matClave && $pos0++ == 1 && $item->bachiller_materia_acd_id == "")
                  <th align="center" style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;">{{$matClave}}</th>
                  @endif
                @endforeach
                @php
                  $pos0 = 1;
            ...
            <tr>
              <th align="center" colspan="1" style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;">Lista</th>
              ...
              @foreach($clave_de_las_materias as $matClave => $valores)
                @foreach($valores as $item)
                  @if ($matClave == $item->matClave && $pos++ == 1 && $item->bachiller_materia_acd_id == "")
                    <th align="center" style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;">{{$item->matNombreCorto}}</th>
            ...
            <tr>
              ...
              @foreach($clave_de_las_materias as $matClave => $valores)
                @foreach($valores as $item)
                  @if ($matClave == $item->matClave && $pos2++ == 1 && $item->bachiller_materia_acd_id == "")
            ...
            <tr>
              ...
              @foreach($clave_de_las_materias as $matClave => $valores)
                @foreach($valores as $item)
                  @if ($matClave == $item->matClave && $pos3++ == 1 && $item->bachiller_materia_acd_id == "")

                    @php
                        $puntos_evidencias_calificados = DB::select("SELECT
                        ...
                        WHERE bg.id = $item->bachiller_grupo_id
                        AND be.bachiller_materia_id = $item->bachiller_materia_id
                        AND p.id = $item->periodo_id
                        AND pl.id = $item->plan_id
                    ...
                    <th align="center" style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;">
                      @if ($ganado->puntos_que_deben_ganar != "")
                      {{$ganado->puntos_que_deben_ganar}}
                      @php
                          $evidenciasCalificadas = $ganado->puntos_que_deben_ganar;
                      @endphp
                      @else
                          0
                      @endif                      
              ...
              <tr>
                ...
                @foreach ($val_alumno as $val)
                  @if ($aluClave == $val->aluClave && $pos4++ == 1)
                    ...
                    @foreach ($materia_id as $bachiller_materia_id => $valoresACD)
                        ...
                        <td align="center">
                          @isset($value[$grupo])
                            @php         
                              ...
                              {{--  {{$puntos_ganar[0]->puntos_que_deben_ganar}}  --}}
