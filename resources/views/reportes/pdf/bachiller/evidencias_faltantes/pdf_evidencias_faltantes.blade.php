...
<head>
  <title>Evidecnias Faltantes</title>
  ...
  <header>
    ...
    <div class="row" style="margin-top: 0px;">
      <div class="columns medium-8">
        ...
        <p>Niv: {{$bachiller_inscritos[0]->depClave}} ({{$bachiller_inscritos[0]->planClave}}) {{$bachiller_inscritos[0]->progNombre}}</p>
        <p>Ubicación: {{$bachiller_inscritos[0]->ubiClave}} {{$bachiller_inscritos[0]->ubiNombre}}</p>
      </div>
