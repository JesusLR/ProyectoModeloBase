    ...
    <header>
        ...
        <div class="row">
            <div class="columns medium-12">
                ...
                <p>Materia: {{$inscritos[0]->gpoMatComplementaria}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Grado
                    : {{$inscritos[0]->cgtGrado}}° Grupo: {{$inscritos[0]->gpoClave}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </p>

                    <p style="text-align: right; margin-top: -40px">Fecha: __________________________</p>

                <p>
                    Docente: {{$inscritos[0]->docente_nombre}} {{$inscritos[0]->docente_ape_paterno}} {{$inscritos[0]->docente_ape_materno}}
