    ...
    <header>
        <div class="row">
            <div class="columns medium-12">
                ...
                <h4 style="margin-top:0px; margin-bottom: 10px;">LISTA DE ASISTENCIA POR GRUPO-MATERIA</h4>

            </div>
        </div>

    </header>
    @foreach ($grupos as $grupo => $valoresForeach)
        @foreach ($valoresForeach as $item)
            @if ($grupo == $item->bachiller_grupo_id && $pocision1++ == 1)
                <div class="row">
                    <div class="columns medium-12">
                        <p>Período: {{$periodoVigente}}</p>
                        ...
                        <p>Materia: {{$item->matClave}}-{{$item->matNombre}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Grado
                            : {{$item->gpoGrado}}° Grupo: {{$item->gpoClave}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </p>
        ...
        <div class="row">
            <div class="columns medium-12">
              <table class="table">
                ...
                <tbody>
                    @foreach ($valoresForeach as $item2)
                        @if ($grupo == $item->bachiller_grupo_id)
                            <tr>
                                <td>{{$pocision2++}}</td>
