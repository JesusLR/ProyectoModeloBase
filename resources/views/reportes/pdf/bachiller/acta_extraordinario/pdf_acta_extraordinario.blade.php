    ...
    <header>
      <div class="row">
        <div class="columns medium-6">
          ...
          <h5 style="margin-top:0px; margin-bottom: 10px;">ACTA DE EXAMEN RECUPERATIVO</h5>
          @if ($periodo != '')
            <p>Período: {{$periodo}}</p>
          @endif
        </div>
      ...
      @foreach ($inscritoEx as $inscrito)
        ...
        <div class="row">
          <div class="columns medium-12" style="margin: 0 0 0 30px;">
            <p>Nivel: {{$inscrito[0]['progClave']}} &nbsp;({{$inscrito[0]['planClave']}}) &nbsp;{{$inscrito[0]['progNombre']}}</p>
        ...
        <table class="table">
          <tr>
            ...
            <th align="center" style="width:15%;">Cve.Pago</th>
