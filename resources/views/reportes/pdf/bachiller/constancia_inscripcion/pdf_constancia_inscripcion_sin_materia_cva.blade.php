    ...
    <header>
      ...
      <div class="row">
        <div class="columns medium-12">
          <p style="font-size: 15px; margin-bottom: 15px; text-align: center; margin-bottom: 50px;">CLAVE DEL CENTRO DE TRABAJO: 31PBH0125T</p>
          ...
          <p style="font-size: 15px; margin-bottom: 35px; text-align: justify;">
            ...
            A petición {{ $peticion }} y para los fines que le sean
