    ...
    <header>
      ...
      <div class="row">
        <div class="columns medium-12">
          <p style="font-size: 15px; margin-bottom: 15px; text-align: center; margin-bottom: 50px;">CLAVE DEL CENTRO DE TRABAJO: 31PBH0014O</p>
          <p style="font-size: 15px; margin-bottom: 15px; text-align: center; margin-bottom: 50px;">No: {{$minutario}}</p>
          <p style="text-align: right; font-size: 15px;">CONSTANCIA DE INSCRIPCION</p>
          <br>
          <p style="text-align: right; font-size: 15px;">Matrícula UADY: {{$curso->alumno->aluMatricula}}</p>
          <br>
          ...
          <p style="font-size: 15px; margin-bottom: 35px; text-align: justify;">
            ...
            joven {{MetodosPersonas::nombreCompleto($persona)}}  {{($periodo->id == $departamento->perActual || $periodo->id == $departamento->perSig) ? "es": "fue"}}
          ...
          <p style="font-size: 15px; margin-bottom: 35px; text-align: justify;">
            ...
            A petición {{ $interesad }} y para los fines que le sean
          ...
          <p style="font-size: 15px; text-align: center;">Secretaria Administrativa</p>
        </div>
