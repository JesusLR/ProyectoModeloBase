    ...
    <header>
      ...
      <div class="row">
        <div class="columns medium-12">
          <p style="font-size: 14px; margin-bottom: 14px; text-align: center; margin-bottom: 50px;">CLAVE DEL CENTRO DE TRABAJO: 31PBH0014O</p>
          ...
          <p style="font-size: 14px; margin-bottom: 35px; text-align: justify;">
            ...
            que comprende las siguientes asignaturas:
          </p>
          ...
          <p style="font-size: 14px; margin-bottom: 35px; text-align: justify;">
            ...
            {{--  El período vacacional correspondiente a este curso escolar es: {{$fechaVacion}}.  --}}
          </p>
