          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <td style="border-top: 1px solid; border-right: 0px solid; border-bottom: 0px solid; border-left: 0px solid;"></td>
                <th align="center" colspan="2">Ev.Proces</th>
                <th align="center" colspan="2">Ev.Produc</th>
                <th align="center" colspan="2">Calif.Final</th>
                <th align="center" colspan="1">Tot</th>
              </tr>
              <tr>
            ...
            <tbody>
              @foreach ($alumno as $item)
                @if ($item->clave_pago == $valorAgrupado->clave_pago)
                  ...
                  @endphp
                  <tr>
                    <td style="width: 20px; border-top: 1px solid; border-right: 0px solid; border-bottom: 1px solid; border-left: 1px solid;">{{$item->matClave}}</td>
