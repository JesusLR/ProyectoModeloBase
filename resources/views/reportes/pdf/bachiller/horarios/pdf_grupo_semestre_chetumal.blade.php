      ...
      <div class="row">
        <div class="columns medium-12">
          <table class="table">
            ...
            @php
              $grupo = collect($grupo)->groupBy("bachiller_grupo_id");
            @endphp
            @foreach ($grupo as $materia)
              <tr>
                <td style="width: 50px;">{{$materia->first()["bachiller_grupo_chetumal"]["bachiller_materia"]["matClave"]}}</td>
                <td style="width: 150px; font-size: 10px;">{{$materia->first()["bachiller_grupo_chetumal"]["bachiller_materia"]["matNombre"]}}</td>
                <td align="center" style="width: 20px;">{{$materia->first()["bachiller_grupo_chetumal"]["gpoClave"]}}</td>
                <td align="center" style="width: 20px;">{{$materia->first()["bachiller_grupo_chetumal"]["gpoTurno"]}}</td>
                <td style="width: 30px;">
                  {{\Carbon\Carbon::parse($materia->first()["bachiller_grupo_chetumal"]["gpoFechaExamenOrdinario"])->day
                  .'/'. \Carbon\Carbon::parse($materia->first()["bachiller_grupo_chetumal"]["gpoFechaExamenOrdinario"])->formatLocalized('%b')
                  .'/'. \Carbon\Carbon::parse($materia->first()["bachiller_grupo_chetumal"]["gpoFechaExamenOrdinario"])->year}}
                </td>
