    ...
    <header>
        <div class="row" style="margin-top: 0px;">
            <div class="columns medium-12">
                ...
                <h3 style="margin-top:0px; margin-bottom: 0px;">RESUMEN DE CALIFICACIONES POR GRUPO HASTA LA FECHA
                    {{ $fechaActual }}</h3>
    ...
    <div class="row">
        <div class="columns medium-12">
            ...
            <table class="table" style="font-size: 8px;">
                ...
                <tbody>
                    @foreach ($tablaBodyAcd as $itemssssACD => $value)
                        <tr>
                            <td align="center">{{ $contador5++ }}</td>
                            <td align="center">{{ $value['aluClave'] }}</td>
                            <td align="">{{ $value['alumno'] }}</td>
                            ...
                            @foreach ($bachiller_materias_acd as $materias_acd_id => $valoresMateriasACD)
                                <td align="center">
                                    @isset($value[$materias_acd_id . '_materia_acd_id'])
                                        @if ($materias_acd_id == $value[$materias_acd_id . '_materia_acd_id'])
                                            {{ $value[$materias_acd_id . '_calif'] }}
                                        @endif
                                    @endisset
                                </td>
                            @endforeach
