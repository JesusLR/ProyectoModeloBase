        ...
        <tbody>
          @foreach ($tablaBody as $itemssss => $value)
            <tr>
              ...
              @foreach ($bachiller_materias as $matClave => $valores)
              <td align="center">
                @isset($value[$matClave.'_matClave'])
                  @if ($matClave == $value[$matClave.'_matClave'])
                  @if ($value[$matClave.'_calif'] < $aprobatorio)
          ...
          <tr>
            ...
            @foreach ($bachiller_materias as $matClavePromedio => $valoresPromedio)
              @foreach ($tablaBody as $itemssss => $value)
                  ...
                  @isset($value[$matClavePromedio.'_calif'])
                    @if ($value[$matClavePromedio.'_matClave'] == $matClavePromedio)
                      @php
