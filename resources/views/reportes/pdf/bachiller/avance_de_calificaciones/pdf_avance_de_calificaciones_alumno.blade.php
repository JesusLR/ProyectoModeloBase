...
<body>
    ...
    <div class="row">
        <div class="columns medium-12">
            <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  WHERE bec.bachiller_grupo_id = $item->bachiller_grupo_id");
                                ...
                                <tr>
                                    <td
                                        style="width: 20px; border-top: 1px solid; border-right: 0px solid; border-bottom: 1px solid; border-left: 1px solid;">
                                        {{ $item->matClave }}</td>
                                    <td
                ...
                <tbody>
                    @foreach ($alumno_acd as $alum_acd)
                        @php
            ...
            INNER JOIN bachiller_evidencias AS bachiller_evidencias ON bachiller_evidencias.id = bachiller_inscritos_evidencias.evidencia_id
            INNER JOIN bachiller_materias AS bachiller_materias ON bachiller_materias.id = bachiller_evidencias.bachiller_materia_id
            WHERE bachiller_inscrito_id=$alum_acd->bachiller_inscrito_id
            AND bachiller_evidencias.periodo_id = $alum_acd->periodo_id
            AND bachiller_evidencias.bachiller_materia_id = $alum_acd->bachiller_materia_id
            ...
            FROM bachiller_evidencias AS bachiller_evidencias
            INNER JOIN bachiller_materias AS bachiller_materias ON bachiller_materias.id = bachiller_evidencias.bachiller_materia_id
            WHERE bachiller_evidencias.periodo_id = $alum_acd->periodo_id
            AND bachiller_evidencias.bachiller_materia_id = $alum_acd->bachiller_materia_id
            AND bachiller_evidencias.bachiller_materia_acd_id = $alum_acd->bachiller_materia_acd_id
            AND bachiller_evidencias.deleted_at IS NULL
            AND bachiller_materias.deleted_at IS NULL");
            ...
            WHERE bec.bachiller_grupo_id = $item->bachiller_grupo_id");
                        ...
                        <tr>
                            <td
                                style="width: 20px; border-top: 1px solid; border-right: 0px solid; border-bottom: 1px solid; border-left: 1px solid;">
                                {{ $alum_acd->matClave }}</td>
                            <td
                                style="width: 270px; border-top: 1px solid; border-right: 0px solid; border-bottom: 1px solid; border-left: 1px solid;">
                                {{ $alum_acd->matNombre }}-<b>{{ $alum_acd->gpoMatComplementaria }}</b></td>
                            <td style="border-top: 1px solid; border-right: 0px solid; border-bottom: 1px solid; border-left: 0px solid;"
                                align="center"></td>
                            <td align="center">
                                {{ $sumaEvidenciaObteCorte1Acd }}
                            </td>
                            <td align="center">
                            ...
                            <td align="center">
                                {{ $sumarEvidenciasCapturadasACD[0]->evidenciasCapturadas }}
                            </td>
                        </tr>
                    @endforeach
                    @php
        ...
        <div class="columns medium-12">
            <table class="table table-bordered">
                <thead>
                    <tr>
                        <td
                            style="width: 20px; border-top: 1px solid; border-right: 0px solid; border-bottom: 0px solid; border-left: 1px solid;">
                        </td>
                        <th
                            style="width: 325px;border-top: 1px solid; border-right: 0px solid; border-bottom: 0px solid; border-left: 0px solid;">
                            ASIGNATURAS NO ACREDITADAS</th>
            ...
            AND ordi.periodo_id = $periodo_id");
                    ...
                    @empty
                        <tr>
                            ...
                            <td
                                style="width: 325px; border-top: 1px solid; border-right: 0px solid; border-bottom: 0px solid; border-left: 1px solid;">
                            </td>
                            <td style="width: 71px; border-top: 1px solid; border-right: 0px solid; border-bottom: 0px solid; border-left: 1px solid;"
                                align="center"></td>
                            <td align="center"
                                style="border-top: 1px solid; border-right: 0px solid; border-bottom: 0px solid; border-left: 1px solid;">
                            </td>
