...
<html>
	<head>
		<title>Detalle evidencia materia complementaria</title>
    ...
    <header>
      <div class="row">
        <div class="columns medium-6">
          ...
          <h5 style="margin-top:0px; margin-bottom: 10px;">EVIDENCIAS POR MATERIA MATERIA COMPLEMENTARIA</h5>
        </div>
        <div class="columns medium-6">
      ...
      <div class="row" style="margin-bottom: 2px">
        <div class="columns medium-4">
            ...
            <p>Materia : {{$materia}}</p>
            <p>Materia complementaria : {{$materiaACD}}</p>
