...
<head>
  <title>Puntos cualitativos</title>
                  ...
                  @foreach ($bachiller_inscritos_evidencias as $item)
                    @if ($item->aluClave == $aluClave)
                      ...
                      <tr>
                        ...
                        <td align="center">{{Utils::fecha_string($item->ievFechaCaptura, 'mesCorto')}}</td>
                        <td>
                          @if ($item->ievClaveCualitativa1 != "")
                            @if ($item->cuaCategoria1 == "ACTI.POS" || $item->cuaCategoria1 == "PARP.POS" || $item->cuaCategoria1 == "PUNT.POS")
                        ...
                        <td>
                          @if ($item->ievClaveCualitativa2 != "")
                            @if ($item->cuaCategoria2 == "ACTI.POS" || $item->cuaCategoria2 == "PARP.POS" || $item->cuaCategoria2 == "PUNT.POS")
                        ...
                        <td>
                          @if ($item->ievClaveCualitativa3 != "")
                            @if ($item->cuaCategoria3 == "ACTI.POS" || $item->cuaCategoria3 == "PARP.POS" || $item->cuaCategoria3 == "PUNT.POS")
