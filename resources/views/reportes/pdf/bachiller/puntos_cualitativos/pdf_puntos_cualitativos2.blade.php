                  ...
                  @foreach ($bachiller_inscritos_evidencias as $item)
                    @if ($item->aluClave == $aluClave)
                      @if ($item->ievClaveCualitativa1 != "" || $item->ievClaveCualitativa2 != "" || $item->ievClaveCualitativa3 != "")
                        @if ($item->cuaCategoria1 == "PUNT.POS" || $item->cuaCategoria1 == "PARP.POS" || $item->cuaCategoria1 == "ACTI.POS" ||
                        $item->cuaCategoria2 == "PUNT.POS" || $item->cuaCategoria2 == "PARP.POS" || $item->cuaCategoria2 == "ACTI.POS" ||
