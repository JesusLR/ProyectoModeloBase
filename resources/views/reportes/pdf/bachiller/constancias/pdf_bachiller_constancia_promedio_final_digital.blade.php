...
<html>
	<head>
		<title>Constancia de promedio</title>
        ...
        <div class="columns medium-12">
            ...
            <p style="font-size: 16px; text-align: justify;">
               ...
               <br><br><br><br>
                ...
                <p style="font-size: 16px; text-align: justify;">
                  A petición de la parte interesada se expide la presente constancia en la ciudad de Mérida, Yucatán {{$fechaDiaLetra}} del mes de {{$mesLetras}} de {{$anoLEtras}}.
                </p>
