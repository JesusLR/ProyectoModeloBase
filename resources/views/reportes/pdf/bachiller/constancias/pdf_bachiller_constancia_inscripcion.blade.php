...
<body>
    ...
    <div class="row" style="margin-top:-30px">
        <div class="columns medium-12">
            ...
            <br>
            <p style="font-size: 16px;" class="tright"><b>ASUNTO: CONSTANCIA DE ESTUDIOS</b></p>
            <br>
            <br>
            <br>
            <br>
            ...
            @if ($curso_alumno->ubiClave == "CVA")
                <p style="font-size: 16px; text-align: justify; text-indent: 3.5em;">
                  La que suscribe, Psicóloga Silvia Violeta Pool Dorantes, Mtra. Lol –Há Canché Gómez, Directora académica de la
    ...
    <div class="row">
        <div class="columns medium-12">
            ...
            <p class="tcenter"><b>DIRECTORA ACADÉMICA</b></p>
            @endif
