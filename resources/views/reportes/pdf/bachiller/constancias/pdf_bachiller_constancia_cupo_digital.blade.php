    ...
    <div class="row" style="margin-top:-110px">
        <div class="columns medium-12">
            ...
            @if ($parametro_ubicacion == "CVA")
                <p style="font-size: 16px; text-align: justify;">
                  La que suscribe, Mtra. Lol –Há Canché Gómez, DIRECTORA ACADEMICA de la
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;" align="center">
                          @if ($itemInscrito->trimestre1 == "10.0")
                            {{number_format((float)$itemInscrito->trimestre1, 0, '.', '')}}
                          @else
                            {{$itemInscrito->trimestre1}}
                          @endif
                        </td>
                        <td style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;" align="center">
                          @if ($itemInscrito->trimestre2 == "10.0")
                            {{number_format((float)$itemInscrito->trimestre2, 0, '.', '')}}
                          @else
                            {{$itemInscrito->trimestre2}}
                          @endif
                        </td>
                        <td style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;" align="center">
                          @if ($itemInscrito->trimestre3 == "10.0")
                            {{number_format((float)$itemInscrito->trimestre3, 0, '.', '')}}
                          @else
                            {{$itemInscrito->trimestre3}}
                          @endif
                        </td>
                        <td style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid;" align="center">
                          @if ($itemInscrito->promedioTrimestre == "10.0")
                            {{number_format((float)$itemInscrito->promedioTrimestre, 0, '.', '')}}
                          @else
                            {{$itemInscrito->promedioTrimestre}}
                          @endif
                        </td>
                    </tr>
                    @php
