    ...
    <body>
      ...
      <div class="row">
        <div class="columns medium-12">
          ...
          <br>
          <p class="tright">Matrícula UADY: {{$parametro_matricula}}</p>
          <br>
          <br>
          <br>
          <br>
          ...
          {{--  text-indent: 3em;   --}}
          <p style="font-size: 15px; text-align: justify;">La que suscribe, Lic. en Psic. María Inés Sauri Quintal,
            Secretaria Administrativa de la Preparatoria "ESCUELA MODELO"
            incorporada a la Universidad Autónoma de Yucatán, hago constar
            que:
          </p>
          @endif
          ...
          <p style="text-indent: 3em; font-size: 15px; text-align: justify;">La que suscribe, Mtra. Lol –Há Canché Gómez, Directora académica de la
            Escuela Secundaria "Modelo Valladolid", clave C.T 31PES0143L, de esta ciudad hace
          ...
          <p style="font-size: 15px; text-align: justify;">
            {{$es}} <strong>{{$alumno}}</strong> observó <strong>BUENA CONDUCTA</strong> durante el tiempo que permaneció en este plantel.
          </p>
          ...
          @if ($parametro_clave_ubicacion == "CME")
          <p style="font-size: 15px; text-align: justify;">
            Y a petición de la interesada y para los fines legales que
            proceden, se expide la presente constancia en la ciudad de
            Mérida Yucatán, {{$fechaDiaLetra}} del mes de {{$mesLetras}} de
            {{$anoLEtras}}.
          </p>
          @endif
      ...
      <div class="row">
        <div class="columns medium-12">
          ...
          <br><br><br><br>
          <p class="tcenter">_______________________________________________________</p>
          @if ($parametro_clave_ubicacion == "CME")
