...
<head>
  <title>Costancia de computo</title>
...
<body>
  ...
  @foreach ($agrupamosPorAluclave as $aluClave => $arrayDedatos)
    @foreach ($arrayDedatos as $alumno)
      @if ($aluClave == $alumno->aluClave && $contador++ == 1)
        <div class="row">
          <div class="columns medium-12">
            ...
            <br>
            <br>
            <p style="font-size: 14px; text-align: right;">Matrícula UADY: {{$alumno->aluMatricula}}</p>
            <br>
            <br>
            <br>
            ...
            <table class="table">
              <thead>
                <tr>
                  <td class="punteado2">ASIGNATURAS</td>
                  <td class="punteado2" colspan="2" align="center">CALIFICACIÓN</td>
                  <td class="punteado2" align="center">FECHA</td>
                </tr>
              </thead>
              <tbody>
                @foreach ($bachiller_historico as $item)
                  ...
                  <tr>
                    ...
                    <td align="left">
                      ...
                      {{--  #70 - 79: "Suficiente"  --}}
                      @if ($item->histCalificacion >= 70 && $item->histCalificacion <= 79)
                        Suficiente
                      @endif

                      {{--  #80 - 89: "Satisfactorio"  --}}
                      @if ($item->histCalificacion >= 80 && $item->histCalificacion <= 89)
                        Satisfactorio
                      @endif
        ...
        <div class="row" style="text-align: center">
          <div class="columns medium-6">
            <p style="font-size: 14px;">{{$parametroPuestoMayus}}</p>
            <br>
            <br>
            <br>
            <br>
