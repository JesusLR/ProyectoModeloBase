      ...
      @if ($aluClave == $item->aluClave && $pocision++ == 1)
        <div class="row">
          ...
          <div class="columns medium-3">
            ...
            <p><b>Grupo:</b> {{$item->semestre.' '.$item->grupo}}</p>
          </div>
        </div>
                ...
                @foreach ($alumno as $valor)
                  @if ($aluClave == $valor->aluClave)
                    <tr>
                      ...
                      @if ($valor->materia_acd == "")
                      <td class="punteado" style="width: 300px;">{{$valor->matClave.'-'.$valor->materia}}</td>
                      @else
                      <td class="punteado" style="width: 300px;">{{$valor->matClave.'-'.$valor->materia_acd}}</td>
                      @endif
                      <td class="punteado" align="center">{{$valor->lunes}}</td>
                      <td class="punteado" align="center">{{$valor->martes}}</td>
                      <td class="punteado" align="center">{{$valor->miercoles}}</td>
