      ...
      <table class="table table-bordered">
        ...
        <tbody>
          <tr>
            ...
            <td class="punteado" align="center">
              @foreach ($alumno as $itemJue)
                @if ($itemJue->jueves == '11:30 a 12:30' || $itemJue->jueves == '10:00 a 12:30' || $itemJue->jueves == '11:30 a 14:30')
                  @if ($itemJue->materia_acd != "")
                    {{$itemJue->materia_acd}}
                  @else
                    {{$itemJue->materia}}
        ...
        <tbody>
          <tr>
            ...
            <td class="punteado" align="center">
              @foreach ($alumno as $itemJue)
                @if ($itemJue->jueves == '12:30 a 13:30' || $itemJue->jueves == '12:30 a 14:30' || $itemJue->jueves == '11:30 a 14:30')
                  @if ($itemJue->materia_acd != "")
                    {{$itemJue->materia_acd}}
                  @else
                    {{$itemJue->materia}}
        ...
        <tbody>
          <tr>
            ...
            <td class="punteado" align="center">
              @foreach ($alumno as $itemJue)
                @if ($itemJue->jueves == '13:30 a 14:30' || $itemJue->jueves == '12:30 a 14:30' || $itemJue->jueves == '11:30 a 14:30')
                  @if ($itemJue->materia_acd != "")
                    {{$itemJue->materia_acd}}
                  @else
                    {{$itemJue->materia}}
