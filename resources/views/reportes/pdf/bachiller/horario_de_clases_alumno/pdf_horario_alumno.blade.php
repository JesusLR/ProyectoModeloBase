  ...
  <div class="row">
    <div class="columns medium-12">
      <table class="table table-bordered">
        <thead>
          <tr>
            <th style="width: 0px;" class="punteado2"></th>
            <th class="punteado" align="center">MATERIA</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            @if ($item->materia_acd == "")
            <td class="punteado" style="width: 300px;">{{$item->matClave.'-'.$item->materia}}</td>
            @else
            <td class="punteado" style="width: 300px;">{{$item->matClave.'-'.$item->materia_acd}}</td>
            @endif
            <td class="punteado" align="center">{{$item->lunes}}</td>
            <td class="punteado" align="center">{{$item->martes}}</td>
            <td class="punteado" align="center">{{$item->miercoles}}</td>
            <td class="punteado" align="center">{{$item->jueves}}</td>
            <td class="punteado2" align="center">{{$item->viernes}}</td>
            {{--  <td class="punteado2" align="center">{{$item->sabado}}</td>  --}}
