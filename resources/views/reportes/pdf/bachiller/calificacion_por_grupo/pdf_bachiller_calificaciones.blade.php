...
<html>
  ...
  <body>
    ...
    @endphp
      ...
      @foreach ($materia_alumos as $matName)
        ...
        <div class="columns medium-12">
          <table class="table">
            <tr>
              ...
              @foreach($thead[$matName->bachiller_materia_id] AS $key => $value)
              <th align="center" style="font-weight: 400;">Evi. #{{$value->eviNumero}} <br> Pts. {{$value->eviPuntos}}</th>
              @endforeach
