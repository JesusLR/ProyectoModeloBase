...
<head>
  <title>Lista de asistencia recuperativos</title>
...
<body>
  ...
  <header>
    <div class="row">
      <div class="columns medium-6">
        ...
        <h5 style="margin-top:0px; margin-bottom: 10px;">LISTA DE ALUMNOS INSCRITOS A RECUPERATIVOS</h5>
      </div>
      <div class="columns medium-6">
  ...
  @foreach ($bachiller_recuperativo as $recuperativo_id => $data)
    @foreach ($data as $item)
        @if ($recuperativo_id == $item->extraordinario_id && $contador++ == 1)
          ...
          <div class="row">
            <div class="columns medium-12">
              <table class="table">
                <thead>
                  <tr>
                    <th style="font-weight: 400;width: 20px; padding-top: 7px;"><b>Núm</b></th>
                    <th style="font-weight: 400; padding-top: 7px;"><b>Cve pago</b></th>
                ...
                <tbody>
                  @foreach ($data as $key => $itemInscritos)
                    @if ($recuperativo_id == $item->extraordinario_id)
                      <tr>
