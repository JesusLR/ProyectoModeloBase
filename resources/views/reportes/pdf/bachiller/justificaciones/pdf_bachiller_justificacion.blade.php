...
<header>
  ...
  <div class="row">
    <div class="columns medium-3" style="text-align: center;">
      {{--  <img class="img-header-logo" width="80px;" src="{{base_path('resources/assets/img/logo.jpg')}}" alt="">  --}}
    </div>
    <div class="columns medium-6" style="text-align: center;">
      <p style="margin-top:0px; margin-bottom: 10px; font-size: 20px;"><b>Preparatoria "ESCUELA MODELO"</b></p>
      <p style="margin-top:0px; margin-bottom: 10px; font-size: 15px;">JUSTIFICACIÓN DE FALTAS DE ASISTENCIA</p>
      {{--  <p style="margin-top:0px; margin-bottom: 10px; font-size: 17px;">TEL. 927-99-44</p>  --}}
...
<body>
  ...
  <div class="row">
    <div class="columns medium-6">
      ...
      <p style="font-size: 14px;">Nombre y firma del tutor</p>
    </div>
    <div class="columns medium-6">
      <p style="text-align: right;">____________________________________________________</p>
      <p style="font-size: 14px; text-align: center;">VISADO DE LA DIRECCIÓN</p>
    </div>
  </div>
  ...
  <div class="row">
    <ul style="list-style-type: disc; font-size: 14px;">
      <li><p>Este documento deberá ser devuelto a la dirección después de la firma de los docentes para
        conservar el derecho a justificaciones posteriores.</p>
      </li>
      <br>
      {{--  <br>  --}}
      <li>
        <p> Este documento es válido ÚNICAMENTE por tres días hábiles a partir de la inasistencia</p>
      </li>
      <br>
      {{--  <br>  --}}
      <li>
        <p>Este formato solo aplica para inasistencias de todo el día</p>
      </li>
      <br>
      {{--  <br>  --}}
      <li>
        <p>Este documento no debe presentar borrones ni enmendaduras</p>
      </li>
    </ul>
  </div>
