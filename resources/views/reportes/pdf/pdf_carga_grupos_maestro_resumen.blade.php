    ...
    <header>
      <div class="row">
        <div class="columns medium-6">
          ...
          <h5 style="margin-top:0px; margin-bottom: 10px;">Carga de Grupos por Maestro (Resumen)</h5>
        </div>
        <div class="columns medium-6">
        ...
        <div class="columns medium-12">
          <table class="table">
            <tr>
              ...
              <th align="center" style="font-weight: 400;">Emp</th>
              <th align="center" style="font-weight: 400;">Nombre del Maestro</th>
              <th align="center" style="font-weight: 400;">Horas <br> Contrato</th>
              <th align="center" style="font-weight: 400;">Horas <br> Docen.</th>
            ...
            @foreach ($maestro as $mto)
              <tr>
                ...
                <td style="width: 30px;">{{$mto->empleado->id}}</td>
                ...
                <td style="width: 40px;" align="center">{{$mto->totalHorasMaestro}}</td>
                <td style="width: 40px;" align="center">{{$mto->cantidadGrupos}}</td>
                <td style="width: 40px;" align="center">{{$mto->cantidadInscritos}}</td>
              </tr>
            @endforeach
