    ...
    <header>
      <div class="row">
        <div class="columns medium-6">
          ...
          <h5 style="margin-top:0px; margin-bottom: 10px;">PROGRAMACION DE EXAMENES EXTRAORDINARIOS</h5>
        </div>
        <div class="columns medium-6">
      ...
      <div class="columns medium-12">
        <table class="table">
          ...
          <tr>
            ...
            <th align="center" style="width:270px;">Nombre de la Materia</th>
            <th align="center" style="width:10px;">Gdo</th>
            <th align="center" style="width:10px;">Gpo</th>
            <th align="center" style="width:10px;">Aula</th>
          ...
          @foreach($programa as $grado)
            ...
            @foreach ($grado as $examen)
              ...
              <tr>
                ...
                <td align="center">{{$examen["aula"]}}</td>
                <td align="center">{{$examen["extFecha"]}}</td>
                @if ($examen["extHora"])
                  <td align="center">{{\Carbon\Carbon::createFromFormat('H:i:s',$examen["extHora"])->format('h:i A')}}</td>
                @else
                  <td></td>
                @endif
                @if ($examen["costo"])
                ...
                <td align="center">${{number_format($priceSubTotal,0)}}</td>
              </tr>
            @endforeach
          @endforeach
          <tr>
