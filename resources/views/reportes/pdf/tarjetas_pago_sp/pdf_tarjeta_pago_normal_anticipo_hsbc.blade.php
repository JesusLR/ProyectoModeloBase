...
<div class="row">
  ...
  <div class="columns medium-4">
    ...
    <div class="columns medium-4">
      <div style="height: 145px; width: 75%; position: relative; border: 1px solid #000; padding: 10px; margin: 0 auto;">
          <p style="text-align: center;margin-bottom: 10px; font-weight: 900;">DE HSBC A HSBC</p>
          <p style="text-align: center;margin-bottom: 30px; font-weight: 900;">SERVICIO 9022</p>
          <p style="text-align: center;margin-bottom: 10px; font-weight: 900;">DE OTRO BANCO A HSBC</p>
          <p style="text-align: center;margin-bottom: 10px; font-weight: 900;">CLABE INTERBANCARIA</p>
          <p style="text-align: center; font-weight: 900;">021180550300090224</p>
      </div>
    </div>
  </div>
