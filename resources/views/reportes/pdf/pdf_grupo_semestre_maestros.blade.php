          ...
          <table class="table">
            <tr>
              ...
              <tr>
                ...
                <td style="width: 50px;">{{$materia["grupo"]["gpoHoraExamenOrdinario"]}}</td>
                <td style="width: 40px;">{{$materia["grupo"]["empleado"]["id"]}}</td>
                <td>
                  {{$materia["grupo"]["empleado"]["persona"]["perApellido1"]}}
                  {{$materia["grupo"]["empleado"]["persona"]["perApellido2"]}}
                  {{$materia["grupo"]["empleado"]["persona"]["perNombre"]}}
                </td>
