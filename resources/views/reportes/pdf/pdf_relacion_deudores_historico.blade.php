  ...
  <body>
      ...
      <div class="row">
            <div class="columns medium-12">
                {{-- dd($pagos) --}}
                <br>
                <p class="letraencabezado10">Se presentan los periodos escolares donde el alumno tiene una deuda pendiente.</p>
                <br>
                <table class="table">
                  @php
                    $deuNum = 0;
                 ...
                 <tr>
                     ...
                     <th style="width:20px;">Clave de Pago</th>
                     <th style="width:150px;">Nombre del Alumno</th>
                     <th style="width:400px;">Información por Periodo/Año/Programa</th>
                 </tr>
              @foreach($pagos as $item)
                        ...
                        @endphp
                         ...
                         <tr>
                             ...
                             <td style="width:400px;">{{$item->perAnioProgEstados}}</td>
                         </tr>
                    <!--
