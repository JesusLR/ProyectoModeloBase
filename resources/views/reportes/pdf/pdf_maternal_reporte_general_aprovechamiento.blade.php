...
@foreach ($cursos_grupo as $itemCurso)
    <div class="row" >
        <h4 style="margin-top:0px; margin-bottom: 5px; text-align: left;">{{$kinderGradoTrimestre}} | Evaluado(a) por el docente: {{$itemCurso->empNombre}} {{$itemCurso->empApellido1}} {{$itemCurso->empApellido2}}</h4>
    ...
    @php
        ...
        $inscritos = Preescolar_inscrito::findOrFail($itemCurso->inscrito_id);
        if($trimestre_a_evaluar == 1){
