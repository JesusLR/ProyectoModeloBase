      ...
      <header>
          <div class="row">
              <div class="columns medium-6">
                  <p class="letraencabezado9">ESCUELA MODELO S.C.P.</p>
                  <p class="letraencabezado9bold">{{$elTitulo}}</p>
                  <p class="letraencabezado9">{{$elPeriodo}}</p>
                  <p class="letraencabezado9">{{$elRango}}</p>
              </div>
              <div class="columns medium-6">
                  <div style="text-align: right;">
                      <p class="letraencabezado9">{{$fechaActual}}</p>
                      <p class="letraencabezado9">{{$horaActual}}</p>
                      <p class="letraencabezado9">{{$nombreArchivo}}</p>
                      <p class="letraencabezado9">{{$laUbicacion}}</p>
                ...
                <table class="table">
                      ...
                      <thead>
                          <tr>
                             ...
                             <th style="width:85px;">Nombre del Alumno</th>
                             <th style="width:5px;">Pago</th>
                             <th style="width:5px;">Prog</th>
                             <th style="width:5px;">Gdo</th>
                             <th style="width:5px;">Gpo</th>
                                  ...
                                  @foreach($pagos as $item)
                                            ...
                                            @endphp
                                             ...
                                             <tr>
                                                 ...
                                                 <td style="width:85px;">{{$item->alumno}}</td>
                                                 <td style="width:5px;">{{$item->plan_pago}}</td>
                                                 <td style="width:5px;">{{$item->cve_programa}}</td>
                                                 <td style="width:5px;">{{$item->grado}}</td>
                                                 <td style="width:5px;">{{$item->grupo}}</td>
