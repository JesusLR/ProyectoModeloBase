...
<html>
      ...
      <div class="row">
        ...
        <div class="columns medium-6">
          <div style="text-align: right;">
            ...
            <p>{{$horaActual}}</p>
            <p>{{$nombreArchivo}}</p>
           <p>Calif.Min.Aprob: {{$depCalif->depCalMinAprob}}</p>
          </div>
        </div>
      </div>
  ...
  <body>
    ...
    <div class="row">
      ...
      <div class="columns medium-6">Gdo/Sem: {{$gpoSemestre}} Grupo: {{$gpoClave}}</div>
        <table class="table">
          <tr>
            <th align="center">Num</th>
            <th align="center">Cve.Pago</th>
            <th align="center">Nombre del alumno</th>
            @foreach ($calificacion as $materias)
            @php
          ...
          @if ($estadoBase->edoNombre != $item["estado"])
          <tr>
            <td>{{$contador}}</td>
