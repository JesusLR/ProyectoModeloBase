...
@section('breadcrumbs')
    ...
    <a href="" class="breadcrumb">Listas para evaluación parcial</a>
@endsection
...
@section('content')
  ...
  <div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/listas_evaluacion_parcial/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">LISTAS PARA EVALUACIÓN PARCIAL</span>
