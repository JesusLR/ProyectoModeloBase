...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Estadísticas estatales de educación continua</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'url' => 'reporte/estadistica_estatal_educacion_continua/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Estadísticas estatales de educación continua</span>
          {{-- NAVIGATION BAR--}}
          ...
          <div id="filtros">
            ...
            <div class="row">
              ...
              <div class="col s12 m6 l4">
                  <label for="perAnio">Ciclo Escolar*</label>
