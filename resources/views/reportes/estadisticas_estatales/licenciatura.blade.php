...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Estadísticas estatales de licenciatura</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'url' => 'reporte/estadistica_estatal_licenciatura/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Estadísticas estatales de licenciatura</span>
          {{-- NAVIGATION BAR--}}
