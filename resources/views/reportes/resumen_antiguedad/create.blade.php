...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Resumen de Antiguedad</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/resumen_antiguedad/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Resumen de Antiguedad</span>
          {{-- NAVIGATION BAR--}}
