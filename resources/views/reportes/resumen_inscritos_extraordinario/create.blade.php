...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Resumen de Inscritos a Extraordinario</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/resumen_inscritos_extraordinario/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Resumen de Inscritos a Extraordinario</span>
          {{-- NAVIGATION BAR--}}
