...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Alumnos regulares que adeudan curso anterior</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'url' => 'reporte/regulares_curso_anterior/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Alumnos regulares que adeudan curso anterior</span>
          {{-- NAVIGATION BAR--}}
