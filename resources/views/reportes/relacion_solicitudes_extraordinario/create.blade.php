...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Relación de Solicitudes a Extraordinario</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/relacion_solicitudes_extraordinario/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Relación de Solicitudes a Extraordinario</span>
          {{-- NAVIGATION BAR--}}
