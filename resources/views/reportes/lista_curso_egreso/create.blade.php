...
@section('breadcrumbs')
    ...
    <a href="" class="breadcrumb">Lista de cursos y egresos</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/lista_cursos_egresos/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">LISTA DE CURSOS Y EGRESOS</span>
                ...
                <div class="row">
                  <div class="col s12 m6 l4">
                    <div class="input-field col s12 m6 l6">
                        {!! Form::number('perAnioPAgo', 1997, array('id' => 'perAnioPAgo', 'class' => 'validate','min'=>'1997', 'required')) !!}
                        {!! Form::label('perAnioPAgo', 'Año curso*', array('class' => '')); !!}
                    </div>
                  </div>
                  <div class="col s12 m6 l4">
