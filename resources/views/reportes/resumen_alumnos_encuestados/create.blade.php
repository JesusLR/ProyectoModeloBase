...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Resumen Alumnos Encuestados</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/resumen_alumnos_encuestados/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Resumen Alumnos Encuestados</span>
          {{-- NAVIGATION BAR--}}
              ...
              <div class="row">
                <div class="col s12 m6 l4">
                  <div class="input-field">
                    <input type="number" name="cgtGradoSemestre" id="cgtGradoSemestre" value="{{old('cgtGradoSemestre')}}">
