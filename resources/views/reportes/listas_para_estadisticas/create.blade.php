...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Listas Para Estadísticas</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'url' => 'reporte/listas_para_estadisticas/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Listas para estadísticas</span>
          {{-- NAVIGATION BAR--}}
          ...
          <div id="filtros">
            ...
            <div class="row">
              <div class="col s12 m6 l4">
                <label for="tipoImpresion">Obtener en:</label>
                <select name="tipoImpresion" id="tipoImpresion" data-tipo-impresion="{{old('tipoImpresion')}}" class="browser-default validate select2" style="width:100%;" required>
                  <option value="W">Documento de Word</option>
