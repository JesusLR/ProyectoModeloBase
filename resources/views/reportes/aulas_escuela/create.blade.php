...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Aulas por escuela</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'url' => 'reporte/aulas_escuela/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Aulas por escuela</span>
          {{-- NAVIGATION BAR--}}
