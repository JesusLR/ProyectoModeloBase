...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">CIBIES Nuevo Ingreso</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/cibies_nuevo_ingreso/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">CIBIES Nuevo Ingreso</span>
          {{-- NAVIGATION BAR--}}
