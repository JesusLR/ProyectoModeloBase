...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Lista por tipo ingreso</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/lista_por_tipo_ingreso/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Lista por tipo ingreso</span>
          {{-- NAVIGATION BAR--}}
          ...
          <div id="filtros">
              ...
              <div class="row">
                ...
                <div class="col s12 m6 l4">
                  ...
                  <select class="browser-default validate select2" data-periodo-id="{{old('periodo_id')}}" name="periodo_id" id="periodo_id" style="width:100%;">
                    <option value="">SELECCIONE UNA OPCIÓN</option>
                  </select>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col s12 m6 l4">
                  ...
                  <div class="input-field col s12 m6 l6">
                    <input type="number" name="cgtGradoSemestre" id="cgtGradoSemestre" class="validate" value="{{old('cgtGradoSemestre')}}">
