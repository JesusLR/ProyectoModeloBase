      ...
      <div class="card ">
        <div class="card-content ">
            ...
            <div class="row">
              ...
              <div class="col s12 m6 l4">
                <div class="">
                  ...
                  <select name="cgtTurno" id="cgtTurno" data-cgt-turno="{{old('cgtTurno')}}" class="browser-default validate select2" style="width:100%;">
                    <option value="">SELECCIONE UNA OPCIÓN</option>
          ...
          <div class="row">
            ...
            <div class="col s12 m6 l4">
              <label for="solo_con_inscritos">Tipo de Cgt</label>
              <select class="browser-default validate select2" id="solo_con_inscritos" name="solo_con_inscritos" style="width:100%;">
                <option value="">Todos</option>
                <option value="1">Con inscritos registrados</option>
              </select>
            </div>
            <div class="col s12 m6 l4">
              <div class="input-field">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var cgtTurno = {!! json_encode(old('cgtTurno')) !!};
        cgtTurno && $('#cgtTurno').val(cgtTurno).select2();
