...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Conteo de Servicio Social</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/conteo_servicio_social/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Conteo de Servicio Social</span>
          {{-- NAVIGATION BAR--}}
          ...
          <div id="filtros">
              ...
              <div class="row">
                ...
                <div class="col s12 m6 l4">
                  <label for="ssClasificacion">Alcance regional</label>
                  <select class="browser-default validate select2" data-clasificacion="{{old('ssClasificacion')}}" name="ssClasificacion" id="ssClasificacion" style="width:100%;">
                    <option value="">SELECCIONE UNA OPCIÓN</option>
                    @foreach($clasificaciones as $clave => $clasificacion)
                      <option value="{{$clave}}">{{$clasificacion}}</option>
                    @endforeach
                  </select>
                </div>
              </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    apply_data_to_select('ssClasificacion', 'clasificacion');
