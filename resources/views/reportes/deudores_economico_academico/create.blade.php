...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Deudores Económico-Académico</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/deudores_economico_academico/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Deudores Económico-Académico</span>
          {{-- NAVIGATION BAR--}}
          ...
          <div id="filtros">
              ...
              <div class="row">
                <div class="col s12 m6 l4">
                  ...
                  <select class="browser-default validate select2" data-tipo-reporte="{{old('tipo_reporte')}}" name="tipo_reporte" id="tipo_reporte" style="width:100%;">
                    <option value="1">Reporte específico</option>
                    <option value="2">Reporte estadístico individual</option>
                    <option value="3">Reporte estadístico general</option>
                  </select>
                </div>
              </div>
