...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Relación de Cambios de Carrera</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/rel_cambios_carrera/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Relación de Cambios de Carrera</span>
          {{-- NAVIGATION BAR--}}
