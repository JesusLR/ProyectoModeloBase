...
@section('breadcrumbs')
    ...
    <a href="" class="breadcrumb">Cambios de plan de pago</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/cambio_plan_pago/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">CAMBIOS DE PLAN DE PAGO</span>
            ...
            <div id="filtros">
              ...
              <div class="row">
                ...
                <div class="col s12 m6 l4">
                  <label for="perAnioPago">Año de curso*</label>
                  <select name="perAnioPago" id="perAnioPago" class="browser-default validate select2" style="width:100%;" required>
