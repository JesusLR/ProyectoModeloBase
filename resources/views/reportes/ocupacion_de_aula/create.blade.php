...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Ocupación de Aulas</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/ocupacion_de_aula/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Ocupación de Aulas</span>
          {{-- NAVIGATION BAR--}}
