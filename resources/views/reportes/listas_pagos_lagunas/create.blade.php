...
@section('breadcrumbs')
    ...
    <a href="" class="breadcrumb">Listas pagos lagunas</a>
@endsection
...
@section('content')
  ...
  <div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/listas_pagos_lagunas/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">LISTAS PAGOS LAGUNAS</span>
            ...
            <div id="filtros">
              ...
              <div class="row">
                <div class="col s12 m6 l4">
                    <label for="mostras_fechas">Mostrar columnas</label>
                    <select name="mostras_fechas" id="mostras_fechas" data-programa-id="{{old('mostras_fechas')}}" class="browser-default validate select2" style="width:100%;">
                        <option value="1">Mostrar todas las columnas</option>
                        <option value="2">Mostrar solo fechas</option>
                    </select>
                </div>
              </div>
          </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        if(ubicacion_id) {
            ...
            getDepartamentosListaCompleta(ubicacion_id);
        }
        ...
        departamento.on('change', function() {
            if(this.value) {
                ...
                getEscuelasListaCompleta(this.value);
            } else {
