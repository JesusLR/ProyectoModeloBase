...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">CIBIES Reincorporados</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/cibies_reincorporados/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">CIBIES Reincorporados</span>
          {{-- NAVIGATION BAR--}}
