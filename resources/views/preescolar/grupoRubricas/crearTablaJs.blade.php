<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#periodo_id").change( event => {
            ...
            $.get(base_url+`/preescolar_grupo_rubricas/obtenerMaterias/${event.target.value}/${programa_id}/${plan_id}/${cgt_id}`,function(res,sta){
                ...
                if(res.materias.length > 0){
                    ...
                    let myTable= "<table><tr><th style='display: none;'></th>";
                        ...
                        res.materias.forEach(element => {
                            ...
                            myTable+=`<td><div class='form-check checkbox-warning-filled'><input onclick="return false;" onkeydown="return false;" class='form-check-input filled-in micheckbox' type='checkbox' checked name='preescolar_materia[]' value='${element.id}' id='${element.id}'><label for='${element.id}'></label></div></td>`;
        ...
        $("#programa_id").change( event => {
            ...
            $.get(base_url+`/preescolar_grupo_rubricas/obtenerMaterias/${periodo_id}/${event.target.value}/${plan_id}/${cgt_id}`,function(res,sta){
        ...
        $("#plan_id").change( event => {
            ...
            $.get(base_url+`/preescolar_grupo_rubricas/obtenerMaterias/${periodo_id}/${programa_id}/${event.target.value}/${cgt_id}`,function(res,sta){
        ...
        $("#cgt_id").change( event => {
            ...
            $.get(base_url+`/preescolar_grupo_rubricas/obtenerMaterias/${periodo_id}/${programa_id}/${plan_id}/${event.target.value}`,function(res,sta){
