...
@section('breadcrumbs')
    ...
    {{--  <a href="{{route('preescolar_asignar_grupo.index')}}" class="breadcrumb">Lista de Inscritos</a>  --}}
    <a href="{{url('preescolar_grupo_rubricas')}}" class="breadcrumb">Grupos rubricas</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'preescolar.preescolar_grupo_rubricas.store', 'method' => 'POST']) !!}
        <div class="card ">
            <div class="card-content ">
                <span class="card-title">GRUPOS RUBRICAS</span>
...
@include('preescolar.grupoRubricas.crearTablaJs')
@include('preescolar.scripts.cgts_sin_grupo_N')
...
@include('preescolar.grupoRubricas.guardarJS')
