...
@section('breadcrumbs')
    ...
    <a href="{{url('preescolar_cgt_materias')}}" class="breadcrumb">CGT Materia</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'preescolar.preescolar_cgt_materias.store', 'method' => 'POST']) !!}
        <div class="card ">
...
@include('preescolar.CGTMaterias.crearTablaJs')
...
@include('preescolar.CGTMaterias.guardarJS')
