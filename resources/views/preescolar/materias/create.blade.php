...
@section('breadcrumbs')
    ...
    <a href="{{url('preescolar_materia')}}" class="breadcrumb">Lista de materias</a>
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'preescolar.preescolar_materia.store', 'method' => 'POST']) !!}
        <div class="card ">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l2">
                        <div class="input-field col s6 m6 l3">
                            <a name="agregarMateriaPreescolar" id="agregarMateriaPreescolar" class="waves-effect btn-large tooltipped #2e7d32 green darken-3"
    ...
    $(document).ready(function() {
        ...
        $("#plan_id").change( event => {
            ...
            $.get(base_url + `/api/plan/semestre/${event.target.value}`, function(res,sta) {
                ...
                $("#matSemestre").empty()
                //fijamos a 3 grados para preescolar y maternal
                for (i = 1; i <= 3; i++) {
                    var selected = "";
...
$(document).ready(function(){
    ...
    $('#agregarMateriaPreescolar').on('click',function(e){
        e.preventDefault();
