...
@section('breadcrumbs')
    ...
    <a href="{{ route('preescolar_grupo.create') }}" class="breadcrumb">Agregar Grupo</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'preescolar_grupo.store', 'method' => 'POST']) !!}
        <div class="card ">
            ...
            <div id="general">
                ...
                <div class="row">
                    <div class="col s12 m6 l4">
                        ...
                        <select disabled id="ubicacion_id" class="browser-default validate select2" required name="ubicacion_id" style="width: 100%;">
                    ...
                    <div class="col s12 m6 l4">
                        ...
                        <select disabled id="departamento_id"
                ...
                <div class="row">
                    <div class="col s12 m6 l4">
                        ...
                        <select disabled id="programa_id"
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l4">
                        ...
                        <select id="empleado_id_auxiliar" class="browser-default validate select2" name="empleado_id_auxiliar" style="width: 100%;">
                            <option value="" selected disabled>SELECCIONE UNA OPCIÓN</option>
                            @foreach($empleados as $empleado)
                                <option value="{{$empleado->id}}" @if(old('empleado_id_auxiliar') == $empleado->id) {{ 'selected' }} @endif>{{$empleado->id ." - ".$empleado->persona->perNombre ." ". $empleado->persona->perApellido1." ".$empleado->persona->perApellido2}}</option>
                            @endforeach
                        </select>
                    </div>
                    {{--  <div style="display: none" class="col s12 m6 l4">
                ...
                if (!data.res) {
                    ...
                    if (data.existeGrupo) {
                        ...
                        html += "<p style='text-align:left;'><b>Materia:</b>"
                            + " " + data.msg.preescolar_materia.matNombre
                        + "</p>"
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#gpoSemestre").change( event => {
            ...
            $.get(base_url+`/obtener/materias/${event.target.value}/${plan_id}`,function(res,sta){
                res.forEach(element => {
    ...
    $(document).ready(function() {
        ...
        function obtenerDepartamentos(ubicacionId) {
            ...
            $.get(base_url+`/api/departamentos/${ubicacionId}`, function(res,sta) {
                ...
                var departamentoSeleccionadoOld = 13;
