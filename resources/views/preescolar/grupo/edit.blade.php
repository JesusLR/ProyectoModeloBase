...
@section('breadcrumbs')
    ...
    <a href="{{url('preescolar_grupo/'.$grupo->id.'/edit')}}" class="breadcrumb">Editar grupo</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
        {{ Form::open(array('method'=>'PUT','route' => ['preescolar_grupo.update', $grupo->id])) }}
        <div class="card ">
                ...
                <div class="row">
                    <div class="col s12 ">
                        ...
                        <select id="materia_id" class="browser-default validate select2" required name="materia_id" style="width: 100%;">
                            <option value="{{$grupo->preescolar_materia->id}}">{{$grupo->preescolar_materia->matNombre}}</option>
                        </select>
                    </div>
                </div>
                <div class="row">
