...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/preescolar_relacion_deudores/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          ...
          <div id="filtros">
                ...
                <div class="row">
                        ...
                        <div class="col s12 m6 l4">
                            {!! Form::label('numSemestre', 'Seleccionar el Año', ['class' => '']); !!}
