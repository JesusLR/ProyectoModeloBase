<script type="text/javascript">
    $(document).ready(function() {
        function obtenerEscuelas (departamentoId) {
            ...
            $.get(base_url+`/preescolar_escuela/api/escuelas/${departamentoId}`,function(res,sta){
            ...
            //OBTENER PERIODOS
            $.get(base_url+`/preescolar_periodo/api/periodos/${departamentoId}`,function(res2,sta){
                var perSeleccionado;
