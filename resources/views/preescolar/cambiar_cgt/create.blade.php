...
@section('breadcrumbs')
    ...
    <a href="{{route('preescolar.preescolar_cambiar_cgt.edit')}}" class="breadcrumb">Cambiar CGT - Grupo </a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'preescolar.preescolar_cambiar_cgt.update', 'method' => 'POST']) !!}
        <div class="card ">
...
@include('preescolar.cambiar_cgt.cgts_sin_grupo_N')
@include('preescolar.scripts.cursos')
@include('preescolar.cambiar_cgt.crearTablaJs')
