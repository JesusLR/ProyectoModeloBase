...
@section('breadcrumbs')
    ...
    <a href="{{ url('preescolar_actividades/'.$actividad->id.'/edit') }}" class="breadcrumb">Editar actividad</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {{ Form::open(array('method'=>'PUT','route' => ['preescolar.preescolar_actividades.update', $actividad->id])) }}
        <div class="card ">
