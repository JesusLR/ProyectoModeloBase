...
@section('breadcrumbs')
    ...
    <a href="{{route('preescolar.preescolar_actividades_inscritos.create')}}" class="breadcrumb">Agregar actividad inscrito</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['enctype' => 'multipart/form-data', 'onKeypress' => 'return disableEnterKey(event)','route' => 'preescolar.preescolar_actividades_inscritos.store', 'method' => 'POST']) !!}
        <div class="card ">
