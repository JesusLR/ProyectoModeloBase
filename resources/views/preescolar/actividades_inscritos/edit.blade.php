...
@section('breadcrumbs')
    ...
    <a href="{{url('preescolar_actividades_inscritos/'.$actividad_inscrito->id.'/edit')}}" class="breadcrumb">Editar actividad inscrito</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {{ Form::open(array('method'=>'PUT','route' => ['preescolar.preescolar_actividades_inscritos.update', $actividad_inscrito->id])) }}
      <div class="card ">
...
@include('preescolar.actividades_inscritos.getActividades')
...
<script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#alumno_id').on('change', function() {
        ...
        $.ajax({
            type: 'GET',
            url: base_url+'/preescolar_materias_inscrito/ultimo_curso/'+alumno_id,
            dataType: 'json',
    ...
    function buscarAlumno()
      {
        ...
        $.ajax({
            type: "POST",
            url: base_url + `/preescolar_materias_inscrito/api/getMultipleAlumnosByFilter`,
            data: {
                aluClave: aluClave,
