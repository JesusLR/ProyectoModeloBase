...
@section('breadcrumbs')
    ...
    <a href="{{url('preescolar_programa')}}" class="breadcrumb">Lista de programas</a>
...
<div class="row">
    <div class="col s12 ">
        {{ Form::open(array('method'=>'PUT','route' => ['preescolar.preescolar_programa.update', $programa->id])) }}
        <div class="card ">
                    ...
                    <div class="col s12 m6 l4">
                        ...
                        <select id="empleado_id" class="browser-default validate select2" required name="empleado_id" style="width: 100%;">
                            ...
                            @foreach($empleados as $empleado)
                                <option value="{{$empleado->id}}" {{ $empleado->id == $programa->empleado->id  ? 'selected="selected"' : '' }}>{{$empleado->empNombre}} {{$empleado->empApellido1}} {{$empleado->empApellido2}}</option>
                            @endforeach 
                        </select>
                    </div>
                    <div class="col s12 m6 l4">
