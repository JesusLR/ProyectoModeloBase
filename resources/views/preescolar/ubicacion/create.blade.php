...
@section('breadcrumbs')
    ...
    <a href="{{url('preescolar_ubicacion')}}" class="breadcrumb">Lista de ubicaciones</a>
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'preescolar.preescolar_ubicacion.store', 'method' => 'POST']) !!}
        <div class="card ">
