...
@section('breadcrumbs')
    ...
    <a href="{{route('curso_preescolar.index')}}" class="breadcrumb">Lista de Preinscripción</a>
    <a href="{{url('preescolar_curso/'.$curso->id)}}" class="breadcrumb">Ver curso</a>
@endsection
            ...
            <div id="general">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m4">
                        <a href="#modalAlumnoDetalle-preescolar" data-alumno-id="{{ $curso->alumno_id  }}" class="btn modal-trigger btn-modal-alumno-detalle-preescolar button button--icon js-button js-ripple-effect ">Ver alumno</a>
                    </div>
                </div>
