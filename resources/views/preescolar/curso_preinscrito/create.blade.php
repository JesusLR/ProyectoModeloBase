...
@section('breadcrumbs')
    ...
    <a href="{{route('curso_preescolar.create')}}" class="breadcrumb">Agregar Preinscripción</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['enctype' => 'multipart/form-data', 'onKeypress' => 'return disableEnterKey(event)','route' => 'curso_preescolar.store', 'method' => 'POST']) !!}
        <div class="card ">
