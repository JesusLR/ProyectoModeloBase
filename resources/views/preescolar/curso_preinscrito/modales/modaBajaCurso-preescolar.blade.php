{{-- MODAL BAJA CURSO --}}
<div id="modalBajaCursoPreescolar" class="modal">
    <div class="modal-content">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'curso_preescolar.bajaCurso', 'method' => 'POST', 'class' => 'form-baja-alumno']) !!}
