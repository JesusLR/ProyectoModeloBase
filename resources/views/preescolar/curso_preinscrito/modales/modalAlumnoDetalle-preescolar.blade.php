{{-- MODAL EQUIVALENTES --}}
<div id="modalAlumnoDetalle-preescolar" class="modal">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on("click", ".btn-modal-alumno-detalle-preescolar", function (e) {
            e.preventDefault()
            var alumno_id = $(this).data("alumno-id");
  
            $.get(base_url+`/preescolar_alumnos/alumnoById/${alumno_id}`, function(res,sta) {
                console.log("res", res)
