...
@section('breadcrumbs')
    ...
    <a href="{{url('preescolar_calendario_calificaciones')}}" class="breadcrumb">Lista de fechas de calificaciones</a>
...
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'preescolar.preescolar_calendario_calificaciones.store', 'method' => 'POST']) !!}
            <div class="card ">
