                    ...
                    <div id="general">
                        ...
                        <div class="row">
                            <div class="col s12 m6 l3">
                                ...
                                {!! Form::date('trimestre1_docente_inicio', \Carbon\Carbon::parse($preescolar_calificaciones_fechas->trimestre1_docente_inicio)->format('Y-m-d'), array('id' => 'trimestre1_docente_inicio', 'class' => 'validate','required','maxlength'=>'255')) !!}
                            </div>                
                            
                            <div class="col s12 m6 l3">
                                {!! Form::label('trimestre1_docente_fin', 'Fecha de fin *', array('class' => '')); !!}
                                {!! Form::date('trimestre1_docente_fin', \Carbon\Carbon::parse($preescolar_calificaciones_fechas->trimestre1_docente_fin)->format('Y-m-d'), array('id' => 'trimestre1_docente_fin', 'class' => 'validate','required','maxlength'=>'255')) !!}
                            </div>

                            <div class="col s12 m6 l3">
                                {!! Form::label('trimestre1_administrativo_edicion', 'Fecha de edición administrativa *', array('class' => '')); !!}
                                {!! Form::date('trimestre1_administrativo_edicion', \Carbon\Carbon::parse($preescolar_calificaciones_fechas->trimestre1_administrativo_edicion)->format('Y-m-d'), array('id' => 'trimestre1_administrativo_edicion', 'class' => 'validate','required','maxlength'=>'255')) !!}
                            </div>

                            <div class="col s12 m6 l3">
                                {!! Form::label('trimestre1_alumnos_publicacion', 'Fecha de publicacón para alumnos *', array('class' => '')); !!}
                                {!! Form::date('trimestre1_alumnos_publicacion', \Carbon\Carbon::parse($preescolar_calificaciones_fechas->trimestre1_alumnos_publicacion)->format('Y-m-d'), array('id' => 'trimestre1_alumnos_publicacion', 'class' => 'validate','required','maxlength'=>'255')) !!}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col s12 m6 l3">
                                ...
                                {!! Form::date('trimestre2_docente_inicio', \Carbon\Carbon::parse($preescolar_calificaciones_fechas->trimestre2_docente_inicio)->format('Y-m-d'), array('id' => 'trimestre2_docente_inicio', 'class' => 'validate','required','maxlength'=>'255')) !!}
                            </div>                
                            
                            <div class="col s12 m6 l3">
                                {!! Form::label('trimestre2_docente_fin', 'Fecha de fin *', array('class' => '')); !!}
                                {!! Form::date('trimestre2_docente_fin', \Carbon\Carbon::parse($preescolar_calificaciones_fechas->trimestre2_docente_fin)->format('Y-m-d'), array('id' => 'trimestre2_docente_fin', 'class' => 'validate','required','maxlength'=>'255')) !!}
                            </div>

                            <div class="col s12 m6 l3">
                                {!! Form::label('trimestre2_administrativo_edicion', 'Fecha de edición administrativa *', array('class' => '')); !!}
                                {!! Form::date('trimestre2_administrativo_edicion', \Carbon\Carbon::parse($preescolar_calificaciones_fechas->trimestre2_administrativo_edicion)->format('Y-m-d'), array('id' => 'trimestre2_administrativo_edicion', 'class' => 'validate','required','maxlength'=>'255')) !!}
                            </div>

                            <div class="col s12 m6 l3">
                                {!! Form::label('trimestre2_alumnos_publicacion', 'Fecha de publicacón para alumnos *', array('class' => '')); !!}
                                {!! Form::date('trimestre2_alumnos_publicacion', \Carbon\Carbon::parse($preescolar_calificaciones_fechas->trimestre2_alumnos_publicacion)->format('Y-m-d'), array('id' => 'trimestre2_alumnos_publicacion', 'class' => 'validate','required','maxlength'=>'255')) !!}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col s12 m6 l3">
                                ...
                                {!! Form::date('trimestre3_docente_inicio', \Carbon\Carbon::parse($preescolar_calificaciones_fechas->trimestre3_docente_inicio)->format('Y-m-d'), array('id' => 'trimestre3_docente_inicio', 'class' => 'validate','required','maxlength'=>'255')) !!}
                            </div>                
                            
                            <div class="col s12 m6 l3">
                                {!! Form::label('trimestre3_docente_fin', 'Fecha de fin *', array('class' => '')); !!}
                                {!! Form::date('trimestre3_docente_fin', \Carbon\Carbon::parse($preescolar_calificaciones_fechas->trimestre3_docente_fin)->format('Y-m-d'), array('id' => 'trimestre3_docente_fin', 'class' => 'validate','required','maxlength'=>'255')) !!}
                            </div>

                            <div class="col s12 m6 l3">
                                {!! Form::label('trimestre3_administrativo_edicion', 'Fecha de edición administrativa *', array('class' => '')); !!}
                                {!! Form::date('trimestre3_administrativo_edicion', \Carbon\Carbon::parse($preescolar_calificaciones_fechas->trimestre3_administrativo_edicion)->format('Y-m-d'), array('id' => 'trimestre3_administrativo_edicion', 'class' => 'validate','required','maxlength'=>'255')) !!}
                            </div>

                            <div class="col s12 m6 l3">
                                {!! Form::label('trimestre3_alumnos_publicacion', 'Fecha de publicacón para alumnos *', array('class' => '')); !!}
                                {!! Form::date('trimestre3_alumnos_publicacion', \Carbon\Carbon::parse($preescolar_calificaciones_fechas->trimestre3_alumnos_publicacion)->format('Y-m-d'), array('id' => 'trimestre3_alumnos_publicacion', 'class' => 'validate','required','maxlength'=>'255')) !!}
                            </div>
                        </div>
