...
@section('breadcrumbs')
  ...
  <a href="{{url('preescolar_alumnos/cambiar_matricula/' . $alumno->id)}}" class="breadcrumb">Cambiar matrícula alumno</a>
@endsection
...
@section('content')
  ...
  <div class="row">
    <div class="col s12 ">
      {!! Form::open(['route' => 'preescolar_alumnos.cambiarMatricula', 'method' => 'POST']) !!}
