...
@section('breadcrumbs')
    ...
    <a href="{{url('preescolar_alumnos/'.$alumno->id.'/edit')}}" class="breadcrumb">Editar alumno</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
        {{ Form::open(array('method'=>'PUT','route' => ['preescolar_alumnos.update', $alumno->id])) }}
        <div class="card ">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l4">
                        ...
                        <div class="input-field col s12 m6 l6">
                            {!! Form::number('aluGradoIngr', $alumno->aluGradoIngr, array('id' => 'aluGradoIngr', 'class' => 'validate','required','min'=>'1','max'=>'3','onKeyPress="if(this.value.length>1) return false;"')) !!}
