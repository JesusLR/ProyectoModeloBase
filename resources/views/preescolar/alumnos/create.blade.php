...
@section('breadcrumbs')
    ...
    <a href="{{route('preescolar_alumnos.create')}}" class="breadcrumb">Agregar alumno</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'preescolar_alumnos.store', 'method' => 'POST']) !!}
