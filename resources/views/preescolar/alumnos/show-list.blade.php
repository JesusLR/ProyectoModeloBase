...
@section('breadcrumbs')
    ...
    <a href="{{url('preescolar_alumnos')}}" class="breadcrumb">Lista de alumnos</a>
@endsection
...
@section('content')
    <div id="table-datatables">
        ...
        <a href="{{ route('preescolar_alumnos.create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
        ...
        <div class="row">
            <div class="col s12">
                <table id="tbl-alumno-preescolar" class="responsive-table display" cellspacing="0" width="100%">
                    <thead>
                    <tr>
                        <th>Clave Alumno</th>
    ...
    {{-- MODAL EQUIVALENTES --}}
    <div id="modalHistorialPagosAlu-Prescolar" class="modal">
        <div class="modal-content">
            <div class="row">
                <div class="col s12 m6 l6">
                    <h4>Historial de pagos</h4>
                ...
                <div class="col s12 m6 l6">
                    ...
                    <form action="{{url('preescolar_reporte/preescolar_historial_pagos_alumno/imprimir')}}" method="POST" style="display:inline;" target="_blank">
                        @csrf
...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $.fn.dataTable.ext.errMode = 'throw';
            $('#tbl-alumno-preescolar').dataTable({
                ...
                "ajax": {
                    "type" : "GET",
                    'url': base_url+"/preescolar_alumnos/list",
                    beforeSend: function () {
