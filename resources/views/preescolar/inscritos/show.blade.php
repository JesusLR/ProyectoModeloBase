...
@section('breadcrumbs')
    ...
    <a href="{{url('inscritosMateria/'.$inscrito->id)}}" class="breadcrumb">Ver inscrito materia</a>
@endsection
          ...
          <div class="card-content ">
            ...
            <div id="general">
                ...
                <div class="row">
                    <div class="col s12 ">
                        <div class="input-field">
                            {!! Form::text('grupo_id', $inscrito->preescolar_grupo->gpoGrado.'-'.$inscrito->preescolar_grupo->gpoClave.'-'.$inscrito->preescolar_grupo->gpoTurno.' '.$inscrito->preescolar_grupo->preescolar_materia->matNombre, array('readonly' => 'true')) !!}
