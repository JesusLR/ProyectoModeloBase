...
@section('breadcrumbs')
    ...
    <a href="{{route('PreescolarInscritos.index')}}" class="breadcrumb">Lista de inscritos materia</a>
@endsection
...
<div id="table-datatables">
    ...
    {{-- @php use App\Models\User; @endphp
        ...
        <a href="{{ route('PreescolarInscritos.create') }}" class="btn-large waves-effect darken-3" type="button">Por materias
    ...
    <div class="row">
        <div class="col s12">
            <table id="tbl-inscrito-preescolar" class="responsive-table display" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th>Ubicación</th>
                    <th>Departamento</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#tbl-inscrito-preescolar').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/inscritosMateria/list",
                beforeSend: function () {
            ...
            "columns":[
                ...
                {data: "matNombre",name:"preescolar_materias.matNombre"},
