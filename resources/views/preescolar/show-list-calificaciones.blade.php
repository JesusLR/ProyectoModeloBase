...
@section('breadcrumbs')
    ...
    <a href="{{url('preescolarinscritos/'.$grupo_id.'/'.$materia_id.'/'.$peraniopago)}}" class="breadcrumb">Alumnos</a>
...
@section('content')
    <div class="row">
        <div class="col s12 ">
            ...
            <input type="hidden" name="peraniopago" value="{{$peraniopago}}">
            ...
            <div class="card ">
                                                ...
                                                <td>
                                                    ...
                                                    @if (is_null($row->trimestre1_nivel))
                                                        ...
                                                        <input
                                                            ...
                                                            type="number" class="permitido calif parcial{{$row->id}}" min="1" @if($depClave == "MAT") max="3" @endif @if($depClave == "PRE") max="4" @endif
                                                            <?= ($trimestre_edicion == 'NO') ? 'readonly onfocus="this.blur()"' : '' ?>
                                                            @if ( ($trimestre_edicion == 'SI') )
                                                            @if($depClave == "MAT") value="3" @endif @if($depClave == "PRE") value="4" @endif required
                                                            @else
                ...
                <div class="card-action">
                    ...
                    @endif
                    <a href="{{url('preescolarinscritos/'.$grupo_id.'/'.$materia_id.'/'.$peraniopago)}}" class="btn-guardar btn-large">Regresar al listado de alumnos</a>
                </div>
