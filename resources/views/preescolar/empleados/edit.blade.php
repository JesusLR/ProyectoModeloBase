...
@section('breadcrumbs')
    ...
    <a href="{{url('preescolar_empleado/'.$empleado->id.'/edit')}}" class="breadcrumb">Editar empleado</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {{ Form::open(array('method'=>'PUT','route' => ['preescolar_empleado.update', $empleado->id])) }}
      <div class="card ">
        <div class="card-content ">
          ...
          <div id="general">
              ...
              <div class="row">
                  ...
                  <div class="col s12 m6 l4">
                      <div class="input-field">
                      {!! Form::number('empHorasCon', $empleado->empHorasCon, array('id' => 'empHorasCon', 'class' => 'validate','required','min'=>'0','max'=>'99999999999','onKeyPress="if(this.value.length==11) return false;"')) !!}
              ...
              <div class="row">
                  ...
                  <div class="col s12 m6 l4">
                    ...
                    <select id="empEstado" name="empEstado" class="browser-default validate select2" required style="width:100%;">
                      ...
                      @if($puedeDarseDeBaja)
                        <option value="B" {{$empleado->empEstado == "B" ? 'selected' : ''}}>BAJA</option>
                      @endif
                    </select>
                  </div>
              </div>
                  ...
                  <div class="col s12 m6 l4">
                      ...
                      <select id="paisId" class="browser-default validate select2" required name="paisId" style="width: 100%;">
                          ...
                          @foreach($paises as $pais)
                              <option value="{{$pais->id}}" @if($empleado->persona->municipio->estado->pais->id == $pais->id) {{ 'selected' }} @endif>{{$pais->paisNombre}}</option>
                          @endforeach
                      </select>
                  </div>
                  <div class="col s12 m6 l4">
                      ...
                      <select id="estado_id" class="browser-default validate select2" required name="estado_id" style="width: 100%;">
                          ...
                          @foreach($estados as $estado)
                              <option value="{{$estado->id}}" @if($empleado->persona->municipio->estado->id == $estado->id) {{ 'selected' }} @endif>{{$estado->edoNombre}}</option>
                          @endforeach
                      </select>
                  </div>
                  <div class="col s12 m6 l4">
                      ...
                      <select id="municipio_id" class="browser-default validate select2" required name="municipio_id" style="width: 100%;">
                          ...
                          @foreach($municipios as $municipio)
                              <option value="{{$municipio->id}}" @if($empleado->persona->municipio->id == $municipio->id) {{ 'selected' }} @endif>{{$municipio->munNombre}}</option>
                          @endforeach
                      </select>
                  </div>
              </div>
