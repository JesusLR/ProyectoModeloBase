...
@section('breadcrumbs')
    ...
    <a href="{{url('preescolar_cambiar_contrasenia/'.$docente->id.'/edit')}}" class="breadcrumb">Editar Contraseña</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
        {{ Form::open(array('method'=>'PUT','route' => ['preescolar.preescolar_cambiar_contrasenia.update', $docente->id])) }}
        <div class="card ">
