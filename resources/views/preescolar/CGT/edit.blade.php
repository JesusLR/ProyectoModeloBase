...
@section('breadcrumbs')
    ...
    <a href="{{url('preescolar_cgt/'.$cgt->id.'/edit')}}" class="breadcrumb">Editar cgt</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
        {{ Form::open(array('method'=>'PUT','route' => ['preescolar.preescolar_cgt.update', $cgt->id])) }}
        <div class="card ">
...
<script>
 // OBTENER MATERIA SEMESTRE Y SEMESTRE CGT
    $("#plan_id").change( event => {
        ...
        $.get(base_url + `/preescolar_plan/plan/semestre/${event.target.value}`, function(res,sta) {
            //seleccionar el post preservado
