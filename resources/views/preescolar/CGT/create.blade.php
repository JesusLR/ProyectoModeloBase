...
@section('breadcrumbs')
    ...
    <a href="{{url('preescolar_cgt')}}" class="breadcrumb">Lista de Cgt</a>
    <a href="{{url('preescolar_cgt/create')}}" class="breadcrumb">Agregar Cgt</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'preescolar.preescolar_cgt.store', 'method' => 'POST']) !!}
...
@include('preescolar.curso_preinscrito.funcionesJSBoletaCalificaciones')
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#btn-guardar').on('click', function() {
            crear_cgt_preescolar();
        });


    });

    function crear_cgt_preescolar() {
        ...
        $.ajax({
            type: 'POST',
            url: '{{route('preescolar.preescolar_cgt.store')}}',
            dataType: 'json',
            data: $('form').serialize(),
