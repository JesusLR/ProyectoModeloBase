...
@section('breadcrumbs')
    ...
    <a href="{{url('preescolar_periodo')}}" class="breadcrumb">Lista de periodos</a>
...
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'preescolar.preescolar_periodo.store', 'method' => 'POST']) !!}
            <div class="card ">
