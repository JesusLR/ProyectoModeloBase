...
@section('breadcrumbs')
    ...
    <a href="{{route('preescolar_alumnos.index')}}" class="breadcrumb">Lista de alumnos</a>
    <a href="{{route('preescolar.preescolar_nuevo_externo.create')}}" class="breadcrumb">Agregar alumno</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'preescolar.preescolar_nuevo_externo.store', 'method' => 'POST']) !!}
        ...
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">AGREGAR ALUMNO: MATERNAL | PREESCOLAR</span>
            ...
            {{-- TUTORES --}}            
            @include('preescolar.alumnos.tutores')
...
@include('preescolar.curso_preinscrito.funcionesAuxiliares')
        ...
        */
        $(document).ready(function(){
            ...
            $('#crearTutor').on('click', function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: base_url + '/preescolar_alumnos/tutores/nuevo_tutor',
        ...
        function verificarPersona() {
            ...
            $.ajax({
                type:'GET',
                url: base_url + '/preescolar_alumnos/verificar_persona',
                data: $('form').serialize(),
                dataType: 'json',
                success: function(data) {
        ...
        function rehabilitarAlumno(alumno_id) {
            $.ajax({
                type:'POST',
                url: base_url+'/preescolar_alumnos/rehabilitar_alumno/'+alumno_id,
                data:{alumno_id: alumno_id, '_token':'{{csrf_token()}}'},
                dataType:'json',
                success: function(alumno) {
                    window.location = base_url+'/preescolar_alumnos/'+alumno.id+'/edit';
                },
                error: function(jqXhr, textStatus, errorMessage) {
                    console.log(errorMessage);
                }
        ...
        function empleado_crearAlumno(empleado_id) {
            ...
            $.ajax({
                type:'POST',
                url: base_url+'/preescolar_alumnos/registrar_empleado/'+empleado_id,
                data: $('form').serialize(),
                dataType:'json',
                success: function (alumno) {
                    window.location = base_url+'/preescolar_alumnos/'+alumno.id+'/edit';
