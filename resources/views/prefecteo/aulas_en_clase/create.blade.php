...
@section('breadcrumbs')
    ...
    <a href="" class="breadcrumb">Aulas en clase</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'aulas_en_clase/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">AULAS EN CLASE</span>
                ...
                <div class="row">
                    <div class="col s12 m4 14" style="margin-top:10px;">
                      ...
                      <div class="input-field col s12 m6 14">
                        <select name="filtroHoraInicio" id="filtroHoraInicio" class="browser-default validate select2" style="width: 100%;" required>
                      ...
                      <div class="input-field col s12 m6 14">
                          {!! Form::label('filtroHoraFinal', 'Hora Final', ['class' => '']); !!}
                        <select name="filtroHoraFinal" id="filtroHoraFinal" class="browser-default validate select2" style="width: 100%;" required>
                          <option value="">Seleccionar hora</option>
                        </select>
                      </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#filtroHoraInicio').on('change',function(){
        ...
        if(hora1){
          ...
          $('#filtroHoraFinal').empty();
          horas2.forEach(function(key,value){
            $('#filtroHoraFinal').append('<option value="'+ value +'">'+ key +'</option>');
          });
        }else{
          $('#filtroHoraFinal').empty();
        }
