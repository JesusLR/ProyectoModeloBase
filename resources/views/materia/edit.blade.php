...
<div class="row">
    <div class="col s12 ">
        {{ Form::open(array('method'=>'PUT','route' => ['materia.update', $materia->id])) }}
        <div class="card ">
          <div class="card-content ">
            ...
            <div id="general">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l4">
                        <div class="input-field">
                            {!! Form::text('matNombreOficial', $materia->matNombreOficial, array('id' => 'matNombreOficial', 'class' => 'validate', 'required', 'maxlength'=>'255')) !!}
                            {!! Form::label('matNombreOficial', 'Nombre oficial*', array('class' => '')); !!}
                        </div>
                    </div>
                    <div class="col s12 m6 l4">
                        <div class="input-field">
                            {!! Form::text('matClaveEquivalente', $materia->matClaveEquivalente, array('id' => 'matClaveEquivalente', 'class' => 'validate', 'maxlength'=>'255')) !!}
                            {!! Form::label('matClaveEquivalente', 'Clave SIIES', array('class' => '')); !!}
                        </div>
                    </div>
                    {{-- <div class="col s12 m6 l4">
                        <div class="input-field">
                            {!! Form::text('matNombre', $materia->matNombre, array('id' => 'matNombre', 'class' => 'validate', 'required', 'maxlength'=>'255')) !!}
                    ...
                    {{-- <div class="col s12 m6 l4">
                        <div class="input-field">
                            ...
                            {!! Form::label('matNombreCorto', 'Nombre corto * (15 caracteres)', array('class' => '')); !!}
                        </div>
                    </div> --}}
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col s12 m6 l4">
                        <div class="input-field">
                            {!! Form::number('matPorcentajeParcial', $materia->matPorcentajeParcial, array('id' => 'matPorcentajeParcial', 'class' => 'validate','min'=>'0','max'=>'100','onKeyPress="if(this.value.length==3) return false;"')) !!}
                            {!! Form::label('matPorcentajeParcial', '% Examen parcial', array('class' => '')); !!}
                        </div>
                    </div>
                    <div class="col s12 m6 l4">
                        <div class="input-field">
                            {!! Form::number('matPorcentajeOrdinario', $materia->matPorcentajeOrdinario, array('id' => 'matPorcentajeOrdinario', 'class' => 'validate','min'=>'0','max'=>'100','onKeyPress="if(this.value.length==3) return false;"')) !!}
