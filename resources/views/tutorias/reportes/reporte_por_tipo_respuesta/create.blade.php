...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Reporte por Tipo de Respuesta</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'reporte/tutorias/reporte_por_tipo_respuesta/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Reporte por Tipo de Respuesta</span>
          {{-- NAVIGATION BAR--}}
          ...
          <div id="filtros">
              ...
              <div class="row">
                ...
                <div class="col s12 m6 l4">
                  ...
                  <select class="browser-default validate select2" name="FormularioID" id="FormularioID" data-formulario-id="{{old('FormularioID')}}" style="width:100%;">
                    <option value="">SELECCIONE UNA OPCIÓN</option>
              ...
              <div class="row">
                ...
                <div class="col s12 m6 l4">
                  <label for="RespuestaID">Respuesta</label>
                  <select class="browser-default validate select2" name="RespuestaID" id="RespuestaID" data-respuesta-id="{{old('RespuestaID')}}" style="width:100%;">
                    <option value="">SELECCIONE UNA OPCIÓN</option>
                  </select>
                </div>
                <div class="col s12 m6 l4">
                  <label for="Semaforizacion">Semaforización</label>
                  <select class="browser-default validate select2" name="Semaforizacion" id="Semaforizacion" data-semaforizacion="{{old('Semaforizacion')}}" style="width:100%;">
                    <option value="">SELECCIONE UNA OPCIÓN</option>
