...
<a href="{{url('tutorias_rol/create')}}" class="breadcrumb">Agregar rol</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'tutorias_rol.store', 'method' => 'POST']) !!}
                    ...
                    <div class="row">
                        <div class="col s12 m6 l4">
                            <div class="input-field">
                                {!! Form::text('Nombre', NULL, array('id' => 'Nombre', 'class' => 'validate','required','maxlength'=>'100')) !!}                            
                        ...
                        <div class="col s12 m6 l4">
                            <div class="input-field">
                                {!! Form::text('Descripcion', NULL, array('id' => 'Descripcion', 'class' => 'validate','required','maxlength'=>'100')) !!}                            
                        ...
                        <div class="col s12 m6 l4">
                            <div class="input-field">
                                {!! Form::text('Clave', NULL, array('id' => 'Clave', 'class' => 'validate','required','maxlength'=>'100')) !!}                            
