            ...
            <div class="card-content ">
                ...
                <div id="general">           
                    ...
                    <div class="row">
                        <div class="col s12 m6 l4">
                            <div class="input-field">
                                {!! Form::text('Nombre', NULL, array('id' => 'Nombre', 'class' => 'validate','required','maxlength'=>'100', 'value' => 'old("Nombre")')) !!}                            
                        ...
                        <div class="col s12 m6 l4">
                            <div class="input-field">
                                {!! Form::text('ApellidoPaterno', NULL, array('id' => 'ApellidoPaterno', 'class' => 'validate','required','maxlength'=>'100')) !!}                            
                        ...
                        <div class="col s12 m6 l4">
                            <div class="input-field">
                                {!! Form::text('ApellidoMaterno', NULL, array('id' => 'ApellidoMaterno', 'class' => 'validate','required','maxlength'=>'100')) !!}                            
                    ...
                    <div class="row">
                        <div class="col s12 m6 l4">
                            <div class="input-field">
                                {!! Form::text('Correo', NULL, array('id' => 'Correo', 'class' => 'validate','maxlength'=>'100')) !!}                            
                        ...
                        <div class="col s12 m6 l4">
                            <div class="input-field">
                                {!! Form::text('NombreUsuario', NULL, array('id' => 'NombreUsuario', 'class' => 'validate','maxlength'=>'100')) !!}                            
                        ...
                        <div class="col s12 m6 l4">
                            <div class="input-field">
                                {!! Form::password('Contrasena', NULL, array('id' => 'Contrasena', 'class' => 'validate','required','maxlength'=>'100')) !!}                            
                    ...
                    <div class="row">
                        <div class="col s12 m6 l4">
                            <div class="input-field">
                                {!! Form::password('ContrasenaDes', NULL, array('id' => 'ContrasenaDes', 'class' => 'validate','required','maxlength'=>'100')) !!}                            
                                {!! Form::label('ContrasenaDes', 'Confirmar contraseña *', array('class' => '')); !!}
                            </div>
                        </div>
                        <div class="col s12 m6 l4">
                            {!! Form::label('RolID', 'Rol *', array('class' => '')); !!}
                            <select id="RolID" class="browser-default validate select2" required name="RolID" style="width: 100%;">
                                <option value="" selected disabled>SELECCIONE UNA OPCIÓN</option>
                                @foreach ($rol as $itemRol)
                                    <option value="{{$itemRol->RolID}}">{{$itemRol->Nombre}}</option>                                   
                                @endforeach
                            </select>
                        </div>
                    </div>
