            ...
            <div id="general">
                ...
                <div class="row">
                    <div class="col s12 m6 l4">
                        ...
                        <input type="date" name="proximaEntrevistaFecha" id="proximaEntrevistaFecha" @if ($primaria_expediente_seguimiento_escolar->proximaEntrevista != "") value="{{\Carbon\Carbon::parse($primaria_expediente_seguimiento_escolar->proximaEntrevista)->format('Y-m-d')}}" @else value="" @endif>
                        {{--  {!! Form::date('proximaEntrevistaFecha', @if ($primaria_expediente_seguimiento_escolar->proximaEntrevista != "") , array('id' => 'proximaEntrevistaFecha', 'class' => '','maxlength'=>'255')) !!}  --}}
                    </div>

                    <div class="col s12 m6 l4">
                        {!! Form::label('proximaEntrevistaHora', 'Hora de próxima entrevista', array('class' => '')); !!}
                        <input type="time" name="proximaEntrevistaHora" id="proximaEntrevistaHora" @if ($primaria_expediente_seguimiento_escolar->proximaEntrevista != "") value="{{\Carbon\Carbon::parse($primaria_expediente_seguimiento_escolar->proximaEntrevista)->format('h:i')}}" @else value="" @endif>
