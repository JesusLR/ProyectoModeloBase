...
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['enctype' => 'multipart/form-data', 'onKeypress' => 'return disableEnterKey(event)','route' =>
        'primaria_calificacion.guardarCalificacion', 'method' => 'POST']) !!}
        <div class="card ">
