...
@section('breadcrumbs')
    ...
    <a href="{{url('primaria_inscritos/'.$grupo_id)}}" class="breadcrumb">Alumnos</a>
            ...
            {!! Form::open(['route' => 'preescolarcalificaciones.store', 'method' => 'POST', 'id' => 'form-guardar']) !!}
                ...
                <div class="card ">
                    ...
                    <div class="card-action">
                        ...
                        @endif
                            <a href="{{ url('primaria_inscritos/'.$grupo->id) }}" class="btn-guardar btn-large">Regresar al listado de alumnos</a>
                    </div>
