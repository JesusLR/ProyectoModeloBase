  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#primaria_grupo_evidencia_id").change( event => {
            ...
            $.get(base_url+`/api/primaria_calificacion/obtenerDatosEvidencia/${event.target.value}`,function(res,sta){
                res.forEach(element => {
                    $("#numero_evaluacion").append(`<option value="${element.numero_evaluacion}">${element.numero_evaluacion}</option>`);
