                        ...
                        const tableData = data.map(function(element){
                            ...
                            return (
                                `<tr>
                                    ...
                                    <td><input id='evidencia1' name='evidencia1[]' step="0.01" type='number' min="5" max="10" class='calif evidencia_${element.alumno_id}' data-inscritoid='${element.id}'></td>
                                    <td><input id='evidencia2' name='evidencia2[]' step="0.01" type='number' min="5" max="10" class='calif evidencia_${element.alumno_id}' data-inscritoid='${element.id}'></td>
                                    <td><input id='evidencia3' name='evidencia3[]' step="0.01" type='number' min="5" max="10" class='calif evidencia_${element.alumno_id}' data-inscritoid='${element.id}'></td>
                                    <td><input id='evidencia4' name='evidencia4[]' step="0.01" type='number' min="5" max="10" class='calif evidencia_${element.alumno_id}' data-inscritoid='${element.id}'></td>
                                    <td><input id='evidencia5' name='evidencia5[]' step="0.01" type='number' min="5" max="10" class='calif evidencia_${element.alumno_id}' data-inscritoid='${element.id}'></td>
                                    <td><input id='evidencia6' name='evidencia6[]' step="0.01" type='number' min="5" max="10" class='calif evidencia_${element.alumno_id}' data-inscritoid='${element.id}'></td>
                                    <td><input id='evidencia7' name='evidencia7[]' step="0.01" type='number' min="5" max="10" class='calif evidencia_${element.alumno_id}' data-inscritoid='${element.id}'></td>
                                    <td><input id='evidencia8' name='evidencia8[]' step="0.01" type='number' min="5" max="10" class='calif evidencia_${element.alumno_id}' data-inscritoid='${element.id}'></td>
                                    <td><input id='evidencia9' name='evidencia9[]' step="0.01" type='number' min="5" max="10" class='calif evidencia_${element.alumno_id}' data-inscritoid='${element.id}'></td>
                                    <td><input id='evidencia10' name='evidencia10[]' step="0.01" type='number' min="5" max="10" class='calif evidencia_${element.alumno_id}' data-inscritoid='${element.id}'></td>
                                    <td><input onmouseover="this.value = parseFloat(this.value).toFixed(1)" readonly='true' id='promedioTotal${element.alumno_id}' name='promedioTotal[]' step="0.01" type='number' min="5" max="10"></td>
                                </tr>`
                            );
        ...
        function obtenerMesEvaluacion(mes_id) {
            ...
            $.get(base_url+`/primaria_grupo/getMesEvidencias/${mes_id}`, function(res,sta) {
                ...
                if(res != ""){
                    ...
                    $("#primaria_grupo_evidencia_id").append(`<option value="" selected disabled>NO HAY EVIDICENCIAS PARA ESTE GRUPO</option>`);
