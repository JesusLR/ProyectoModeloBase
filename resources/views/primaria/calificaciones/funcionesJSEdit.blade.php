                    ...
                    const tableData = data.map(function(element, index, arrayobj) {
                            ...
                            return (
                                `<tr>
                                    ...
                                    <td><input tabindex="2" type='number' id='evidencia2' onblur="if(this.value>10){this.value='';}else if(this.value<5){this.value='';}" value='${element.calificacion_evidencia2}' name='evidencia2[]' step="0.1" lang="en"  min="5" max="10" class='calif evidencia_${element.primaria_inscrito_id} noUpperCase' data-inscritoid='${element.primaria_inscrito_id}'></td>
                                    <td><input tabindex="3" type='number' id='evidencia3' onblur="if(this.value>10){this.value='';}else if(this.value<5){this.value='';}" value='${element.calificacion_evidencia3}' name='evidencia3[]' step="0.1" lang="en"  min="5" max="10" class='calif evidencia_${element.primaria_inscrito_id} noUpperCase' data-inscritoid='${element.primaria_inscrito_id}'></td>
                                    <td><input tabindex="4" type='number' id='evidencia4' onblur="if(this.value>10){this.value='';}else if(this.value<5){this.value='';}" value='${element.calificacion_evidencia4}' name='evidencia4[]' step="0.1" lang="en" min="5" max="10" class='calif evidencia_${element.primaria_inscrito_id} noUpperCase' data-inscritoid='${element.primaria_inscrito_id}'></td>
                                    <td><input tabindex="5" type='number' id='evidencia5' onblur="if(this.value>10){this.value='';}else if(this.value<5){this.value='';}" value='${element.calificacion_evidencia5}' name='evidencia5[]' step="0.1" lang="en"  min="5" max="10" class='calif evidencia_${element.primaria_inscrito_id} noUpperCase' data-inscritoid='${element.primaria_inscrito_id}'></td>
                                    <td><input tabindex="6" type='number' id='evidencia6' onblur="if(this.value>10){this.value='';}else if(this.value<5){this.value='';}" value='${element.calificacion_evidencia6}' name='evidencia6[]' step="0.1" lang="en"  min="5" max="10" class='calif evidencia_${element.primaria_inscrito_id} noUpperCase' data-inscritoid='${element.primaria_inscrito_id}'></td>
                                    <td><input tabindex="7" type='number' id='evidencia7' onblur="if(this.value>10){this.value='';}else if(this.value<5){this.value='';}" value='${element.calificacion_evidencia7}' name='evidencia7[]' step="0.1" lang="en"  min="5" max="10" class='calif evidencia_${element.primaria_inscrito_id} noUpperCase' data-inscritoid='${element.primaria_inscrito_id}'></td>
                                    <td><input tabindex="8" type='number' id='evidencia8' onblur="if(this.value>10){this.value='';}else if(this.value<5){this.value='';}" value='${element.calificacion_evidencia8}' name='evidencia8[]' step="0.1" lang="en"  min="5" max="10" class='calif evidencia_${element.primaria_inscrito_id} noUpperCase' data-inscritoid='${element.primaria_inscrito_id}'></td>
                                    <td><input tabindex="9" type='number' id='evidencia9' onblur="if(this.value>10){this.value='';}else if(this.value<5){this.value='';}" value='${element.calificacion_evidencia9}' name='evidencia9[]' step="0.1" lang="en"  min="5" max="10" class='calif evidencia_${element.primaria_inscrito_id} noUpperCase' data-inscritoid='${element.primaria_inscrito_id}'></td>
                                    <td><input tabindex="10" type='number' id='evidencia10' onblur="if(this.value>10){this.value='';}else if(this.value<5){this.value='';}" value='${element.calificacion_evidencia10}' name='evidencia10[]' step="0.1" lang="en" min="5" max="10" class='calif evidencia_${element.primaria_inscrito_id} noUpperCase' data-inscritoid='${element.primaria_inscrito_id}'></td>
