        ...
        function obtenerMesEvaluacion(mes_id) {
            ...
            $.get(base_url+`/primaria_grupo/getMesEvidencias/${mes_id}`, function(res,sta) {
                ...
                if(res != ""){
                    ...
                    $("#primaria_grupo_evidencia_id").append(`<option value="" selected disabled>NO HAY MES EVIDENCIA PARA ESTE GRUPO</option>`);
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        function obtenerAlumnos(alumnoId, grupoId) {
            ...
            /*
            $.get(base_url + `/api/newCalificacionesAlumnos/${alumnoId}/${grupoId}`, function(res, sta) {
            });
            */
            ...
            $.get(base_url + `/api/getCalificacionesAlumnos/${alumnoId}/${grupoId}`, function(res, sta) {
                ...
                if(calificaciones != ""){
                    ...
                    const tableData = data.map(function(element){
                            ...
                            return (
                                `<tr>
                                    ...
                                    <td><input type='number' id='evidencia1' onblur="if(this.value>10){this.value='';}else if(this.value<5){this.value='';}" value='${element.calificacion_evidencia1}' name='evidencia1[]' step="0.1" lang="en"  min="5" max="10" class='calif evidencia_${element.primaria_inscrito_id} noUpperCase' data-inscritoid='${element.primaria_inscrito_id}'></td>
                    ...
                    var data_create = res.alumnos_create;
                    ...
                    if(data_create != ""){
                        ...
                        $("#Tabla").show();
                        $(".btn-guardar").text("GUARDAR")
                        const data_create = res.alumnos_create;
                        const tableData = data_create.map(function(element){
                            ...
                            return (
                                `<tr>
                                    <td style="display:none"><input name='id[]' type='text' value='${element.id}'></td>
                                    <td style="display:none"><input name='primaria_inscrito_id[]' type='text' value='${element.id}'></td>
                                    <td>${element.perApellido1} ${element.perApellido2} ${element.perNombre}</td>
                                    <td><input type="number" onblur="if(this.value>10){this.value='5';}else if(this.value<5){this.value='5';}" id='evidencia1' name='evidencia1[]' step="0.01"  lang="en" min="5" max="10" class='calif evidencia_${element.alumno_id} noUpperCase' data-inscritoid='${element.id}'></td>
                                    <td><input type="number" onblur="if(this.value>10){this.value='5';}else if(this.value<5){this.value='5';}" id='evidencia2' name='evidencia2[]' step="0.01" lang="en" min="5" max="10" class='calif evidencia_${element.alumno_id} noUpperCase' data-inscritoid='${element.id}'></td>
                                    <td><input type="number" onblur="if(this.value>10){this.value='5';}else if(this.value<5){this.value='5';}" id='evidencia3' name='evidencia3[]' step="0.01" lang="en" min="5" max="10" class='calif evidencia_${element.alumno_id} noUpperCase' data-inscritoid='${element.id}'></td>
                                    <td><input type="number" onblur="if(this.value>10){this.value='5';}else if(this.value<5){this.value='5';}" id='evidencia4' name='evidencia4[]' step="0.01" lang="en" min="5" max="10" class='calif evidencia_${element.alumno_id} noUpperCase' data-inscritoid='${element.id}'></td>
                                    <td><input type="number" onblur="if(this.value>10){this.value='5';}else if(this.value<5){this.value='5';}" id='evidencia5' name='evidencia5[]' step="0.01" lang="en" min="5" max="10" class='calif evidencia_${element.alumno_id} noUpperCase' data-inscritoid='${element.id}'></td>
                                    <td><input type="number" onblur="if(this.value>10){this.value='5';}else if(this.value<5){this.value='5';}" id='evidencia6' name='evidencia6[]' step="0.01" lang="en" min="5" max="10" class='calif evidencia_${element.alumno_id} noUpperCase' data-inscritoid='${element.id}'></td>
                                    <td><input type="number" onblur="if(this.value>10){this.value='5';}else if(this.value<5){this.value='5';}" id='evidencia7' name='evidencia7[]' step="0.01" lang="en" min="5" max="10" class='calif evidencia_${element.alumno_id} noUpperCase' data-inscritoid='${element.id}'></td>
                                    <td><input type="number" onblur="if(this.value>10){this.value='5';}else if(this.value<5){this.value='5';}" id='evidencia8' name='evidencia8[]' step="0.01" lang="en" min="5" max="10" class='calif evidencia_${element.alumno_id} noUpperCase' data-inscritoid='${element.id}'></td>
                                    <td><input type="number" onblur="if(this.value>10){this.value='5';}else if(this.value<5){this.value='5';}" id='evidencia9' name='evidencia9[]' step="0.01" lang="en" min="5" max="10" class='calif evidencia_${element.alumno_id} noUpperCase' data-inscritoid='${element.id}'></td>
                                    <td><input type="number" onblur="if(this.value>10){this.value='5';}else if(this.value<5){this.value='5';}" id='evidencia10' name='evidencia10[]' step="0.01" lang="en" min="5" max="10" class='calif evidencia_${element.alumno_id} noUpperCase' data-inscritoid='${element.id}'></td>
                                    <td><input type='number' onmouseover="this.value = parseFloat(this.value).toFixed(1)" readonly='true' id='promedioTotal${element.alumno_id}' name='promedioTotal[]' lang="en"  step="0.01" min="5" max="10"></td>
                                    <td style="display:none"><input name='tipoDeAccion' type='text' value='GUARDAR'></td>
