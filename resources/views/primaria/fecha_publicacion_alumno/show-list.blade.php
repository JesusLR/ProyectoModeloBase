...
<div id="table-datatables">
    ...
    <a href="{{ route('primaria.primaria_fecha_publicacion_calificacion_alumno.create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#tbl-fecha-publicacion-calif').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/primaria_fecha_publicacion_calificacion_alumno/list",
                beforeSend: function () {
