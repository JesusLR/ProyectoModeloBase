...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $.get(base_url+`/primaria_api/departamentos/${ubicacion_id}`,function(res,sta){
            var perActual;
            res.forEach(element => {
                var selected = "";
            ...
            $.get(base_url+`/primaria_periodo/api/periodos/${departamento_id}`,function(res2,sta){
            ...
            $.get(base_url+`/api/escuelas/${departamento_id}`,function(res,sta){
                ...
                $.get(base_url+`/api/primaria_programa/${escuela_id}`,function(res,sta){
                    res.forEach(element => {
                    ...
                    if(programa_id != "" && programa_id != null){
                        ...
                        $.get(base_url+`/primaria_plan/api/planes/${programa_id}`,function(res2,sta){
                            res2.forEach(element => {
                                ...
                                if(periodo_id != "" && periodo_id != null){
                                    ...
                                    $.get(base_url+`/primaria_cgt/api/cgts/${plan_id}/${periodo_id}`,function(res3,sta){
                            ...
                            if(plan_id != "" && plan_id != null){
                                ...
                                $.get(base_url+`/primaria_plan/plan/semestre/${plan_id}`,function(res,sta){
                                ...
                                if(cgt_id != "" && cgt_id != null){
                                    ...
                                    $.get(base_url+`/primaria_grupo/materias/${cgt_id}`,function(res4,sta){
