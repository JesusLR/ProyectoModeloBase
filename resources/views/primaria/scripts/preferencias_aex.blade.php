...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $.get(base_url+`/primaria_actividades_inscritos/api/departamentos/${ubicacion_id}`,function(res,sta){
            var perActual;
            res.forEach(element => {
                var selected = "";
            ...
            $.get(base_url+`/primaria_actividades_inscritos/api/periodos/${departamento_id}`,function(res2,sta){
                var perSeleccionado;
