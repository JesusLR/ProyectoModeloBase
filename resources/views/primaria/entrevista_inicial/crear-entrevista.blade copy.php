          ...
          <div class="card-content ">
            ...
            <div id="general">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l8">
                        <div class="input-field">
                            {!! Form::text('obsTratamientoMedico', NULL, array('id' => 'obsTratamientoMedico', 'class' => 'validate', 'maxlength'=>'255', 'disabled')) !!}
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l9">
                        <div class="input-field">
                            {!! Form::text('obsHemofilia', NULL, array('id' => 'obsHemofilia', 'class' => 'validate', 'maxlength'=>'255', 'disabled')) !!}
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l9">
                        <div class="input-field">
                            {!! Form::text('obsEpilepsia', NULL, array('id' => 'obsEpilepsia', 'class' => 'validate', 'maxlength'=>'255', 'disabled')) !!}
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l9">
                        <div class="input-field">
                            {!! Form::text('obsKawasaqui', NULL, array('id' => 'obsKawasaqui', 'class' => 'validate', 'maxlength'=>'255', 'disabled')) !!}
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l9">
                        <div class="input-field">
                            {!! Form::text('obsAsma', NULL, array('id' => 'obsAsma', 'class' => 'validate', 'maxlength'=>'255', 'disabled')) !!}
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l9">
                        <div class="input-field">
                            {!! Form::text('obsDiabetes', NULL, array('id' => 'obsDiabetes', 'class' => 'validate', 'maxlength'=>'255', 'disabled')) !!}
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l9">
                        <div class="input-field">
                            {!! Form::text('obsCardiaco', NULL, array('id' => 'obsCardiaco', 'class' => 'validate', 'maxlength'=>'255', 'disabled')) !!}
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l9">
                        <div class="input-field">
                            {!! Form::text('obsDermatologico', NULL, array('id' => 'obsDermatologico', 'class' => 'validate', 'maxlength'=>'255', 'disabled')) !!}
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l9">
                        <div class="input-field">
                            {!! Form::text('tipoAlergias', NULL, array('id' => 'tipoAlergias', 'class' => 'validate', 'maxlength'=>'255', 'disabled')) !!}
