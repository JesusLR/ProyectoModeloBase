...
<div id="table-datatables">
    <br>
    <a id="listaAsistencia" class="btn-large waves-effect darken-3" target="_blank"  href="{{url('primaria_inscritos/lista_de_asistencia/grupo/'.$grupo->id)}}">Lista asistencia
        <i class="material-icons left">picture_as_pdf</i>
    </a>
    <a href="{{route('primaria_asignar_grupo.create')}}" class="btn-large waves-effect darken-3" type="button">Inscribir
        ...
        <p style="font-size: 17px;"><strong>Asignatura: </strong> {{$grupo->matClaveAsignatura}}-{{$grupo->matNombreAsignatura}}</p>
        @endif
    ...
    <div class="row">
        <div class="col s12">
            <table id="tbl-grupo-inscritos-primaria" class="responsive-table display" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th>Clave Alumno</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#tbl-grupo-inscritos-primaria').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/primaria_inscritos/list/" + {!! json_encode($grupo->id)!!},
                beforeSend: function () {
            ...
            "columns":[
                ...
                {data: "modalidad_asistencia"},
                {data: "docente_asignado"},
                {data: "action"}
            ],
            //Apply the search
...
<script type="text/javascript">
$(document).ready(function() {
    var json =  base_url+"/primaria_inscritos/list/" + {!! json_encode($grupo->id)!!}
        $.ajax({
            type: "GET",
            url: json,
