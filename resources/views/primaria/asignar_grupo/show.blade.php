          ...
          <div class="card-content ">
            ...
            <div id="general">
                ...
                <div class="row">
                    <div class="col s12 ">
                        <div class="input-field">
                            {!! Form::text('grupo_id', $inscrito->primaria_grupo->gpoGrado.'-'.$inscrito->primaria_grupo->gpoClave.'-'.$inscrito->primaria_grupo->gpoTurno.' '.$inscrito->primaria_grupo->gpoMatComplementaria.', '.$inscrito->primaria_grupo->primaria_materia->matNombre, array('readonly' => 'true')) !!}
