                    ...
                    <div class="col s12 ">
                        ...
                        <select id="grupo_id" class="browser-default validate select2" required name="grupo_id" style="width: 100%;">
                            ...
                            @foreach($grupos as $grupo)
                                <option value="{{$grupo->id}}" @if($inscrito->primaria_grupo_id == $grupo->id) {{ 'selected' }} @endif>{{"Grupo: ".$grupo->gpoGrado.'-'.$grupo->gpoClave.'-'.$grupo->gpoTurno.' '.$grupo->gpoMatComplementaria.' '."Materia: ".$grupo->primaria_materia->matClave.'-'.$grupo->primaria_materia->matNombre.' '."Maestro: ".$grupo->primaria_empleado->empNombre.' '.$grupo->primaria_empleado->empApellido1.' '.$grupo->primaria_empleado->empApellido2}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
