...
<div id="table-datatables">
    <h4 class="header">ALUMNOS INSCRITOS A GRUPOS MATERIAS / ASIGNATURAS</h4>
    {{-- @php use App\Models\User; @endphp
        @if (User::permiso("inscrito") != "D" && User::permiso("inscrito") != "P") --}}
        <a href="{{ route('primaria_asignar_grupo.create') }}" class="btn-large waves-effect darken-3" type="button"> Inscribir a Grupo Materia / Asignatura
