...
@section('template_title')
    Primaria inscritos a grupos materias
@endsection
...
@section('breadcrumbs')
    ...
    <a href="{{route('primaria_asignar_grupo.index')}}" class="breadcrumb">Lista de inscritos a grupos materias</a>
    <a href="{{route('primaria_asignar_grupo.create')}}" class="breadcrumb">Agregar inscritos a grupos materias</a>
@endsection
      ...
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'primaria_asignar_grupo.store', 'method' => 'POST']) !!}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">INSCRIBIR ALUMNOS INSCRITOS A GRUPOS MATERIAS / ASIGNATURAS</span>
