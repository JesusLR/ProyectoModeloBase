...
@section('breadcrumbs')
    ...
    {{-- <a href="{{route('primaria.primaria_cambiar_cgt.edit')}}" class="breadcrumb">Cambiar CGT</a> --}}
    <a href="{{route('primaria.primaria_cambiar_cgt.edit')}}" class="breadcrumb">Cambiar CGT - Grupo </a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'primaria.primaria_cambiar_cgt.update', 'method' => 'POST']) !!}
        <div class="card ">
...
@include('primaria.cambiar_cgt.crearTablaJs')
