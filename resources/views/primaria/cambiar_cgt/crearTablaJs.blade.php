<script type="text/javascript">
    $(document).ready(function() {
        ...
        function obtenerAlumnos(periodo_id, programa_id,plan_id, cgt_id) {
            ...
            $.get(base_url+`/primaria_cambiar_cgt/getAlumnosGrado/${periodo_id}/${programa_id}/${plan_id}/${cgt_id}`, function(res,sta) {
                $.get(base_url+`/primaria_cambiar_cgt/getGradoGrupo/${periodo_id}/${programa_id}/${plan_id}/${cgt_id}`, function(grupos,sta) {
