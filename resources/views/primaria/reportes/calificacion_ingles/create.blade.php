          ...
          <div id="filtros">
            ...
            <div class="row">
              ...
              <div class="col s12 m6 l4">
                  ...
                  <select name="plan_id" id="plan_id" data-plan_id-id="{{old('plan_id')}}" class="browser-default validate select2" style="width:100%;" required>
                      <option value="">SELECCIONE UNA OPCIÓN</option>
                  </select>
              </div>
              <div class="col s12 m6 l4">
            ...
            <div class="row">
              ...
              <div class="col s12 m6 l4">
                ...
                <select required name="conceptos" id="conceptos" data-conceptos-id="{{old('conceptos')}}" class="browser-default validate select2" style="width:100%;">
                    <option value="">SELECCIONE UNA OPCIÓN</option>
                    <option value="TODOS" {{ old('conceptos') == 'TODOS' ? 'selected' : '' }}>TODOS</option>
