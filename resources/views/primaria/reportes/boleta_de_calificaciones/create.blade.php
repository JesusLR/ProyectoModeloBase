...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'route' => 'primaria_boleta_de_calificaciones.imprimir.boletadesdecurso', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Boleta de calificaciones</span>
          {{-- NAVIGATION BAR--}}
