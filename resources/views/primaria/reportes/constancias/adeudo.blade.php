...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Constancia de no adeudo</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'route' => 'primaria_reporte.no_adeudo.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">CONTANCIA DE NO ADEUDO</span>
          {{-- NAVIGATION BAR--}}
