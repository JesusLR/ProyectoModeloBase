...
@section('breadcrumbs')
  ...
  <a href="" class="breadcrumb">Constancia pasaporte</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'route' => 'primaria_reporte.constancia_pasaporte.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">CONTANCIA PASAPORTE</span>
          {{-- NAVIGATION BAR--}}
          ...
          <div id="filtros">
            ...
            <div class="row">
              ...
              <div class="col s12 m6 l4">
                ...
                <select name="formato" id="formato" data-formato-id="{{old('formato')}}" class="browser-default validate select2" style="width:100%;" required>
