...
@section('breadcrumbs')
    ...
    <a href="" class="breadcrumb">Lista alumnos preescolar</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'primaria.primaria_estatus_preescolar.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">LISTA DE ALUMNOS PREESCOLAR</span>
            ...
            <div id="filtros">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l4">
                        {!! Form::label('estudioPre', 'Alumnos que estudiaron en preescolar', ['class' => '']); !!}
                        <select name="estudioPre" id="estudioPre" class="browser-default validate select2" style="width: 100%;">
