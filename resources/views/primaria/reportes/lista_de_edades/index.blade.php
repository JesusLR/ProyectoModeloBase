...
@section('template_title')
    Reporte lista de edades
@endsection

@section('breadcrumbs')
  <a href="{{url('primaria_curso')}}" class="breadcrumb">Inicio</a>
  <a href="" class="breadcrumb">Lista de edades de alumnos</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'route' => 'primaria.primaria_lista_edades.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">LISTA DE EDADES DE ALUMNOS</span>          
          ...
          <div id="filtros">
            ...
            <div class="row">
              ...
              <div class="col s12 m6 l4">
                <label for="fechaCalcular">Fecha de calculo *</label>
                <input type="date" name="fechaCalcular" id="fechaCalcular" value="{{old('fechaCalcular')}}" required>
              </div>
