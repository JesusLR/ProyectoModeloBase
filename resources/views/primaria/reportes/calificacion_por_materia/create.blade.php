...
Resumen calificación materia
@endsection

@section('breadcrumbs')
  <a href="{{url('primaria_curso')}}" class="breadcrumb">Inicio</a>
  <a href="" class="breadcrumb">Resumen de calificaciones por materia</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)', 'route' => 'primaria_reporte.calificacion_por_materia.imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
      <div class="card ">
        <div class="card-content ">
          <span class="card-title">Resumen de calificaciones por materia</span>
          {{-- NAVIGATION BAR--}}
          ...
          <div id="filtros">
            ...
            <div class="row">
                <div class="col s12 m6 l4">
                    ...
                    <select name="grupo_id" id="grupo_id" data-programa-id="{{old('grupo_id')}}" class="browser-default validate select2" style="width:100%;">
                        <option value="">SELECCIONE UNA OPCIÓN</option>
                    </select>
                </div>
              <div class="col s12 m6 l4">
