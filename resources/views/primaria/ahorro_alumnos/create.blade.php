          ...
          <div class="card-content ">
            ...
            <div id="general">
                ...
                <div class="row">
                    ...
                    <input type="hidden" name="primaria_empleado_id" id="primaria_empleado_id" value="{{$empleado}}">


                    <div class="col s12 m6 l4">
                        <div class="input-field" id="sal_fin">
                            <label style="color: red" for="saldo_final">Saldo total disponible</label>
                            <strong><input type="number" value="{{old('saldo_final')}}" name="saldo_final" id="saldo_final" class="validate" min="0" step="0.01" readonly></strong>
                        </div>
                    </div>
                </div>
...
@section('footer_scripts')
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        if(month == "01"){
            //$('input[name=aplica_mes_nombre]').val("JUNIO");
