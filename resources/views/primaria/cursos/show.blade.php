                    ...
                    <div class="col s12 m6 l4">
                        ...
                        <div class="input-field">
                            @if ($curso->curPrimariaFoto && !strpos($curso->curPrimariaFoto, '.pdf'))
                                <img style="width:200px;" src="{{url('/primaria_curso_images/' . $curso->curPrimariaFoto . '/' . $periodo->perAnioPago.'/'.$campus) }}" alt="">
                            @endif

                            @if($curso->curPrimariaFoto && strpos($curso->curPrimariaFoto, '.pdf'))
                                <label>Imagen</label>
                                <embed src="/primaria_curso_images/{{$curso->curPrimariaFoto}}/{{$periodo->perAnioPago}}/{{$campus}}"
