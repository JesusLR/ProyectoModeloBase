...
@section('breadcrumbs')
    ...
    <label class="breadcrumb">Ver materia ACD</label>
@endsection
    ...
    <div class="col s12 ">
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">MATERIA ACD #{{$materia_acd->id}} DE LA MATERIA: <b>{{$materia_acd->matClave.'-'.$materia_acd->matNombre}}</b></span>
            ...
            <div id="general">
                ...
                <div class="row">                    
                    ...
                    {{--  <div class="col s12 m6 l4">
                        <div class="input-field">
                            {!! Form::number('primaria_matPorcentajeCalificacion', $materia_acd->primaria_matPorcentajeCalificacion, array('id' => 'primaria_matPorcentajeCalificacion', 'class' => '','maxlength'=>'60', 'readonly')) !!}
