...
@section('breadcrumbs')
    ...
    <a href="{{route('primaria.primaria_materia.index_acd', ['materia_id' => $materia_acd->primaria_materia_id, 'plan_id' => $materia_acd->plan_id])}}" class="breadcrumb">Lista de materias ACD</a>
...
<div class="row">
    <div class="col s12 ">
        {{ Form::open(array('method'=>'PUT','route' => ['primaria.primaria_materia_acd.update_acd', $materia_acd->id])) }}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">EDITAR MATERIA ACD #{{$materia_acd->id}} DE LA MATERIA: <b>{{$materia_acd->matClave.'-'.$materia_acd->matNombre}}</b></span>
            ...
            <div id="general">
                ...
                <div class="row">
                    ...
                    <input type="hidden" name="primaria_materia_id" id="primaria_materia_id" value="{{$materia_acd->primaria_materia_id}}">
                    <input type="hidden" name="gpoGrado" id="gpoGrado" value="{{$materia_acd->matSemestre}}">
                    <input type="hidden" name="primaria_matClave" id="primaria_matClave" value="{{$materia_acd->matClave}}">
                ...
                <div class="row">                    
                    ...
                    {{--  <div class="col s12 m6 l4">
                        <div class="input-field">
                            {!! Form::number('primaria_matPorcentajeCalificacion', $materia_acd->primaria_matPorcentajeCalificacion, array('id' => 'primaria_matPorcentajeCalificacion', 'class' => '','maxlength'=>'60')) !!}
