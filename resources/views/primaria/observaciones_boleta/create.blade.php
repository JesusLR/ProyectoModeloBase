...
@section('breadcrumbs')
    ...
    <a href="{{route('primaria_asignar_cgt.edit')}}" class="breadcrumb">Agregar observación</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'primaria.primaria.primaria_obs_boleta.guardar',
        'method' => 'POST']) !!}
        <div class="card ">
...
@include('primaria.observaciones_boleta.crearTablaJs')
