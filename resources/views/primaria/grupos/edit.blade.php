...
@section('breadcrumbs')
    ...
    <a href="{{url('primaria_grupo/'.$grupo->id.'/edit')}}" class="breadcrumb">Editar grupo</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
        {{ Form::open(array('method'=>'PUT','route' => ['primaria_grupo.update', $grupo->id])) }}
        <div class="card ">
                ...
                <div class="row">
                    <div class="col s12 l6">
                        ...
                        <select id="materia_id" class="browser-default validate select2" required name="materia_id" style="width: 100%;">
                            <option value="{{$grupo->primaria_materia->id}}">{{$grupo->primaria_materia->matNombre}}</option>
                        </select>
                    </div>
