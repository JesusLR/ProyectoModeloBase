...
<a href="{{url('primaria_empleado/cambio-estado')}}" class="breadcrumb">Cambio estado de empleados</a>
@endsection
...
<div id="table-datatables">
    ...
    <div class="row">
        <div class="col s12">
            <table id="table-empleados-cambio-estado_pri" class="responsive-table display" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th>ID</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        escuela.on('change', function() {
            if (this.value) {
                ...
                $('#table-empleados-cambio-estado_pri').dataTable({
                    ...
                    "ajax": {
                        "type" : "GET",
                        'url': base_url+"/api/primaria_empleado/"+this.value,
                        beforeSend: function () {
                    ...
                    "columns":[
                        {data: "empleado_id",name:"primaria_empleados.id"},
                        {data: "empApellido1", name: "primaria_empleados.empApellido1"},
                        {data: "empApellido2", name: "primaria_empleados.empApellido2"},
                        {data: "empNombre", name: "primaria_empleados.empNombre"},
        ...
        $('#table-empleados-cambio-estado_pri').dataTable({
            ...
            "ajax": {
                "type" : "GET",
                'url': base_url+"/api/primaria_empleado"+escuela_id,
                beforeSend: function () {
                    $('.preloader').fadeIn(200,function(){$(this).append('<div id="preloader"></div>');;});
    ...
    function cambiarMultiplesStatusEmpleados(listado) {
        $.ajax({
            type: 'POST',
            url: `${base_url}/primaria_cambiar_status_empleado/actualizar_lista`,
            dataType: 'json',
