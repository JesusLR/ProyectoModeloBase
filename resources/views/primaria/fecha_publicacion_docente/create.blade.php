...
@section('breadcrumbs')
    ...
    <a href="{{route('primaria.primaria_fecha_publicacion_calificacion_docente.create')}}" class="breadcrumb">Agregar fechas de captura calificaciones</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'primaria.primaria_fecha_publicacion_calificacion_docente.store','method' => 'POST']) !!}
        <div class="card ">
                ...
                <div id="general">
                    ...
                    <div class="row">
                        ...
                        <div class="col s12 m6 l4">
                            ...
                            <select id="primaria_mes_evaluaciones_id" data-primaria_mes_evaluaciones-id="{{old('primaria_mes_evaluaciones_id')}}" class="browser-default validate select2" required name="primaria_mes_evaluaciones_id"
                                style="width: 100%;">
                                <option value="" selected disabled>SELECCIONE UNA OPCIÓN</option>
            ...
            $.get(base_url+`/primaria_fecha_publicacion_calificacion_docente/getMesEvaluacion/${event.target.value}`,function(res,sta){
                ...
                res.forEach(element => {
                    ...
                    if(element.mes == 'ENERO'){
                        $("#primaria_mes_evaluaciones_id").append(`<option value="${element.id}" ${selected}>DICIEMBRE-ENERO</option>`);
                    }else{
