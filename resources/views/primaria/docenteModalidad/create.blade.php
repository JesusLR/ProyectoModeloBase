...
@section('breadcrumbs')
    ...
    <a href="{{route('primaria.primaria_docente_inscrito_modalidad.index')}}" class="breadcrumb">Docente modalidad</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
        {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'primaria.primaria_docente_inscrito_modalidad.store', 'method' => 'POST']) !!}
        <div class="card ">
            <div class="card-content ">
                <span class="card-title">CAMBIAR DOCENTE INSCRITO (MODALIDAD)</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col s12 m6 l4">
                            <div class="input-field">
                                ...
                                <input type="text" id="aluClave" name="aluClave">
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-action" id="boton-guardar" style="display: none;">
                <button id="btn-guardar-inscritos-modalidad" class="btn-large btn-save waves-effect darken-3" type="submit"><i class="material-icons left">save</i> Guardar</button>
            </div>
        </div>
        {!! Form::close() !!}
    </div>
...
@include('primaria.docenteModalidad.createTable')
