    ...
    @if (Auth::user()->departamento_cobranza == 1)
        ...
        <li class="bold">
            <a class="collapsible-header waves-effect waves-cyan">
                ...
                <span class="nav-text">Universidad: C.Escolar</span>
            </a>
            <div class="collapsible-body">
                <ul>
                    ...
                    @endif
                    @if(App\Models\User::permiso("alumno") == "A" 
                    || App\Models\User::permiso("alumno") == "B" 
                    || Auth::user()->username == "DESARROLLO"
        ...
        @if (Auth::user()->username == "DESARROLLO"
            ...
            <li class="bold">
                <a class="collapsible-header waves-effect waves-cyan">
                    <i class="material-icons">dashboard</i>
                    <span class="nav-text">Universidad: Pagos</span>
                </a>
                <div class="collapsible-body">
                    <ul>
                        <li>
        ...
        <li class="bold">
            <a class="collapsible-header waves-effect waves-cyan">
                <i class="material-icons">dashboard</i>
                <span class="nav-text">Universidad: Reportes</span>
            </a>
            <div class="collapsible-body">
                            ...
                            <div class="collapsible-body">
                                <ul>
                                    ...
                                    || Auth::user()->username == "CSAURI")
                                        ...
                                        @endif
                                        @if (Auth::user()->username == "FLOPEZH" || Auth::user()->username == "CSAURI")
                                        <li>
                                            <a href="{{ url('ridiomas_listas_pagos') }}">
                                                <i class="material-icons">keyboard_arrow_right</i>
                                                <span>Lista pagos (Idiomas)</span>
                                            </a>
                                        </li>
                                        @endif
                                        <li>
        ...
        @if(auth()->user()->isAdmin('inscritos_edu_continua'))
            <li class="bold">
                <a class="collapsible-header waves-effect waves-cyan">
                    <i class="material-icons">dashboard</i>
                    <span class="nav-text">Educación Continua</span>
                </a>
                <div class="collapsible-body">
                    <ul>
                        <li>
