...
@section('breadcrumbs')
    ...
    <a href="{{ route('universidad.universidad_actividades.create') }}" class="breadcrumb">Agregar actividad</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'universidad.universidad_actividades.store', 'method' => 'POST']) !!}
        <div class="card ">
