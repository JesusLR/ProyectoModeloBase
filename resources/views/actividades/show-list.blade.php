...
<div id="table-datatables">
    ...
    <div class="row">
        <div class="col s12">
            <a href="{{ route('universidad.universidad_actividades.create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
            ...
            <table id="tbl-actividades-universidad" class="responsive-table display" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>Año Escolar</th>
                        <th>Período</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#tbl-actividades-universidad').dataTable({
