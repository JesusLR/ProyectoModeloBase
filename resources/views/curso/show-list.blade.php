    ...
    $(document).on("click", ".btn-modal-ficha-pago", function(e) {
        ...
        if(pedirConfirmacion == 'SI') {
            swal({
                ...
                text: "{!!Lang::get('preinscritos/textos.yaPago')!!}",
                type: "warning",
                ...
                if (isConfirm) {
                    window.open("crearReferencia/" + curso_id + "/" + "si", "_blank");
                } else {
                    window.open("crearReferencia/" + curso_id + "/" + "no", "_blank");
                }
                swal.close()
            });
        } else {
    ...
    $(document).on("click", ".btn-modal-ficha-pago-hsbc", function(e) {
        ...
        if(pedirConfirmacion == 'SI') {
            swal({
                ...
                if (isConfirm) {
                    window.open("crearReferenciahsbc/" + curso_id + "/" + "si", "_blank");
                } else {
                    window.open("crearReferenciahsbc/" + curso_id + "/" + "no", "_blank");
                }
                swal.close()
            });
        } else {
