...
@section('breadcrumbs')
    ...
    <a href="{{url('curso/'.$curso->id.'/edit')}}" class="breadcrumb">Editar preinscripción</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
        {{ Form::open(['enctype' => 'multipart/form-data', 'method'=>'PUT','route' => ['curso.update', $curso->id]]) }}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">EDITAR PREINSCRIPCIÓN #{{$curso->id}} @if($curso->curPlanPago=='D') <span style="color:#0277bd">Este alumno se registro como plan de 12 meses</span> @endif</span>
                    ...
                    @if($permiso == 'A' || $permiso == 'B')
                        <div class="col s12 m6 l4">
                            ...
                            <select name="curEstado" id="curEstado" required class="browser-default validate select2" style="width: 100%;">
                                <option value="{{$curso->curEstado}}">{{$estadoCurso[$curso->curEstado]}}</option>
