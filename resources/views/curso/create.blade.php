...
@section('breadcrumbs')
    ...
    <a href="{{url('curso/create')}}" class="breadcrumb">Agregar Preinscripción</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['enctype' => 'multipart/form-data', 'onKeypress' => 'return disableEnterKey(event)','route' => 'curso.store', 'method' => 'POST', 'id'=>'form_preinscribir']) !!}
        <div class="card ">
                    ...
                    <div class="col s12 m6 l8">
                        ...
                        @if (isset($candidato))
                            ...
                            @if ($candidato->perFoto)
                                    ...
                                    @if ($candidato->perFoto && !strpos($candidato->perFoto, '.pdf'))
                                        <img height="200px" src="{{url('/exani_images/' . $candidato->perFoto) }}" alt="">
                                    @endif
                                    @if($candidato->perFoto && strpos($candidato->perFoto, '.pdf'))
                                        <label>Imagen</label>
          ...
          <div class="card-action">
                {!! Form::button('<i class="material-icons left">save</i> Guardar', ['class' => 'btn-large waves-effect  darken-3', 'id' => 'btn_preinscribir']) !!}
          </div>
        </div>
      {!! Form::close() !!}
    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#btn_preinscribir').on('click', function(e) {
            e.preventDefault();
            $(this).prop('disabled', true);
            $('#form_preinscribir').submit();
        });
