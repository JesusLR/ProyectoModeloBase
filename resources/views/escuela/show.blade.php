          ...
          <div class="card-content ">
            ...
            <div id="general">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l4">
                        <div class="input-field">
                            {!! Form::text('academico_empleado_id', $academico_empleado->persona->perNombre.' '.$administrativo_empleado->persona->perApellido1.' '.$administrativo_empleado->persona->perApellido2, array('readonly' => 'true')) !!}
                            {!! Form::label('academico_empleado_id', 'Coordinador Académico', array('class' => '')); !!}
                        </div>
                    </div>
                    <div class="col s12 m6 l4">
                        <div class="input-field">
                            {!! Form::text('administrativo_empleado_id', $administrativo_empleado->persona->perNombre.' '.$administrativo_empleado->persona->perApellido1.' '.$administrativo_empleado->persona->perApellido2, array('readonly' => 'true')) !!}
