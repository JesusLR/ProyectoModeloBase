            ...
            <div id="general">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l4">
                        ...
                        <select id="academico_empleado_id" class="browser-default validate select2" data-empleado-id="{{old('academico_empleado_id')}}" required name="academico_empleado_id" style="width: 100%;">
                            <option value="">SELECCIONE UNA OPCIÓN</option>
                            @foreach($empleados as $empleado)
                                <option value="{{$empleado->id}}">{{$empleado->id}} - {{$empleado->persona->nombreCompleto()}}</option>
                            @endforeach
                    ...
                    <div class="col s12 m6 l4">
                        ...
                        <select id="administrativo_empleado_id" class="browser-default validate select2" data-empleado-id="{{old('administrativo_empleado_id')}}" required name="administrativo_empleado_id" style="width: 100%;">
                            <option value="">SELECCIONE UNA OPCIÓN</option>
                            @foreach($empleados as $empleado)
                                <option value="{{$empleado->id}}">{{$empleado->id}} - {{$empleado->persona->nombreCompleto()}}</option>
                            @endforeach
