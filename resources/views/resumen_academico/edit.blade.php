...
@section('breadcrumbs')
    ...
    <a href="{{url('resumen_academico')}}" class="breadcrumb">Lista de resúmenes</a>
    <label class="breadcrumb">Editar Resumen</label>
@endsection
...
<div class="row">
    <div class="col s12 ">
        {{ Form::open(array('method'=>'PUT','route' => ['resumen_academico.update', $resumenAcademico->id])) }}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">EDITAR RESUMEN #{{$resumenAcademico->id}}</span>
              ...
              <div class="row">
                <div class="col s12 m6 l4">
                  <div class="input-field col s12 m6 l6">
                    <input type="text" name="aluClave" id="aluClave" required class="validate">
