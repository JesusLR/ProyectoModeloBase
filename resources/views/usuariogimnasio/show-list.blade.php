...
<div id="table-datatables">
    ...
    <a href="{{ url('/usuariogim/create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
    ...
    <div class="row">
        <div class="col s12">
            <table id="tbl-usuarios" class="responsive-table display" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th>Numero</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        */
        $('#tbl-usuarios').on('click', '.btn-generar-ficha', function() {
