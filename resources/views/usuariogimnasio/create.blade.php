...
@section('breadcrumbs')
    ...
    <a href="{{url('usuariogim')}}" class="breadcrumb">Lista de usuarios del gimnasio</a>
    <a href="{{url('usuariogim/create')}}" class="breadcrumb">Agregar usuario de gimnasio</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'usuariogim.store', 'method' => 'POST', 'id' => 'form_usuagim']) !!}
          ...
          <div class="card-content ">
            ...
            <div id="general">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l8" id="busqueda_alumno">
