  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#idiomas_grupo_evidencia_id").change( event => {
            var primaria_grupo_id2 = $("#primaria_grupo_id2").val();
            $.get(base_url+`/idiomas_calificacion/getCalificacionesAlumnos/${event.target.value}/${primaria_grupo_id2}`,function(res,sta){
