...
@section('breadcrumbs')
    ...
    <a href="{{url('idiomas_ficha_pago')}}" class="breadcrumb">Referencia de pago</a>
@endsection

@section('content')
    {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'idiomas.storeFichaGeneral', 'method' => 'POST',  "target" => "_blank"]) !!}
    <div class="card ">
...
<script type="text/javascript">
   ...
   $(document).on('click', '#buscarAlumno', function (e) {
       ...
       var cuoAnio = $('#cuoAnio').val();
        $.get(base_url+`/idiomas_ficha_pago/getCursoAlumno/${aluClave}/${cuoAnio}`, function(res,sta) {
