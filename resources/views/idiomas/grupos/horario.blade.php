            ...
            <div class="card ">
                <div class="card-content ">
                    ...
                    <div id="general">
                        ...
                        <input id="periodo_id" name="periodo_id" type="hidden" value="{{$grupo->periodo_id}}">
                        ...
                        <div class="row">
                            <div class="col s12">
                                <span>Periodo: <b>{{$grupo->periodo->perNumero}} {{$grupo->periodo->perAnio}}</b></span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col s12">
