...
@section('breadcrumbs')
    ...
    <a href="{{url('idiomas_empleado/'.$empleado->id.'/edit')}}" class="breadcrumb">Editar empleado</a>
@endsection
...
<div class="row">
  <div class="col s12 ">
    {{ Form::open(array('method'=>'PUT','route' => ['idiomas.idiomas_empleado.update', $empleado->id])) }}
      <div class="card ">
        <div class="card-content ">
          ...
          <div id="general">
              ...
              <div class="row">
                  <div class="col s12 m6 l4">
                      ...
                      {!! Form::text('empNombre', $empleado->empNombre, array('id' => 'empNombre', 'class' => 'validate','required','maxlength'=>'40')) !!}
                      {!! Form::label('empNombre', 'Nombre(s) *', array('class' => '')); !!}
                      </div>
                  </div>
                  <div class="col s12 m6 l4">
                      <div class="input-field">
                      {!! Form::text('empApellido1', $empleado->empApellido1, array('id' => 'empApellido1', 'class' => 'validate','required','maxlength'=>'30')) !!}
                      {!! Form::label('empApellido1', 'Primer apellido *', array('class' => '')); !!}
                      </div>
                  </div>
                  <div class="col s12 m6 l4">
                      <div class="input-field">
                      {!! Form::text('empApellido2', $empleado->empApellido2, array('id' => 'empApellido2', 'class' => 'validate','maxlength'=>'30')) !!}
              ...
              <div class="row">
                  ...
                  <div class="col s12 m6 l4">
                      <div class="input-field">
                      {!! Form::text('empNSS', $empleado->empNSS, array('id' => 'empNSS', 'class' => 'validate','pattern' => '[A-Z,a-z,0-9]*','maxlength'=>'11')) !!}
              ...
              <div class="row">
                  <div class="col s12 m6 l4">
                      <div class="input-field">
                      {!! Form::text('empCurp', $empleado->empCURP, array('id' => 'empCurp', 'class' => 'validate','required')) !!}
                      {!! Form::hidden('empCurpOld', $empleado->empCURP, ['id' => 'empCurpOld']) !!}
                  ...
                  <div class="col s12 m6 l4">
                      <div class="input-field">
                      {!! Form::number('empHoras', $empleado->empHoras, array('id' => 'empHoras', 'class' => 'validate','required','min'=>'0','max'=>'99999999999','onKeyPress="if(this.value.length==11) return false;"')) !!}
              ...
              <div class="row">
                  ...
                  <div class="col s12 m6 l4">
                    ...
                    <select id="empEstado" name="empEstado" class="browser-default validate select2" required style="width:100%;">
                      <option value="A" {{ $empleado->empEstado == "A" ? 'selected' : '' }}>ALTA</option>
                      @if($puedeDarseDeBaja)
                        <option value="B" {{ $empleado->empEstado == "A" ? 'selected' : '' }}>BAJA</option>
                      @endif
                    </select>
                  </div>
              </div>
              ...
              <div class="row">
                <div class="col s12 m6 l4">
                    ...
                    {!! Form::date('empFechaIngreso', $empleado->empFechaIngreso, array('id' => 'empFechaIngreso', 'class' => 'validate','maxlength'=>'60')) !!}
                </div>
          ...
          <div id="personal">
              ...
              <div class="row">
                  <div class="col s12 m6 l4">
                      <div class="input-field">
                      {!! Form::text('empDirCalle', $empleado->empDireccionCalle, array('id' => 'empDirCalle', 'class' => 'validate','required','maxlength'=>'25')) !!}
                      {!! Form::label('empDirCalle', 'Calle *', array('class' => '')); !!}
                      </div>
                  </div>
                  <div class="col s12 m6 l4">
                        <div class="input-field">
                        {!! Form::text('empDirNumExt', $empleado->empDireccionNumero, array('id' => 'empDirNumExt', 'class' => 'validate','required','maxlength'=>'6')) !!}
                        {!! Form::label('empDirNumExt', 'Número *', array('class' => '')); !!}
                        </div>
                    </div>
                  {{--  <div class="col s12 m6 l4">
                      <div class="input-field">
                      {!! Form::text('empDirNumInt', $empleado->persona->empDirNumInt, array('id' => 'empDirNumInt', 'class' => 'validate','maxlength'=>'6')) !!}
              ...
              <div class="row">
                  <div class="col s12 m6 l4">
                      <div class="input-field">
                      {!! Form::text('empDirColonia', $empleado->empDireccionColonia, array('id' => 'empDirColonia', 'class' => 'validate','required','maxlength'=>'60')) !!}
                      {!! Form::label('empDirColonia', 'Colonia *', array('class' => '')); !!}
                      </div>
                  </div>
                  <div class="col s12 m6 l4">
                      <div class="input-field">
                      {!! Form::number('empDirCP', $empleado->empDireccionCP, array('id' => 'empDirCP', 'class' => 'validate','required', 'pattern' => '[A-Z,a-z,0-9]*','min'=>'0','max'=>'99999','onKeyPress="if(this.value.length==5) return false;"')) !!}
              ...
              <div class="row">
                  ...
                  <div class="col s12 m6 l4">
                      ...
                      {!! Form::date('empFechaNacimiento', $empleado->empFechaNacimiento, array('id' => 'empFechaNacimiento', 'class' => ' validate','required')) !!}
                  </div>
              </div>
              ...
              <div class="row">
                  <div class="col s12 m6 l4">
                      <div class="input-field">
                      {!! Form::number('empTelefono1', $empleado->empTelefono, array('id' => 'empTelefono1', 'class' => 'validate','min'=>'0','max'=>'9999999999','onKeyPress="if(this.value.length==10) return false;"')) !!}
                      {!! Form::label('empTelefono1', 'Teléfono fijo', array('class' => '')); !!}
                      </div>
                  </div>
                  {{--  <div class="col s12 m6 l4">
                      <div class="input-field">
                      {!! Form::number('empTelefono2', $empleado->persona->empTelefono2, array('id' => 'empTelefono2', 'class' => 'validate','min'=>'0','max'=>'9999999999','onKeyPress="if(this.value.length==10) return false;"')) !!}
                      {!! Form::label('empTelefono2', 'Teléfono móvil', array('class' => '')); !!}
                      </div>
                  </div>  --}}
                  <div class="col s12 m6 l4">
                      <div class="input-field">
                      {!! Form::email('empCorreo1', $empleado->empCorreo1, array('id' => 'empCorreo1', 'class' => 'validate','maxlength'=>'60')) !!}
        ...
        $(document).ready(function() {
          ...
          avoidSpecialCharacters('perApellido2');
            ...
            function obtenerDepartamentos(ubicacionId) {
                ...
                $.get(base_url+`/idiomas_api/departamentos/${ubicacionId}`, function(res,sta) {
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            function obtenerEscuelas (departamentoId) {
                ...
                $.get(base_url+`/idiomas_api/escuelas/${departamentoId}`,function(res,sta){
                ...
                //OBTENER PERIODOS
                $.get(base_url+`/idiomas_periodo/api/periodos/${departamentoId}`,function(res2,sta){
                    var perSeleccionado;
                    ...
                    $.get(base_url+`/idiomas_periodo/api/periodo/${perSeleccionado}`,function(res3,sta){
            ...
            $("#empEstado").val(empleado.empEstado).trigger( "change" );
