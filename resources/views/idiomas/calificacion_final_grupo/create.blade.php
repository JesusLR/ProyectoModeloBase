...
@section('breadcrumbs')
    ...
    <a href="" class="breadcrumb">Calificación final grupo</a>
@endsection

@section('content')
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','url' => 'idiomas_calificacion_final_grupo/imprimir', 'method' => 'POST', 'target' => '_blank']) !!}
        <div class="card ">
          <div class="card-content ">
            <span class="card-title">CALIFICACIÓN FINAL GRUPO</span>
