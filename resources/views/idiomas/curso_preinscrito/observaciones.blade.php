...
@section('breadcrumbs')
    ...
    <a href="{{url('preescolar_curso/observaciones/'.$curso->id)}}" class="breadcrumb">Observaciones</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'curso_preescolar.storeObservacionesCurso', 'method' => 'POST','enctype' => 'multipart/form-data', "class" => "form-guardar-preescolar"]) !!}
                        ...
                        <div class="col s12 m6 l8">
                            <div class="file-field input-field">
                                <a {{!$cursoObservaciones ? "disabled": ""}}
                                   class="btn" href="{{url('curso/curso_archivo_observaciones/'. $curso->id)}}" target="blank">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        e.preventDefault()
			...
			function(isConfirm) {
				if (isConfirm) {
                    $(".form-guardar-preescolar").submit()
                } else {
                    swal.close()
				}
			});
