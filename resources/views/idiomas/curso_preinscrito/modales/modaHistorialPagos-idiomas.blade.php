{{-- MODAL EQUIVALENTES --}}
<div id="modalHistorialPagosIdiomas" class="modal">
    <div class="modal-content">
        ...
        <div class="row">
            ...
            <div id="tab1" class="col s12">
                <table id="tbl-historial-pagos-idiomas" class="responsive-table display" cellspacing="0" width="100%">
                    <thead>
                        <tr>
            ...
            <div id="tab2" class="col s12">
                ...
                <table id="tbl-historial-pagos-alu-idiomas" class="responsive-table display" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th>Concepto de pago</th>
                            <th>Importe</th>
