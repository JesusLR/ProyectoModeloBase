{{-- MODAL EQUIVALENTES --}}
<div id="modalAlumnoDetalle-idiomas" class="modal">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on("click", ".btn-modal-alumno-detalle-idiomas", function (e) {
            e.preventDefault()
            var alumno_id = $(this).data("alumno-id");
  
            $.get(base_url+`/api/alumnoById/${alumno_id}`, function(res,sta) {
                console.log("res", res)
                ...
                $("#modalAlumnoDetalle-idiomas label").addClass("active")
