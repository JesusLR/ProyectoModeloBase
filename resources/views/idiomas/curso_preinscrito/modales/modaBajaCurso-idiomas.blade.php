{{-- MODAL BAJA CURSO --}}
<div id="modalBajaCursoIdiomas" class="modal">
    <div class="modal-content">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'curso_idiomas.bajaCurso', 'method' => 'POST', 'class' => 'form-baja-alumno']) !!}
