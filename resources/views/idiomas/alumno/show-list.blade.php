...
@section('breadcrumbs')
    ...
    <a href="{{url('idiomas_alumno')}}" class="breadcrumb">Lista de alumnos</a>
@endsection

@section('content')
    <div id="table-datatables">
        <h4 class="header">ALUMNOS</h4>
        <a href="{{ url('/idiomas_alumno/create') }}" class="btn-large waves-effect  darken-3" type="button">Agregar
        ...
        <div class="row">
            <div class="col s12">
                <table id="tbl-idiomas-alumno" class="responsive-table display" cellspacing="0" width="100%">
                    <thead>
                    <tr>
                        <th>Clave Alumno</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#tbl-idiomas-alumno').dataTable({
                ...
                "ajax": {
                    "type" : "GET",
                    'url': base_url+"/api/idiomas_alumno/list",
                    beforeSend: function () {
