...
@section('breadcrumbs')
    ...
    <a href="{{url('idiomas_alumno/create')}}" class="breadcrumb">Agregar alumno</a>
@endsection
...
<div class="row">
    <div class="col s12 ">
      {!! Form::open(['onKeypress' => 'return disableEnterKey(event)','route' => 'idiomas_alumno.store', 'method' => 'POST']) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 m6 l6" style="margin-top:5px;">
                                <div style="position:relative;">
                                    <input type="checkbox" name="esExtranjero" id="esExtranjero" value="S" {{(isset($candidato) && $candidato->esExtranjero) ? "checked": ""}} {{isset($candidato) ? "readonly": ""}}>
    ...
    <script type="text/javascript">
        ...
        */
        ...
        function verificarPersona() {
            ...
            $.ajax({
                type:'GET',
                url: base_url + '/api/idiomas_alumno/verificar_persona',
                data: $('form').serialize(),
                dataType: 'json',
                success: function(data) {
                    if(data.alumno){
