...
class User extends Authenticatable
{
   ...
   */
   protected static function boot()
   {
    ...
    {
        return $this->belongsTo('App\Models\Primaria\Primaria_empleado', "empleado_id");
    }

    public function secundaria_empleado()
    {
        return $this->belongsTo('App\Models\Secundaria\Secundaria_empleados', "empleado_id");
    }

    public function bachiller_empleado()
    {
        return $this->belongsTo('App\Models\Bachiller\Bachiller_empleados', "empleado_id");
    }


    public function permisos()
    {
        return $this->hasMany('App\Models\Permiso_programa_user');
    }

    public function matriculas_anteriores()
    {
        return $this->hasMany('App\Models\MatriculaAnterior');
    }
