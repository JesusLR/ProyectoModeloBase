...
namespace App\Http\Controllers\Natacion;
...
class NatacionAlumnoController extends Controller
{
    ...
    public function index()
    {
        ...
        return View('natacion.alumno.show-list', [
        ...
        return Datatables::of($alumnos)
            ...
            ->addColumn('action', function($query) {
                ...
                if (User::permiso("alumno") == "A") {
                    $btnBorrar = '<form id="delete_' . $query->alumno_id . '" action="natacion_alumno/' . $query->alumno_id . '" method="POST" style="display:inline-block;">
                ...
                <a href="natacion_alumno/cambiar_matricula/' . $query->alumno_id . '" class="button button--icon js-button js-ripple-effect" title="Cambiar matricula">
                ...
                */
                ...
                return '<a href="natacion_alumno/' . $query->alumno_id . '" class="button button--icon js-button js-ripple-effect" title="Ver">
                    <i class="material-icons">visibility</i>
                </a>
                <a '.$btnModificarHide.' href="natacion_alumno/' . $query->alumno_id . '/edit" class="button button--icon js-button js-ripple-effect" title="Editar">
    ...
    public function listHistorialPagosAluclave(Request $request, $aluClave) {
        ...
        ->whereIn('pagConcPago', ["31", "32", "33", "34", "35"])->get()
    ...
    public function create()
    {
        ...
        return view('natacion.alumno.create', compact('departamentos', 'paises'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            */
            ...
            return redirect('natacion_alumno/create')->withInput();
        }
        ...
        return redirect('natacion_alumno');
    }//function store.
    ...
    public function show($id)
    {
        ...
        return view('natacion.alumno.show', compact('alumno', 'departamentos', 'preparatoriaProcedencia', 'ultimoCurso'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('natacion.alumno.edit', compact(
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            */
            ...
            $errorMessage = $e->errorInfo[2];
            alert()->error('Ups...' . $errorCode,$errorMessage)->showConfirmButton();
            return redirect('natacion_alumno/' . $id . '/edit')->withInput();
        }
    ...
    public function empleado_crearAlumno(Request $request,$empleado_id){
        ...
        if ($validator->fails()) {
            return redirect ('natacion_alumno/create')->withErrors($validator)->withInput();
        }
