...
use Validator;
use Auth;
class BachillerPeriodosController extends Controller
{
    ...
    {
        return view('bachiller.periodos.show-list');
    }
    ...
    public function list()
    {
        ...
        ->addColumn('action',function($query) {
            return '<a href="bachiller_periodo/' . $query->periodo_id . '" class="button button--icon js-button js-ripple-effect" title="Ver">
                <i class="material-icons">visibility</i>
            </a>
            <a href="bachiller_periodo/' . $query->periodo_id . '/edit" class="button button--icon js-button js-ripple-effect" title="Editar">
                <i class="material-icons">edit</i>
            </a>
            <form id="delete_' . $query->periodo_id . '" action="bachiller_periodo/' . $query->periodo_id . '" method="POST" style="display:inline;">
    ...
    */
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            return redirect ('bachiller_periodo/create')->withErrors($validator)->withInput();
        }
        ...
        try {
            ...
            return redirect('bachiller_periodo/create')->withInput();
        }
    }
    ...
    public function show($id)
    {
        ...
        return view('bachiller.periodos.show', [
            'periodo' => $periodo
        ]);
    }
    ...
    public function edit($id)
    {
        if (User::permiso("periodo") == "A" || User::permiso("periodo") == "B") {
            ...
            return view('bachiller.periodos.edit', [
                'periodo' => $periodo
            ]);
        } else {
            alert()->error('Ups...', 'Sin privilegios para esta acción!')->showConfirmButton()->autoClose(5000);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $errorMessage = $e->errorInfo[2];
            alert()->error('Ups...' . $errorCode,$errorMessage)->showConfirmButton();
            return redirect('bachiller_periodo/' . $id . '/edit')->withInput();
        }
    }
