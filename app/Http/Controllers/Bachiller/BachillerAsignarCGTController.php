...
class BachillerAsignarCGTController extends Controller
{
    ...
    public function edit(Request $request)
    {
        ...
        return view('bachiller.asignar_cgt.create', [
    ...
    public function update(Request $request)
    {
        ...
        if (!empty($cgt_id)) {
            ...
            for ($i = 0; $i < $contar; $i++) {
                ...
                //$resultado =  DB::select("call procBachillerAlumnoCambioCGT(".$curso_id[$i].", ".$cgt_id[$i].")");
            }
