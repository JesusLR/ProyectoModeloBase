...
class BachillerCalificacionEvidenciaController extends Controller
{
    ...
    public function imprimir_reporte($bachiller_grupo_id)
    {
        ...
        $parametro_NombreArchivo = "pdf_bachiller_inscritos_evidencias";
        ...
        view('reportes.pdf.bachiller.calificacion_inscritos_evidencias.pdf_bachiller_inscritos_evidencias');
        $pdf = PDF::loadView('reportes.pdf.bachiller.calificacion_inscritos_evidencias.' . $parametro_NombreArchivo, [
