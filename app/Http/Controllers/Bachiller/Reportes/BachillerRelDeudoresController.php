...
class BachillerRelDeudoresController extends Controller
{
  ...
  public function reporte()
  {
    ...
    return view('bachiller.reportes.relacion_deudores.create', [
        "aluEstado" => $aluEstado,
  ...
  public function imprimir(Request $request)
  {
      ...
      $parametro_progClave = "BAC";
      $parametro_progClaveB = "BAC";
      if ($request->progClave == "TODOS")
      {
          $parametro_progClave = "BAC";
        //   $parametro_progClaveB = "PRB";
      }
      if ($request->progClave == "BAC")
      {
          $parametro_progClave = "BAC";
          $parametro_progClaveB = "BAC";
      }
      ...
      $temporary_table_name = "_" . substr(str_shuffle($permitted_chars), 0, 15);
              ...
              $parametro_NombreArchivo = 'pdf_bachiller_relacion_deudores';
              $result =  DB::select("call procBachillerColeAlumnosPrograma("
                  .$userId
                  .",".$request->perAnio
                  .",'".$request->ubiClave
                  ."','".$request->depClave
              ...
              $parametro_Titulo = "RELACIÓN DE DEUDORES DE ESCUELA: BACHILLER";//.$result[0]->_return_escuela;
      ...
      if($pagos_deudores_collection->isEmpty()) {
        ...
        $pdf = PDF::loadView('reportes.pdf.bachiller.relacion_deudores.'. $parametro_NombreArchivo, [
