...
class BachillerMejoresPromediosController extends Controller
{
    ...
    public function reporte()
    {
      ...
      return view('bachiller.reportes.mejores_promedios.create',compact('ubicaciones'));
    }
    ...
    public function imprimir(Request $request){
      ...
      # --------------------------------------------------------------------------------
      $historicoData = self::buscarHistoricos($cursos_periodo, $plan, $request->periodo_id);
      # --------------------------------------------------------------------------------
