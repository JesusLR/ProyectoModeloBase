...
class BachillerBuenaConductaController extends Controller
{
  ...
  public function reporte()
  {
    ...
    return view('bachiller.reportes.buena_conducta.create',[
  ...
  public function imprimir(Request $request)
  {
    ...
    // view('reportes.pdf.bachiller.buena_conducta.pdf_buena_conducta');
    return PDF::loadView('reportes.pdf.bachiller.buena_conducta.'. $nombreArchivo, [
          "curso" => $curso,
