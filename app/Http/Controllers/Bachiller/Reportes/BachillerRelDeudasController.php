...
class BachillerRelDeudasController extends Controller
{
  ...
  public function reporte()
  {
    ...
    $aluEstado = [
      ...
      return view('bachiller.reportes.relacion_deudas.create', [
        "aluEstado" => $aluEstado,
  ...
  public function imprimir(Request $request)
    {
        ...
        {
            $parametro_NombreArchivo = 'pdf_bachiller_relacion_deudas';
            $parametro_Titulo = "RELACIÓN DE DEUDAS DEL ALUMNO";
            $result =  DB::select("call procBachillerDeudasAlumno("
                .$userId
                .",'".$request->aluClave
                ."','".$request->ubiClave
                ."','".$request->tipoResumen
        ...
        $pdf = PDF::loadView('reportes.pdf.bachiller.relacion_deudas.'. $parametro_NombreArchivo, [
