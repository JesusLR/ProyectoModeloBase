...
class BachillerAlumnosHistoriaClinicaController extends Controller
{
    ...
    public function index()
    {
        ...
        $bachiller_alumnos_historia_clinica = Bachiller_alumnos_historia_clinica::get();

        return view('bachiller.historia_clinica.index', [
            'bachiller_alumnos_historia_clinica' => $bachiller_alumnos_historia_clinica
        ]);        
    }
    ...
    public function list()
    {
        if (Auth::user()->bachiller == 1) {
            $bachiller_alumnos_historia_clinica = Bachiller_alumnos_historia_clinica::select(
                'bachiller_alumnos_historia_clinica.id as historia_id',
                'alumnos.aluClave',
                ...
                ->join('alumnos', 'bachiller_alumnos_historia_clinica.alumno_id', '=', 'alumnos.id')
                ->join('personas', 'alumnos.persona_id', '=', 'personas.id')
                ->latest('bachiller_alumnos_historia_clinica.created_at');
        }

        return Datatables::of($bachiller_alumnos_historia_clinica)
            ...
            ->addColumn('action', function ($query) {
                ...
                if (Auth::user()->bachiller == 1) {
                    ...
                    if($query->aluEstado != "B"){
                        $btnEditar = '<a href="/bachiller_historia_clinica/' . $query->historia_id . '/edit" class="button button--icon js-button js-ripple-effect" title="Editar">
                            <i class="material-icons">edit</i>
                        </a>';
                    }
                    $btnMostrarAcciones = '
                    <a href="/bachiller_historia_clinica/'.$query->historia_id.'" class="button button--icon js-button js-ripple-effect" title="Ver">
    ...
    public function create()
    {
        ...
        $nombreEntrevistador = $user_empleado->empleado->persona->perNombre.' '.$user_empleado->empleado->persona->perApellido1.' '.$user_empleado->empleado->persona->perApellido2;


        return view('bachiller.historia_clinica.create', [
            'paises' => $paises,
            'estados' => $estados,
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if($persona){
                ...
                $familia = Bachiller_alumnos_historia_clinica_familiares::create([
                ...
                $embarazo = Bachiller_alumnos_historia_clinica_nacimiento::create([
                    'historia_id' => $bachiller_alumnos_historia_clinica->id,
                ...
                $medica = Bachiller_alumnos_historia_clinica_medica::create([
                    'historia_id' => $bachiller_alumnos_historia_clinica->id,
                ...
                $habito = Bachiller_alumnos_historia_clinica_habitos::create([
                    'historia_id' => $bachiller_alumnos_historia_clinica->id,
                ...
                $desarrollo = Bachiller_alumnos_historia_clinica_desarrollo::create([
                    'historia_id' => $bachiller_alumnos_historia_clinica->id,
                ...
                $heredo = Bachiller_alumnos_historia_clinica_heredo::create([
                    'historia_id' => $bachiller_alumnos_historia_clinica->id,
                ...
                $social = Bachiller_alumnos_historia_clinica_sociales::create([
                    'historia_id' => $bachiller_alumnos_historia_clinica->id,
                ...
                $conducta = Bachiller_alumnos_historia_clinica_conducta::create([
                    'historia_id' => $bachiller_alumnos_historia_clinica->id,
                ...
                $actividad = Bachiller_alumnos_historia_clinica_actividades::create([
                    'historia_id' => $bachiller_alumnos_historia_clinica->id,
            ...
            alert('Escuela Modelo', 'El expediente del alumno se ha creado con éxito','success')->showConfirmButton()->autoClose('6000');
            return redirect()->route('bachiller.bachiller_historia_clinica.index');
            ...
            return redirect('bachiller_historia_clinica/create')->withInput();
        }
    }
    ...
    {
        $departamentos = MetodosDepartamentos::buscarSoloAcademicos(1, ['BAC'])->unique("depClave");
        // obtiene los datos de la tabla Bachiller_alumnos_historia_clinica
        $historia = Bachiller_alumnos_historia_clinica::select('bachiller_alumnos_historia_clinica.*',
        ...
        ->join('alumnos', 'alumnos.id', '=', 'bachiller_alumnos_historia_clinica.alumno_id')
        ...
        $tutores = TutorAlumno::with('tutor')->where('alumno_id', $historia->alumno_id)->get();
        ...
        $familia = Bachiller_alumnos_historia_clinica_familiares::select()->where('historia_id', '=', $historia->id)->first();

        $embarazo = Bachiller_alumnos_historia_clinica_nacimiento::select()->where('historia_id', '=', $historia->id)->first();

        $medica = Bachiller_alumnos_historia_clinica_medica::select()->where('historia_id', '=', $historia->id)->first();

        $habitos = Bachiller_alumnos_historia_clinica_habitos::select()->where('historia_id', '=', $historia->id)->first();

        $desarrollo = Bachiller_alumnos_historia_clinica_desarrollo::select()->where('historia_id', '=', $historia->id)->first();

        $heredo = Bachiller_alumnos_historia_clinica_heredo::select()->where('historia_id', '=', $historia->id)->first();

        $social = Bachiller_alumnos_historia_clinica_sociales::select()->where('historia_id', '=', $historia->id)->first();

        $consucta = Bachiller_alumnos_historia_clinica_conducta::select()->where('historia_id', '=', $historia->id)->first();

        $actividad = Bachiller_alumnos_historia_clinica_actividades::select()->where('historia_id', '=', $historia->id)->first();
        ...
        return view('bachiller.historia_clinica.show', [
            'paises' => $paises,
            'historia' => $historia,
            'familia' => $familia,
            ...
            'tutores' => $tutores,
            'secundaria_municipio_id' => $secundaria_municipio_id,
            'secundaria_estado_id' => $secundaria_estado_id,
            'secundaria_pais_id' => $secundaria_pais_id
        ]);
    ...
    public function edit($id)
    {
        ...
        $historia = Bachiller_alumnos_historia_clinica::select('bachiller_alumnos_historia_clinica.id','bachiller_alumnos_historia_clinica.alumno_id',
        'bachiller_alumnos_historia_clinica.hisTipoSangre','bachiller_alumnos_historia_clinica.hisAlergias','bachiller_alumnos_historia_clinica.hisEscuelaProcedencia',
        'bachiller_alumnos_historia_clinica.hisUltimoGrado','bachiller_alumnos_historia_clinica.hisRecursado','bachiller_alumnos_historia_clinica.hisRecursadoDetalle',
        'bachiller_alumnos_historia_clinica.hisIngresoSecundaria',
        'bachiller_alumnos_historia_clinica.hisEdadActualMeses','bachiller_alumnos_historia_clinica.usuario_at','bachiller_alumnos_historia_clinica.hisTutorOficial',
        'bachiller_alumnos_historia_clinica.hisParentescoTutor','bachiller_alumnos_historia_clinica.hisCelularTutor',
        'bachiller_alumnos_historia_clinica.hisCorreoTutor','bachiller_alumnos_historia_clinica.hisCalleTutor',
        'bachiller_alumnos_historia_clinica.hisNumeroExtTutor','bachiller_alumnos_historia_clinica.hisNumeroIntTutor',
        'bachiller_alumnos_historia_clinica.hisColoniaTutor','bachiller_alumnos_historia_clinica.hisCPTutor',
        'alumnos.persona_id','alumnos.aluClave','personas.perCurp', 'personas.perApellido1', 'personas.perApellido2', 'personas.perNombre',
        'personas.perFechaNac', 'municipios.id as municipio_id', 'municipios.munNombre', 'estados.edoNombre','paises.id as pais_id' ,'paises.paisNombre')
        ->join('alumnos', 'alumnos.id', '=', 'bachiller_alumnos_historia_clinica.alumno_id')
        ->join('personas', 'personas.id', '=', 'alumnos.persona_id')
       ...
       $pais_alumno = Pais::findOrFail($estado_alumno->pais_id);
        ...
        $familia = Bachiller_alumnos_historia_clinica_familiares::select('bachiller_alumnos_historia_clinica_familiares.*')->where('historia_id', '=', $historia->id)->first();
        ...
        $embarazo = Bachiller_alumnos_historia_clinica_nacimiento::select('bachiller_alumnos_historia_clinica_nacimiento.*')->where('historia_id', '=', $historia->id)->first();

        $medica = Bachiller_alumnos_historia_clinica_medica::select('bachiller_alumnos_historia_clinica_medica.*')->where('historia_id', '=', $historia->id)->first();

        $habitos = Bachiller_alumnos_historia_clinica_habitos::select('bachiller_alumnos_historia_clinica_habitos.*')->where('historia_id', '=', $historia->id)->first();

        $desarrollo = Bachiller_alumnos_historia_clinica_desarrollo::select('bachiller_alumnos_historia_clinica_desarrollo.*')->where('historia_id', '=', $historia->id)->first();

        $heredo = Bachiller_alumnos_historia_clinica_heredo::select('bachiller_alumnos_historia_clinica_heredo.*')->where('historia_id', '=', $historia->id)->first();

        $social = Bachiller_alumnos_historia_clinica_sociales::select('bachiller_alumnos_historia_clinica_sociales.*')->where('historia_id', '=', $historia->id)->first();

        $consucta = Bachiller_alumnos_historia_clinica_conducta::select('bachiller_alumnos_historia_clinica_conducta.*')->where('historia_id', '=', $historia->id)->first();

        $actividad = Bachiller_alumnos_historia_clinica_actividades::select('bachiller_alumnos_historia_clinica_actividades.*')->where('historia_id', '=', $historia->id)->first();
        ...
        return view('bachiller.historia_clinica.edit', [
            'paises' => $paises,
            'historia' => $historia,
            'familia' => $familia,
            'embarazo' => $embarazo,
            ...
            'secundaria_estado_id' => $secundaria_estado_id,
            'secundaria_pais_id' => $secundaria_pais_id,
            "preparatoria_municipio_id" => $preparatoria_municipio_id,
            "preparatoria_estado_id" => $preparatoria_estado_id,
            "preparatoria_pais_id" => $preparatoria_pais_id
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $historia_alumno = Bachiller_alumnos_historia_clinica::where('id', $id)->first();
            ...
            $familia = Bachiller_alumnos_historia_clinica_familiares::select()->where('historia_id', '=', $historia_alumno->id)->first();
            ...
            $embarazo = Bachiller_alumnos_historia_clinica_nacimiento::select()->where('historia_id', '=', $historia_alumno->id)->first();
            ...
            $medica = Bachiller_alumnos_historia_clinica_medica::select()->where('historia_id', '=', $historia_alumno->id)->first();
            ...
            $habito = Bachiller_alumnos_historia_clinica_habitos::select()->where('historia_id', '=', $historia_alumno->id)->first();
            ...
            $desarrollo = Bachiller_alumnos_historia_clinica_desarrollo::select()->where('historia_id', '=', $historia_alumno->id)->first();
            ...
            $heredo = Bachiller_alumnos_historia_clinica_heredo::select()->where('historia_id', '=', $historia_alumno->id)->first();
            ...
            $social = Bachiller_alumnos_historia_clinica_sociales::select()->where('historia_id', '=', $historia_alumno->id)->first();
            ...
            $conducta = Bachiller_alumnos_historia_clinica_conducta::select()->where('historia_id', '=', $historia_alumno->id)->first();
            ...
            $actividad = Bachiller_alumnos_historia_clinica_actividades::select()->where('historia_id', '=', $historia_alumno->id)->first();
    
            $nombreEntrevistador = User::with('empleado.persona')->where('id', auth()->user()->id)->first();
            ...
            $actividad->update([
                ...
                'actGradoSugerido' => $request->actGradoSugerido,
                'actGradoElegido' => $request->actGradoElegido,
                'actNombreEntrevista' => $nombreEntrevistador->empleado->persona->perNombre.' '.$nombreEntrevistador->empleado->persona->perApellido1.' '.$nombreEntrevistador->empleado->persona->perApellido2
            ]);
    
            alert('Escuela Modelo', 'El expediente del alumno se ha actualizo con éxito','success')->showConfirmButton();
            // return redirect()->route('bachiller.bachiller_historia_clinica.index');
            ...
            $errorMessage = $e->errorInfo[2];
            alert()->error('Ups...' . $errorCode,$errorMessage)->showConfirmButton();
            return redirect('bachiller_historia_clinica/' . $id . '/edit')->withInput();
        }
