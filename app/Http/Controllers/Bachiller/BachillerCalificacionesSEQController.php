...
use App\Models\Bachiller\Bachiller_porcentajes;
...
class BachillerCalificacionesSEQController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $grupo = Bachiller_cch_grupos::with(
            'bachiller_materia',
            'periodo',
            'bachiller_empleado',
        ...
        */
        ...
        return view(
            'bachiller.calendario.show-list',
            compact(
                'calificaciones',
                'grupo',
                'grupo_id',
    ...
    public function getAlumnos(Request $request, $id)
    {
        if ($request->ajax()) {
            ...
            $alumnos = Bachiller_cch_inscritos::select(
    ...
    public function getGrupos(Request $request, $id)
    {
        ...
        if ($request->ajax()) {
            ...
            $gruposactuales = DB::table('bachiller_cch_inscritos')
                ->select(
                    'bachiller_cch_inscritos.bachiller_grupo_id',
                    DB::raw('count(*) as grupo_id, bachiller_cch_inscritos.bachiller_grupo_id'),
                    'bachiller_cch_grupos.gpoGrado',
                    DB::raw('count(*) as gpoGrado, bachiller_cch_grupos.gpoGrado'),
                    'bachiller_cch_grupos.gpoClave',
                    DB::raw('count(*) as gpoClave, bachiller_cch_grupos.gpoClave'),
                    'periodos.perAnio',
                    ...
                    DB::raw('count(*) as matClave, bachiller_materias.matClave')
                )
                ->join('bachiller_cch_grupos', 'bachiller_cch_inscritos.bachiller_grupo_id', '=', 'bachiller_cch_grupos.id')
                ->join('cursos', 'bachiller_cch_inscritos.curso_id', '=', 'cursos.id')
                ->join('cgt', 'cursos.cgt_id', '=', 'cgt.id')
    ...
    public function getMaterias2(Request $request, $id)
    {
        ...
        if ($request->ajax()) {
            ...
            $materia2 = DB::table('bachiller_cch_inscritos')
                ->select(
                    'bachiller_materias.matNombre',
                    DB::raw('count(*) as matNombre, bachiller_materias.matNombre'),
                    'bachiller_materias.id',
                    DB::raw('count(*) as id, bachiller_materias.id'),
                    'bachiller_cch_inscritos.bachiller_grupo_id',
                    DB::raw('count(*) as bachiller_grupo_id, bachiller_cch_inscritos.bachiller_grupo_id')
                )
    ...
    public function edit_calificacion($id)
    {
        ...
        return view('bachiller.calificaciones_chetumal.edit', [
    ...
    //         if ($request->que_vamos_a_calificar == "parcial1") {
    ...
    //         if ($request->que_vamos_a_calificar == "parcial2") {
    //             // validaremos si pasa el parcial 2
    //             if($insCalificacionOrdinarioParcial2[$x] == -1 || $insCalificacionOrdinarioParcial2[$x] == -2){
    //                 if($insCalificacionOrdinarioParcial2[$x] == -1){
    //                     $pasoParcial2[$x] = 'SI';
    //                 }else{
    ...
    //         if ($request->que_vamos_a_calificar == "parcial3") {

    //             // validaremos si pasa el parcial 3
    //             if($insCalificacionOrdinarioParcial3[$x] == -1 || $insCalificacionOrdinarioParcial3[$x] == -2){
    //                 if($insCalificacionOrdinarioParcial3[$x] == -1){
    //                     $pasoParcial3[$x] = 'SI';
    //                 }else{
    ...
    //         if ($request->que_vamos_a_calificar == "parcial4") {

    //             // validaremos si pasa el parcial 4
    //             if($insCalificacionOrdinarioParcial4[$x] == -1 || $insCalificacionOrdinarioParcial4[$x] == -2){
    //                 if($insCalificacionOrdinarioParcial4[$x] == -1){
    //                     $pasoParcial4[$x] = 'SI';
    //                 }else{
    ...
    //         if ($request->que_vamos_a_calificar == "recuperacion") {
