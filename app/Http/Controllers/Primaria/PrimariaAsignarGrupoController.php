...
class PrimariaAsignarGrupoController extends Controller
{
    ...
    public function list()
    {
        ...
        return DataTables::of($inscritos)
            ...
            ->addColumn('action',function($query) use ($permisoC) {
                ...
                $btnEditar = '<a href="primaria_asignar_grupo/' . $query->inscrito_id . '/edit" class="button button--icon js-button js-ripple-effect" title="Editar">
                ...
                <form id="delete_' . $query->inscrito_id . '" action="primaria_asignar_grupo/' . $query->inscrito_id . '" method="POST" style="display: inline;">
                    ...
                    <a href="#" data-id="' . $query->inscrito_id . '" class="button button--icon js-button js-ripple-effect confirm-delete" title="Eliminar" style="display:none;">
    ...
    public function getGrupos(Request $request, $curso_id)
    {
        if ($request->ajax()) {
            ...
            $grupos = Primaria_grupo::select("primaria_grupos.id as id", "primaria_grupos.gpoGrado", "primaria_grupos.gpoClave", "primaria_grupos.gpoTurno", "primaria_grupos.gpoMatComplementaria",
