...
use App\Http\Models\Primaria\Primaria_expediente_perfiles;
...
class PrimariaCursoController extends Controller
{
    ...
    public function list()
    {
        if (Auth::user()->primaria == 1) {
            $cursos = Curso::select('cursos.id as curso_id', 'cursos.curTipoBeca', 'cursos.curPorcentajeBeca',
                ...
                'periodos.perNumero', 'periodos.perAnio','personas.perSexo',
        ...
        return Datatables::of($cursos)
            ...
            ->addColumn('action', function($query) use ($permisos, $permisoA) {
                ...
                {
                    $userDepClave = "PRI";
                    //Auth::user()->empleado->escuela->departamento->depClave;
                                ...
                                $btnTarjetaPagoHSBC = '<a target="_blank" href="tarjetaPagoAlumno/' . $query->curso_id .'/HSBC" class="button modal-trigger button--icon js-button js-ripple-effect" title="HSBC">
                                    <i class="material-icons">strikethrough_s</i>
                                        ...
                                        $btnTarjetaPagoBBVA = '<form style="display: inline-block;" id="autorizado_' . $query->curso_id . '" action="tarjetaPagoAlumno/' . $query->curso_id .'/BBVA">
                                                <a href="#" data-alumno_id="' . $query->alumno_id . '" data-persona1="' . $expediente[0] . '" data-persona2="' . $expediente[1] . '" data-curso_id="' . $query->curso_id . '" data-movimiento="PRIMARIA TARJETA PAGO BBVA PREINSCRITO" data-ip="' . $localIP . '" data-usuario_at="' . $user_id . '" data-departamento="' . $query->depClave . '" class="button button--icon js-button js-ripple-effect confirm-autorizado" title="BBVA">
                                                    <i class="material-icons">format_bold</i>
                                                </a>
                                                </form>';
                    ...
                    $btnCartaConductaSinFoto = "";
                    $btnCartaConductaConFoto = "";
                    $btnBoletaACD = "";
                    $btnBoleta = "";
                    $btnGruposAlumnos = "";
                    $btnConstanciaPasaporteInglesFoto = "";
                    $btnConstanciaPasaporteInglesSinFoto = "";
                    $btnConstanciaPasaporteFoto = "";
                    $btnConstanciaPasaporteSinFoto = "";
                    ...
                    if ($query->curEstado != "B" && $ubicacionClave->ubiClave == $query->ubiClave || Auth::user()->departamento_sistemas == 1)
                        {
                            $btnBajaCurso = '<a href="#modalBajaCursoPrimaria" data-curso-id="' . $query->curso_id . '" class="modal-trigger btn-modal-baja-curso button button--icon js-button js-ripple-effect " title="Baja curso">
                    ...
                    if ($expediente[0] == "" && $expediente[1] == "") {                    
                        ...
                        // ver curso
                        $btnVer = '<a href="/primaria_curso/'.$query->curso_id.'" class="button button--icon js-button js-ripple-effect" title="Ver">
                        ...
                        $btnGruposAlumnos = '<a href="primaria_curso/grupos_alumno/'.$query->curso_id.'" class="button button--icon js-button js-ripple-effect" title="Grupo Calificaciones">
                        ...
                        if ($query->curEstado == "R") {
                            ...
                            $btnCartaConductaSinFoto = '<a href="primaria_reporte/carta_conducta/imprimir/' . $query->curso_id . '/sin_foto" target="_blank" class="button button--icon js-button js-ripple-effect" title="Carta conducta (sin foto)" >
                                <i class="material-icons">picture_as_pdf</i>
                                </a>';

                            $btnCartaConductaConFoto = '<a href="primaria_reporte/carta_conducta/imprimir/' . $query->curso_id . '/con_foto" target="_blank" class="button button--icon js-button js-ripple-effect" title="Carta conducta (con foto)" >
                                <i class="material-icons">picture_as_pdf</i>
                            </a>';

                            $btnConstanciaPasaporteInglesFoto = '<a href="primaria_reporte/constancia_pasaporte_ingles/imprimir/' . $query->curso_id . '/con_foto" target="_blank" class="button button--icon js-button js-ripple-effect" title="Constancia Pasaporte Ingles (con foto)" >
                                <i class="material-icons">picture_as_pdf</i>
                            </a>';
                        ...
                        if (!$esDeudor)
                        {
                            $btnConstanciaNoAdeudo = '<a href="primaria_reporte/constancia_no_adeudo/imprimir/' . $query->curso_id . '/con_foto" target="_blank" id="deudor" class="button button--icon js-button js-ripple-effect" title="Constancia no adeudo (con foto)" >
                            <i class="material-icons">picture_as_pdf</i>
                            </a>';

                            $btnConstanciaNoAdeudoSinFoto = '<a href="primaria_reporte/constancia_no_adeudo/imprimir/' . $query->curso_id . '/sin_foto" target="_blank" id="deudor" class="button button--icon js-button js-ripple-effect" title="Constancia no adeudo (sin foto)" >
                            <i class="material-icons">picture_as_pdf</i>
                            </a>';
                        }
                        ...
                        $btnGruposAlumnos = '<form style="display: inline-block;" id="autorizado_' . $query->curso_id . '" action="primaria_curso/grupos_alumno/' . $query->curso_id . '">
                        <a href="#" data-alumno_id="' . $query->alumno_id . '" data-persona1="' . $expediente[0] . '" data-persona2="' . $expediente[1] . '" data-curso_id="' . $query->curso_id . '" data-movimiento="PRIMARIA GRUPOS CALIFICACIONES" data-ip="' . $localIP . '" data-usuario_at="' . $user_id . '" data-departamento="' . $query->depClave . '" class="button button--icon js-button js-ripple-effect confirm-autorizado" title="Grupos Calificaciones">
                            <i class="material-icons">assignment_turned_in</i>
                        </a>
                        </form>';

                        if ($query->curEstado == "R") {
                            $btnBoleta = '<form style="display: inline-block;" id="autorizado_' . $query->curso_id . '" action="boletaAlumnoCurso/' . $query->curso_id . '">
                            <a href="#" data-alumno_id="' . $query->alumno_id . '" data-persona1="' . $expediente[0] . '" data-persona2="' . $expediente[1] . '" data-curso_id="' . $query->curso_id . '" data-movimiento="PRIMARIA BOLETA" data-ip="' . $localIP . '" data-usuario_at="' . $user_id . '" data-departamento="' . $query->depClave . '" class="button button--icon js-button js-ripple-effect confirm-autorizado" title="Boleta">
                                <i class="material-icons">assignment_ind</i>
                            </a>
                            </form>';

                            $btnBoletaACD = '<form style="display: inline-block;" id="autorizado_' . $query->curso_id . '" action="reporte/primaria_boleta_de_calificaciones_acd/' . $query->curso_id . '">
                            <a href="#" data-alumno_id="' . $query->alumno_id . '" data-persona1="' . $expediente[0] . '" data-persona2="' . $expediente[1] . '" data-curso_id="' . $query->curso_id . '" data-movimiento="PRIMARIA BOLETA ACD" data-ip="' . $localIP . '" data-usuario_at="' . $user_id . '" data-departamento="' . $query->depClave . '" class="button button--icon js-button js-ripple-effect confirm-autorizado" title="Boleta ACD">
                                <i class="material-icons">picture_as_pdf</i>
                            </a>
                            </form>';
                            ...
                            $btnConstanciaEstudiosinFoto = '<form style="display: inline-block;" id="autorizado_' . $query->curso_id . '" action="primaria_reporte/constancia_estudio/imprimir/' . $query->curso_id . '/sin_foto">
                                ...
                                if ($query->curPrimariaFoto != ""){
                                    $btnConstanciaEstudioConFoto = '<form style="display: inline-block;" id="autorizado_' . $query->curso_id . '" action="primaria_reporte/constancia_estudio/imprimir/' . $query->curso_id . '/con_foto">
                                    <a href="#" data-alumno_id="' . $query->alumno_id . '" data-persona1="' . $expediente[0] . '" data-persona2="' . $expediente[1] . '" data-curso_id="' . $query->curso_id . '" data-movimiento="PRIMARIA CONSTANCIA DE ESTUDIO CON FOTO" data-ip="' . $localIP . '" data-usuario_at="' . $user_id . '" data-departamento="' . $query->depClave . '" class="button button--icon js-button js-ripple-effect confirm-autorizado" title="Constancia de estudio (con foto)">
                                        <i class="material-icons">picture_as_pdf</i>
                                    </a>
                                    </form>';
                                }
                            ...
                            $btnCartaConductaSinFoto = '<form style="display: inline-block;" id="autorizado_' . $query->curso_id . '" action="primaria_reporte/carta_conducta/imprimir/' . $query->curso_id . '/sin_foto">
                                <a href="#" data-alumno_id="' . $query->alumno_id . '" data-persona1="' . $expediente[0] . '" data-persona2="' . $expediente[1] . '" data-curso_id="' . $query->curso_id . '" data-movimiento="PRIMARIA CARTA CONDUCTA SIN FOTO" data-ip="' . $localIP . '" data-usuario_at="' . $user_id . '" data-departamento="' . $query->depClave . '" class="button button--icon js-button js-ripple-effect confirm-autorizado" title="Carta conducta (sin foto)">
                                    <i class="material-icons">picture_as_pdf</i>
                                </a>
                                </form>';

                            $btnCartaConductaConFoto = '<form style="display: inline-block;" id="autorizado_' . $query->curso_id . '" action="primaria_reporte/carta_conducta/imprimir/' . $query->curso_id . '/con_foto">
                                <a href="#" data-alumno_id="' . $query->alumno_id . '" data-persona1="' . $expediente[0] . '" data-persona2="' . $expediente[1] . '" data-curso_id="' . $query->curso_id . '" data-movimiento="PRIMARIA CARTA CONDUCTA CON FOTO" data-ip="' . $localIP . '" data-usuario_at="' . $user_id . '" data-departamento="' . $query->depClave . '" class="button button--icon js-button js-ripple-effect confirm-autorizado" title="Carta conducta (con foto)">
                                    <i class="material-icons">picture_as_pdf</i>
                                </a>
                                </form>';
                            ...
                            $btnConstanciaPasaporteInglesSinFoto = '<form style="display: inline-block;" id="autorizado_' . $query->curso_id . '" action="primaria_reporte/constancia_pasaporte_ingles/imprimir/' . $query->curso_id . '/sin_foto">
                            <a href="#" data-alumno_id="' . $query->alumno_id . '" data-persona1="' . $expediente[0] . '" data-persona2="' . $expediente[1] . '" data-curso_id="' . $query->curso_id . '" data-movimiento="PRIMARIA CONSTANCIA PASAPORTE INGLES SIN FOTO" data-ip="' . $localIP . '" data-usuario_at="' . $user_id . '" data-departamento="' . $query->depClave . '" class="button button--icon js-button js-ripple-effect confirm-autorizado" title="Constancia Pasaporte Ingles (sin foto)">
                                <i class="material-icons">picture_as_pdf</i>
                            </a>
                            </form>';

                            $btnConstanciaPasaporteFoto = '<form style="display: inline-block;" id="autorizado_' . $query->curso_id . '" action="primaria_reporte/constancia_pasaporte_/imprimir/' . $query->curso_id . '/con_foto">
                            <a href="#" data-alumno_id="' . $query->alumno_id . '" data-persona1="' . $expediente[0] . '" data-persona2="' . $expediente[1] . '" data-curso_id="' . $query->curso_id . '" data-movimiento="PRIMARIA CONSTANCIA PASAPORTE CON FOTO" data-ip="' . $localIP . '" data-usuario_at="' . $user_id . '" data-departamento="' . $query->depClave . '" class="button button--icon js-button js-ripple-effect confirm-autorizado" title="Constancia Pasaporte (con foto)">
                                <i class="material-icons">picture_as_pdf</i>
                            </a>
                            </form>';

                            $btnConstanciaPasaporteSinFoto = '<form style="display: inline-block;" id="autorizado_' . $query->curso_id . '" action="primaria_reporte/constancia_pasaporte/imprimir/' . $query->curso_id . '/sin_foto">
                            <a href="#" data-alumno_id="' . $query->alumno_id . '" data-persona1="' . $expediente[0] . '" data-persona2="' . $expediente[1] . '" data-curso_id="' . $query->curso_id . '" data-movimiento="PRIMARIA CONSTANCIA PASAPORTE SIN FOTO" data-ip="' . $localIP . '" data-usuario_at="' . $user_id . '" data-departamento="' . $query->depClave . '" class="button button--icon js-button js-ripple-effect confirm-autorizado" title="Constancia Pasaporte (sin foto)">
                                <i class="material-icons">picture_as_pdf</i>
                            </a>
                            </form>';
                        ...
                        if (!$esDeudor)
                        {
                            ...
                            $btnConstanciaNoAdeudoSinFoto = '<form style="display: inline-block;" id="autorizado_' . $query->curso_id . '" action="primaria_reporte/constancia_no_adeudo/imprimir/' . $query->curso_id . '/sin_foto">
                                <a href="#" data-alumno_id="' . $query->alumno_id . '" data-persona1="' . $expediente[0] . '" data-persona2="' . $expediente[1] . '" data-curso_id="' . $query->curso_id . '" data-movimiento="PRIMARIA CONSTANCIA NO ADEUDO SIN FOTO" data-ip="' . $localIP . '" data-usuario_at="' . $user_id . '" data-departamento="' . $query->depClave . '" class="button button--icon js-button js-ripple-effect confirm-autorizado" title="Constancia no adeudo (sin foto)">
                                    <i class="material-icons">picture_as_pdf</i>
                                </a>
                            </form>';
                        }
    ...
    */
    ...
    public function bajaCurso(Request $request)
    {
        ...
        // dd( $curso->id);
        // 1) OBTENER INSCRITOS grupos - materias de este alumno
        $inscritosObj = Primaria_inscrito::where("curso_id", "=", $curso->id);
        ...
        $borrarCalificaciones = Primaria_calificacione::whereIn("primaria_inscrito_id", $inscritoIds)->delete();
        ...
        try {
            ...
            $resultado_array =  DB::select("call procPrimariaAlumnoBajaInscritos(" . $cursoId . ")");

            $envio_notificacion = new NotificacionPrimaria($curso);
    ...
    public function store(Request $request)
    {
        ...
        if (!$request->es_candidato_tiene_foto) {
            if ($request->curPrimariaFoto) {
                ...
                $path = $request->curPrimariaFoto->move(storage_path(env("PRIMARIA_IMAGEN_CURSO_PATH").$periodo->perAnioPago."/".$campus),
                    $imageName);
            }
        }
        ...
        $primaria_expediente_entrevista_inicial = Primaria_expediente_entrevista_inicial::where('alumno_id', $request->alumno_id)->first();

        if($primaria_expediente_entrevista_inicial == ""){
            ...
            if ($resultado_collection->isEmpty()) {
                ...
                if($laclavedelprograma == "PRI" || $laclavedelprograma == "PRB")
                {
                    ...
                    $expediente = Primaria_expediente_entrevista_inicial::where('alumno_id', '=', $eliddelalumno)->first();
            ...
            if($primaria_expediente_entrevista_inicial->estatus_edicion == 0){
                alert('Upss', 'No se puede realizar el registro, debido que aun no sea actualizado los datos de la entrevista inicial','warning')->showConfirmButton()->autoClose('6000');
                return redirect('primaria_curso/create')->withInput();
            }
        }
        ...
        try {
            ...
            //CHECAR SI ES UN NUEVO ALUMNO DE PRIMARIA para agregar en expediente
            if($laclavedelprograma == "PRI" || $laclavedelprograma == "PRB")
            {
                $fechaActual = Carbon::now('America/Merida');
                $perfil = Primaria_expediente_perfiles::where('curso_id', '=', $laNuevaPreinscripcion->id)->first();

                if ($perfil === null) {

                    Primaria_expediente_perfiles::create([
                        'curso_id' => $laNuevaPreinscripcion->id
                    ]);
            ...
            $obtenerCursoNuevo->update([
                'curPrimariaFoto' => $alum->aluClave.'.jpg'
            ]);
    ...
    public function show($id)
    {
        ...
        return view('primaria.cursos.show', compact('curso','tiposIngreso','planesPago',
            'estadoCurso','tiposBeca','opcionTitulo', 'periodo', 'lafechabuena', 'quemostrar', 'usuario_at', 'campus'));
    }
    ...
    public function destroy($id)
    {
        ...
        $primaria_inscrito = Primaria_inscrito::where('curso_id', $id)->get();
        ...
        try {
            ...
            if($curso->delete()) {
                ...
                if(count($primaria_inscrito) > 0){
                    Primaria_inscrito::where('curso_id', $id)->delete();
                }
