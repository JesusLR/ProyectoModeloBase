...
class PrimariaAgendaController extends Controller
{
    ...
    public function index()
    {
        ...
        ->leftJoin('primaria_empleados', 'primaria_agenda_colores.empleado_id', '=', 'primaria_empleados.id')
        ->get();
    ...
    public function show($id)
    {
        ...
        ->leftJoin('primaria_empleados as empCreador', 'primaria_agendas.primaria_empleado_creador', '=', 'empCreador.id')
