...
class PrimariaCalificacionesController extends Controller
{
    ...
    public function edit_calificacion($id)
    {
        ...
        if (count($alumnos_inscritos) <= 0) {
            alert()->warning('Sin coincidencias', 'No hay alumnos inscritos a este grupo.')->showConfirmButton();
            return back();
        }
        ...
        $resultado_array =  DB::select("call procPrimariaCrearMesesCalificacionesFaltantes(" . $id . ", "
            ...
            for ($i = 0; $i < count($primaria_inscrito_id); $i++) {
                ...
                DB::table('primaria_calificaciones')
                    ...
                    ->update([
                        ...
                        'calificacion_evidencia1' => (isset($request->evidencia1)) ? $evidencia1[$i] : false,
                        'calificacion_evidencia2' => (isset($request->evidencia2)) ? $evidencia2[$i] : false,
                        'calificacion_evidencia3' => (isset($request->evidencia3)) ? $evidencia3[$i] : false,
                        'calificacion_evidencia4' => (isset($request->evidencia4)) ? $evidencia4[$i] : false,
                        'calificacion_evidencia5' => (isset($request->evidencia5)) ? $evidencia5[$i] : false,
                        'calificacion_evidencia6' => (isset($request->evidencia6)) ? $evidencia6[$i] : false,
                        'calificacion_evidencia7' => (isset($request->evidencia7)) ? $evidencia7[$i] : false,
                        'calificacion_evidencia8' => (isset($request->evidencia8)) ? $evidencia8[$i] : false,
                        'calificacion_evidencia9' => (isset($request->evidencia9)) ? $evidencia9[$i] : false,
                        'calificacion_evidencia10'=> (isset($request->evidencia10)) ? $evidencia10[$i] : false,
    ...
    public function boletadesdecurso($curso_id)
    {
        ...
        $ubicacion = $periodoEscolar->departamento->ubicacion->id;
        ...
        if ($periodoEscolar->perAnioPago >= 2021) {
            ...
            view('reportes.pdf.primaria.boleta_de_calificaciones.pdf_primaria_boleta_calificaciones_2021');
