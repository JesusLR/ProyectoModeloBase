...
class PrimariaPlanesController extends Controller
{
    ...
    {
        return view('primaria.planes.show-list');
    }
    ...
    public function list()
    {
        ...
        return DataTables::of($planes)->addColumn('action',function($query){
            return '<a href="primaria_plan/'.$query->plan_id.'" class="button button--icon js-button js-ripple-effect" title="Ver">
                <i class="material-icons">visibility</i>
            </a>
            <a href="primaria_plan/'.$query->plan_id.'/edit" class="button button--icon js-button js-ripple-effect" title="Editar">
                <i class="material-icons">edit</i>
            </a>
            <a href="#modalCambiarEstadoPrimaria" data-plan-id="'.$query->plan_id.'" class="btn-modal-estatus-plan-primaria modal-trigger button button--icon js-button js-ripple-effect" title="Cambiar Estado">
                <i class="material-icons">unarchive</i>
            </a>
            
            <form id="delete_' . $query->plan_id . '" action="primaria_plan/' . $query->plan_id . '" method="POST" style="display:inline;">
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            return redirect ('primaria_plan/create')->withErrors($validator)->withInput();
        }
        ...
        if (Utils::validaPermiso('plan',$programa_id)) {
            ...
            return redirect()->to('primaria_materia/create');
        }
    ...
    public function show($id)
    {
        ...
        return view('primaria.planes.show', [
            'plan' => $plan
        ]);
    }
    ...
    public function edit($id)
    {
        if (User::permiso("plan") == "A" || User::permiso("plan") == "B") {
            ...
            return view('primaria.planes.edit', [
                'plan' => $plan
            ]);
