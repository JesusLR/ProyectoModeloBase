...
class PrimariaCambiarCGTController extends Controller
{
    ...
    public function edit(Request $request)
    {
        ...
        return view('primaria.cambiar_cgt.create', [
    ...
    public function getPrimariaInscritoCursos(Request $request, $periodo_id, $programa_id, $plan_id, $cgt_id)
    {
        if($request->ajax()){
            ...
            // llama al procedure
            $resultado_array =  DB::select("call procPrimariaInscritoHayDatos(".$periodo_id.", ".$programa_id.", '".$plan_id."', ".$cgt_id.",".$cgt->cgtGradoSemestre.",'".$cgt->cgtGrupo."')");
    ...
    public function update(Request $request)
    {
        ...
        if (!empty($cgt_id)) {
            ...
            for ($i = 0; $i < $contar; $i++) {
                ...
                $resultado =  DB::select("call procPrimariaAlumnoCambioCGT(".$curso_id[$i].", ".$cgt_id[$i].")");
            }
