    ...
    public function list()
    {
        ...
        return DataTables::of($cgts)->addColumn('action',function($query) {
            ...
            if($departamento_control_escolar == 1 || $departamento_sistemas == 1){
                ...
                $btnCambioMatricula = '<a href="primaria_cambiar_matriculas_cgt/'.$query->cgt_id.'" class="button button--icon js-button js-ripple-effect" title="Cambiar matrículas de alumnos">
                    <i class="material-icons">supervisor_account</i>
                </a>';
                $btnEditar = '<a href="primaria_cgt/'.$query->cgt_id.'/edit" class="button button--icon js-button js-ripple-effect" title="Editar">
                    <i class="material-icons">edit</i>
                </a>';

                $btnBorrar = '<form id="delete_'.$query->cgt_id.'" action="primaria_cgt/'.$query->cgt_id.'" method="POST" style="display:inline;">
