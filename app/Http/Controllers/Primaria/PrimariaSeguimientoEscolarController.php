...
use App\Models\Primaria\Primaria_expediente_seguimiento_escolar;
use Carbon\Carbon;
...
class PrimariaSeguimientoEscolarController extends Controller
{
    ...
    {
        $primaria_empleado_id = Auth::user()->id;
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $proximaEntrevistaFecha = $request->proximaEntrevistaFecha;
                $proximaEntrevistaHora = $request->proximaEntrevistaHora;

                if($proximaEntrevistaFecha != "" && $proximaEntrevistaHora =! ""){
                    $proximaFecha = $proximaEntrevistaFecha.' '.$proximaEntrevistaHora;
                }else{
                    $proximaFecha = NULL;
                }
                ...
                Primaria_expediente_seguimiento_escolar::create([
                    ...
                    'proximaEntrevista' => $proximaFecha,
                    ...
                    'primaria_empleado_directora' => $request->perNombreExtra,
