...
class PrimariaCalificacionesIngresController extends Controller
{
    ...
    public function imprimir(Request $request)
    {
        ...
        if ($request->conceptos == "TODOS") {
            ...
            $resultado_array =  DB::select("call procPrimariaCalificacionesMateriaInglesTodosLosConceptos(" . $perAnioPago . ", " . $gpoGrado . ", '" . $gpoClave . "'," . $programa_id . "," . $plan_id . ")");
        } else {
            // llama al procedure de los alumnos a buscar 
