...
class PrimariaRelDeudasController extends Controller
{
  ...
  public function reporte()
  {
    ...
    $aluEstado = [
      ...
      return view('primaria.reportes.relacion_deudas.create', [
        "aluEstado" => $aluEstado,
  ...
  public function imprimir(Request $request)
    {
        ...
        {
            $parametro_NombreArchivo = 'pdf_primaria_relacion_deudas';
            $parametro_Titulo = "RELACIÓN DE DEUDAS DEL ALUMNO";
            $result =  DB::select("call procPrimariaDeudasAlumno("
                .$userId
                .",'".$request->aluClave
                ."','".$request->ubiClave
                ."','".$request->tipoResumen
        ...
        $pdf = PDF::loadView('reportes.pdf.primaria.relacion_deudas.'. $parametro_NombreArchivo, [
