...
class PrimariaAsistenciaGrupoController extends Controller
{
    /**
    ...
    public function reporte()
    {
        ...
        return view('primaria.reportes.asistencia_grupo.create',compact('tiposIngreso', 'alumnos_curso', 'ubicaciones'));
    }
    ...
    public function imprimir(Request $request) {
        ...
        // view('reportes.pdf.primaria.lista_de_asistencia.pdf_asistencia_grupo');
        $pdf = PDF::loadView('reportes.pdf.primaria.lista_de_asistencia.pdf_asistencia_grupo', [
            "datos" => $datos,
            "info" => $info,
