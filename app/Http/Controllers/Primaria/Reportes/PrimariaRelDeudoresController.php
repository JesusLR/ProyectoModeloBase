...
class PrimariaRelDeudoresController extends Controller
{
  ...
  public function reporte()
  {
    ...
    $aluEstado = [
      ...
      return view('primaria.reportes.relacion_deudores.create', [
        "aluEstado" => $aluEstado,
  ...
  public function imprimir(Request $request)
  {
      ...
      $parametro_progClave = "PRI";
      $parametro_progClaveB = "PRI";
      if ($request->progClave == "TODOS")
      {
          $parametro_progClave = "PRI";
          $parametro_progClaveB = "PRB";
      }
      if ($request->progClave == "PRB")
      {
          $parametro_progClave = "PRB";
          $parametro_progClaveB = "PRB";
      }
      ...
      $temporary_table_name = "_" . substr(str_shuffle($permitted_chars), 0, 15);
              ...
              $parametro_NombreArchivo = 'pdf_primaria_relacion_deudores';
              $result =  DB::select("call procPrimariaColeAlumnosPrograma("
                  .$userId
                  .",".$request->perAnio
                  .",'".$request->ubiClave
                  ."','".$request->depClave
              ...
              $parametro_Titulo = "RELACIÓN DE DEUDORES DE ESCUELA: PRIMARIA";//.$result[0]->_return_escuela;
      ...
      if($pagos_deudores_collection->isEmpty()) {
        ...
        $pdf = PDF::loadView('reportes.pdf.primaria.relacion_deudores.'. $parametro_NombreArchivo, [
