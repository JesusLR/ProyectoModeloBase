    ...
    public function imprimirCalificaciones(Request $request)
    {
        ...
        if ($perAnioPago >= 2021) {
            ...
            if ($conceptos == "TODOS") {
                ...
                $resultado_array =  DB::select("call procPrimariaCalificacionesGrupoAsignaturasTodosLosConceptos(" . $perAnioPago . ", " . $gpoGrado . ", '" . $gpoClave . "', " . $programa_id . "," . $plan_id . ")");
            } else {
                ...
                if ($conceptos == "TODOS") {
                    ...
                    // llama al procedure de los alumnos a buscar
                    return $resultado_array =  DB::select("call procPrimariaCalificacionesGrupoAsignaturasTodosLosConceptos(" . $perAnioPago . ", " . $gpoGrado . ", '" . $gpoClave . "'," . $programa_id . "," . $plan_id . ")");
                } else {
                    // agrupa los alumnos
                    $calificacionesInscritos = DB::table('primaria_inscritos')
                        ->select(
                    ...
                    // llama al procedure de los alumnos a buscar
                    $resultado_array =  DB::select("call procPrimariaCalificacionesGrupoAsignaturas(" . $perAnioPago . ", " . $gpoGrado . ", '" . $gpoClave . "', '" . $conceptos . "'," . $programa_id . "," . $plan_id . ")");
                }
            }
        } else {
            // agrupa los alumnos
            ...
            $datos_cabecera = Primaria_inscrito::select(
                ...
                ->get();
            // llama al procedure de los alumnos a buscar
            $resultado_array =  DB::select("call procPrimariaCalificacionesGrupo(" . $perAnioPago . ", " . $gpoGrado . ", '" . $gpoClave . "', '" . $conceptos . "'," . $programa_id . "," . $plan_id . ")");
        }
        ...
        if ($tipoCalificacionVista == "todosGrupos") {
            ...
            if ($perAnioPago >= 2021) {
                ...
                $parametro_NombreArchivo = 'pdf_primaria_calificaciones'; //nombre del archivo blade
            }

            // view('reportes.pdf.primaria.calificacion_por_grupo.pdf_primaria_calificaciones_asignaturas');
            $pdf = PDF::loadView('reportes.pdf.primaria.calificacion_por_grupo.' . $parametro_NombreArchivo, [
            ...
            if ($perAnioPago >= 2021) {
                ...
                if ($conceptos == "TODOS") {
                    ...
                    $materiaNombreSep =  DB::select("call procPrimariaCalificacionesSEPGrupoMateriasTodosLosConceptos("
                    . $perAnioPago . ", " . $gpoGrado . ", '" . $gpoClave . "'," . $programa_id . "," . $plan_id . ")");
                }else{
                    // obtiene el nombre de la materia (SEP)
                $materiaNombreSep =  DB::select("call procPrimariaCalificacionesSEPGrupoMaterias("
                . $perAnioPago . ", " . $gpoGrado . ", '" . $gpoClave . "', '"
                . $conceptos . "'," . $programa_id . "," . $plan_id . ")");
                }
                
            } else {

                if ($conceptos == "TODOS") {
                    $materiaNombreSep =  DB::select("call procPrimariaCalificacionesSEPGrupoTodosLosConceptos(" . $perAnioPago . ", " . $gpoGrado . ", '" . $gpoClave . "'," . $programa_id . "," . $plan_id . ")");

                }else{
                    $materiaNombreSep =  DB::select("call procPrimariaCalificacionesSEPGrupo(" . $perAnioPago . ", " . $gpoGrado . ", '" . $gpoClave . "', '" . $conceptos . "'," . $programa_id . "," . $plan_id . ")");
            ...
            if ($perAnioPago >= 2021) {
                ...
                $parametro_NombreArchivo = 'pdf_primaria_calificaciones_sep'; //nombre del archivo blade
