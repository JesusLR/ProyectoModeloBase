...
class PrimariaRelacionPadresTutoresController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('primaria.reportes.relacion_de_tutores.create', [
    ...
    public function imprimir(Request $request)
    {
        ...
        if($aluClave == "") {
            // llamada al SP 
            $resultado_array =  DB::select("call procPrimariaFamiliaresTutoresGradoGrupo(" . $programa_id . ", 
            " . $plan_id . ",
            " . $periodo_id . ",
            " . $gpoGrado . ",
            '" . $gpoClave . "')");
            ...
            // llamada al SP 
            $resultado_array =  DB::select("call procPrimariaFamiliaresTutoresAlumno(" . $programa_id . ", 
            " . $plan_id . ",
            " . $periodo_id . ",
            " . $gpoGrado . ",
            '" . $gpoClave . "',
        ...
        // view('reportes.pdf.primaria.relacion_de_tutores.pdf_relacion_de_tutores');



        $parametro_NombreArchivo = 'pdf_relacion_de_tutores';
        $pdf = PDF::loadView('reportes.pdf.primaria.relacion_de_tutores.' . $parametro_NombreArchivo, [
