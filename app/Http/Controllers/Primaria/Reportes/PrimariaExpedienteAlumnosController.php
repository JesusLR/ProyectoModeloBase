    ...
    public function imprimirExpediente(Request $request)
    {
        ...
        if($tipoReporte == 3){
            ...
            if($aluClave != ""){
                ...
                $unicoAlumno =  DB::select("call procPrimariaUnAlumnoInscritoGrupo(". $periodo->perAnio . "," . $grado . ",'" . $grupo . "','" . $concepto . "', ".$alumno->id.")");
                ...
                // llama al procedure de los alumnos a buscar 
                $grupoAlumnos =  DB::select("call procPrimariaAlumnosInscritosGrupo(". $periodo->perAnio . "," . $grado . ",'" . $grupo . "','" . $concepto . "')");
