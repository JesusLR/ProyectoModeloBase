...
class PrimariaFaltasController extends Controller
{
    /**
    ...
    public function reporte()
    {
        ...
        return view('primaria.reportes.faltas.create',compact('tiposIngreso', 'alumnos_curso', 'ubicaciones'));
    }
    ...
    public function imprimir(Request $request) {
        ...
        $nombreArchivo = 'pdf_faltas_grupo.pdf';

        // view('reportes.pdf.primaria.faltas.pdf_faltas_grupo');
        $pdf = PDF::loadView('reportes.pdf.primaria.faltas.pdf_faltas_grupo', [
            "datos" => $datos,
            "info" => $info,
