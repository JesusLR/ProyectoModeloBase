...
class PrimariaResumenInscritosSexoController extends Controller
{
  ...
  public function reporte()
  {
    ...
    return view('primaria.reportes.resumen_inscritos_sexo.create', compact('anioActual', 'ubicaciones'));
  }
  ...
  public function imprimir(Request $request)
  {
    ...
    $resultados =  DB::select("call procPrimariaResumenInscritosSexo(
      ".$periodoS->perNumero.",
      ".$periodoS->perAnio.",
      '".$ubicacion->ubiClave."',
      '".$programa->progClave."',
    ...
    // view('reportes.pdf.primaria.resumen_inscritos_sexo.pdf_resumen_inscritos_sexo');
    $nombreArchivo = 'pdf_resumen_inscritos_sexo';
    $pdf = PDF::loadView('reportes.pdf.primaria.resumen_inscritos_sexo.' . $nombreArchivo, [
