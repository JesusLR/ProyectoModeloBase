...
class PrimariaEstudiaronPreescolarController extends Controller
{
    /**
    ...
    public function reporte()
    {
        ...
        return view('primaria.reportes.estudiaronPreescolar.create',compact('alumnos_curso', 'ubicaciones'));
    }
    ...
    public function imprimir(Request $request) {
        ...
        $datos = $cursos->map(function($curso, $key) {
            ...
            return collect([
                ...
                'progNombreCorto' => $curso->cgt->plan->programa->progNombre,
        ...
        // view('reportes.pdf.primaria.estudioPreescolar.pdf_alumnos_por_grupo');
        $pdf = PDF::loadView('reportes.pdf.primaria.estudioPreescolar.pdf_alumnos_por_grupo', [
            "datos" => $datos,
            "info" => $info,
