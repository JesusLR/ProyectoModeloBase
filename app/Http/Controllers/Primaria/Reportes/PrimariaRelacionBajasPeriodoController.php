...
class PrimariaRelacionBajasPeriodoController extends Controller
{
    ...
    public function reporte() {
    	...
    	return view('primaria.reportes.relacion_bajas_periodo.create', compact('ubicaciones'));
    }//reporte.
    ...
    public function imprimir(Request $request) {
        ...
        $pdf = PDF::loadView("reportes.pdf.primaria.relacion_bajas_periodo.".$nombreArchivo, [
        "escuelas" => $escuelas,
        'periodo' => $periodo,
