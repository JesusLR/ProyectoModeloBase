...
class PrimariaAlumnoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('primaria.alumnos.show-list', [
    ...
    public function cambiarMatricula(Request $request)
    {
        ...
        if (User::permiso("alumno") == "A" || User::permiso("alumno") == "B" || User::permiso("alumno") == "E") {
            ...
            return redirect('primaria_alumno');
        }
    }
    ...
    public function postCambiarMatricula (Request $request)
    {
        ...
        if ($alumno->save()) {
            ...
            return redirect('primaria_alumno')->withInput();
        } else {
            ...
            ->addColumn('action', function($query) {
                        ...
                        && (Auth::user()->username != "ANGELINAMICHELL"))
                {
                            ...
                            if (User::permiso("alumno") == "A") {
                                $btnBorrar = '<form id="delete_' . $query->alumno_id . '" action="primaria_alumno/' . $query->alumno_id . '" method="POST" style="display:inline-block;">
                                ...
                                $btnModificarEstatus = '<a href="#modalEstatusAlumno-primaria" data-alumno-id="'. $query->alumno_id . '" class="btn-modal-estatus-alumno modal-trigger button button--icon js-button js-ripple-effect" title="Cambiar Estatus Del Alumno">
                            ...
                            if (User::permiso("alumno") == "A" || User::permiso("alumno") == "B" || User::permiso("alumno") == "C") {
                                $btnHistorialPagos = '<a href="#modalHistorialPagosAluPrimaria" data-nombres="' . $query->perNombre . " " . $query->perApellido1 . " " . $query->perApellido2 .
                                    '" data-aluClave="' . $query->aluClave . '" data-alumno-id="'.$query->alumno_id.'" class="modal-trigger btn-modal-historial-pagos-primaria button button--icon js-button js-ripple-effect" title="Historial Pagos">
                    ...
                    return $modalCursos .'
                    <a href="primaria_alumno/' . $query->alumno_id . '" class="button button--icon js-button js-ripple-effect" title="Ver">
                        <i class="material-icons">visibility</i>
                    </a>
                    <a href="primaria_alumno/' . $query->alumno_id . '/edit" class="button button--icon js-button js-ripple-effect" title="Editar">
    ...
    public function changePassword(Request $request, $alumno_id)
    {
        ...
        return view('primaria.alumnos.change_password', compact('alumno'));
    }
    ...
    public function create()
    {
        ...
        return view('primaria.alumnos.create', compact('departamentos', 'paises'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            */
            ...
            return redirect('primaria_alumno/create')->withInput();
        }
        ...
        return view('primaria.cursos.create', compact(
            'ubicaciones',
            'planesPago',
            'tiposIngreso',
            'tiposBeca',
    ...
    public function show($id)
    {
        ...
        return view('primaria.alumnos.show', compact('alumno', 'departamentos', 'preparatoriaProcedencia', 'ultimoCurso', 'personaAutorizada1', 'personaAutorizada2'));
    }
    ...
    public function edit($id)
    {
        ...
        if (User::permiso("alumno") == "A" || User::permiso("alumno") == "B" || User::permiso("alumno") == "C" || User::permiso("alumno") == "E") {
            return view('primaria.alumnos.edit', compact(
        ...
        return redirect()->route('primaria_alumno.index');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            */
            ...
            $errorMessage = $e->errorInfo[2];
            alert()->error('Ups...' . $errorCode,$errorMessage)->showConfirmButton();
            return redirect('primaria_alumno/' . $id . '/edit')->withInput();
        }
    ...
    public function empleado_crearAlumno(Request $request,$empleado_id){
        ...
        if ($validator->fails()) {
            return redirect ('primaria_alumno/create')->withErrors($validator)->withInput();
        }
