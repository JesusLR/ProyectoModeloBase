...
use App\Http\Models\Secundaria\Secundaria_alumnos_historia_clinica_actividades;
use App\Http\Models\Secundaria\Secundaria_alumnos_historia_clinica_conducta;
use App\Http\Models\Secundaria\Secundaria_alumnos_historia_clinica_desarrollo;
use App\Http\Models\Secundaria\Secundaria_alumnos_historia_clinica_familiares;
use App\Http\Models\Secundaria\Secundaria_alumnos_historia_clinica_habitos;
use App\Http\Models\Secundaria\Secundaria_alumnos_historia_clinica_heredo;
use App\Http\Models\Secundaria\Secundaria_alumnos_historia_clinica_medica;
use App\Http\Models\Secundaria\Secundaria_alumnos_historia_clinica_nacimiento;
use App\Http\Models\Secundaria\Secundaria_alumnos_historia_clinica_sociales;
...
class SecundariaAlumnosHistoriaClinicaController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        'secundaria_alumnos_historia_clinica.hisUltimoGrado','secundaria_alumnos_historia_clinica.hisRecursado','secundaria_alumnos_historia_clinica.hisRecursadoDetalle',
        'secundaria_alumnos_historia_clinica.hisIngresoSecundaria',
        'secundaria_alumnos_historia_clinica.hisEdadActualMeses','secundaria_alumnos_historia_clinica.usuario_at',
        'alumnos.persona_id','alumnos.aluClave','personas.perCurp', 'personas.perApellido1', 'personas.perApellido2', 'personas.perNombre',
        'personas.perFechaNac', 'municipios.id as municipio_id', 'municipios.munNombre', 'estados.edoNombre','paises.id as pais_id' ,'paises.paisNombre')
        ->join('alumnos', 'alumnos.id', '=', 'secundaria_alumnos_historia_clinica.alumno_id')
        ->join('personas', 'personas.id', '=', 'alumnos.persona_id')
