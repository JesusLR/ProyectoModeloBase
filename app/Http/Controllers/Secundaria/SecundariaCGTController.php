    ...
    public function list()
    {
        ...
        return DataTables::of($cgts)->addColumn('action',function($query) {
            ...
            if($departamento_sistemas == 1){
                ...
                $btnCambioMatricula = '<a href="secundaria_cambiar_matriculas_cgt/'.$query->cgt_id.'" class="button button--icon js-button js-ripple-effect" title="Cambiar matrículas de alumnos">
                    <i class="material-icons">supervisor_account</i>
                </a>';
                $btnEditar = '<a href="secundaria_cgt/'.$query->cgt_id.'/edit" class="button button--icon js-button js-ripple-effect" title="Editar">
                    <i class="material-icons">edit</i>
                </a>';

                $btnBorrar = '<form id="delete_'.$query->cgt_id.'" action="secundaria_cgt/'.$query->cgt_id.'" method="POST" style="display:inline;">
