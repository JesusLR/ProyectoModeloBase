...
use Validator;
use Auth;
class SecundariaPeriodosController extends Controller
{
    ...
    {
        return view('secundaria.periodos.show-list');
    }
    ...
    public function list()
    {
        ...
        ->addColumn('action',function($query) {
            return '<a href="secundaria_periodo/' . $query->periodo_id . '" class="button button--icon js-button js-ripple-effect" title="Ver">
                <i class="material-icons">visibility</i>
            </a>
            <a href="secundaria_periodo/' . $query->periodo_id . '/edit" class="button button--icon js-button js-ripple-effect" title="Editar">
                <i class="material-icons">edit</i>
            </a>
            <form id="delete_' . $query->periodo_id . '" action="secundaria_periodo/' . $query->periodo_id . '" method="POST" style="display:inline;">
    ...
    public function getPeriodoActual(Request $request, $departamento_id)
    {
        $fecha = Carbon::now('CDT');
    ...
    */
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            return redirect ('secundaria_periodo/create')->withErrors($validator)->withInput();
        }
        ...
        try {
            ...
            return redirect('secundaria_periodo/create')->withInput();
        }
    }
    ...
    public function show($id)
    {
        ...
        return view('secundaria.periodos.show', [
            'periodo' => $periodo
        ]);
    }
    ...
    public function edit($id)
    {
        if (User::permiso("periodo") == "A" || User::permiso("periodo") == "B") {
            ...
            return view('secundaria.periodos.edit', [
                'periodo' => $periodo
            ]);
        } else {
            alert()->error('Ups...', 'Sin privilegios para esta acción!')->showConfirmButton()->autoClose(5000);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $errorMessage = $e->errorInfo[2];
            alert()->error('Ups...' . $errorCode,$errorMessage)->showConfirmButton();
            return redirect('secundaria_periodo/' . $id . '/edit')->withInput();
        }
    }
