...
class SecundariaListaNegraController extends Controller
{
    ...
    {
        return view('secundaria.listaNegra.show-list');
    }
    ...
    public function list()
    {
        ...
        return DataTables::of($listaNegra)
            ...
            ->addColumn('action', function ($query) {
                ...
                $btnEditar = '<a href="secundaria_alumnos_restringidos/' . $query->id . '/edit" class="button button--icon js-button js-ripple-effect" title="Editar">
                        <i class="material-icons">edit</i>
                    </a>';

                $btnBorrar = '<form id="delete_' . $query->id . '" action="secundaria_alumnos_restringidos/' . $query->id . '" method="POST" style="display:inline;">
                ...
                return '<a href="secundaria_alumnos_restringidos/' . $query->id . '" class="button button--icon js-button js-ripple-effect" title="Ver">
    ...
    public function create()
    {
        ...
        return view('secundaria.listaNegra.create',[
            'alumno' => $alumno,
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            return redirect ('secundaria_alumnos_restringidos/create')->withErrors($validator)->withInput();
        }
        ...
        if($listaNegra != ""){
            ...
            return redirect ('secundaria_alumnos_restringidos/create')->withInput();
        }else{
    ...
    public function edit($id)
    {
        ...
        return view('secundaria.listaNegra.edit',[
    ...
    public function show($id)
    {
        ...
        return view('secundaria.listaNegra.show',[
            'listaNegra' => $listaNegra,
            'alumno' => $alumno,
            'persona' => $persona,
            'NivelListaNegra' => $NivelListaNegra,
    ...
    public function destroy($id)
    {
        ...
        return redirect('secundaria_alumnos_restringidos')->withInput();
    }
}
