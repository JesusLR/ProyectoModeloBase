...
class SecundariaCambiarCGTController extends Controller
{
    ...
    public function edit(Request $request)
    {
        ...
        return view('secundaria.cambiar_cgt.create', [
    ...
    public function getSecundariaInscritoCursos(Request $request, $periodo_id, $programa_id, $plan_id, $cgt_id)
    {
        if($request->ajax()){
            ...
            // llama al procedure
            $resultado_array =  DB::select("call procSecundariaInscritoHayDatos(".$periodo_id.", ".$programa_id.", '".$plan_id."', ".$cgt_id.",".$cgt->cgtGradoSemestre.",'".$cgt->cgtGrupo."')");
    ...
    public function update(Request $request)
    {
        ...
        if (!empty($cgt_id)) {
            ...
            for ($i = 0; $i < $contar; $i++) {
                ...
                $resultado =  DB::select("call procSecundariaAlumnoCambioCGT(".$curso_id[$i].", ".$cgt_id[$i].")");
            }
