...
class SecundariaResumenDeInasistenciasController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('secundaria.reportes.resumen_de_inasistencias.create', [
    ...
    public function reporteResumenInasistencias(Request $request)
    {
        ...
        if ($tipoReporte == "porMes") {
            $parametro_Titulo = "RESUMEN DE INASISTENCIAS MENSUALES";
        }
        if ($tipoReporte == "porBimestre") {
            $parametro_Titulo = "RESUMEN DE INASISTENCIAS BIMESTRAL";
        }
        if ($tipoReporte == "porTrimestre") {
            $parametro_Titulo = "RESUMEN DE INASISTENCIAS TRIMESTRAL";
        }
        ...
        if ($tipoCalificacionVista == "todasLasMaterias") {
            ...
            $parametro_NombreArchivo = 'pdf_secundaria_resumen_de_inasistencias'; //nombre del archivo blade

            $pdf = PDF::loadView('reportes.pdf.secundaria.resumen_de_inasistencias.' . $parametro_NombreArchivo, [
        ...
        if ($tipoCalificacionVista == "matOficialesSep") {
            ...
            $parametro_NombreArchivo = 'pdf_secundaria_resumen_de_inasistencias_sep'; //nombre del archivo blade
            // view('reportes.pdf.secundaria.resumen_de_inasistencias.pdf_secundaria_resumen_de_inasistencias_sep');
