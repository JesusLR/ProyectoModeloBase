...
class SecundariaResumenInscritosSexoController extends Controller
{
  ...
  public function reporte()
  {
    ...
    return view('secundaria.reportes.resumen_inscritos_sexo.create', compact('anioActual', 'ubicaciones'));
  }
  ...
  public function imprimir(Request $request)
  {
    ...
    $resultados =  DB::select("call procSecundariaResumenInscritosSexo(
      " . $periodoS->perNumero . ",
      " . $periodoS->perAnio . ",
      '" . $ubicacion->ubiClave . "',
      '" . $programa->progClave . "',
    ...
    // view('reportes.pdf.secundaria.resumen_inscritos_sexo.pdf_resumen_inscritos_sexo');
    $nombreArchivo = 'pdf_resumen_inscritos_sexo';
    $pdf = PDF::loadView('reportes.pdf.secundaria.resumen_inscritos_sexo.' . $nombreArchivo, [
