...
class SecundariaAlumnosBecadosController extends Controller
{
    ...
    public function reporte()
    {
      ...
      return view('secundaria.reportes.alumnos_becados.create', [
        'tiposBeca' => $tiposBeca,
    ...
    public function imprimir(Request $request)
    {
      ...
      return PDF::loadView('reportes.pdf.secundaria.alumnos_becados.' . $nombreArchivo, [
        "datos" => $this->alumnos,
