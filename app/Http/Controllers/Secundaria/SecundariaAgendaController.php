...
class SecundariaAgendaController extends Controller
{
    ...
    public function index()
    {
        ...
        ->leftJoin('users', 'users.id', '=', 'secundaria_agenda_colores.users_id')
        ->leftJoin('secundaria_empleados', 'secundaria_empleados.id', '=', 'users.empleado_id')
        ->get();
    ...
    public function show($id)
    {
        ...
        'secundaria_empleados.empApellido1 as perApellido1', 
        'secundaria_empleados.empApellido2 as perApellido2')
        ->leftJoin('users', 'users.id', '=', 'secundaria_agendas.usuario_at')
        ->leftJoin('secundaria_empleados', 'secundaria_empleados.id', '=', 'users.empleado_id')
