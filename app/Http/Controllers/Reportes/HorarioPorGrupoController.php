...
class HorarioPorGrupoController extends Controller
{
  ...
  {
    return View('reportes/horario_por_grupo.create', [
  ...
  public function imprimir(Request $request)
  {
    ...
    $cgts = DB::select(DB::raw("call procHorarioCGT(
      {$periodo->perNumero},
      {$periodo->perAnio},
      '{$ubicacion->ubiClave}',
      '{$ubicacion->depClave}',
    ...
    foreach ($cgts as $cgt) {
      ...
      $section->addText('UNIVERSIDAD MODELO', $universidadFontStyle, $centeredText);
      ...
      $horarios = DB::select(DB::raw('call procHorarioImpreso('
        ."'".$cgt->perNumero . "'"
        .","."'".$cgt->perAnio . "'"
        .","."'".$cgt->ubiClave . "'"
        .",". "'".$cgt->progClave . "'"
      ...
      foreach ($horarios as $horario) {
        ...
        $table->addCell(2000)->addText($horario->horaInicio."-".$horario->horaFinal, $cellFontStyle, $cellVCentered);
      ...
      $lista = DB::select(DB::raw('call procHorarioLista('
        ."'".$cgt->perNumero . "'"
        .","."'".$cgt->perAnio . "'"
        .","."'".$cgt->ubiClave . "'"
        .",". "'".$cgt->progClave . "'"
