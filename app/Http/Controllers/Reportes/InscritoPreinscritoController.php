...
class InscritoPreinscritoController extends Controller
{
    /**
    ...
    public function reporte()
    {
        ...
        return View('reportes/inscrito_preinscrito.create',compact('tiposIngreso','alumnos_curso','alumnos_estado','tipo_reporte','orden_reporte','espaciado', 'ubicaciones'));
    }
        ...
        if (count($cgts)) {
            ...
            foreach ($cgts as $cgt) {
                ...
                foreach ($alumno as $fila) {
                    ...
                    if($fila->curEstado == "C" || $fila->estadoActual == "A"){
                        $estadoActual = "(Con)";
                    }
                    ...
                    $datoNombre = sprintf("%s %s %s", $fila->perApellido1, $fila->perApellido2, $fila->perNombre.' '.$estadoActual);
                    $estadoActual = "";
            ...
            return redirect('reporte/inscrito_preinscrito')->withInput();
        }
