...
class RelDeudasController extends Controller
{
  ...
  public function reporte()
  {
    ...
    $aluEstado = [
      ...
      return View('reportes/relacion_deudas.create', [
        "aluEstado" => $aluEstado,
  ...
  public function imprimir(Request $request)
    {
        ...
        {
            $parametro_NombreArchivo = 'pdf_relacion_deudas';
            $parametro_Titulo = "RELACIÓN DE DEUDAS DEL ALUMNO";
            $result =  DB::select("call procDeudasAlumno("
                .$userId
                .",'".$request->aluClave
                ."','".$request->ubiClave
                ."','".$request->tipoResumen."')");

            $pagos_deudores_array = DB::select('select * from _relacion_deudas_temp');
