...
class HistoricoInscripcionController extends Controller
{
  /**
  ...
  public function reporte()
  {
    ...
    return View('reportes.historico_inscripcion.create',compact('grados', 'opciones', 'ubicaciones'));
  }
  ...
  /**
    ...
    {
      if ($opcion == 'F') {
        $mensaje = 'SÓLO SE INCLUYEN ALUMNOS QUE ESTEN REGISTRADOS EN AL MENOS UN CURSO ANTERIOR AL NIVEL SUPERIOR';
      } elseif ($opcion == 'R') {
      ...
      $sheet->setCellValue('A1', "ESCUELA MODELO, S.C.P.");
      $sheet->setCellValue('A2', "HISTORICOS DE INSCRIPCIONES DE ALUMNOS DE NIVEL SUPERIOR");
