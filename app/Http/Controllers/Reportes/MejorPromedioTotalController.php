...
class MejorPromedioTotalController extends Controller
{
    //
    ...
    public function reporte() {
    	...
    	return view('reportes/mejor_promedio_total.create', compact('ubicaciones'));
    }
    ...
    public function imprimir(Request $request) {
    	...
    	$promedios = DB::select('call procMejoresPromediosTotal('.$parametros.')');
