...
class GimnasioAlumnoController extends Controller
{
    ...
    public function index()
    {
        ...
        return View('gimnasio.alumno.show-list', [
        ...
        return Datatables::of($alumnos)
            ...
            ->addColumn('action', function($query) {
                ...
                if (User::permiso("alumno") == "A") {
                    $btnBorrar = '<form id="delete_' . $query->alumno_id . '" action="gimnasio_alumno/' . $query->alumno_id . '" method="POST" style="display:inline-block;">
                ...
                <a href="gimnasio_alumno/cambiar_matricula/' . $query->alumno_id . '" class="button button--icon js-button js-ripple-effect" title="Cambiar matricula">
                ...
                */
                ...
                return '<a href="gimnasio_alumno/' . $query->alumno_id . '" class="button button--icon js-button js-ripple-effect" title="Ver">
                    <i class="material-icons">visibility</i>
                </a>
                <a '.$btnModificarHide.' href="gimnasio_alumno/' . $query->alumno_id . '/edit" class="button button--icon js-button js-ripple-effect" title="Editar">
    ...
    public function create()
    {
        ...
        return view('gimnasio.alumno.create', compact('departamentos', 'paises'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            */
            ...
            return redirect('gimnasio_alumno/create')->withInput();
        }
        ...
        return redirect('gimnasio_alumno');
    }//function store.
    ...
    public function show($id)
    {
        ...
        return view('gimnasio.alumno.show', compact('alumno', 'departamentos', 'preparatoriaProcedencia', 'ultimoCurso'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('gimnasio.alumno.edit', compact(
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            */
            ...
            $errorMessage = $e->errorInfo[2];
            alert()->error('Ups...' . $errorCode,$errorMessage)->showConfirmButton();
            return redirect('gimnasio_alumno/' . $id . '/edit')->withInput();
        }
    ...
    public function empleado_crearAlumno(Request $request,$empleado_id){
        ...
        if ($validator->fails()) {
            return redirect ('gimnasio_alumno/create')->withErrors($validator)->withInput();
        }
