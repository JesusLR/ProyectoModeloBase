...
class EgresadoController extends Controller
{
    ...
    public function __contruct(){
    	...
    	$this->middleware('permisos:egresados');
    }
    ...
    */
    public function filtro(){
    	...
    	return view('egresados.procesar', [
    ...
    public function procesar(Request $request){
    	...
    	$resacas = ResumenAcademico::with('plan.programa','alumno.persona')
    ...
    public function getAlumnoByClave($aluClave){
    	...
    	$resumen = ResumenAcademico::with(['periodoUltimo','alumno.persona', 'plan.programa.escuela.departamento.ubicacion'])
    ...
    */
    ...
    public function index(){
        return view('egresados.show-list');
    }//index
    ...
    public function store(Request $request){
        ...
        $resumen = ResumenAcademico::with(['alumno','plan.programa'])
