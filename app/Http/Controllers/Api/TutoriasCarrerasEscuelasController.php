...
class TutoriasCarrerasEscuelasController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'idCampus' => 'required|int',
            'idEscuela' => 'required|int',
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    return DB::select("call procExUniProgramasPorEscuela(". $request->idCampus .
                        ", ". $request->idEscuela .")");
                }
            }
