...
class PreescolarActividadesController extends Controller
{
    ...
    {
        return view('preescolar.actividades.show-list');
    }
        ...
        return DataTables::of($actividad)
            ...
            ->addColumn('action', function ($actividad) {
                $acciones = '<div class="row">                   
                    ...
                    <a href="preescolar_actividades/' . $actividad->id . '" class="button button--icon js-button js-ripple-effect" title="Ver">
                    <i class="material-icons">visibility</i>
                    </a>

                    <a href="preescolar_actividades/' . $actividad->id . '/edit" class="button button--icon js-button js-ripple-effect" title="Editar">
    ...
    public function create()
    {
        ...
        return view('preescolar.actividades.create', [
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            return redirect('preescolar_actividades/create')->withErrors($validator)->withInput();
        } else {
            try {
                ...
                return redirect()->route('preescolar.preescolar_actividades.index');
                ...
                alert()
                    ...
                    ->showConfirmButton();
                return redirect('preescolar_actividades/create')->withInput();
            }
        }
    }
    ...
    public function show($id)
    {
        ...
        return view('preescolar.actividades.show', [
            'actividad' => $actividad
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('preescolar.actividades.edit', [
            'empleados' => $empleados,
            'actividad' => $actividad,
            'ubicaciones' => $ubicaciones
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validator->fails()) {
            return redirect('preescolar_actividades/'.$id.'/edit')->withErrors($validator)->withInput();
        } else {
            try {
                ...
                alert()
                    ->error('Ups...' . $errorCode, $errorMessage)
                    ->showConfirmButton();
                return redirect('preescolar_actividades/'.$id.'/edit')->withInput();
            }
        }
    }
