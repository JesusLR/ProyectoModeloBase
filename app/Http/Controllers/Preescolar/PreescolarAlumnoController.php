...
class PreescolarAlumnoController extends Controller
{
    ...
    public function index()
    {
        ...
        return View('preescolar.alumnos.show-list', [
    ...
    public function cambiarMatricula(Request $request)
    {
        ...
        if (User::permiso("alumno") == "A" || User::permiso("alumno") == "B" || User::permiso("alumno") == "E") {
            return view('preescolar.alumnos.cambiar-matricula-preescolar', compact('alumno', 'departamentos', "planes"));
        } else {
            alert()->error('Ups...', 'Sin privilegios para esta acción!')->showConfirmButton()->autoClose(2000);
            return redirect('preescolar_alumnos');
        }
    }
    ...
    public function postCambiarMatricula (Request $request)
    {
        ...
        if ($alumno->save()) {
            ...
            return redirect('preescolar_alumnos')->withInput();
        } else {
        ...
        return Datatables::of($alumnos)
            ...
            ->addColumn('action', function($query) {
                ...
                if (User::permiso("alumno") == "A") {
                    ...
                    if ($alumnoExiste) {
                        $btnPasswordChange = '<a href="preescolar_alumnos/change_password/' . $query->alumno_id . '" class="button button--icon js-button js-ripple-effect" title="Cambiar contraseña Del Alumno">
                ...
                $btnHistorialPagos = '<a href="#modalHistorialPagosAlu-Prescolar" data-nombres="' . $query->perNombre . " " . $query->perApellido1 . " " . $query->perApellido2 .
                ...
                return $modalCursos . '<a href="preescolar_alumnos/' . $query->alumno_id . '" class="button button--icon js-button js-ripple-effect" title="Ver">
                    <i class="material-icons">visibility</i>
                </a>
                <a href="preescolar_alumnos/' . $query->alumno_id . '/edit" class="button button--icon js-button js-ripple-effect" title="Editar">
    ...
    public function changePassword(Request $request, $alumno_id)
    {
        ...
        return view('preescolar.alumnos.change_password', compact('alumno'));
    }
    ...
    public function create()
    {
        ...
        $departamentos = Departamentos::buscarSoloAcademicos(1, ['PRE','MAT'])->unique("depClave");
        //dd($departamentos);
        $paises = Pais::get();

        return view('preescolar.alumnos.create', compact('departamentos', 'paises'));
    }
 ...
 and p.deleted_at is null and p.perCurp = ?", [$nosoymexicano]);
        ...
        return view('preescolar.curso_preinscrito.create', compact(
    ...
    public function show($id)
    {
        ...
        return view('preescolar.alumnos.show', compact('alumno', 'departamentos', 'preparatoriaProcedencia', 'ultimoCurso', 'personaAutorizada1', 'personaAutorizada2'));
    }
    ...
    public function edit($id)
    {
        ...
        if (User::permiso("alumno") == "A" || User::permiso("alumno") == "B" || User::permiso("alumno") == "C" || User::permiso("alumno") == "E") {
            return view('preescolar.alumnos.edit', compact(
        ...
        return redirect()->route('preescolar_alumnos.index');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'municipio_id.required' => 'El municipio es obligatorio',
            'perSexo.required' => 'El sexo es obligatorio',
            'perTelefono2.required' => 'El campo teléfono móvil es obligatorio.',
            'perCorreo1.email' => 'Debe proporcionar una dirección de correo válida, Favor de verificar.',
        ...
        try {
            ...
            */
            ...
            $errorMessage = $e->errorInfo[2];
            alert()->error('Ups...' . $errorCode,$errorMessage)->showConfirmButton();
            return redirect('preescolar_alumnos/' . $id . '/edit')->withInput();
        }
    ...
    public function empleado_crearAlumno(Request $request,$empleado_id){
        ...
        if ($validator->fails()) {
            return redirect ('preescolar_alumnos/create')->withErrors($validator)->withInput();
        }
