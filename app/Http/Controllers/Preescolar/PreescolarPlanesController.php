...
class PreescolarPlanesController extends Controller
{
    ...
    {
        return view('preescolar.planes.show-list');
    }
    ...
    public function list()
    {
        ...
        return DataTables::of($planes)->addColumn('action',function($query){
            return '<a href="preescolar_plan/'.$query->plan_id.'" class="button button--icon js-button js-ripple-effect" title="Ver">
                <i class="material-icons">visibility</i>
            </a>
            <a href="preescolar_plan/'.$query->plan_id.'/edit" class="button button--icon js-button js-ripple-effect" title="Editar">
                <i class="material-icons">edit</i>
            </a>
            <a href="#modalCambiarEstadoPreescolar" data-plan-id="'.$query->plan_id.'" class="btn-modal-estatus-plan-preescolar modal-trigger button button--icon js-button js-ripple-effect" title="Cambiar Estado">
                <i class="material-icons">unarchive</i>
            </a>

            <form id="delete_' . $query->plan_id . '" action="preescolar_plan/' . $query->plan_id . '" method="POST" style="display:inline;">
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            return redirect ('preescolar_plan/create')->withErrors($validator)->withInput();
        }
        ...
        if (Utils::validaPermiso('plan',$programa_id)) {
            ...
            return redirect()->to('preescolar_materia/create');
        }
    ...
    public function show($id)
    {
        ...
        return view('preescolar.planes.show', [
            'plan' => $plan
        ]);
    }
    ...
    public function edit($id)
    {
        if (User::permiso("plan") == "A" || User::permiso("plan") == "B") {
            ...
            return view('preescolar.planes.edit', [
                'plan' => $plan
            ]);
