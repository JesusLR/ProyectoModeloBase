...
class PreescolarRelDeudasController extends Controller
{
  ...
  public function reporte()
  {
    ...
    $aluEstado = [
      ...
      return View('preescolar/reportes_relacion_deudas.create', [
        "aluEstado" => $aluEstado,
  ...
  public function imprimir(Request $request)
    {
        ...
        {
            $parametro_NombreArchivo = 'pdf_preescolar_relacion_deudas';
            $parametro_Titulo = "RELACIÓN DE DEUDAS DEL ALUMNO";
            $result =  DB::select("call procPreescolarDeudasAlumno("
                .$userId
                .",'".$request->aluClave
                ."','".$request->ubiClave
                ."','".$request->tipoResumen
