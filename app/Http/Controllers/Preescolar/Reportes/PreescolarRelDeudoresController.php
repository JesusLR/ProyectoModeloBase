...
class PreescolarRelDeudoresController extends Controller
{
  ...
  public function reporte()
  {
    ...
    $aluEstado = [
      ...
      return View('preescolar/reportes_relacion_deudores.create', [
        "aluEstado" => $aluEstado,
  ...
  public function imprimir(Request $request)
  {
      ...
      $parametro_Semestre_Fin = 3;
      $parametro_Semestre_Filtro_Inicio = 1;
      $parametro_Semestre_Filtro_Fin = 3;
      ...
      $temporary_table_name = "_" . substr(str_shuffle($permitted_chars), 0, 15);
          ...
          {
              $parametro_NombreArchivo = 'pdf_preescolar_relacion_deudores';
              $result =  DB::select("call procPreescolarColeAlumnosPrograma("
                  .$userId
                  .",".$request->perAnio
                  .",'".$request->ubiClave
                  ."','".$request->depClave
      ...
      if($pagos_deudores_collection->isEmpty()) {
        ...
        $pdf = PDF::loadView('reportes.pdf.preescolar.'. $parametro_NombreArchivo, [
