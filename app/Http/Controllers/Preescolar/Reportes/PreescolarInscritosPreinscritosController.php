...
class PreescolarInscritosPreinscritosController extends Controller
{
     /**
    ...
    public function reporte()
    {
        ...
        return View('preescolar.reportes_inscritos-preinscritos.create',compact('tiposIngreso','alumnos_curso','alumnos_estado','tipo_reporte','orden_reporte','espaciado', 'ubicaciones', 'departamentos'));
    }
    ...
    public function imprimir(Request $request)
    {
        ...
        if (count($cgts)) {
            ...
            $pdf->AliasNbPages();
            $pdf->SetTitle('Relacion de Preescolar Inscritos');
            $pdf->SetFont('Times', '', 9);
...
class PDF extends Fpdf
{
    function Header()
    {
        ...
        $this->Ln($altoTitulo);
        $this->Cell(0, $altoTitulo, "PreescolarInscritosPreinscritosController.php", $dibujarLinea, 0, 'R');
        $this->Ln($altoTitulo);
