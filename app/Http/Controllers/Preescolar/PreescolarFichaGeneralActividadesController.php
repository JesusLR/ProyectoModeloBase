...
class PreescolarFichaGeneralActividadesController extends Controller
{
     ...
     */
    public function index($aluClave = null, $perAnioPago = null, $programa_id = null)
    {
        ...
        return view('preescolar.ficha_general.create', [
    ...
    public function obtenerCuotaConcepto(Request $request)
    {
        ...
        $conceptoPago = Conceptospago_aex::where("progClave", "=", $cuoConcepto)->first();
