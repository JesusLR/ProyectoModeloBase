...
class PreescolarFechaCalificacionesController extends Controller
{
    ...
    {
        return view('preescolar.fechas_calificaciones.show-list');
    }
    ...
    public function list()
    {
        ...
        return DataTables::of($preescolar_calificaciones_fechas)
            ...
            ->addColumn('action', function ($query) {
                return '<a href="preescolar_fecha_de_calificaciones/' . $query->id . '" class="button button--icon js-button js-ripple-effect" title="Ver">
                <i class="material-icons">visibility</i>
            </a>
            <a href="preescolar_fecha_de_calificaciones/' . $query->id . '/edit" class="button button--icon js-button js-ripple-effect" title="Editar">
    ...
    public function create()
    {
        ...
        return view('preescolar.fechas_calificaciones.create', [
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                if ($trimestre1_docente_inicio >= $periodo->perFechaInicial && $trimestre1_docente_inicio <= $periodo->perFechaFinal) {
                    if ($trimestre1_docente_fin > $trimestre1_docente_inicio) {
                        if ($trimestre1_administrativo_edicion > $trimestre1_docente_inicio && $trimestre1_administrativo_edicion < $periodo->perFechaFinal && $trimestre1_administrativo_edicion > $trimestre1_docente_fin) {
                            if ($trimestre1_alumnos_publicacion > $trimestre1_docente_inicio && $trimestre1_alumnos_publicacion <= $periodo->perFechaFinal && $trimestre1_alumnos_publicacion > $trimestre1_administrativo_edicion) {
                                $trimestreUno = "Todo Bien";
                            } else {
                                alert('Escuela Modelo', 'La fecha de publicación del trimestre 1 no puede ser menor a la fecha de edición', 'warning')->showConfirmButton();
                                return redirect('preescolar_fecha_de_calificaciones/create')->withErrors($validator)->withInput();
                            }
                        } else {
                            alert('Escuela Modelo', 'La fecha de edición del trimestre 1 no puede ser menor a la fecha de inicio, ni menor a la fecha de fin', 'warning')->showConfirmButton();
                            return redirect('preescolar_fecha_de_calificaciones/create')->withErrors($validator)->withInput();
                        }
                    } else {
                ...
                if ($trimestre2_docente_inicio > $trimestre1_alumnos_publicacion) {
                    if ($trimestre2_docente_inicio >= $periodo->perFechaInicial && $trimestre2_docente_inicio <= $periodo->perFechaFinal) {
                        if ($trimestre2_docente_fin > $trimestre2_docente_inicio) {
                            if ($trimestre2_administrativo_edicion > $trimestre2_docente_inicio && $trimestre2_administrativo_edicion < $periodo->perFechaFinal && $trimestre2_administrativo_edicion > $trimestre2_docente_fin) {
                                if ($trimestre2_alumnos_publicacion > $trimestre2_docente_inicio && $trimestre2_alumnos_publicacion <= $periodo->perFechaFinal && $trimestre2_alumnos_publicacion > $trimestre2_administrativo_edicion) {
                                    $trimestreUno = "Todo Bien";
                                } else {
                                    alert('Escuela Modelo', 'La fecha de publicación del trimestre 2 no puede ser menor a la fecha de edición', 'warning')->showConfirmButton();
                                    return redirect('preescolar_fecha_de_calificaciones/create')->withErrors($validator)->withInput();
                                }
                            } else {
                                alert('Escuela Modelo', 'La fecha de edición del trimestre 2 no puede ser menor a la fecha de inicio, ni menor a la fecha de fin', 'warning')->showConfirmButton();
                                return redirect('preescolar_fecha_de_calificaciones/create')->withErrors($validator)->withInput();
                            }
                        } else {
                        ...
                        alert('Escuela Modelo', 'La fecha de inicio del trimestre 2 no puede ser menor a la fecha de inicio del período seleccionado ni mayor a la fecha de fin del período seleccionado', 'warning')->showConfirmButton();
                        return redirect('preescolar_fecha_de_calificaciones/create')->withErrors($validator)->withInput();
                    }
                } else {
                ...
                if ($trimestre3_docente_inicio > $trimestre1_alumnos_publicacion && $trimestre3_docente_inicio > $trimestre2_alumnos_publicacion) {
                    if ($trimestre3_docente_inicio >= $periodo->perFechaInicial && $trimestre3_docente_inicio <= $periodo->perFechaFinal) {
                        if ($trimestre3_docente_fin > $trimestre3_docente_inicio) {
                            if ($trimestre3_administrativo_edicion > $trimestre3_docente_inicio && $trimestre3_administrativo_edicion < $periodo->perFechaFinal && $trimestre3_administrativo_edicion > $trimestre3_docente_fin) {
                                if ($trimestre3_alumnos_publicacion > $trimestre3_docente_inicio && $trimestre3_alumnos_publicacion <= $periodo->perFechaFinal && $trimestre3_alumnos_publicacion > $trimestre3_administrativo_edicion) {
                                    $trimestreUno = "Todo Bien";
                                } else {
                                    alert('Escuela Modelo', 'La fecha de publicación del trimestre 3 no puede ser menor a la fecha de edición', 'warning')->showConfirmButton();
                                    return redirect('preescolar_fecha_de_calificaciones/create')->withErrors($validator)->withInput();
                                }
                            } else {
                                alert('Escuela Modelo', 'La fecha de edición del trimestre 3 no puede ser menor a la fecha de inicio, ni menor a la fecha de fin', 'warning')->showConfirmButton();
                                return redirect('preescolar_fecha_de_calificaciones/create')->withErrors($validator)->withInput();
                            }
                        } else {
                        ...
                        alert('Escuela Modelo', 'La fecha de inicio del trimestre 3 no puede ser menor a la fecha de inicio del período seleccionado ni mayor a la fecha de fin del período seleccionado', 'warning')->showConfirmButton();
                        return redirect('preescolar_fecha_de_calificaciones/create')->withErrors($validator)->withInput();
                    }
                } else {
                ...
                alert()
                    ...
                    ->showConfirmButton();
                return redirect('preescolar_fecha_de_calificaciones/create')->withInput();
            }
        }
    }
