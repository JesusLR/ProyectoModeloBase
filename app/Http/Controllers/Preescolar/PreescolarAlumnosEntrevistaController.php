...
class PrimariaAlumnosEntrevistaInicialController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('preescolar.entrevista_inicial.create', [
            'paises' => $paises
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            return redirect ('entrevista')->withErrors($validator)->withInput();
        }else{
            try {
                Preescolar_alumnos_entrevista::create([
                ...
                ->showConfirmButton();
                return redirect('entrevista')->withInput();
            }
        }
     ...
     *
     * @param  \App\Preescolar_alumnos_entrevista  $preescolar_alumnos_entrevista
     * @return \Illuminate\Http\Response
     */
    public function show(Preescolar_alumnos_entrevista $preescolar_alumnos_entrevista)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Preescolar_alumnos_entrevista $preescolar_alumnos_entrevista)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, Preescolar_alumnos_entrevista $preescolar_alumnos_entrevista)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(Preescolar_alumnos_entrevista $preescolar_alumnos_entrevista)
    {
        //
    }
}
