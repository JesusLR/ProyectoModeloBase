...
use Validator;
use Auth;
class IdiomasPeriodosController extends Controller
{
    ...
    {
        return view('idiomas.periodos.show-list');
    }
    ...
    public function list()
    {
        ...
        ->addColumn('action',function($query) {
            return '<a href="idiomas_periodo/' . $query->periodo_id . '" class="button button--icon js-button js-ripple-effect" title="Ver">
                <i class="material-icons">visibility</i>
            </a>
            <a href="idiomas_periodo/' . $query->periodo_id . '/edit" class="button button--icon js-button js-ripple-effect" title="Editar">
                <i class="material-icons">edit</i>
            </a>
            <form id="delete_' . $query->periodo_id . '" action="idiomas_periodo/' . $query->periodo_id . '" method="POST" style="display:inline;">
    ...
    public function getPeriodosTodos(Request $request, $departamento_id)
    {
        $fecha = Carbon::now('CDT');
    ...
    public function getPeriodosCurso(Request $request, $departamento_id)
    {
        $fecha = Carbon::now('CDT');
    ...
    public function getPeriodoAnteActuSig(Request $request, $departamento_id)
    {
        $fecha = Carbon::now('CDT');
        ...
        if ($departamento->depClave == "IDI")
        {
            ...
            {
                $periodos = Periodo::where('departamento_id',$departamento_id)
                    ->whereIn('id', [$perAnte, $perActual, $perSiguiente])
                    ->orderBy('id', 'desc')->get();
            }
            else
            {
    ...
    */
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            return redirect ('idiomas_periodo/create')->withErrors($validator)->withInput();
        }
        ...
        try {
            ...
            return redirect('idiomas_periodo/create')->withInput();
        }
    }
    ...
    public function show($id)
    {
        ...
        return view('idiomas.periodos.show', [
            'periodo' => $periodo
        ]);
    }
    ...
    public function edit($id)
    {
        if (User::permiso("periodo") == "A" || User::permiso("periodo") == "B") {
            ...
            return view('idiomas.periodos.edit', [
                'periodo' => $periodo
            ]);
        } else {
            alert()->error('Ups...', 'Sin privilegios para esta acción!')->showConfirmButton()->autoClose(5000);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $errorMessage = $e->errorInfo[2];
            alert()->error('Ups...' . $errorCode,$errorMessage)->showConfirmButton();
            return redirect('idiomas_periodo/' . $id . '/edit')->withInput();
        }
    }
