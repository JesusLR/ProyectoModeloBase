...
class PreinscripcionAutoController extends Controller
{
    public static $becas;
    ...
    public function create() {
    	return view('preinscripcion_auto.create',[
    ...
    public function preinscribir(Request $request) {
        ...
        self::$resumenesData = ResumenAcademico::whereIn('alumno_id', $cursos->pluck('alumno_id'))
    ...
    */
    private static function procesar_resumen_academico($curso_anterior, $plan) {
        ...
        if(!$resumen) {
            $resumen = ResumenAcademico::create([
    ...
    */
    private static function buscarPagos($cursos, $periodo) {
        ...
        ->whereIn('pagConcPago', ['00', '01', '02', '03', '04', '05'])
